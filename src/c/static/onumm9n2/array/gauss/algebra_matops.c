...
feonumm9n2_t feoarrm9n2_dotproduct_FF(feoarrm9n2_t* lhs, feoarrm9n2_t* rhs){
    ...
    res = feonumm9n2_createEmpty( rhs->nip);

    feoarrm9n2_dotproduct_FF_to(lhs, rhs, &res);
...
void feoarrm9n2_dotproduct_FF_to(feoarrm9n2_t* lhs, feoarrm9n2_t* rhs, feonumm9n2_t* res){
    ...
    // Check Dimensions
    feoarrm9n2_dimCheck_FF_samesize(lhs, rhs, res);

    for (i = 0; i<res->nip; i++){

        oarrm9n2_dotproduct_OO_to( &lhs->p_data[i], &rhs->p_data[i], &res->p_data[i] );
...
feonumm9n2_t feoarrm9n2_dotproduct_OF(oarrm9n2_t* lhs, feoarrm9n2_t* rhs){
    ...
    feoarrm9n2_dotproduct_OF_to( lhs, rhs, &res);
...
void feoarrm9n2_dotproduct_OF_to( oarrm9n2_t* lhs, feoarrm9n2_t* rhs, feonumm9n2_t* res){
    ...
    // Check Dimensions
    feoarrm9n2_dimCheck_OF_samesize(lhs, rhs, res);

    for (i = 0; i < res->nip; i++){

        oarrm9n2_dotproduct_OO_to( lhs, &rhs->p_data[i], &res->p_data[i] );
...
feonumm9n2_t feoarrm9n2_dotproduct_RF( darr_t* lhs, feoarrm9n2_t* rhs){
    ...
    feoarrm9n2_dotproduct_RF_to( lhs, rhs, &res);
...
void feoarrm9n2_dotproduct_RF_to( darr_t* lhs, feoarrm9n2_t* rhs, feonumm9n2_t* res){
    ...
    // Check Dimensions
    feoarrm9n2_dimCheck_RF_samesize(lhs, rhs, res);

    for (i = 0; i < res->nip; i++){

        oarrm9n2_dotproduct_RO_to( lhs, &rhs->p_data[i], &res->p_data[i] );
...
feoarrm9n2_t feoarrm9n2_matmul_FF(feoarrm9n2_t* lhs, feoarrm9n2_t* rhs){
    ...
    // Check dimensions.
    res = feoarrm9n2_createEmpty( lhs->nrows, rhs->ncols, lhs->nip);

    feoarrm9n2_matmul_FF_to( lhs, rhs, &res);
...
void feoarrm9n2_matmul_FF_to(feoarrm9n2_t* lhs, feoarrm9n2_t* rhs, feoarrm9n2_t* res){
    ...
    // Check Dimensions
    feoarrm9n2_dimCheck_FF_matmul(lhs, rhs, res);

    for (i = 0; i<res->nip; i++){

        oarrm9n2_matmul_OO_to( &lhs->p_data[i], &rhs->p_data[i], &res->p_data[i] );
...
feoarrm9n2_t feoarrm9n2_matmul_OF(oarrm9n2_t* lhs, feoarrm9n2_t* rhs){
    ...
    // Check dimensions.
    res = feoarrm9n2_createEmpty( lhs->nrows, rhs->ncols, rhs->nip);

    feoarrm9n2_matmul_OF_to( lhs, rhs, &res);
...
void feoarrm9n2_matmul_OF_to(oarrm9n2_t* lhs, feoarrm9n2_t* rhs, feoarrm9n2_t* res){
    ...
    // Check Dimensions
    feoarrm9n2_dimCheck_OF_matmul(lhs, rhs, res);

    for (i = 0; i<res->nip; i++){

        oarrm9n2_matmul_OO_to( lhs, &rhs->p_data[i], &res->p_data[i] );
...
feoarrm9n2_t feoarrm9n2_matmul_FO(feoarrm9n2_t* lhs, oarrm9n2_t* rhs){
    ...
    feoarrm9n2_matmul_FO_to( lhs, rhs, &res);
...
void feoarrm9n2_matmul_FO_to(feoarrm9n2_t* lhs, oarrm9n2_t* rhs, feoarrm9n2_t* res){
    ...
    // Check Dimensions
    feoarrm9n2_dimCheck_FO_matmul(lhs, rhs, res);

    for (i = 0; i<res->nip; i++){

        oarrm9n2_matmul_OO_to( &lhs->p_data[i], rhs, &res->p_data[i] );
...
feoarrm9n2_t feoarrm9n2_matmul_RF(darr_t* lhs, feoarrm9n2_t* rhs){
    ...
    feoarrm9n2_matmul_RF_to( lhs, rhs, &res);
...
void feoarrm9n2_matmul_RF_to(darr_t* lhs, feoarrm9n2_t* rhs, feoarrm9n2_t* res){
    ...
    // Check Dimensions
    feoarrm9n2_dimCheck_RF_matmul(lhs, rhs, res);

    for (i = 0; i<res->nip; i++){

        oarrm9n2_matmul_RO_to( lhs, &rhs->p_data[i], &res->p_data[i] );
...
feoarrm9n2_t feoarrm9n2_matmul_FR(feoarrm9n2_t* lhs, darr_t* rhs){
    ...
    feoarrm9n2_matmul_FR_to( lhs, rhs, &res);
...
void feoarrm9n2_matmul_FR_to(feoarrm9n2_t* lhs, darr_t* rhs, feoarrm9n2_t* res){
    ...
    // Check Dimensions
    feoarrm9n2_dimCheck_FR_matmul(lhs, rhs, res);

    for (i = 0; i<res->nip; i++){

        oarrm9n2_matmul_OR_to( &lhs->p_data[i], rhs, &res->p_data[i] );
...
feonumm9n2_t feoarrm9n2_norm(feoarrm9n2_t* arr){
    ...
    res = feonumm9n2_createEmpty( arr->nip);

    feoarrm9n2_norm_to( arr, &res );
...
void feoarrm9n2_norm_to(feoarrm9n2_t* arr, feonumm9n2_t* res){
    ...
    for (i = 0; i<arr->nip; i++){
        ...
        oarrm9n2_pnorm_to( &arr->p_data[i], 2.0, &res->p_data[i]);
...
void feoarrm9n2_pnorm_to(feoarrm9n2_t* arr, coeff_t p, feonumm9n2_t* res){
    ...
    for (i = 0; i<arr->nip; i++){
        ...
        oarrm9n2_pnorm_to( &arr->p_data[i], p, &res->p_data[i]);
...
void feoarrm9n2_det_to(feoarrm9n2_t* arr, feonumm9n2_t* res){
    ...
    // Check dimensions (squareness)
    feoarrm9n2_dimCheck_F_squareness( arr, arr);
    feoarrm9n2_dimCheck_fF_elementwise(res,arr,arr);

    for (i = 0; i<arr->nip; i++){
        
        oarrm9n2_det_to( &arr->p_data[i], &res->p_data[i]);
...
void feoarrm9n2_invert_to(feoarrm9n2_t* arr, feoarrm9n2_t* res){
    ...
    feoarrm9n2_dimCheck_F_squareness( arr, res);
    
    for (i = 0; i<arr->nip; i++){

        oarrm9n2_invert_to( &arr->p_data[i], &res->p_data[i]);
...
feoarrm9n2_t feoarrm9n2_transpose(feoarrm9n2_t* arr){
    ...
    res = feoarrm9n2_createEmpty( arr->ncols, arr->nrows, arr->nip);
    
    feoarrm9n2_transpose_to( arr, &res );
...
void feoarrm9n2_transpose_to(feoarrm9n2_t* arr, feoarrm9n2_t* res){
    ...
    // Check dimensions.
    feoarrm9n2_dimCheck_F_transpose( arr, res);
    
    for (i = 0; i<arr->nip; i++){

        oarrm9n2_transpose_to( &arr->p_data[i], &res->p_data[i]);
