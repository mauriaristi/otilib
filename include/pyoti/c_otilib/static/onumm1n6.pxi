cdef extern from "oti/oti.h" nogil:
  ...
  # From ../../../include/oti/static/onumm1n6/scalar/structures.h
  
  ctypedef struct  onumm1n6_t : # {
    coeff_t r;
    coeff_t e1;
    coeff_t e11;
    coeff_t e111;
  ...
  # From ../../../include/oti/static/onumm1n6/array/structures.h
  
  ctypedef struct  oarrm1n6_t : # {
      onumm1n6_t*    p_data;
      uint64_t       nrows;
      uint64_t       ncols;
      uint64_t        size;
  ...
  # From ../../../include/oti/static/onumm1n6/scalar/gauss/structures.h
  
  ctypedef struct  feonumm1n6_t: # {
      onumm1n6_t*  p_data;
      uint64_t    nip;
  # } feonumm1n6_t;
  
  
  # From ../../../include/oti/static/onumm1n6/array/gauss/structures.h
  
  ctypedef struct  feoarrm1n6_t: # {
      oarrm1n6_t*      p_data;
      uint64_t      nrows;
      uint64_t      ncols;
      uint64_t       size;
  ...
  # =========================================================================================
  # From ../../../include/oti/static/onumm1n6/scalar/functions.h
  ...
  # From ../../../include/oti/static/onumm1n6/scalar/base.h
  ...
  # From ../../../include/oti/static/onumm1n6/scalar/utils.h
  
  void onumm1n6_get_active_bases(onumm1n6_t* num, imdir_t* list);
  
  
  # From ../../../include/oti/static/onumm1n6/scalar/algebra.h
  ...
  void onumm1n6_trunc_sum_oo_to(ord_t order, onumm1n6_t* lhs,onumm1n6_t* rhs, onumm1n6_t* res);
  void onumm1n6_trunc_sub_oo_to(ord_t order, onumm1n6_t* lhs,onumm1n6_t* rhs, onumm1n6_t* res);
  ...
  # From ../../../include/oti/static/onumm1n6/scalar/gauss.h
  
  
  
  # From ../../../include/oti/static/onumm1n6/scalar/gauss/functions.h
  ...
  # From ../../../include/oti/static/onumm1n6/scalar/gauss/base.h
  ...
  feonumm1n6_t feonumm1n6_init();
  
  
  # From ../../../include/oti/static/onumm1n6/scalar/gauss/utils.h
  ...
  # From ../../../include/oti/static/onumm1n6/scalar/gauss/algebra.h
  
  feonumm1n6_t feonumm1n6_neg(   feonumm1n6_t* num);
  void     feonumm1n6_neg_to(feonumm1n6_t* num, feonumm1n6_t* res);
  feonumm1n6_t feonumm1n6_sum_ff(   feonumm1n6_t* lhs, feonumm1n6_t* rhs);
  void     feonumm1n6_sum_ff_to(feonumm1n6_t* lhs, feonumm1n6_t* rhs, feonumm1n6_t* res);
  feonumm1n6_t feonumm1n6_sum_of(   onumm1n6_t* lhs, feonumm1n6_t* rhs);
  void     feonumm1n6_sum_of_to(onumm1n6_t* lhs, feonumm1n6_t* rhs, feonumm1n6_t* res);
  feonumm1n6_t feonumm1n6_sum_rf(   coeff_t lhs, feonumm1n6_t* rhs);
  void     feonumm1n6_sum_rf_to(coeff_t lhs, feonumm1n6_t* rhs, feonumm1n6_t* res);
  feonumm1n6_t feonumm1n6_sub_ff(     feonumm1n6_t* lhs,  feonumm1n6_t* rhs);
  void     feonumm1n6_sub_ff_to(  feonumm1n6_t* lhs,  feonumm1n6_t* rhs, feonumm1n6_t* res);
  feonumm1n6_t feonumm1n6_sub_of(    onumm1n6_t* lhs,  feonumm1n6_t* rhs);
  void     feonumm1n6_sub_of_to( onumm1n6_t* lhs,  feonumm1n6_t* rhs, feonumm1n6_t* res);
  feonumm1n6_t feonumm1n6_sub_fo(     feonumm1n6_t* lhs, onumm1n6_t* rhs);
  void     feonumm1n6_sub_fo_to(  feonumm1n6_t* lhs, onumm1n6_t* rhs, feonumm1n6_t* res);
  feonumm1n6_t feonumm1n6_sub_rf(       coeff_t lhs,  feonumm1n6_t* rhs);
  void     feonumm1n6_sub_rf_to(    coeff_t lhs,  feonumm1n6_t* rhs, feonumm1n6_t* res);
  feonumm1n6_t feonumm1n6_sub_fr(     feonumm1n6_t* lhs,    coeff_t rhs);
  void     feonumm1n6_sub_fr_to(  feonumm1n6_t* lhs,    coeff_t rhs, feonumm1n6_t* res);
  feonumm1n6_t feonumm1n6_mul_ff(   feonumm1n6_t* lhs, feonumm1n6_t* rhs);
  void     feonumm1n6_mul_ff_to(feonumm1n6_t* lhs, feonumm1n6_t* rhs, feonumm1n6_t* res);
  feonumm1n6_t feonumm1n6_mul_of(   onumm1n6_t* lhs, feonumm1n6_t* rhs);
  void     feonumm1n6_mul_of_to(onumm1n6_t* lhs, feonumm1n6_t* rhs, feonumm1n6_t* res);
  feonumm1n6_t feonumm1n6_mul_rf(   coeff_t lhs, feonumm1n6_t* rhs);
  void     feonumm1n6_mul_rf_to(coeff_t lhs, feonumm1n6_t* rhs, feonumm1n6_t* res);
  feonumm1n6_t feonumm1n6_div_ff(     feonumm1n6_t* lhs,  feonumm1n6_t* rhs);
  void     feonumm1n6_div_ff_to(  feonumm1n6_t* lhs,  feonumm1n6_t* rhs, feonumm1n6_t* res);
  feonumm1n6_t feonumm1n6_div_of(    onumm1n6_t* lhs,  feonumm1n6_t* rhs);
  void     feonumm1n6_div_of_to( onumm1n6_t* lhs,  feonumm1n6_t* rhs, feonumm1n6_t* res);
  feonumm1n6_t feonumm1n6_div_fo(     feonumm1n6_t* lhs, onumm1n6_t* rhs);
  void     feonumm1n6_div_fo_to(  feonumm1n6_t* lhs, onumm1n6_t* rhs, feonumm1n6_t* res);
  feonumm1n6_t feonumm1n6_div_rf(       coeff_t lhs,  feonumm1n6_t* rhs);
  void     feonumm1n6_div_rf_to(    coeff_t lhs,  feonumm1n6_t* rhs, feonumm1n6_t* res);
  feonumm1n6_t feonumm1n6_div_fr(     feonumm1n6_t* lhs,    coeff_t rhs);
  void     feonumm1n6_div_fr_to(  feonumm1n6_t* lhs,    coeff_t rhs, feonumm1n6_t* res);
  
  
  # From ../../../include/oti/static/onumm1n6/array/functions.h
  
  oarrm1n6_t oarrm1n6_atanh(   oarrm1n6_t* arr);
  void    oarrm1n6_atanh_to(oarrm1n6_t* arr, oarrm1n6_t* res);
  oarrm1n6_t oarrm1n6_asinh(   oarrm1n6_t* arr);
  void    oarrm1n6_asinh_to(oarrm1n6_t* arr, oarrm1n6_t* res);
  oarrm1n6_t oarrm1n6_acosh(   oarrm1n6_t* arr);
  void    oarrm1n6_acosh_to(oarrm1n6_t* arr, oarrm1n6_t* res);
  oarrm1n6_t oarrm1n6_tanh(    oarrm1n6_t* arr);
  void    oarrm1n6_tanh_to( oarrm1n6_t* arr, oarrm1n6_t* res);
  oarrm1n6_t oarrm1n6_cbrt(    oarrm1n6_t* arr);
  void    oarrm1n6_cbrt_to( oarrm1n6_t* arr, oarrm1n6_t* res);
  oarrm1n6_t oarrm1n6_sqrt(    oarrm1n6_t* arr);
  void    oarrm1n6_sqrt_to( oarrm1n6_t* arr, oarrm1n6_t* res);
  oarrm1n6_t oarrm1n6_cosh(    oarrm1n6_t* arr);
  void    oarrm1n6_cosh_to( oarrm1n6_t* arr, oarrm1n6_t* res);
  oarrm1n6_t oarrm1n6_sinh(    oarrm1n6_t* arr);
  void    oarrm1n6_sinh_to( oarrm1n6_t* arr, oarrm1n6_t* res);
  oarrm1n6_t oarrm1n6_asin(    oarrm1n6_t* arr);
  void    oarrm1n6_asin_to( oarrm1n6_t* arr, oarrm1n6_t* res);
  oarrm1n6_t oarrm1n6_acos(    oarrm1n6_t* arr);
  void    oarrm1n6_acos_to( oarrm1n6_t* arr, oarrm1n6_t* res);
  oarrm1n6_t oarrm1n6_atan(    oarrm1n6_t* arr);
  void    oarrm1n6_atan_to( oarrm1n6_t* arr, oarrm1n6_t* res);
  oarrm1n6_t oarrm1n6_tan(     oarrm1n6_t* arr);
  void    oarrm1n6_tan_to(  oarrm1n6_t* arr, oarrm1n6_t* res);
  oarrm1n6_t oarrm1n6_cos(     oarrm1n6_t* arr);
  void    oarrm1n6_cos_to(  oarrm1n6_t* arr, oarrm1n6_t* res);
  oarrm1n6_t oarrm1n6_sin(     oarrm1n6_t* arr);
  void    oarrm1n6_sin_to(  oarrm1n6_t* arr, oarrm1n6_t* res);
  oarrm1n6_t oarrm1n6_logb(    oarrm1n6_t* arr, double base);
  void    oarrm1n6_logb_to( oarrm1n6_t* arr, double base, oarrm1n6_t* res);
  oarrm1n6_t oarrm1n6_log10(   oarrm1n6_t* arr);
  void    oarrm1n6_log10_to(oarrm1n6_t* arr, oarrm1n6_t* res);
  oarrm1n6_t oarrm1n6_log(     oarrm1n6_t* arr);
  void    oarrm1n6_log_to(  oarrm1n6_t* arr, oarrm1n6_t* res);
  oarrm1n6_t oarrm1n6_exp(     oarrm1n6_t* arr);
  void    oarrm1n6_exp_to(  oarrm1n6_t* arr, oarrm1n6_t* res);
  oarrm1n6_t oarrm1n6_pow(     oarrm1n6_t* arr, double e);
  void    oarrm1n6_pow_to(  oarrm1n6_t* arr, double e, oarrm1n6_t* res);
  
  
  # From ../../../include/oti/static/onumm1n6/array/algebra_elementwise.h
  
  oarrm1n6_t oarrm1n6_neg(oarrm1n6_t* arr);
  void oarrm1n6_neg_to(oarrm1n6_t* rhs, oarrm1n6_t* res);
  oarrm1n6_t oarrm1n6_sum_OO(oarrm1n6_t*   lhs, oarrm1n6_t* rhs);
  oarrm1n6_t oarrm1n6_sum_RO(darr_t*    lhs, oarrm1n6_t* rhs);
  oarrm1n6_t oarrm1n6_sum_oO(onumm1n6_t* lhs, oarrm1n6_t* rhs);
  oarrm1n6_t oarrm1n6_sum_rO(coeff_t    lhs, oarrm1n6_t* rhs);
  void oarrm1n6_sum_OO_to(oarrm1n6_t*   lhs, oarrm1n6_t* rhs, oarrm1n6_t* res);
  void oarrm1n6_sum_RO_to(darr_t*    lhs, oarrm1n6_t* rhs, oarrm1n6_t* res);
  void oarrm1n6_sum_oO_to(onumm1n6_t* lhs, oarrm1n6_t* rhs, oarrm1n6_t* res);
  void oarrm1n6_sum_rO_to(coeff_t    lhs, oarrm1n6_t* rhs, oarrm1n6_t* res);
  void oarrm1n6_trunc_sum_OO_to(ord_t order, oarrm1n6_t* arr1, oarrm1n6_t* arr2, oarrm1n6_t* res);
  oarrm1n6_t oarrm1n6_sub_OO(oarrm1n6_t*   lhs, oarrm1n6_t*   rhs);
  oarrm1n6_t oarrm1n6_sub_RO(darr_t*    lhs, oarrm1n6_t*   rhs);
  oarrm1n6_t oarrm1n6_sub_OR(oarrm1n6_t*   lhs, darr_t*    rhs);
  oarrm1n6_t oarrm1n6_sub_oO(onumm1n6_t* lhs, oarrm1n6_t*   rhs);
  oarrm1n6_t oarrm1n6_sub_Oo(oarrm1n6_t*   lhs, onumm1n6_t* rhs);
  oarrm1n6_t oarrm1n6_sub_rO(coeff_t    lhs, oarrm1n6_t*   rhs);
  oarrm1n6_t oarrm1n6_sub_Or(oarrm1n6_t*   lhs, coeff_t    rhs);
  void oarrm1n6_sub_OO_to( oarrm1n6_t*   lhs, oarrm1n6_t*   rhs, oarrm1n6_t* res);
  void oarrm1n6_sub_RO_to( darr_t*    lhs, oarrm1n6_t*   rhs, oarrm1n6_t* res);
  void oarrm1n6_sub_OR_to( oarrm1n6_t*   lhs, darr_t*    rhs, oarrm1n6_t* res);
  void oarrm1n6_sub_oO_to( onumm1n6_t* lhs, oarrm1n6_t*   rhs, oarrm1n6_t* res);
  void oarrm1n6_sub_Oo_to( oarrm1n6_t*   lhs, onumm1n6_t* rhs, oarrm1n6_t* res);
  void oarrm1n6_sub_rO_to( coeff_t    lhs, oarrm1n6_t*   rhs, oarrm1n6_t* res);
  void oarrm1n6_sub_Or_to( oarrm1n6_t*   lhs, coeff_t    rhs, oarrm1n6_t* res);
  void oarrm1n6_trunc_sub_OO_to(ord_t order, oarrm1n6_t* arr1, oarrm1n6_t* arr2, oarrm1n6_t* res);
  oarrm1n6_t oarrm1n6_mul_OO(oarrm1n6_t*   lhs, oarrm1n6_t* rhs);
  oarrm1n6_t oarrm1n6_mul_RO(darr_t*    lhs, oarrm1n6_t* rhs);
  oarrm1n6_t oarrm1n6_mul_oO(onumm1n6_t* lhs, oarrm1n6_t* rhs);
  oarrm1n6_t oarrm1n6_mul_rO(coeff_t    lhs, oarrm1n6_t* rhs);
  void oarrm1n6_mul_OO_to(oarrm1n6_t*   lhs, oarrm1n6_t* rhs, oarrm1n6_t* res);
  void oarrm1n6_mul_RO_to(darr_t*    lhs, oarrm1n6_t* rhs, oarrm1n6_t* res);
  void oarrm1n6_mul_oO_to(onumm1n6_t* lhs, oarrm1n6_t* rhs, oarrm1n6_t* res);
  void oarrm1n6_mul_rO_to(coeff_t    lhs, oarrm1n6_t* rhs, oarrm1n6_t* res);
  void oarrm1n6_gem_OO_to(  oarrm1n6_t* arr1, oarrm1n6_t* arr2, oarrm1n6_t* arr3, oarrm1n6_t* res);
  void oarrm1n6_gem_oO_to(onumm1n6_t* arr1, oarrm1n6_t* arr2, oarrm1n6_t* arr3, oarrm1n6_t* res);
  oarrm1n6_t oarrm1n6_div_OO(oarrm1n6_t*   lhs, oarrm1n6_t*   rhs);
  oarrm1n6_t oarrm1n6_div_OR(oarrm1n6_t*   lhs, darr_t*    rhs);
  oarrm1n6_t oarrm1n6_div_RO(darr_t*    lhs, oarrm1n6_t*   rhs);
  oarrm1n6_t oarrm1n6_div_oO(onumm1n6_t* lhs, oarrm1n6_t*   rhs);
  oarrm1n6_t oarrm1n6_div_Oo(oarrm1n6_t*   lhs, onumm1n6_t* rhs);
  oarrm1n6_t oarrm1n6_div_rO(coeff_t    lhs, oarrm1n6_t*   rhs);
  oarrm1n6_t oarrm1n6_div_Or(oarrm1n6_t*   lhs, coeff_t    rhs);
  void oarrm1n6_div_OO_to(oarrm1n6_t*   lhs, oarrm1n6_t*   rhs, oarrm1n6_t* res);
  void oarrm1n6_div_RO_to(darr_t*    lhs, oarrm1n6_t*   rhs, oarrm1n6_t* res);
  void oarrm1n6_div_OR_to(oarrm1n6_t*   lhs, darr_t*    rhs, oarrm1n6_t* res);
  void oarrm1n6_div_oO_to(onumm1n6_t* lhs, oarrm1n6_t*   rhs, oarrm1n6_t* res);
  void oarrm1n6_div_Oo_to(oarrm1n6_t*   lhs, onumm1n6_t* rhs, oarrm1n6_t* res);
  void oarrm1n6_div_rO_to(coeff_t    lhs, oarrm1n6_t*   rhs, oarrm1n6_t* res);
  void oarrm1n6_div_Or_to(oarrm1n6_t*   lhs, coeff_t    rhs, oarrm1n6_t* res);
  
  
  # From ../../../include/oti/static/onumm1n6/array/base.h
  
  void    oarrm1n6_taylor_integrate_to( coeff_t* deltas, oarrm1n6_t* arr, oarrm1n6_t* res);
  oarrm1n6_t oarrm1n6_taylor_integrate(    coeff_t* deltas, oarrm1n6_t* arr);
  void    oarrm1n6_get_order_im_to( ord_t order, oarrm1n6_t* arr, oarrm1n6_t* res);
  oarrm1n6_t oarrm1n6_get_order_im(    ord_t order, oarrm1n6_t* arr);
  void oarrm1n6_set_slice_r( coeff_t val,
                          int64_t starti, int64_t stopi, int64_t stepi,
                          int64_t startj, int64_t stopj, int64_t stepj,
                           oarrm1n6_t* res);
  void oarrm1n6_set_slice_O( oarrm1n6_t* val,
                          int64_t starti, int64_t stopi, int64_t stepi,
                          int64_t startj, int64_t stopj, int64_t stepj,
                           oarrm1n6_t* res);
  void oarrm1n6_set_slice_o( onumm1n6_t* val,
                          int64_t starti, int64_t stopi, int64_t stepi,
                          int64_t startj, int64_t stopj, int64_t stepj,
                           oarrm1n6_t* res);
  oarrm1n6_t oarrm1n6_get_slice( oarrm1n6_t* arr,
                          int64_t starti, int64_t stopi, int64_t stepi,
                          int64_t startj, int64_t stopj, int64_t stepj);
  void oarrm1n6_get_slice_to( oarrm1n6_t* arr,
                          int64_t starti, int64_t stopi, int64_t stepi,
                          int64_t startj, int64_t stopj, int64_t stepj,
                           oarrm1n6_t* res);
  oarrm1n6_t oarrm1n6_truncate_im(    imdir_t idx, ord_t order, oarrm1n6_t* arr);
  void    oarrm1n6_truncate_im_to( imdir_t idx, ord_t order, oarrm1n6_t* arr, oarrm1n6_t* res);
  oarrm1n6_t oarrm1n6_extract_im(   imdir_t idx, ord_t order, oarrm1n6_t* arr);
  void    oarrm1n6_extract_im_to(imdir_t idx, ord_t order, oarrm1n6_t* arr, oarrm1n6_t* res);
  darr_t  oarrm1n6_get_deriv(    imdir_t idx, ord_t order, oarrm1n6_t* arr);
  void    oarrm1n6_get_deriv_to( imdir_t idx, ord_t order, oarrm1n6_t* arr, oarrm1n6_t* res);
  oarrm1n6_t oarrm1n6_get_deriv_o(  imdir_t idx, ord_t order, oarrm1n6_t* arr);
  oarrm1n6_t oarrm1n6_extract_deriv(    imdir_t idx, ord_t order, oarrm1n6_t* arr);
  void    oarrm1n6_extract_deriv_to( imdir_t idx, ord_t order, oarrm1n6_t* arr, oarrm1n6_t* res);
  darr_t  oarrm1n6_get_im(   imdir_t idx, ord_t order, oarrm1n6_t* arr);
  oarrm1n6_t oarrm1n6_get_im_o( imdir_t idx, ord_t order, oarrm1n6_t* arr);
  void    oarrm1n6_get_im_to(imdir_t idx, ord_t order, oarrm1n6_t* arr, oarrm1n6_t* res);
  void    oarrm1n6_copy_to(oarrm1n6_t* arr, oarrm1n6_t* res);
  oarrm1n6_t oarrm1n6_copy(oarrm1n6_t* arr);
  void oarrm1n6_set_all_r( coeff_t num, oarrm1n6_t* arr);
  void oarrm1n6_set_item_i_r( coeff_t num, uint64_t i, oarrm1n6_t* arr);
  void oarrm1n6_set_item_ij_r( coeff_t num, uint64_t i, uint64_t j, oarrm1n6_t* arr);
  void oarrm1n6_set_r(   coeff_t  num,   oarrm1n6_t* arr);
  void oarrm1n6_set_o( onumm1n6_t* num,   oarrm1n6_t* arr);
  void oarrm1n6_set_O(   oarrm1n6_t* arrin, oarrm1n6_t* arr);
  void oarrm1n6_set_all_o( onumm1n6_t* src, oarrm1n6_t* arr);
  void oarrm1n6_set_item_i_o( onumm1n6_t* num, uint64_t i, oarrm1n6_t* arr);
  void oarrm1n6_set_item_ij_o( onumm1n6_t* num, uint64_t i, uint64_t j, oarrm1n6_t* arr);
  onumm1n6_t oarrm1n6_get_item_i(    oarrm1n6_t* arr, uint64_t i);
  void      oarrm1n6_get_item_i_to( oarrm1n6_t* arr, uint64_t i,             onumm1n6_t* res);
  onumm1n6_t oarrm1n6_get_item_ij(   oarrm1n6_t* arr, uint64_t i, uint64_t j);
  void      oarrm1n6_get_item_ij_to(oarrm1n6_t* arr, uint64_t i, uint64_t j, onumm1n6_t* res);
  oarrm1n6_t oarrm1n6_init();
  void oarrm1n6_free(oarrm1n6_t* arr);
  oarrm1n6_t oarrm1n6_empty_like(oarrm1n6_t* arr);
  oarrm1n6_t oarrm1n6_eye(uint64_t nrows);
  oarrm1n6_t oarrm1n6_ones(uint64_t nrows, uint64_t ncols);
  oarrm1n6_t oarrm1n6_zeros(uint64_t nrows, uint64_t ncols);
  oarrm1n6_t oarrm1n6_createEmpty(uint64_t nrows, uint64_t ncols);
  
  
  # From ../../../include/oti/static/onumm1n6/array/utils.h
  
  void oarrm1n6_dimCheck_OO_elementwise(oarrm1n6_t* arr1, oarrm1n6_t* arr2, oarrm1n6_t* res);
  void oarrm1n6_dimCheck_RO_elementwise(darr_t*  arr1, oarrm1n6_t* arr2, oarrm1n6_t* res);
  void oarrm1n6_dimCheck_OO_matmul(oarrm1n6_t* arr1, oarrm1n6_t* arr2, oarrm1n6_t* res);
  void oarrm1n6_dimCheck_RO_matmul(darr_t*  arr1, oarrm1n6_t* arr2, oarrm1n6_t* res);
  void oarrm1n6_dimCheck_OR_matmul(oarrm1n6_t* arr1, darr_t*  arr2, oarrm1n6_t* res);
  void oarrm1n6_dimCheck_O_squareness(oarrm1n6_t* arr1, oarrm1n6_t* res);
  void oarrm1n6_dimCheck_OO_samesize(oarrm1n6_t* arr1, oarrm1n6_t* res);
  void oarrm1n6_dimCheck_RO_samesize(darr_t* arr1, oarrm1n6_t* res);
  ord_t oarrm1n6_get_order(oarrm1n6_t* arr);
  void oarrm1n6_get_active_bases(oarrm1n6_t* arr, imdir_t* list_vals);
  
  
  # From ../../../include/oti/static/onumm1n6/array/algebra_matops.h
  
  onumm1n6_t oarrm1n6_dotproduct_OO(    oarrm1n6_t* lhs, oarrm1n6_t* rhs);
  void      oarrm1n6_dotproduct_OO_to( oarrm1n6_t* lhs, oarrm1n6_t* rhs, onumm1n6_t* res);
  onumm1n6_t oarrm1n6_dotproduct_RO(     darr_t* lhs, oarrm1n6_t* rhs);
  void      oarrm1n6_dotproduct_RO_to(  darr_t* lhs, oarrm1n6_t* rhs, onumm1n6_t* res);
  oarrm1n6_t oarrm1n6_matmul_OO(    oarrm1n6_t* lhs, oarrm1n6_t* rhs);
  oarrm1n6_t oarrm1n6_matmul_OR(    oarrm1n6_t* lhs,  darr_t* rhs);
  oarrm1n6_t oarrm1n6_matmul_RO(     darr_t* lhs, oarrm1n6_t* rhs);
  void    oarrm1n6_matmul_OO_to( oarrm1n6_t* lhs, oarrm1n6_t* rhs, oarrm1n6_t* res);
  void    oarrm1n6_matmul_OR_to( oarrm1n6_t* lhs,  darr_t* rhs, oarrm1n6_t* res);
  void    oarrm1n6_matmul_RO_to(  darr_t* lhs, oarrm1n6_t* rhs, oarrm1n6_t* res);
  oarrm1n6_t oarrm1n6_transpose(    oarrm1n6_t* arr1);
  void    oarrm1n6_transpose_to( oarrm1n6_t* arr1, oarrm1n6_t* res);
  oarrm1n6_t oarrm1n6_invert(    oarrm1n6_t* arr1);
  void    oarrm1n6_invert_to( oarrm1n6_t* arr1, oarrm1n6_t* res);
  onumm1n6_t oarrm1n6_det(    oarrm1n6_t* arr1);
  void      oarrm1n6_det_to( oarrm1n6_t* arr1, onumm1n6_t* res);
  onumm1n6_t oarrm1n6_norm(    oarrm1n6_t* arr1);
  void      oarrm1n6_norm_to( oarrm1n6_t* arr1,  onumm1n6_t* res);
  onumm1n6_t oarrm1n6_pnorm(    oarrm1n6_t* arr1, coeff_t p);
  void      oarrm1n6_pnorm_to( oarrm1n6_t* arr1, coeff_t p, onumm1n6_t* res);
  
  
  # From ../../../include/oti/static/onumm1n6/array/gauss.h
  
  
  
  # From ../../../include/oti/static/onumm1n6/array/gauss/functions.h
  ...
  # From ../../../include/oti/static/onumm1n6/array/gauss/base.h
  
  void      feoarrm1n6_get_order_im_to( ord_t order, feoarrm1n6_t* arr, feoarrm1n6_t* res);
  feoarrm1n6_t feoarrm1n6_get_order_im(    ord_t order, feoarrm1n6_t* arr);
  feoarrm1n6_t feoarrm1n6_get_deriv(   imdir_t idx, ord_t order, feoarrm1n6_t* arr);
  void      feoarrm1n6_get_deriv_to(imdir_t idx, ord_t order, feoarrm1n6_t* arr, feoarrm1n6_t* res);
  feoarrm1n6_t feoarrm1n6_get_im(      imdir_t idx, ord_t order, feoarrm1n6_t* arr);
  void      feoarrm1n6_get_im_to(   imdir_t idx, ord_t order, feoarrm1n6_t* arr, feoarrm1n6_t* res);
  feoarrm1n6_t feoarrm1n6_truncate_im(   imdir_t idx, ord_t order, feoarrm1n6_t* arr);
  void      feoarrm1n6_truncate_im_to(imdir_t idx, ord_t order, feoarrm1n6_t* arr, feoarrm1n6_t* res);
  feoarrm1n6_t feoarrm1n6_copy(   feoarrm1n6_t* src);
  void      feoarrm1n6_copy_to(feoarrm1n6_t* src, feoarrm1n6_t* res);
  feoarrm1n6_t feoarrm1n6_get_im(    imdir_t idx, ord_t order, feoarrm1n6_t* arr);
  void      feoarrm1n6_get_im_to( imdir_t idx, ord_t order, feoarrm1n6_t* arr, feoarrm1n6_t* res);
  feoarrm1n6_t feoarrm1n6_get_deriv(    imdir_t idx, ord_t order, feoarrm1n6_t* arr);
  void      feoarrm1n6_get_deriv_to( imdir_t idx, ord_t order, feoarrm1n6_t* arr, feoarrm1n6_t* res);
  feoarrm1n6_t feoarrm1n6_extract_im(    imdir_t idx, ord_t order, feoarrm1n6_t* arr);
  void      feoarrm1n6_extract_im_to( imdir_t idx, ord_t order, feoarrm1n6_t* arr,  feoarrm1n6_t* res);
  feoarrm1n6_t feoarrm1n6_extract_deriv(    imdir_t idx, ord_t order, feoarrm1n6_t* arr);
  void      feoarrm1n6_extract_deriv_to( imdir_t idx, ord_t order, feoarrm1n6_t* arr, feoarrm1n6_t* res);
  oarrm1n6_t   feoarrm1n6_get_item_k(  feoarrm1n6_t* arr, uint64_t k);
  feonumm1n6_t  feoarrm1n6_get_item_ij( feoarrm1n6_t* arr, uint64_t i, uint64_t j);
  onumm1n6_t feoarrm1n6_get_item_ijk(feoarrm1n6_t* arr, uint64_t i, uint64_t j, uint64_t k);
  void feoarrm1n6_get_item_ij_to(  feoarrm1n6_t* arr, uint64_t i, uint64_t j,
                                 feonumm1n6_t* res);
  void feoarrm1n6_get_item_k_to(   feoarrm1n6_t* arr, uint64_t k,
                                  oarrm1n6_t* res);
  void feoarrm1n6_get_item_ijk_to( feoarrm1n6_t* arr, uint64_t i, uint64_t j, uint64_t k,
                                onumm1n6_t* res);
  feoarrm1n6_t feoarrm1n6_get_slice(feoarrm1n6_t* arr,
                            int64_t starti, int64_t stopi, int64_t stepi,
                            int64_t startj, int64_t stopj, int64_t stepj);
  void      feoarrm1n6_get_slice_to(feoarrm1n6_t* arr,
                            int64_t starti, int64_t stopi, int64_t stepi,
                            int64_t startj, int64_t stopj, int64_t stepj,
                            feoarrm1n6_t* res);
  void feoarrm1n6_set_item_ij_r(   coeff_t  elm, uint64_t i, uint64_t j,
                              feoarrm1n6_t* res);
  void feoarrm1n6_set_item_ij_o(  onumm1n6_t* elm, uint64_t i, uint64_t j,
                               feoarrm1n6_t* res);
  void feoarrm1n6_set_item_ij_f(  feonumm1n6_t* elm, uint64_t i, uint64_t j,
                              feoarrm1n6_t* res);
  void feoarrm1n6_set_item_k_r(    coeff_t  elm, uint64_t k,
                              feoarrm1n6_t* res);
  void feoarrm1n6_set_item_k_o(  onumm1n6_t* elm, uint64_t k,
                              feoarrm1n6_t* res);
  void feoarrm1n6_set_item_k_R(    oarrm1n6_t* elm, uint64_t k,
                            feoarrm1n6_t* res);
  void feoarrm1n6_set_item_k_O(    oarrm1n6_t* elm, uint64_t k,
                            feoarrm1n6_t* res);
  void feoarrm1n6_set_item_ijk_r(   coeff_t  elm, uint64_t i, uint64_t j, uint64_t k,
                               feoarrm1n6_t* res);
  void feoarrm1n6_set_item_ijk_o( onumm1n6_t* elm, uint64_t i, uint64_t j, uint64_t k,
                               feoarrm1n6_t* res);
  void feoarrm1n6_set_slice_r( coeff_t val,
                           int64_t starti, int64_t stopi, int64_t stepi,
                           int64_t startj, int64_t stopj, int64_t stepj,
                            feoarrm1n6_t* res);
  void feoarrm1n6_set_slice_o( onumm1n6_t* val,
                           int64_t starti, int64_t stopi, int64_t stepi,
                           int64_t startj, int64_t stopj, int64_t stepj,
                            feoarrm1n6_t* res);
  void feoarrm1n6_set_slice_f( feonumm1n6_t* val,
                           int64_t starti, int64_t stopi, int64_t stepi,
                           int64_t startj, int64_t stopj, int64_t stepj,
                            feoarrm1n6_t* res);
  void feoarrm1n6_set_slice_O( oarrm1n6_t* val,
                           int64_t starti, int64_t stopi, int64_t stepi,
                           int64_t startj, int64_t stopj, int64_t stepj,
                            feoarrm1n6_t* res);
  void feoarrm1n6_set_slice_F( feoarrm1n6_t* val,
                           int64_t starti, int64_t stopi, int64_t stepi,
                           int64_t startj, int64_t stopj, int64_t stepj,
                            feoarrm1n6_t* res);
  void feoarrm1n6_set_all_o( onumm1n6_t* num, feoarrm1n6_t* arr );
  void feoarrm1n6_set_all_r(   coeff_t  num, feoarrm1n6_t* arr );
  void feoarrm1n6_set_all_f(  feonumm1n6_t* num, feoarrm1n6_t* arr );
  void feoarrm1n6_set_r(    coeff_t src, feoarrm1n6_t* res );
  void feoarrm1n6_set_o( onumm1n6_t* src, feoarrm1n6_t* res );
  void feoarrm1n6_set_f(  feonumm1n6_t* src, feoarrm1n6_t* res );
  void feoarrm1n6_set_R(    darr_t* src, feoarrm1n6_t* res );
  void feoarrm1n6_set_O(   oarrm1n6_t* src, feoarrm1n6_t* res );
  void feoarrm1n6_set_F( feoarrm1n6_t* src, feoarrm1n6_t* res );
  feoarrm1n6_t feoarrm1n6_eye( uint64_t size,  uint64_t nip);
  feoarrm1n6_t feoarrm1n6_zeros(  uint64_t nrows,   uint64_t ncols, uint64_t nip    );
  feoarrm1n6_t feoarrm1n6_ones( uint64_t nrows,   uint64_t ncols, uint64_t nip     );
  feoarrm1n6_t feoarrm1n6_createEmpty( uint64_t nrows,   uint64_t ncols, uint64_t nIntPts);
  void feoarrm1n6_free(feoarrm1n6_t* arr);
  feoarrm1n6_t feoarrm1n6_init();
  ord_t feoarrm1n6_get_order(feoarrm1n6_t* arr);
  
  
  # From ../../../include/oti/static/onumm1n6/array/gauss/utils.h
  
  void feoarrm1n6_dimCheck_FF_samesize(feoarrm1n6_t* arr1, feoarrm1n6_t* arr2, feonumm1n6_t* res);
  void feoarrm1n6_dimCheck_OF_samesize(  oarrm1n6_t* arr1, feoarrm1n6_t* arr2, feonumm1n6_t* res);
  void feoarrm1n6_dimCheck_RF_samesize(   darr_t* arr1, feoarrm1n6_t* arr2, feonumm1n6_t* res);
  ...
  void feoarrm1n6_dimCheck_fF_elementwise( feonumm1n6_t* num1, feoarrm1n6_t* arr2, feoarrm1n6_t* res);
  void feoarrm1n6_dimCheck_Ff_elementwise(feoarrm1n6_t* arr1,  feonumm1n6_t* num2, feoarrm1n6_t* res);
  ...
  void feoarrm1n6_dimCheck_FfO_integrate(feoarrm1n6_t* arr, feonumm1n6_t* num,oarrm1n6_t* res);
  void feoarrm1n6_get_active_bases(feoarrm1n6_t* arr, imdir_t* list_vals);
  
  
  # From ../../../include/oti/static/onumm1n6/array/gauss/algebra.h
