...
// ****************************************************************************************************
void fearrso_get_order_im_to( ord_t order, fearrso_t* arr, fearrso_t* res){{
...
// ****************************************************************************************************
fearrso_t fearrso_get_order_im( ord_t order, fearrso_t* arr){{
...
// ****************************************************************************************************
void fearrso_copy_to(fearrso_t* src, fearrso_t* dst){{
...
// ****************************************************************************************************
fearrso_t fearrso_copy(fearrso_t* src){{
...
// ****************************************************************************************************
void fearrso_truncate_im_to(imdir_t idx, ord_t order, fearrso_t* arr, fearrso_t* res){{
...
// ****************************************************************************************************
fearrso_t fearrso_truncate_im(imdir_t idx, ord_t order, fearrso_t* arr){{
...
// ****************************************************************************************************
void fearrso_extract_deriv_to(imdir_t idx, ord_t order, fearrso_t* arr, fearrso_t* res){{
...
// ****************************************************************************************************
fearrso_t fearrso_extract_deriv( imdir_t idx, ord_t order, fearrso_t* arr){{
...
// ****************************************************************************************************
void fearrso_get_deriv_to(imdir_t idx, ord_t order, fearrso_t* arr, fearrso_t* res){{
...
// ****************************************************************************************************
fearrso_t fearrso_get_deriv(imdir_t idx, ord_t order, fearrso_t* arr){{
...
// ****************************************************************************************************
void fearrso_get_im_to(imdir_t idx, ord_t order, fearrso_t* arr, fearrso_t* res){{
...
// ****************************************************************************************************
void fearrso_extract_im_to(imdir_t idx, ord_t order, fearrso_t* arr, fearrso_t* res){{
...
// ****************************************************************************************************
arrso_t fearrso_get_item_k(fearrso_t* arr, uint64_t k){{
...
// ****************************************************************************************************
fesoti_t fearrso_get_item_ij(fearrso_t* arr, uint64_t i, uint64_t j){{
...
// ****************************************************************************************************
sotinum_t fearrso_get_item_ijk(fearrso_t* arr, uint64_t i, uint64_t j, uint64_t k){{
...
// ****************************************************************************************************
void fearrso_get_item_k_to(fearrso_t* arr, uint64_t k, arrso_t* res){{
...
// ****************************************************************************************************
void fearrso_get_item_ij_to(fearrso_t* arr, uint64_t i, uint64_t j, fesoti_t* res){{
...
// ****************************************************************************************************
void fearrso_get_item_ijk_to(fearrso_t* arr, uint64_t i, uint64_t j, uint64_t k, sotinum_t* res){{
...
// ****************************************************************************************************
void fearrso_set_item_k( arrso_t* arr , uint64_t k, fearrso_t* res){{
...
// // ****************************************************************************************************
// void fearrso_set_item_ij(fesoti_t* num, uint64_t i, uint64_t j, fearrso_t* res){{
...
// ****************************************************************************************************
void fearrso_set_item_ij_f(fesoti_t* num, uint64_t i, uint64_t j, fearrso_t* res){{
...
// ****************************************************************************************************
void fearrso_set_item_ij_o( sotinum_t* num, uint64_t i, uint64_t j, fearrso_t* res){{
...
// ****************************************************************************************************
void fearrso_set_item_ij_r( coeff_t num, uint64_t i, uint64_t j, fearrso_t* res){{
...
// ****************************************************************************************************
void fearrso_set_f( fesoti_t* num, fearrso_t* res ){{ 
...
// ****************************************************************************************************
void fearrso_set_o( sotinum_t* num, fearrso_t* res ){{ 
...
// ****************************************************************************************************
void fearrso_set_r( coeff_t num, fearrso_t* res ){{ 
...
// ****************************************************************************************************
void fearrso_set_all_f( fesoti_t* num, fearrso_t* res ){{ 
...
// ****************************************************************************************************
void fearrso_set_all_o( sotinum_t* num, fearrso_t* res ){{ 
...
// ****************************************************************************************************
void fearrso_set_all_r( coeff_t num, fearrso_t* res ){{ 
