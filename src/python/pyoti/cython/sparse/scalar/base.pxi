...
cdef class sotinum:
  ...
  def __add__(self, other_in):
    """
    Addition of sotinum with other elements.

    Note: Self is always thought of sotinum.
    """
    #*************************************************************************************************
  ...
  # #***************************************************************************************************
  # def __radd__(self, other_in):
  #   """
  #   Addition of sotinum with other elements. (.) + o
  ...
  # #***************************************************************************************************
  # def __rsub__(self, other_in):
  #   """
  #   Subtraction of sotinum objects.

  #   It overloads the subtract operator "-". It allows the 
  #   subtraction of spr_otinum numbers of different orders, 
  #   and the subtraction of a spr_otinum number and a scalar. 
