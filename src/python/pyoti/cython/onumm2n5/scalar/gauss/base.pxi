...
cdef class feonumm2n5:
  ...
  def __init__(self, real, uint64_t nip): 
    """
    PURPOSE:      Python level constructor of the feonumm2n5 class.
  ...
  #***************************************************************************************************
  @staticmethod
  cdef feonumm2n5 create(feonumm2n5_t* num, uint8_t FLAGS = 1):
    """
    ...
    cdef feonumm2n5 res = <feonumm2n5> feonumm2n5.__new__(feonumm2n5)
  ...
  def  __getitem__(self, val):
    ...
    return onumm2n5.create(&res, FLAGS=0)
