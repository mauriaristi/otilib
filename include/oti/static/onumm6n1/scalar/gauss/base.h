#ifndef OTI_ONUMM6N1_SCALAR_GAUSS_BASE_H
#define OTI_ONUMM6N1_SCALAR_GAUSS_BASE_H
...
@param[in] num FEonumm6n1 to free
******************************************************************************************************/
...
@param[in] num FEonumm6n1
******************************************************************************************************/
ord_t feonumm6n1_get_order( feonumm6n1_t* num );
// ----------------------------------------------------------------------------------------------------

/**************************************************************************************************//**
@brief Initialize a feonumm6n1 structure.

******************************************************************************************************/
feonumm6n1_t feonumm6n1_init(void);
// ----------------------------------------------------------------------------------------------------
