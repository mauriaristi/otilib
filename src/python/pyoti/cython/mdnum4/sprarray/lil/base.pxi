...
cdef class lil_mdmat4:
  ...
  def __init__(self, shape): 
    """
    PURPOSE:      Python level constructor of the lil_mdmat4 class.

    DESCRIPTION:  Creates a new empty lil_mdmat4 matrix.
  ...
  def copy(self):
    ...
    cdef lil_mdmat4 res = lil_mdmat4(self.shape)
    cdef uint64_t i, k
  ...
  def tocsr(self):
    ...
    """
    return csr_mdmat4(self,shape=self.shape)
