...
cdef class mdarr2_t:
  ...
  def __init__(self, realArray, ord_t order = 0, bases_t nbases = 0, object nnz = None): 
    """
    PURPOSE:      Python level constructor of the mdarr2_t class.
  ...
  #***************************************************************************************************
  @staticmethod
  cdef mdarr2_t create(mdarr2_t* arr, uint8_t FLAGS = 1):
    """
    ...
    cdef mdarr2_t mat = <mdarr2_t> mdarr2_t.__new__(mdarr2_t)
  ...
  def __repr__(self):
    ...
    #     out+= (mdnum2_t.create(&d_mdnum2,FLAGS=0)).__str__()+", "
    #   # end for 
    #   out = out[:-2] + "],\n"
    # # end for 
    # out =out[:-2] + "]"
  ...
  cpdef set(self, object rhs):
    ...
    if   trhs is mdnum2_t:
      ...
      raise ValueError( "Cant assign '{0}' into a mdarr2_t object.".format(trhs) )
  ...
  def get_active(self):
    ...
    mdarr2_get_active( &self.arr, bases_list)
  ...
  #***************************************************************************************************
  @staticmethod
  def dot( mdarr2_t lhs, mdarr2_t rhs, mdarr2_t out = None): 
    """
  ...
  #***************************************************************************************************
  @staticmethod
  def inv( mdarr2_t arr,  mdarr2_t out = None): 
    """
  ...
  #***************************************************************************************************
  @staticmethod
  def transpose( mdarr2_t arr,  mdarr2_t out = None ): 
    """
  ...
  #***************************************************************************************************
  @staticmethod
  def add( mdarr2_t lhs, mdarr2_t rhs, mdarr2_t out = None): 
    """
