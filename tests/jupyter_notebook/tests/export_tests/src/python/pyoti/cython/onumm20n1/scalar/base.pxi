...
cdef class onumm20n1_t:
  ...
  def __init__(self, coeff_t re_coeff, bases_t nbases = 0,ord_t order = 0, uint8_t FLAGS = 1, 
    ...
    if nnz is not None:
      ...
      self.num =  onumm20n1_createEmpty(p_nnz, orderdef)
      ...
      self.num =  onumm20n1_createEmpty(p_nnz, order)
      ...
      self.num =  onumm20n1_createReal(re_coeff, order)
  ...
  #***************************************************************************************************
  @staticmethod
  cdef onumm20n1_t create( onumm20n1_t* num, uint8_t FLAGS = 1 ):
    """
    ...
    cdef onumm20n1_t otin = <onumm20n1_t> onumm20n1_t.__new__(onumm20n1_t)
  ...
  def __repr__(self):
    """
    PURPOSE:  To print a representation of the onumm20n1_t object in a compact form.
    """
    #*************************************************************************************************
  ...
  def long_repr(self):
    """
    PURPOSE:  To print a representation of the onumm20n1_t object in a full detail form.
    """
    #*************************************************************************************************
    global h
    global p_dH
  ...
  def __str__(self):
    """
    PURPOSE: To print a representation of the onumm20n1_t object that could 
  ...
  def __getitem__(self, list index):
    """
    PURPOSE:  To get the value of a onumm20n1_t coefficient.
    ...
    return onumm20n1_get_item( idx, order, &self.num)
  ...
  def __setitem__(self, list item, coeff_t value):
    """
    PURPOSE:  To set the value of a onumm20n1_t coefficient.
    ...
    onumm20n1_set_item( value, index, order, &self.num)
  ...
  def __neg__(self):
    ...
    cdef onumm20n1_t res = onumm20n1_neg(&self.num)
  ...
  def __add__(self, other_in):
    """
    PURPOSE:      Add onumm20n1_t with other things.
  ...
  #************************************************************************
    ...
    if ( type1 is type2) : # Case Sum between OTIs.
      tmp1 = self
      tmp2 = other_in
      res =  onumm20n1_sub_oo(&tmp1.num, &tmp2.num);
    
    elif (type2 in number_types): # Case Sum to real number. Very slow, consider changing this...
      
      tmp1 = self
      res = onumm20n1_sub_or(&tmp1.num, other_in);

    elif (type1 in number_types): # Case 1.5. reverse Sum to real number.
      
      tmp1 = other_in
      res = onumm20n1_sub_ro(self, &tmp1.num);   
  ...
  def __mul__(self, other_in):
    ...
    if ( type1 is type2) : # Case Sum between OTIs.
      ...
      tmp1 = self
      tmp2 = other_in
      res = onumm20n1_mul_oo( &tmp1.num, &tmp2.num)
    
    elif (type2 in number_types): # Case Sum to real number. Very slow, consider changing this...
      
      tmp1 = self
      res = onumm20n1_mul_ro( other_in, &tmp1.num);

    elif (type1 in number_types): # Case 1.5. reverse Sum to real number.
      
      tmp1 = other_in
      res = onumm20n1_mul_ro( self, &tmp1.num);       
  ...
  def __truediv__(self, other_in):
    """
    PURPOSE:      To define how to divide two onumm20n1_t numbers.
  ...
  def __pow__(self, n,z):
    ...
    cdef onumm20n1_t S = self

    res = onumm20n1_pow(&S.num, n)
  ...
  cpdef set(self, object rhs):
    ...
    if trhs is onumm20n1_t:
      ...
      orhs = rhs
      onumm20n1_set_o( &orhs.num, &self.num)

    else:
      rrhs = rhs
      onumm20n1_set_r( rrhs, &self.num)      
  ...
  cpdef  set_im( self,  object val, object humdir):
    ...
    if tval is onumm20n1_t:
      ...
      oval = val
      onumm20n1_set_im_o( &oval.num, indx, order, &self.num) 

    else:

      rval = val
      onumm20n1_set_im_r( val, indx, order, &self.num) 
  ...
  cpdef  set_deriv( self,  object val, object humdir):
    ...
    if tval is onumm20n1_t:
      ...
      oval = val
      onumm20n1_set_deriv_o( &oval.num, indx, order, &self.num) 

    else:

      rval = val
      onumm20n1_set_deriv_r( val, indx, order, &self.num) 
  ...
  cpdef  truncate( self, object humdir):
    ...
    res = onumm20n1_truncate_im( indx, order, &self.num) 
  ...
  cpdef get_deriv( self, object humdir):
    ...
    indx, order = imdir(humdir)
    return onumm20n1_get_deriv(indx,order, &self.num) 
  ...
  cpdef get_im( self, object humdir):
    ...
    indx, order = imdir(humdir)
    return onumm20n1_get_item(indx,order, &self.num) 
  ...
  cpdef extract_im( self, object humdir):
    ...
    res = onumm20n1_extract_im(indx,order, &self.num) 
  ...
  cpdef extract_deriv( self, object humdir):
    ...
    res = onumm20n1_extract_deriv(indx,order, &self.num)
  ...
  cpdef get_order_im( self, ord_t order):
    ...
    res = onumm20n1_get_order_im( order, &self.num)
  ...
  def copy(self):
    ...
    cdef onumm20n1_t res = onumm20n1_copy( &self.num )
    return onumm20n1_t.create(&res)
  ...
  def get_active_bases(self):
    ...
    onumm20n1_get_active_bases( &self.num, bases_list)
  ...
  def taylor_integrate(self, object bases, object deltas):
    ...
    res = onumm20n1_taylor_integrate( c_deltas, &self.num)
