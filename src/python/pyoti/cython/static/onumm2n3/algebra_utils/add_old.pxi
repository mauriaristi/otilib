...
# cdef object __add__FX__(feomatm2n3 Flhs, object rhs, object out = None):
#   """
#   PURPOSE:  Addition between feomatm2n3 and object.
...
cdef object __add__OX__(omatm2n3 Olhs, object rhs, object out = None):
  """
  PURPOSE:  Addition between omatm2n3 and an object.
  ...
  #   if res_flag:
  #     Fres = out
  #     feonumm2n3_sum_Of_to( &Orhs.arr, &flhs.num ,&Fres.arr)
  #   else:      
  #     cFres = feonumm2n3_sum_Of( &Orhs.arr, &flhs.num)
  #     res = feomatm2n3.create(&cFres)
  #   # end if
    ...
    if res_flag:
      ...
      cOres = oarrm2n3_sum_OO( &Orhs.arr, &Orhs.arr)
      res = omatm2n3.create( &cOres )
    # end if
...
cdef object __add__RX__(dmat Rlhs, object rhs, object out = None):
  """
  PURPOSE:  Addition between onumm2n3 and an object.
  ...
  #   if res_flag:
  #     ores = out
  #     onumm2n3_sum_Ro_to( &Rlhs.arr, &orhs.num ,&ores.num)
  #   else:
  #     cores = onumm2n3_sum_Ro( &Rlhs.arr, &orhs.num )
  ...
  #   if res_flag:
  #     fres = out
  #     feonumm2n3_sum_Rf_to( &Rlhs.arr, &frhs.num ,&fres.num)
  #   else:      
  #     cfres = feonumm2n3_sum_Rf( &Rlhs.arr, &frhs.num)
...
cdef object __add__fX__(feonumm2n3 flhs, object rhs, object out = None):
  """
  PURPOSE:  Addition between feonumm2n3 and an object.
  ...
  #   if res_flag:
  #     Rres = out
  #     feonumm2n3_sum_Rf_to( &Rrhs.arr, &flhs.num ,&Fres.arr)
  #   else:      
  #     cFres = feonumm2n3_sum_Rf( &Rrhs.arr, &flhs.num)
  #     res = feomatm2n3.create(&cFres)
  #   # end if
...
cdef object __add__oX__(onumm2n3 olhs, object rhs, object out = None):
  ...
  #   if res_flag:
  #     Ores = out
  #     onumm2n3_sum_oR_to( &olhs.num, &Rrhs.arr ,&Ores.arr)
  #   else:      
  #     cOres = onumm2n3_sum_oR( &olhs.num, &Rrhs.arr)
  #     res = omatm2n3.create(&cOres)
  #   # end if
