...
cdef class feomatm3n2:
  ...
  def __init__(self, shape, uint64_t nip): 
    """
    PURPOSE:      Python level constructor of the feomatm3n2 class.
    ...
    if (isinstance(shape, tuple)):
      ...
      if( ndim == 1 ):
        ...
        raise ValueError("Cant create feomatm3n2 for dimensions greater than 2.")
    ...
    for i in range(self.arr.nrows):
      for j in range(self.arr.ncols):
        for k in range(self.arr.nip):
          ...
          fedarr_set_item_ijk_r( onumm3n2_tmp.r , i, j, k, &tmp.arr);
        # end for
      # end for
    # end for
  ...
  #***************************************************************************************************
  @staticmethod
  cdef feomatm3n2 create(feoarrm3n2_t* arr, uint8_t FLAGS = 1):
    """
    ...
    cdef feomatm3n2 res = <feomatm3n2> feomatm3n2.__new__(feomatm3n2)
  ...
  #***************************************************************************************************
  cdef __setitem__f(self,  object val, feonumm3n2 value):
    """
    PURPOSE: Set item from feonumm3n2 value.
    """
    #*************************************************************************************************
  ...
  #***************************************************************************************************
  cdef __setitem__F(self,  object val, feomatm3n2 value):
    """
    PURPOSE: Set item from feomatm3n2 value.
    """
    #*************************************************************************************************
  ...
  def __add__(self, other):
    ...
    cdef feomatm3n2 Flhs,Frhs
    cdef feonumm3n2  flhs,frhs
    cdef dmat    Dlhs,Drhs
    cdef onumm3n2 olhs,orhs
    cdef omatm3n2   Olhs,Orhs
  ...
  cpdef set_ijk(self, object rhs, uint64_t i, uint64_t j, uint64_t k):
    ...
    if   trhs is onumm3n2:
      ...
      orhs = rhs
      feoarrm3n2_set_item_ijk_o( &orhs.num, i, j, k, &self.arr)
      ...
      try:
        ...
        rrhs = rhs
        feoarrm3n2_set_item_ijk_r( rrhs, i, j, k, &self.arr)
      
      except:
      
        raise ValueError("Supported values are real scalar and onumm3n2.")
  ...
  cpdef set(self, object rhs):
    ...
    #   feoarrm3n2_set_F( &Frhs.arr, &self.arr)   
      ...
      try:
        ...
        raise ValueError("Supported values are real scalar, onumm3n2 and feonumm3n2.")
  ...
  #***************************************************************************************************
  cpdef  get_item_ij( self, int64_t i, int64_t j, feonumm3n2 out=None):
    """
    PURPOSE:      Get an item from feomatm3n2 array.
