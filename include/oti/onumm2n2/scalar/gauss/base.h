#ifndef OTI_ONUMM2N2_SCALAR_GAUSS_BASE_H
#define OTI_ONUMM2N2_SCALAR_GAUSS_BASE_H
...
@param[in] num FEonumm2n2 to free
******************************************************************************************************/
...
@param[in] num FEonumm2n2
******************************************************************************************************/
ord_t feonumm2n2_get_order( feonumm2n2_t* num );
// ----------------------------------------------------------------------------------------------------

/**************************************************************************************************//**
@brief Initialize a feonumm2n2 structure.

******************************************************************************************************/
feonumm2n2_t feonumm2n2_init(void);
// ----------------------------------------------------------------------------------------------------
