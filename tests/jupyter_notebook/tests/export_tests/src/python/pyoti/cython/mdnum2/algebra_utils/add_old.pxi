...
# ARRAY
#*****************************************************************************************************
cdef object __add__FX__(femdarr2_t Flhs, object rhs, object out = None):
  """
  PORPUSE: Addition between femdarr2_t and object.
...
# cdef object __add__FX__(femdarr2_t Flhs, object rhs, object out = None):
#   """
#   PURPOSE:  Addition between femdarr2_t and object.
...
#*****************************************************************************************************
cdef object __add__OX__(mdarr2_t Olhs, object rhs, object out = None):
  """
  PURPOSE:  Addition between mdarr2_t and an object.
  ...
  #   if res_flag:
  #     Fres = out
  #     femdnum2_sum_Of_to( &Orhs.arr, &flhs.num ,&Fres.arr)
  #   else:      
  #     cFres = femdnum2_sum_Of( &Orhs.arr, &flhs.num)
  #     res = femdarr2_t.create(&cFres)
  #   # end if
    ...
    if res_flag:
      ...
      cOres = mdarr2_sum_OO( &Orhs.arr, &Orhs.arr)
      res = mdarr2_t.create( &cOres )
    # end if
...
cdef object __add__RX__(dmat Rlhs, object rhs, object out = None):
  """
  PURPOSE:  Addition between mdnum2_t and an object.
  ...
  #   if res_flag:
  #     ores = out
  #     mdnum2_sum_Ro_to( &Rlhs.arr, &orhs.num ,&ores.num)
  #   else:
  #     cores = mdnum2_sum_Ro( &Rlhs.arr, &orhs.num )
  ...
  #   if res_flag:
  #     fres = out
  #     femdnum2_sum_Rf_to( &Rlhs.arr, &frhs.num ,&fres.num)
  #   else:      
  #     cfres = femdnum2_sum_Rf( &Rlhs.arr, &frhs.num)
...
#*****************************************************************************************************
cdef object __add__fX__(femdnum2_t flhs, object rhs, object out = None):
  """
  PURPOSE:  Addition between femdnum2_t and an object.
  ...
  #   if res_flag:
  #     Rres = out
  #     femdnum2_sum_Rf_to( &Rrhs.arr, &flhs.num ,&Fres.arr)
  #   else:      
  #     cFres = femdnum2_sum_Rf( &Rrhs.arr, &flhs.num)
  #     res = femdarr2_t.create(&cFres)
  #   # end if
...
#*****************************************************************************************************
cdef object __add__oX__(mdnum2_t olhs, object rhs, object out = None):
  """
  PURPOSE:  Addition between mdnum2_t and an object.
  ...
  #   if res_flag:
  #     Ores = out
  #     mdnum2_sum_oR_to( &olhs.num, &Rrhs.arr ,&Ores.arr)
  #   else:      
  #     cOres = mdnum2_sum_oR( &olhs.num, &Rrhs.arr)
  #     res = mdarr2_t.create(&cOres)
  #   # end if
