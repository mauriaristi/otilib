...
cdef class csr_mdmat2:
  ...
  def __init__(self, arg1, shape=None, copy = True): 
    """
    PURPOSE:      Python level constructor of the csr_mdmat2 class.

    DESCRIPTION:  Creates a new empty csr_mdmat2 matrix.
  ...
  def copy(self):
    ...
    cdef csr_mdmat2 res = <csr_mdmat2> csr_mdmat2.__new__(csr_mdmat2)
    cdef object[:]   data
  ...
  def get_active_bases(self):
    ...
    for i in range(self.data.size):
      ...
      oval = self.data[i]
      mdnum2_get_active_bases( &oval.num, bases_list)
...
# ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
# :::::::::::::::::::::::::::::::::::: END OF CLASS csr_mdmat2 ::::::::::::::::::::::::::::::::::::::::
# ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::

# ****************************************************************************************************
cdef void csrmdmat2_matmul_SO_to(csr_mdmat2 lhs, mdmat2 rhs, mdmat2 res):
  """
...
# ****************************************************************************************************
cdef mdmat2 csrmdmat2_matmul_SO(csr_mdmat2 lhs, mdmat2 rhs):
  """
  PORPUSE:  Perform matrix-matrix multiplication between csr matrix and dense matrix.
  ...
  csrmdmat2_matmul_SO_to( lhs, rhs, res)
