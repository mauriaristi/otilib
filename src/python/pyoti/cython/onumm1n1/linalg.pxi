...
cpdef dot(object lhs, object rhs, object out = None):
  ...
  elif tlhs is csr_omatm1n1:

    # Slhs = lhs
    if   trhs is omatm1n1: # SO
      if res_flag:
        Ores = out
        csromatm1n1_matmul_SO_to( lhs, rhs, Ores)
      else:
        res = csromatm1n1_matmul_SO( lhs, rhs)
      # end if 
...
#*****************************************************************************************************
cdef solve_sparse(csr_omatm1n1 K_in, omatm1n1 b_in, omatm1n1 out = None):
  """
  PURPOSE:   Solve OTI linear system of equations for a dense K_in.
  """
  #***************************************************************************************************
...
cpdef set_order_im_from_array(ord_t ordi, np.ndarray arr, omatm1n1 tmp):
  ...
  #     tmp[i,j] += onumm1n1.create( &otmp, FLAGS = 0)
