...
cdef object __mul__OX__({arr_pytype} Olhs, object rhs, object out = None):
  ...
  if trhs == {num_pytype}:
    ...
    if res_flag:
      Ores = out
      {arr_func}_mul_oO_to( &orhs.num, &Olhs.arr, &Ores.arr )
    else:
      cOres = {arr_func}_mul_oO( &orhs.num, &Olhs.arr )
    ...
    if res_flag:
      Ores = out
      {arr_func}_mul_OO_to( &Olhs.arr, &Orhs.arr, &Ores.arr )
    else:
      cOres = {arr_func}_mul_OO( &Olhs.arr, &Orhs.arr )
      res = {arr_pytype}.create( &cOres )
    # end if
  elif trhs == dmat:
    Rrhs = rhs
    if res_flag:
      Ores = out
      {arr_func}_mul_RO_to( &Rrhs.arr, &Olhs.arr, &Ores.arr )
    else:
      cOres = {arr_func}_mul_RO( &Rrhs.arr, &Olhs.arr )
      res = {arr_pytype}.create( &cOres )
    # end if
  elif trhs in number_types:
    rrhs = rhs
    if res_flag:
      Ores = out
      {arr_func}_mul_rO_to( rrhs, &Olhs.arr, &Ores.arr )
    else:
      cOres = {arr_func}_mul_rO( rrhs, &Olhs.arr )
      res = {arr_pytype}.create( &cOres )
    # end if
  else:
...
cdef object __mul__RX__(dmat Rlhs, object rhs, object out = None):
  ...
  if trhs == {fearr_pytype}:
    ...
    if res_flag:
      Ores = out
      {arr_func}_mul_RO_to( &Rlhs.arr, &Orhs.arr, &Ores.arr )
    else:
      cOres = {arr_func}_mul_RO( &Rlhs.arr, &Orhs.arr )
      res = {arr_pytype}.create( &cOres )
    # end if
  elif trhs == dmat:
    Rrhs = rhs
...
cdef object __mul__oX__({num_pytype} olhs, object rhs, object out = None):
  ...
  if trhs == {num_pytype}:
    ...
    if res_flag:
      Ores = out
      {arr_func}_mul_oO_to( &olhs.num, &Orhs.arr, &Ores.arr )
    else:
      cOres = {arr_func}_mul_oO( &olhs.num, &Orhs.arr )
      res = {arr_pytype}.create( &cOres )
    # end if
  elif trhs in number_types:
    rrhs = rhs
...
cdef object __mul__rX__(coeff_t rlhs, object rhs, object out = None):
  ...
  if trhs == {num_pytype}:
    ...
    if res_flag:
      Ores = out
      {arr_func}_mul_rO_to( rlhs, &Orhs.arr, &Ores.arr )
    else:
      cOres = {arr_func}_mul_rO( rlhs, &Orhs.arr )
      res = {arr_pytype}.create( &cOres )
    # end if
  elif trhs == dmat:
    Rrhs = rhs
