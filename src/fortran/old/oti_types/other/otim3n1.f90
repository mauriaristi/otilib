MODULE OTIM3N1
  ...
  INTERFACE OPERATOR(*)
    MODULE PROCEDURE ONUMM3N1_MUL_ONUMM3N1,R_MUL_ONUMM3N1,ONUMM3N1_MUL_R
  END INTERFACE

  INTERFACE OPERATOR(+)
    MODULE PROCEDURE ONUMM3N1_ADD_ONUMM3N1,R_ADD_ONUMM3N1,ONUMM3N1_ADD_R
  END INTERFACE

  INTERFACE OPERATOR(-)
    MODULE PROCEDURE ONUMM3N1_NEG,ONUMM3N1_SUB_ONUMM3N1,R_SUB_ONUMM3N1,ONUMM3N1_SUB_R
  END INTERFACE
  ...
  ELEMENTAL FUNCTION ONUMM3N1_ADD_ONUMM3N1(LHS,RHS)&
    RESULT(RES)
    IMPLICIT NONE
  ...
  END FUNCTION ONUMM3N1_ADD_ONUMM3N1

  ELEMENTAL FUNCTION R_ADD_ONUMM3N1(LHS,RHS)&
    RESULT(RES)
    IMPLICIT NONE
    REAL(DP), INTENT(IN) :: LHS 
    TYPE(ONUMM3N1), INTENT(IN) :: RHS 
  ...
  END FUNCTION R_ADD_ONUMM3N1

  ELEMENTAL FUNCTION ONUMM3N1_ADD_R(LHS,RHS)&
    RESULT(RES)
    IMPLICIT NONE
    TYPE(ONUMM3N1), INTENT(IN) :: LHS 
  ...
  ELEMENTAL FUNCTION ONUMM3N1_SUB_ONUMM3N1(LHS,RHS)&
    RESULT(RES)
    IMPLICIT NONE
    TYPE(ONUMM3N1), INTENT(IN) :: LHS 
    TYPE(ONUMM3N1), INTENT(IN) :: RHS 
  ...
  END FUNCTION ONUMM3N1_SUB_ONUMM3N1

  ELEMENTAL FUNCTION R_SUB_ONUMM3N1(LHS,RHS)&
    RESULT(RES)
    IMPLICIT NONE
    REAL(DP), INTENT(IN) :: LHS 
    TYPE(ONUMM3N1), INTENT(IN) :: RHS 
  ...
  END FUNCTION R_SUB_ONUMM3N1

  ELEMENTAL FUNCTION ONUMM3N1_SUB_R(LHS,RHS)&
    RESULT(RES)
    IMPLICIT NONE
    TYPE(ONUMM3N1), INTENT(IN) :: LHS 
    REAL(DP), INTENT(IN) :: RHS 
  ...
  END FUNCTION ONUMM3N1_SUB_R

  ELEMENTAL FUNCTION ONUMM3N1_MUL_ONUMM3N1(LHS,RHS)&
    RESULT(RES)
    IMPLICIT NONE
    TYPE(ONUMM3N1), INTENT(IN) :: LHS 
    TYPE(ONUMM3N1), INTENT(IN) :: RHS 
  ...
  END FUNCTION ONUMM3N1_MUL_ONUMM3N1

  ELEMENTAL FUNCTION R_MUL_ONUMM3N1(LHS,RHS)&
    RESULT(RES)
    IMPLICIT NONE
    REAL(DP), INTENT(IN) :: LHS 
    TYPE(ONUMM3N1), INTENT(IN) :: RHS 
  ...
  END FUNCTION R_MUL_ONUMM3N1

  ELEMENTAL FUNCTION ONUMM3N1_MUL_R(LHS,RHS)&
    RESULT(RES)
    IMPLICIT NONE
    TYPE(ONUMM3N1), INTENT(IN) :: LHS 
    REAL(DP), INTENT(IN) :: RHS 
