#ifndef OTI_ONUMM4N1_SCALAR_GAUSS_BASE_H
#define OTI_ONUMM4N1_SCALAR_GAUSS_BASE_H
...
@param[in] num FEonumm4n1 to free
******************************************************************************************************/
...
@param[in] num FEonumm4n1
******************************************************************************************************/
ord_t feonumm4n1_get_order( feonumm4n1_t* num );
// ----------------------------------------------------------------------------------------------------

/**************************************************************************************************//**
@brief Initialize a feonumm4n1 structure.

******************************************************************************************************/
feonumm4n1_t feonumm4n1_init(void);
// ----------------------------------------------------------------------------------------------------
