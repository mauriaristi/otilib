...
cdef class onumm5n3:
  ...
  def __init__(self, coeff_t re_coeff):
    ...
    self.num = onumm5n3_create_r(re_coeff)
  ...
  def  order(self): 
    ...
    return onumm5n3_get_order(&self.num)
  ...
  #***************************************************************************************************
  @staticmethod
  cdef onumm5n3 create( onumm5n3_t* num, uint8_t FLAGS = 1 ):
    """
    ...
    cdef onumm5n3 otin = <onumm5n3> onumm5n3.__new__(onumm5n3)

    otin.num     = onumm5n3_copy(num)
  ...
  def __repr__(self):
    """
    PURPOSE:  To print a representation of the onumm5n3 object in a compact form.
    """
    #*************************************************************************************************
    ...
    for ordi in range(1,self.order+1):
      ...
      for i in range( onumm5n3_get_ndir_order(ordi,&self.num) ):
        
        idx = onumm5n3_get_indx(i, ordi) 
        num = '%+.4f'%( onumm5n3_get_item(idx,ordi,&self.num) )
  ...
  def short_repr(self):
    ...
    head = 'onumm5n3('
    body = str(self.num.r) + ", nnz: " + str(onumm5n3_get_ndir_total(&self.num)) + ', order: ' + str(self.order)
    tail = ')'
  ...
  def __str__(self):
    """
    PURPOSE: To print a representation of the onumm5n3 object that could 
  ...
  def __getitem__(self, list index):
    """
    PURPOSE:  To get the value of a onumm5n3 coefficient.
    ...
    return onumm5n3_get_item( idx, order, &self.num)
  ...
  def __setitem__(self, list item, coeff_t value):
    """
    PURPOSE:  To set the value of a onumm5n3 coefficient.
    ...
    onumm5n3_set_item( value, index, order, &self.num)
  ...
  def __neg__(self):
    ...
    cdef onumm5n3_t res = onumm5n3_neg(&self.num)
  ...
  def __add__(self, other_in):
    """
    PURPOSE:      Add onumm5n3 with other things.
  ...
  #************************************************************************
    ...
    if ( type1 is type2) : # Case Sum between OTIs.
      tmp1 = self
      tmp2 = other_in
      res =  onumm5n3_sub_oo(&tmp1.num, &tmp2.num);
    
    elif (type2 in number_types): # Case Sum to real number. Very slow, consider changing this...
      
      tmp1 = self
      res = onumm5n3_sub_or(&tmp1.num, other_in);

    elif (type1 in number_types): # Case 1.5. reverse Sum to real number.
      
      tmp1 = other_in
      res = onumm5n3_sub_ro(self, &tmp1.num);   
  ...
  def __mul__(self, other_in):
    ...
    if ( type1 is type2) : # Case Sum between OTIs.
      ...
      tmp1 = self
      tmp2 = other_in
      res = onumm5n3_mul_oo( &tmp1.num, &tmp2.num)
    
    elif (type2 in number_types): # Case Sum to real number. Very slow, consider changing this...
      
      tmp1 = self
      res = onumm5n3_mul_ro( other_in, &tmp1.num);

    elif (type1 in number_types): # Case 1.5. reverse Sum to real number.
      
      tmp1 = other_in
      res = onumm5n3_mul_ro( self, &tmp1.num);       
  ...
  def __truediv__(self, other_in):
    """
    PURPOSE:      To define how to divide two onumm5n3 numbers.
  ...
  def __pow__(self, n,z):
    ...
    cdef onumm5n3_t res
    cdef onumm5n3 S = self

    res = onumm5n3_pow(&S.num, n)
  ...
  cpdef set(self, object rhs):
    ...
    if trhs is onumm5n3:
      ...
      orhs = rhs
      onumm5n3_set_o( &orhs.num, &self.num)

    else:
      rrhs = rhs
      onumm5n3_set_r( rrhs, &self.num)      
  ...
  cpdef  set_im( self,  object val, object humdir):
    ...
    if tval is onumm5n3:
      ...
      oval = val
      onumm5n3_set_im_o( &oval.num, indx, order, &self.num) 

    else:

      rval = val
      onumm5n3_set_im_r( val, indx, order, &self.num) 
  ...
  cpdef  set_deriv( self,  object val, object humdir):
    ...
    if tval is onumm5n3:
      ...
      oval = val
      onumm5n3_set_deriv_o( &oval.num, indx, order, &self.num) 

    else:

      rval = val
      onumm5n3_set_deriv_r( val, indx, order, &self.num) 
  ...
  cpdef  truncate( self, object humdir):
    ...
    res = onumm5n3_truncate_im( indx, order, &self.num) 
  ...
  cpdef get_deriv( self, object humdir):
    ...
    indx, order = imdir(humdir)
    return onumm5n3_get_deriv(indx,order, &self.num) 
  ...
  cpdef get_im( self, object humdir):
    ...
    indx, order = imdir(humdir)
    return onumm5n3_get_item(indx,order, &self.num) 
  ...
  cpdef extract_im( self, object humdir):
    ...
    res = onumm5n3_extract_im(indx,order, &self.num) 
  ...
  cpdef extract_deriv( self, object humdir):
    ...
    res = onumm5n3_extract_deriv(indx,order, &self.num)
  ...
  cpdef get_order_im( self, ord_t order):
    ...
    res = onumm5n3_get_order_im( order, &self.num)
  ...
  def copy(self):
    ...
    cdef onumm5n3_t res = onumm5n3_copy( &self.num )
    return onumm5n3.create(&res)
  ...
  def get_active_bases(self):
    ...
    onumm5n3_get_active_bases( &self.num, bases_list)
  ...
  def taylor_integrate(self, object bases, object deltas):
    ...
    res = onumm5n3_taylor_integrate( c_deltas, &self.num)
