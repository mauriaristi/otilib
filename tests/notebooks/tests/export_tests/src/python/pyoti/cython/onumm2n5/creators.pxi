...
cpdef e( object hum_dir, bases_t nbases = 0 , ord_t order = 0, uint64_t nip = 0):
  """
  PURPOSE:  To create a onumm2n5_t with value 1 at the specified imaginary direction
  ...
  if nip == 0: 
    ...
    # Create a onumm2n5_t
    ores = onumm2n5_createReal(0.0, order_res)

    # Set the coefficient to 1.
    onumm2n5_set_item(1.0, indx_hd, order_hd, &ores) 

    res = onumm2n5_t.create(&ores)

  else:
    
    fres = feonumm2n5_t(0.0, nip, order = order_res, nbases = nbases)
...
cpdef zero( bases_t nbases = 0 , ord_t order = 0, uint64_t nip = 0):
  ...
  if nip == 0: 
    ...
    # Create a onumm2n5_t
    ores = onumm2n5_createReal(0.0)

    res = onumm2n5_t.create(&ores)

  else:
    
    fres = feonumm2n5_t(0.0, nip, order = order, nbases = nbases)
...
cpdef one( bases_t nbases = 0 , ord_t order = 0, uint64_t nip = 0):
  ...
  if nip == 0: 
    ...
    # Create a onumm2n5_t
    ores = onumm2n5_createReal(1.0)

    res = onumm2n5_t.create(&ores)

  else:
    
    fres = feonumm2n5_t(1.0, nip, order = order, nbases = nbases)
...
cpdef number( coeff_t num, bases_t nbases = 0 , ord_t order = 0, uint64_t nip = 0):
  ...
  if nip == 0: 
    ...
    # Create a onumm2n5_t
    ores = onumm2n5_createReal(num)

    res = onumm2n5_t.create(&ores)

  else:
    
    fres = feonumm2n5_t(num, nip, order = order, nbases = nbases)
...
cpdef eye(uint64_t size, bases_t nbases = 0, ord_t order = 0, uint64_t nip = 0):
  ...
  if nip == 0:
    ...
    # This will create an oarrm2n5_t.
    Ores = oarrm2n5_eye(size,nbases,order)

    return oarrm2n5_t.create(&Ores)

  else:

    # This will create a feoarrm2n5_t
    Fres = feoarrm2n5_eye(size,nip,nbases,order)

    return feoarrm2n5_t.create(&Fres)
...
cpdef array( object arr, bases_t nbases = 0, ord_t order = 0, uint64_t nip = 0):
  ...
  if (tin is oarrm2n5_t) or (tin is feoarrm2n5_t):
...
cpdef zeros( object shape_in, bases_t nbases = 0, ord_t order = 0, uint64_t nip = 0):
  ...
  if nip == 0:
    ...
    # This will create an oarrm2n5_t.
    Ores = oarrm2n5_zeros(nrows,ncols,nbases,order)
    ...
    # This will create a feoarrm2n5_t
    Fres = feoarrm2n5_zeros(nrows,ncols,nip,nbases,order)
...
cpdef ones( object shape_in, bases_t nbases = 0, ord_t order = 0, uint64_t nip = 0):
  ...
  if nip == 0:
    ...
    # This will create an oarrm2n5_t.
    Ores = oarrm2n5_ones(nrows,ncols,nbases,order)
    ...
    # This will create a feoarrm2n5_t
    Fres = feoarrm2n5_ones(nrows,ncols,nip,nbases,order)
