...
onumm1n10_t onumm1n10_taylor_integrate(coeff_t* deltas,onumm1n10_t* lhs){
  ...
  res.e111111 = factor*lhs->e111111;
  // Order 7;
  factor = pow(deltas[0],7);
  res.e1111111 = factor*lhs->e1111111;
  // Order 8;
  factor = pow(deltas[0],8);
  res.e11111111 = factor*lhs->e11111111;
  // Order 9;
  factor = pow(deltas[0],9);
  res.e111111111 = factor*lhs->e111111111;
  // Order 10;
  factor = pow(deltas[0],10);
  res.e1111111111 = factor*lhs->e1111111111;
