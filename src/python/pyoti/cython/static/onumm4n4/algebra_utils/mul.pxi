#*****************************************************************************************************
cdef object __mul__FX__(feomatm4n4 Flhs, object rhs, object out = None):
  """
  PORPUSE: Multiplication between feomatm4n4 and object.
...
#*****************************************************************************************************
cdef object __mul__OX__(omatm4n4 Olhs, object rhs, object out = None):
  """
  PORPUSE: Multiplication between omatm4n4 and object.
...
#*****************************************************************************************************
cdef object __mul__oX__(onumm4n4 olhs, object rhs, object out = None):
  """
  PORPUSE: Multiplication between onumm4n4 and object.
...
#*****************************************************************************************************
cdef object __mul__fX__(feonumm4n4 flhs, object rhs, object out = None):
  """
  PORPUSE: Multiplication between feonumm4n4 and object.
