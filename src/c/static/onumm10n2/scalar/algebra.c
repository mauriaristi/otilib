...
onumm10n2_t onumm10n2_div_ro(coeff_t num, onumm10n2_t* den){
    ...
    onumm10n2_t inv = onumm10n2_pow(den,-1);
    onumm10n2_t res = onumm10n2_mul_ro(num,&inv);
...
onumm10n2_t onumm10n2_div_oo(onumm10n2_t* num, onumm10n2_t* den){
    ...
    onumm10n2_t res = onumm10n2_mul_oo(num,&inv);
...
onumm10n2_t onumm10n2_div_or(onumm10n2_t* num, coeff_t val){
    ...
    return onumm10n2_mul_ro(1.0/val,num);
...
onumm10n2_t onumm10n2_mul_oo(  onumm10n2_t* lhs,  onumm10n2_t* rhs){
  ...
  res.e1A = lhs->r * rhs->e1A + lhs->e1A * rhs->r + lhs->e1 * rhs->eA 
          + lhs->eA * rhs->e1;
  res.e2A = lhs->r * rhs->e2A + lhs->e2A * rhs->r + lhs->e2 * rhs->eA 
          + lhs->eA * rhs->e2;
  res.e3A = lhs->r * rhs->e3A + lhs->e3A * rhs->r + lhs->e3 * rhs->eA 
          + lhs->eA * rhs->e3;
  res.e4A = lhs->r * rhs->e4A + lhs->e4A * rhs->r + lhs->e4 * rhs->eA 
          + lhs->eA * rhs->e4;
  res.e5A = lhs->r * rhs->e5A + lhs->e5A * rhs->r + lhs->e5 * rhs->eA 
          + lhs->eA * rhs->e5;
  res.e6A = lhs->r * rhs->e6A + lhs->e6A * rhs->r + lhs->e6 * rhs->eA 
          + lhs->eA * rhs->e6;
  res.e7A = lhs->r * rhs->e7A + lhs->e7A * rhs->r + lhs->e7 * rhs->eA 
          + lhs->eA * rhs->e7;
  res.e8A = lhs->r * rhs->e8A + lhs->e8A * rhs->r + lhs->e8 * rhs->eA 
          + lhs->eA * rhs->e8;
  res.e9A = lhs->r * rhs->e9A + lhs->e9A * rhs->r + lhs->e9 * rhs->eA 
          + lhs->eA * rhs->e9;
...
onumm10n2_t onumm10n2_trunc_mul_oo(  onumm10n2_t* lhs,  onumm10n2_t* rhs){
  ...
  res.e1A =  + lhs->e1 * rhs->eA + lhs->eA * rhs->e1;
  res.e2A =  + lhs->e2 * rhs->eA + lhs->eA * rhs->e2;
  res.e3A =  + lhs->e3 * rhs->eA + lhs->eA * rhs->e3;
  res.e4A =  + lhs->e4 * rhs->eA + lhs->eA * rhs->e4;
  res.e5A =  + lhs->e5 * rhs->eA + lhs->eA * rhs->e5;
  res.e6A =  + lhs->e6 * rhs->eA + lhs->eA * rhs->e6;
  res.e7A =  + lhs->e7 * rhs->eA + lhs->eA * rhs->e7;
  res.e8A =  + lhs->e8 * rhs->eA + lhs->eA * rhs->e8;
  res.e9A =  + lhs->e9 * rhs->eA + lhs->eA * rhs->e9;
  res.eAA =  + lhs->eA * rhs->eA;
    ...
    case 0:
      switch( ord_rhs ){
        ...
        case 2:
          ...
          res->e1A = c->e1A + a->r * b->e1A;
          res->e2A = c->e2A + a->r * b->e2A;
          res->e3A = c->e3A + a->r * b->e3A;
          res->e4A = c->e4A + a->r * b->e4A;
          res->e5A = c->e5A + a->r * b->e5A;
          res->e6A = c->e6A + a->r * b->e6A;
          res->e7A = c->e7A + a->r * b->e7A;
          res->e8A = c->e8A + a->r * b->e8A;
          res->e9A = c->e9A + a->r * b->e9A;
          res->eAA = c->eAA + a->r * b->eAA;
          break;
      }
      break;
    case 1:
      switch( ord_rhs ){
        ...
        case 1:
          ...
          res->e1A = c->e1A + a->e1 * b->eA + a->eA * b->e1;
          res->e2A = c->e2A + a->e2 * b->eA + a->eA * b->e2;
          res->e3A = c->e3A + a->e3 * b->eA + a->eA * b->e3;
          res->e4A = c->e4A + a->e4 * b->eA + a->eA * b->e4;
          res->e5A = c->e5A + a->e5 * b->eA + a->eA * b->e5;
          res->e6A = c->e6A + a->e6 * b->eA + a->eA * b->e6;
          res->e7A = c->e7A + a->e7 * b->eA + a->eA * b->e7;
          res->e8A = c->e8A + a->e8 * b->eA + a->eA * b->e8;
          res->e9A = c->e9A + a->e9 * b->eA + a->eA * b->e9;
          res->eAA = c->eAA + a->eA * b->eA;
          break;
      }
      break;
    case 2:
      switch( ord_rhs ){
        case 0:
          ...
          res->e1A = c->e1A + a->e1A * b->r;
          res->e2A = c->e2A + a->e2A * b->r;
          res->e3A = c->e3A + a->e3A * b->r;
          res->e4A = c->e4A + a->e4A * b->r;
          res->e5A = c->e5A + a->e5A * b->r;
          res->e6A = c->e6A + a->e6A * b->r;
          res->e7A = c->e7A + a->e7A * b->r;
          res->e8A = c->e8A + a->e8A * b->r;
          res->e9A = c->e9A + a->e9A * b->r;
          res->eAA = c->eAA + a->eAA * b->r;
          break;
      }
      break;
  }
...
void onumm10n2_trunc_sum_oo_to(ord_t order, onumm10n2_t* lhs,onumm10n2_t* rhs, onumm10n2_t* res){
  // Addition like function 'lhs + rhs'
  switch(order){
    case(0):
      //  Real
...
void onumm10n2_trunc_sub_oo_to(ord_t order, onumm10n2_t* lhs,onumm10n2_t* rhs, onumm10n2_t* res){
  // Addition like function 'lhs - rhs'
  switch(order){
    case(0):
      //  Real
...
onumm10n2_t onumm10n2_feval(coeff_t* feval_re, onumm10n2_t* x){
  ...
  onumm10n2_t deltax = (*x), deltax_power = (*x);
  deltax.r = 0.0;
  deltax_power.r = 0.0;
  onumm10n2_set_r(0.0, &res);
  //  Real
  res.r = feval_re[0];
  // Order 1
  factor *=1;
  coef    = feval_re[1]/ factor;;
  onumm10n2_gem_ro_to( coef, &deltax_power, &res, &res);
  deltax_power = onumm10n2_mul_oo(&deltax_power,&deltax);
  // Order 2
  factor *=2;
