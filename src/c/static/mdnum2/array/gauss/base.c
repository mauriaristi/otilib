...
// ****************************************************************************************************
void femdarr2_set_item_ijk_o(mdnum2_t* num, uint64_t i, uint64_t j, uint64_t k, 
    femdarr2_t* res){
...
// ****************************************************************************************************
void femdarr2_set_item_ijk_r(coeff_t num, uint64_t i, uint64_t j, uint64_t k, 
    femdarr2_t* res){
...
// ****************************************************************************************************
femdarr2_t femdarr2_createEmpty( uint64_t nrows, uint64_t ncols, uint64_t nip){  
