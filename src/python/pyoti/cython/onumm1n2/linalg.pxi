...
cpdef dot(object lhs, object rhs, object out = None):
  ...
  elif tlhs is csr_omatm1n2:

    # Slhs = lhs
    if   trhs is omatm1n2: # SO
      if res_flag:
        Ores = out
        csromatm1n2_matmul_SO_to( lhs, rhs, Ores)
      else:
        res = csromatm1n2_matmul_SO( lhs, rhs)
      # end if 
...
#*****************************************************************************************************
cpdef solve(object K_in, omatm1n2 b_in, omatm1n2 out = None):
  """
...
#*****************************************************************************************************
cdef solve_dense(omatm1n2 K_in, omatm1n2 b_in, omatm1n2 out = None):
  """
...
#*****************************************************************************************************
cdef solve_sparse(csr_omatm1n2 K_in, omatm1n2 b_in, omatm1n2 out = None):
  """
  PURPOSE:   Solve OTI linear system of equations for a dense K_in.
  """
  #***************************************************************************************************
...
cpdef set_order_im_from_array(ord_t ordi, np.ndarray arr, omatm1n2 tmp):
  ...
  #     tmp[i,j] += onumm1n2.create( &otmp, FLAGS = 0)
