...
cdef class mdmat5:
  ...
  def __init__(self, realArray): 
    """
    PURPOSE:      Python level constructor of the mdmat5 class.
    ...
    if isinstance( realArray, np.ndarray):
      ...
      if ( ndim >= 3 ):
        ...
        self.arr = mdarr5_zeros( nrows, ncols)

        for i in range(self.arr.nrows):
      
          val = realArray[i]
          mdarr5_set_item_i_r( val, i, &self.arr)
        ...
        for i in range(self.arr.nrows):      
          for j in range(self.arr.ncols):
            ...
            val = realArray[i,j]
            mdarr5_set_item_ij_r( val, i, j, &self.arr)
  ...
  def order(self): 
    ...
    return mdarr5_get_order(&self.arr)
  ...
  #***************************************************************************************************
  @staticmethod
  cdef mdmat5 create(mdarr5_t* arr, uint8_t FLAGS = 1):
    """
    ...
    cdef mdmat5 mat = <mdmat5> mdmat5.__new__(mdmat5)
  ...
  def __repr__(self):
    ...
    #   out += "["
    #   for j in range(self.arr.ncols):
    #     d_mdnum5 = mdarr5_get_item_ij(&self.arr, i, j)
    #     out+= (mdnum5.create(&d_mdnum5,FLAGS=0)).__str__()+", "
    #   # end for 
    #   out = out[:-2] + "],\n"
    # # end for 
    # out =out[:-2] + "]"
  ...
  def  __getitem__(self, val):
    ...
    if tval == int:
      ...
      if val < self.arr.nrows:
        ...
        Ores = mdarr5_get_slice( &self.arr, starti, stopi, stepi, startj, stopj, stepj)
        res  = mdmat5.create(&Ores)
  ...
  cdef __setitem__r(self, object val, coeff_t value):
    ...
    if tval == int:
      ...
      if val < self.arr.nrows:
        ...
        mdarr5_set_slice_r( value, starti, stopi, stepi, startj, stopj, stepj, &self.arr)
      ...
      if len(val) == 2:
        ...
        if ( tval0 == int and tval1 == int ):
          ...
          if val[0] < self.arr.nrows and val[1] < self.arr.ncols:
            ...
            mdarr5_set_item_ij_r( value, val[0], val[1], &self.arr)
  ...
  cdef __setitem__o(self,  object val, mdnum5 value):
    ...
    if tval == int:
      ...
      if val < self.arr.nrows:
        ...
        mdarr5_set_slice_o( &value.num, starti, stopi, stepi, startj, stopj, stepj, &self.arr)
      ...
      if len(val) == 2:
        ...
        if ( tval0 == int and tval1 == int ):
          ...
          if val[0] < self.arr.nrows and val[1] < self.arr.ncols:
            ...
            mdarr5_set_item_ij_o( &value.num, val[0], val[1], &self.arr)
  ...
  cdef __setitem__O(self,  object val, mdmat5 value):
    ...
    if tval == int:
      ...
      if val < self.arr.nrows:
        ...
        mdarr5_set_slice_O( &value.arr, starti, stopi, stepi, startj, stopj, stepj, &self.arr)
  ...
  def copy(self):
    ...
    cdef mdarr5_t res = mdarr5_copy(&self.arr)
  ...
  def __neg__(self):
    ...
    cdef mdarr5_t res = mdarr5_neg(&self.arr)
  ...
  def __add__(self, other):
    ...
    if (tlhs == trhs):
      ...
      res = mdarr5_sum_OO(&lhs.arr,&rhs.arr)
      ...
      res = mdarr5_sum_oO(&olhs.num,&rhs.arr)
      ...
      res = mdarr5_sum_oO(&orhs.num,&lhs.arr)
    
    elif (tlhs in number_types):
      
      rhs = other
      res = mdarr5_sum_rO(self, &rhs.arr)

    elif (trhs in number_types):
        
      lhs = self
      res = mdarr5_sum_rO(other, &lhs.arr)
      ...
      res = mdarr5_sum_RO(&dlhs.arr,&rhs.arr)
      ...
      res = mdarr5_sum_RO(&drhs.arr,&lhs.arr)
  ...
  def __sub__(self, other):
    ...
    if (tlhs == trhs):
      ...
      res = mdarr5_sub_OO(&lhs.arr,&rhs.arr)
      ...
      res = mdarr5_sub_oO(&olhs.num,&rhs.arr)
      ...
      res = mdarr5_sub_Oo(&lhs.arr, &orhs.num)
    
    elif (tlhs in number_types):
      
      rhs = other
      res = mdarr5_sub_rO(self, &rhs.arr)

    elif (trhs in number_types):
        
      lhs = self
      res = mdarr5_sub_Or(&lhs.arr, other)
      ...
      res = mdarr5_sub_RO(&dlhs.arr,&rhs.arr)
      ...
      res = mdarr5_sub_OR(&lhs.arr, &drhs.arr)
  ...
  def __mul__(self, other):
    ...
    if (tlhs == trhs):
      ...
      res = mdarr5_mul_OO(&lhs.arr,&rhs.arr)
      ...
      res = mdarr5_mul_oO(&olhs.num,&rhs.arr)
      ...
      res = mdarr5_mul_oO(&orhs.num,&lhs.arr)
    
    elif (tlhs in number_types):
      
      rhs = other
      res = mdarr5_mul_rO(self, &rhs.arr)

    elif (trhs in number_types):
        
      lhs = self
      res = mdarr5_mul_rO(other, &lhs.arr)
      ...
      res = mdarr5_mul_RO(&dlhs.arr,&rhs.arr)
      ...
      res = mdarr5_mul_RO(&drhs.arr,&lhs.arr)
  ...
  def __truediv__(self, other):
    ...
    if (tlhs == trhs):
      ...
      res = mdarr5_div_OO(&lhs.arr,&rhs.arr)
      ...
      res = mdarr5_div_oO(&olhs.num,&rhs.arr)
      ...
      res = mdarr5_div_Oo(&lhs.arr, &orhs.num)
    
    elif (tlhs in number_types):
      
      rhs = other
      res = mdarr5_div_rO(self, &rhs.arr)

    elif (trhs in number_types):
        
      lhs = self
      res = mdarr5_div_Or(&lhs.arr, other)
      ...
      res = mdarr5_div_RO(&dlhs.arr,&rhs.arr)
      ...
      res = mdarr5_div_OR(&lhs.arr, &drhs.arr)
  ...
  cpdef get_deriv(self, object hum_dir):
    """
    PURPOSE: Get the corresponding imaginary direction in the mdmat5 object.
    """
    #*************************************************************************************************
    ...
    res_darr = mdarr5_get_deriv( item[ZERO],  item[ONE], &self.arr)
  ...
  cpdef get_im(self, object hum_dir):
    ...
    res_darr = mdarr5_get_im( item[ZERO],  item[ONE], &self.arr)
  ...
  cpdef extract_im(self, object hum_dir):
    ...
    res = mdarr5_extract_im( item[ZERO],  item[ONE], &self.arr)
  ...
  cpdef  extract_deriv(self, object hum_dir):
    ...
    res = mdarr5_extract_deriv( item[ZERO],  item[ONE], &self.arr)
  ...
  cpdef  get_order_im(self, ord_t order):
    ...
    res = mdarr5_get_order_im( order, &self.arr)
  ...
  cpdef  truncate( self, object humdir):
    ...
    res = mdarr5_truncate_im( indx, order, &self.arr) 
  ...
  cpdef set(self, object rhs):
    ...
    if   trhs is mdnum5:
      ...
      orhs = rhs
      mdarr5_set_o( &orhs.num, &self.arr)

    elif trhs is mdmat5:

      Orhs = rhs
      mdarr5_set_O( &Orhs.arr, &self.arr)      

    elif trhs in number_types:

      rrhs = rhs
      mdarr5_set_r( rrhs, &self.arr)

    else:

      raise ValueError( "Cant assign '{0}' into a mdmat5 object.".format(trhs) )
  ...
  def get_active_bases(self):
    ...
    mdarr5_get_active_bases( &self.arr, bases_list)
  ...
  def taylor_integrate(self, object bases, object deltas):
    ...
    res = mdarr5_taylor_integrate( c_deltas, &self.arr)
  ...
  #***************************************************************************************************
  @staticmethod
  def dot( mdmat5 lhs, mdmat5 rhs, mdmat5 out = None): 
    """
    ...
    if out is not None:
      ...
      mdarr5_matmul_OO_to( &lhs.arr, &rhs.arr ,&out.arr)

    else:

      res = mdarr5_matmul_OO( &lhs.arr, &rhs.arr )
  ...
  #***************************************************************************************************
  @staticmethod
  def inv( mdmat5 arr,  mdmat5 out = None): 
    """
    ...
    if out is not None:
      ...
      mdarr5_invert_to( &arr.arr,&out.arr)

    else:

      res = mdarr5_invert( &arr.arr)
  ...
  #***************************************************************************************************
  @staticmethod
  def transpose( mdmat5 arr,  mdmat5 out = None ): 
    """
    ...
    if out is not None:
      ...
      mdarr5_transpose_to( &arr.arr, &out.arr)

    else:

      res = mdarr5_transpose( &arr.arr)
  ...
  #***************************************************************************************************
  @staticmethod
  def add( mdmat5 lhs, mdmat5 rhs, mdmat5 out = None): 
    """
    ...
    if out is not None:
      ...
      mdarr5_sum_OO_to( &lhs.arr, &rhs.arr ,&out.arr)
