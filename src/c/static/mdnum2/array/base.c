...
mdarr2_t mdarr2_extract_im(imdir_t idx, ord_t order, mdarr2_t* arr){
    ...
    mdarr2_t res = mdarr2_zeros( arr->nrows, arr->ncols);
...
inline mdarr2_t mdarr2_empty_like(mdarr2_t* arr){
    ...
    res = mdarr2_createEmpty(arr->nrows, arr->ncols);    
