...
void {fearr_func}_truncate_im_to(imdir_t idx, ord_t order, {fearr_type}* arr, {fearr_type}* res){{
    ...
    for( i = 0; i < arr->nip; i++){{
        ...
        {arr_func}_truncate_im_to( idx, order, &arr->p_data[i], &res->p_data[i]);
...
{fearr_type} {fearr_func}_truncate_im(imdir_t idx, ord_t order, {fearr_type}* arr){{
    ...
    {fearr_func}_truncate_im_to( idx, order, arr, &res);
...
// // ****************************************************************************************************
// void {fearr_func}_set_item_ij({fenum_type}* num, uint64_t i, uint64_t j, {fearr_type}* res){{
...
// ****************************************************************************************************
void {fearr_func}_set_item_ijk_o({num_type}* num, uint64_t i, uint64_t j, uint64_t k, 
    {fearr_type}* res){{
...
// ****************************************************************************************************
void {fearr_func}_set_item_ijk_r(coeff_t num, uint64_t i, uint64_t j, uint64_t k, 
    {fearr_type}* res){{
...
// ****************************************************************************************************
void {fearr_func}_set_f( {fenum_type}* num, {fearr_type}* res ){{ 
    ...
    for( i = 0; i < res->nip; i++){{
        ...
        {arr_func}_set_all_o( &num->p_data[i], &res->p_data[i]);
...
// ****************************************************************************************************
void {fearr_func}_set_o( {num_type}* num, {fearr_type}* res ){{ 
    
    uint64_t i;
    
    for( i = 0; i < res->nip; i++){{

        {arr_func}_set_all_o( num, &res->p_data[i]);
...
// ****************************************************************************************************
void {fearr_func}_set_r( coeff_t num, {fearr_type}* res ){{ 
    
    uint64_t i;
    
    for( i = 0; i < res->nip; i++){{

        {arr_func}_set_all_r( num, &res->p_data[i]);
...
// ****************************************************************************************************
void {fearr_func}_set_all_f( {fenum_type}* num, {fearr_type}* res ){{ 
...
// ****************************************************************************************************
void {fearr_func}_set_all_o( {num_type}* num, {fearr_type}* res ){{ 
...
// ****************************************************************************************************
void {fearr_func}_set_all_r( coeff_t num, {fearr_type}* res ){{ 
...
{fearr_type} {fearr_func}_eye( uint64_t size, uint64_t nip ){{ 
    ...
    for( k = 0; k < res.nip; k++){{
        ...
        {arr_func}_set_all_r( 0.0, &res.p_data[k]);
...
{fearr_type} {fearr_func}_zeros( uint64_t nrows, uint64_t ncols, uint64_t nip ){{ 
    ...
    for( i = 0; i < res.nip; i++){{
        ...
        {arr_func}_set_all_r( 0.0, &res.p_data[i]);
...
{fearr_type} {fearr_func}_ones( uint64_t nrows, uint64_t ncols, uint64_t nip  ){{ 
    ...
    for( i = 0; i < res.nip; i++){{
        ...
        {arr_func}_set_all_r( 1.0, &res.p_data[i]);
...
{fearr_type} {fearr_func}_createEmpty( uint64_t nrows, uint64_t ncols, uint64_t nip){{  
    ...
    // {num_func}array_createEmpty({num_func}array_t* p_array, uint64_t nrows, uint64_t ncols, uint8_t order);
    if (res.p_data == NULL){{
        printf("--- MemoryError ---\n");
        exit(1);
    }}
