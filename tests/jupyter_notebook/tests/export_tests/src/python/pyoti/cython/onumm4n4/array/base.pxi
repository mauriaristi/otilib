...
cdef class oarrm4n4_t:
  ...
  def __init__(self, realArray, ord_t order = 0, bases_t nbases = 0, object nnz = None): 
    """
    PURPOSE:      Python level constructor of the oarrm4n4_t class.
  ...
  #***************************************************************************************************
  @staticmethod
  cdef oarrm4n4_t create(oarrm4n4_t* arr, uint8_t FLAGS = 1):
    """
    ...
    cdef oarrm4n4_t mat = <oarrm4n4_t> oarrm4n4_t.__new__(oarrm4n4_t)
  ...
  def __repr__(self):
    ...
    #     out+= (onumm4n4_t.create(&d_onumm4n4,FLAGS=0)).__str__()+", "
    #   # end for 
    #   out = out[:-2] + "],\n"
    # # end for 
    # out =out[:-2] + "]"
  ...
  cpdef get_im(self, object hum_dir):
    """
    PURPOSE: Get the corresponding imaginary direction in the oarrm4n4_t object.
    """
    #*************************************************************************************************
  ...
  cpdef set(self, object rhs):
    ...
    if   trhs is onumm4n4_t:
      ...
      raise ValueError( "Cant assign '{0}' into a oarrm4n4_t object.".format(trhs) )
  ...
  #***************************************************************************************************
  @staticmethod
  def dot( oarrm4n4_t lhs, oarrm4n4_t rhs, oarrm4n4_t out = None): 
    """
  ...
  #***************************************************************************************************
  @staticmethod
  def inv( oarrm4n4_t arr,  oarrm4n4_t out = None): 
    """
  ...
  #***************************************************************************************************
  @staticmethod
  def transpose( oarrm4n4_t arr,  oarrm4n4_t out = None ): 
    """
  ...
  #***************************************************************************************************
  @staticmethod
  def add( oarrm4n4_t lhs, oarrm4n4_t rhs, oarrm4n4_t out = None): 
    """
