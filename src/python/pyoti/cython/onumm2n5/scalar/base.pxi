...
cdef class onumm2n5:
  ...
  def __init__(self, coeff_t re_coeff):
    ...
    self.num = onumm2n5_create_r(re_coeff)
  ...
  def  order(self): 
    ...
    return onumm2n5_get_order(&self.num)
  ...
  #***************************************************************************************************
  @staticmethod
  cdef onumm2n5 create( onumm2n5_t* num, uint8_t FLAGS = 1 ):
    """
    ...
    cdef onumm2n5 otin = <onumm2n5> onumm2n5.__new__(onumm2n5)

    otin.num     = onumm2n5_copy(num)
  ...
  def __repr__(self):
    """
    PURPOSE:  To print a representation of the onumm2n5 object in a compact form.
    """
    #*************************************************************************************************
    ...
    for ordi in range(1,self.order+1):
      ...
      for i in range( onumm2n5_get_ndir_order(ordi,&self.num) ):
        
        idx = onumm2n5_get_indx(i, ordi) 
        num = '%+.4f'%( onumm2n5_get_item(idx,ordi,&self.num) )
  ...
  def short_repr(self):
    ...
    head = 'onumm2n5('
    body = str(self.num.r) + ", nnz: " + str(onumm2n5_get_ndir_total(&self.num)) + ', order: ' + str(self.order)
    tail = ')'
  ...
  def __str__(self):
    """
    PURPOSE: To print a representation of the onumm2n5 object that could 
  ...
  def __getitem__(self, list index):
    """
    PURPOSE:  To get the value of a onumm2n5 coefficient.
  ...
  def __setitem__(self, list item, coeff_t value):
    """
    PURPOSE:  To set the value of a onumm2n5 coefficient.
  ...
  def __add__(self, other_in):
    """
    PURPOSE:      Add onumm2n5 with other things.
  ...
  def __truediv__(self, other_in):
    """
    PURPOSE:      To define how to divide two onumm2n5 numbers.
