...
cdef class mdmat10:
  ...
  def __init__(self, realArray): 
    """
    PURPOSE:      Python level constructor of the mdmat10 class.
    ...
    if isinstance( realArray, np.ndarray):
      ...
      if ( ndim >= 3 ):
        ...
        self.arr = mdarr10_zeros( nrows, ncols)

        for i in range(self.arr.nrows):
      
          val = realArray[i]
          mdarr10_set_item_i_r( val, i, &self.arr)
        ...
        for i in range(self.arr.nrows):      
          for j in range(self.arr.ncols):
            ...
            val = realArray[i,j]
            mdarr10_set_item_ij_r( val, i, j, &self.arr)
  ...
  def T(self): 
    ...
    res = mdarr10_transpose( &self.arr)
  ...
  def order(self): 
    ...
    return mdarr10_get_order(&self.arr)
  ...
  #***************************************************************************************************
  @staticmethod
  cdef mdmat10 create(mdarr10_t* arr, uint8_t FLAGS = 1):
    """
    ...
    cdef mdmat10 mat = <mdmat10> mdmat10.__new__(mdmat10)
  ...
  def __repr__(self):
    ...
    #   out += "["
    #   for j in range(self.arr.ncols):
    #     d_mdnum10 = mdarr10_get_item_ij(&self.arr, i, j)
    #     out+= (mdnum10.create(&d_mdnum10,FLAGS=0)).__str__()+", "
    #   # end for 
    #   out = out[:-2] + "],\n"
    # # end for 
    # out =out[:-2] + "]"
  ...
  def  __getitem__(self, val):
    ...
    if tval == int:
      ...
      if val < self.arr.nrows:
        ...
        Ores = mdarr10_get_slice( &self.arr, starti, stopi, stepi, startj, stopj, stepj)
        res  = mdmat10.create(&Ores)
  ...
  cdef __setitem__r(self, object val, coeff_t value):
    ...
    if tval == int:
      ...
      if val < self.arr.nrows:
        ...
        mdarr10_set_slice_r( value, starti, stopi, stepi, startj, stopj, stepj, &self.arr)
      ...
      if len(val) == 2:
        ...
        if ( tval0 == int and tval1 == int ):
          ...
          if val[0] < self.arr.nrows and val[1] < self.arr.ncols:
            ...
            mdarr10_set_item_ij_r( value, val[0], val[1], &self.arr)
  ...
  cdef __setitem__o(self,  object val, mdnum10 value):
    ...
    if tval == int:
      ...
      if val < self.arr.nrows:
        ...
        mdarr10_set_slice_o( &value.num, starti, stopi, stepi, startj, stopj, stepj, &self.arr)
      ...
      if len(val) == 2:
        ...
        if ( tval0 == int and tval1 == int ):
          ...
          if val[0] < self.arr.nrows and val[1] < self.arr.ncols:
            ...
            mdarr10_set_item_ij_o( &value.num, val[0], val[1], &self.arr)
  ...
  cdef __setitem__O(self,  object val, mdmat10 value):
    ...
    if tval == int:
      ...
      if val < self.arr.nrows:
        ...
        mdarr10_set_slice_O( &value.arr, starti, stopi, stepi, startj, stopj, stepj, &self.arr)
  ...
  def copy(self):
    ...
    cdef mdarr10_t res = mdarr10_copy(&self.arr)
  ...
  def __neg__(self):
    ...
    cdef mdarr10_t res = mdarr10_neg(&self.arr)
  ...
  def __add__(self, other):
    ...
    if (tlhs == trhs):
      ...
      res = mdarr10_sum_OO(&lhs.arr,&rhs.arr)
      ...
      res = mdarr10_sum_oO(&olhs.num,&rhs.arr)
      ...
      res = mdarr10_sum_oO(&orhs.num,&lhs.arr)
    
    elif (tlhs in number_types):
      
      rhs = other
      res = mdarr10_sum_rO(self, &rhs.arr)

    elif (trhs in number_types):
        
      lhs = self
      res = mdarr10_sum_rO(other, &lhs.arr)
      ...
      res = mdarr10_sum_RO(&dlhs.arr,&rhs.arr)
      ...
      res = mdarr10_sum_RO(&drhs.arr,&lhs.arr)
  ...
  def __sub__(self, other):
    ...
    if (tlhs == trhs):
      ...
      res = mdarr10_sub_OO(&lhs.arr,&rhs.arr)
      ...
      res = mdarr10_sub_oO(&olhs.num,&rhs.arr)
      ...
      res = mdarr10_sub_Oo(&lhs.arr, &orhs.num)
    
    elif (tlhs in number_types):
      
      rhs = other
      res = mdarr10_sub_rO(self, &rhs.arr)

    elif (trhs in number_types):
        
      lhs = self
      res = mdarr10_sub_Or(&lhs.arr, other)
      ...
      res = mdarr10_sub_RO(&dlhs.arr,&rhs.arr)
      ...
      res = mdarr10_sub_OR(&lhs.arr, &drhs.arr)
  ...
  def __mul__(self, other):
    ...
    if (tlhs == trhs):
      ...
      res = mdarr10_mul_OO(&lhs.arr,&rhs.arr)
      ...
      res = mdarr10_mul_oO(&olhs.num,&rhs.arr)
      ...
      res = mdarr10_mul_oO(&orhs.num,&lhs.arr)
    
    elif (tlhs in number_types):
      
      rhs = other
      res = mdarr10_mul_rO(self, &rhs.arr)

    elif (trhs in number_types):
        
      lhs = self
      res = mdarr10_mul_rO(other, &lhs.arr)
      ...
      res = mdarr10_mul_RO(&dlhs.arr,&rhs.arr)
      ...
      res = mdarr10_mul_RO(&drhs.arr,&lhs.arr)
  ...
  def __truediv__(self, other):
    ...
    if (tlhs == trhs):
      ...
      res = mdarr10_div_OO(&lhs.arr,&rhs.arr)
      ...
      res = mdarr10_div_oO(&olhs.num,&rhs.arr)
      ...
      res = mdarr10_div_Oo(&lhs.arr, &orhs.num)
    
    elif (tlhs in number_types):
      
      rhs = other
      res = mdarr10_div_rO(self, &rhs.arr)

    elif (trhs in number_types):
        
      lhs = self
      res = mdarr10_div_Or(&lhs.arr, other)
      ...
      res = mdarr10_div_RO(&dlhs.arr,&rhs.arr)
      ...
      res = mdarr10_div_OR(&lhs.arr, &drhs.arr)
  ...
  cpdef get_deriv(self, object hum_dir):
    """
    PURPOSE: Get the corresponding imaginary direction in the mdmat10 object.
    """
    #*************************************************************************************************
    ...
    res_darr = mdarr10_get_deriv( item[ZERO],  item[ONE], &self.arr)
  ...
  cpdef get_im(self, object hum_dir):
    ...
    res_darr = mdarr10_get_im( item[ZERO],  item[ONE], &self.arr)
  ...
  cpdef extract_im(self, object hum_dir):
    ...
    res = mdarr10_extract_im( item[ZERO],  item[ONE], &self.arr)
  ...
  cpdef  extract_deriv(self, object hum_dir):
    ...
    res = mdarr10_extract_deriv( item[ZERO],  item[ONE], &self.arr)
  ...
  cpdef  get_order_im(self, ord_t order):
    ...
    res = mdarr10_get_order_im( order, &self.arr)
  ...
  cpdef  truncate( self, object humdir):
    ...
    res = mdarr10_truncate_im( indx, order, &self.arr) 
  ...
  cpdef set(self, object rhs):
    ...
    if   trhs is mdnum10:
      ...
      orhs = rhs
      mdarr10_set_o( &orhs.num, &self.arr)

    elif trhs is mdmat10:

      Orhs = rhs
      mdarr10_set_O( &Orhs.arr, &self.arr)      

    elif trhs in number_types:

      rrhs = rhs
      mdarr10_set_r( rrhs, &self.arr)

    else:

      raise ValueError( "Cant assign '{0}' into a mdmat10 object.".format(trhs) )
  ...
  def get_active_bases(self):
    ...
    mdarr10_get_active_bases( &self.arr, bases_list)
  ...
  def taylor_integrate(self, object bases, object deltas):
    ...
    res = mdarr10_taylor_integrate( c_deltas, &self.arr)
  ...
  #***************************************************************************************************
  @staticmethod
  def dot( mdmat10 lhs, mdmat10 rhs, mdmat10 out = None): 
    """
    ...
    if out is not None:
      ...
      mdarr10_matmul_OO_to( &lhs.arr, &rhs.arr ,&out.arr)

    else:

      res = mdarr10_matmul_OO( &lhs.arr, &rhs.arr )
  ...
  #***************************************************************************************************
  @staticmethod
  def inv( mdmat10 arr,  mdmat10 out = None): 
    """
    ...
    if out is not None:
      ...
      mdarr10_invert_to( &arr.arr,&out.arr)

    else:

      res = mdarr10_invert( &arr.arr)
  ...
  #***************************************************************************************************
  @staticmethod
  def transpose( mdmat10 arr,  mdmat10 out = None ): 
    """
    ...
    if out is not None:
      ...
      mdarr10_transpose_to( &arr.arr, &out.arr)

    else:

      res = mdarr10_transpose( &arr.arr)
  ...
  #***************************************************************************************************
  @staticmethod
  def add( mdmat10 lhs, mdmat10 rhs, mdmat10 out = None): 
    """
    ...
    if out is not None:
      ...
      mdarr10_sum_OO_to( &lhs.arr, &rhs.arr ,&out.arr)
