#ifndef OTI_ONUMM4N2_SCALAR_GAUSS_BASE_H
#define OTI_ONUMM4N2_SCALAR_GAUSS_BASE_H
...
@param[in] num FEonumm4n2 to free
******************************************************************************************************/
...
@param[in] num FEonumm4n2
******************************************************************************************************/
ord_t feonumm4n2_get_order( feonumm4n2_t* num );
// ----------------------------------------------------------------------------------------------------

/**************************************************************************************************//**
@brief Initialize a feonumm4n2 structure.

******************************************************************************************************/
feonumm4n2_t feonumm4n2_init(void);
// ----------------------------------------------------------------------------------------------------
