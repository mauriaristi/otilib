...
cpdef dot(object lhs, object rhs, object out = None):
  ...
  elif tlhs is csr_omatm10n1:

    # Slhs = lhs
    if   trhs is omatm10n1: # SO
      if res_flag:
        Ores = out
        csromatm10n1_matmul_SO_to( lhs, rhs, Ores)
      else:
        res = csromatm10n1_matmul_SO( lhs, rhs)
      # end if 
...
cpdef solve(object K_in, omatm10n1 b_in, omatm10n1 out = None):
  ...
  cdef csr_omatm10n1  S, Sres, Stmp  
  cdef uint64_t i,j,k,l
  cdef ord_t ordi, ord_lhs, ord_rhs, Oord
  cdef uint8_t res_flag = 1
  cdef object res
...
#*****************************************************************************************************
cdef solve_sparse(csr_omatm10n1 K_in, omatm10n1 b_in, omatm10n1 out = None):
  """
  PURPOSE:   Solve OTI linear system of equations for a dense K_in.
  """
  #***************************************************************************************************
...
cpdef set_order_im_from_array(ord_t ordi, np.ndarray arr, omatm10n1 tmp):
  ...
  #     tmp[i,j] += onumm10n1.create( &otmp, FLAGS = 0)
