...
cdef class onumm4n4:
  ...
  def __init__(self, coeff_t re_coeff):
    ...
    self.num = onumm4n4_create_r(re_coeff)
  ...
  def  order(self): 
    ...
    return onumm4n4_get_order(&self.num)
  ...
  #***************************************************************************************************
  @staticmethod
  cdef onumm4n4 create( onumm4n4_t* num, uint8_t FLAGS = 1 ):
    """
    ...
    cdef onumm4n4 otin = <onumm4n4> onumm4n4.__new__(onumm4n4)

    otin.num     = onumm4n4_copy(num)
  ...
  def __repr__(self):
    """
    PURPOSE:  To print a representation of the onumm4n4 object in a compact form.
    """
    #*************************************************************************************************
    ...
    for ordi in range(1,self.order+1):
      ...
      for i in range( onumm4n4_get_ndir_order(ordi,&self.num) ):
        
        idx = onumm4n4_get_indx(i, ordi) 
        num = '%+.4f'%( onumm4n4_get_item(idx,ordi,&self.num) )
  ...
  def short_repr(self):
    ...
    head = 'onumm4n4('
    body = str(self.num.r) + ", nnz: " + str(onumm4n4_get_ndir_total(&self.num)) + ', order: ' + str(self.order)
    tail = ')'
  ...
  def __str__(self):
    """
    PURPOSE: To print a representation of the onumm4n4 object that could 
  ...
  def __getitem__(self, list index):
    """
    PURPOSE:  To get the value of a onumm4n4 coefficient.
  ...
  def __setitem__(self, list item, coeff_t value):
    """
    PURPOSE:  To set the value of a onumm4n4 coefficient.
  ...
  def __add__(self, other_in):
    """
    PURPOSE:      Add onumm4n4 with other things.
  ...
  def __truediv__(self, other_in):
    """
    PURPOSE:      To define how to divide two onumm4n4 numbers.
