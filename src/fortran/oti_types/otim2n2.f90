...
CONTAINS
  ...
  ! ===============   SCALAR OPERATIONS  ==================
  ! ADDITION OF TWO OTI NUMBERS
  FUNCTION REAL_ADD_ONUMM2N2(LHS, RHS) &
    RESULT(RES)
    IMPLICIT NONE
  ...
  FUNCTION ONUMM2N2_ADD_REAL(LHS, RHS) &
    RESULT(RES)
    IMPLICIT NONE
  ...
  FUNCTION ONUMM2N2_SUB_REAL(LHS, RHS) &
    RESULT(RES)
    IMPLICIT NONE
    TYPE(ONUM_M2N2), INTENT(IN) :: LHS
    REAL(REAL_KIND), INTENT(IN) :: RHS
  ...
  ! SUBTRACTION OF TWO OTI NUMBERS
  FUNCTION REAL_SUB_ONUMM2N2(LHS, RHS) &
    RESULT(RES)
    IMPLICIT NONE
    TYPE(ONUM_M2N2), INTENT(IN) :: RHS
    REAL(REAL_KIND), INTENT(IN) :: LHS
  ...
  FUNCTION ONUMM2N2_MUL_REAL(LHS, RHS) &
    RESULT(RES)
    IMPLICIT NONE
    TYPE(ONUM_M2N2), INTENT(IN) :: LHS
    REAL(REAL_KIND), INTENT(IN) :: RHS
  ...
  ! MULTIPLICATION OF OTI NUMBER TIMES REAL NUMBER
  FUNCTION REAL_MUL_ONUMM2N2(LHS, RHS) &
    RESULT(RES)
    IMPLICIT NONE
