...
cdef class lil_omatm1n2:
  ...
  def __init__(self, shape): 
    """
    PURPOSE:      Python level constructor of the lil_omatm1n2 class.

    DESCRIPTION:  Creates a new empty lil_omatm1n2 matrix.
  ...
  def copy(self):
    ...
    cdef lil_omatm1n2 res = lil_omatm1n2(self.shape)
    cdef uint64_t i, k
  ...
  def tocsr(self):
    ...
    """
    return csr_omatm1n2(self,shape=self.shape)
