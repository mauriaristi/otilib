...
void mdarr6_taylor_integrate_to( coeff_t* deltas, mdarr6_t* arr, mdarr6_t* res){
    ...
    mdarr6_dimCheck_OO_elementwise(arr,res,res);

    for (i = 0; i<arr->size; i++ ){
        
        mdnum6_taylor_integrate_to( deltas, &arr->p_data[i], &res->p_data[i]);
...
mdarr6_t mdarr6_taylor_integrate( coeff_t* deltas, mdarr6_t* arr){
    ...
    mdarr6_taylor_integrate_to( deltas, arr, &res);
...
void mdarr6_get_order_im_to( ord_t order, mdarr6_t* arr, mdarr6_t* res){
    ...
    for (i = 0; i<arr->size; i++ ){
        ...
        mdnum6_get_order_im_to( order, &arr->p_data[i], &res->p_data[i]);
...
mdarr6_t mdarr6_get_order_im( ord_t order, mdarr6_t* arr){
    ...
    mdarr6_get_order_im_to( order, arr, &res);
...
void mdarr6_truncate_im_to( imdir_t idx, ord_t order, mdarr6_t* arr, mdarr6_t* res){
    ...
    for (i = 0; i<arr->size; i++ ){
        ...
        mdnum6_truncate_im_to( idx, order, &arr->p_data[i], &res->p_data[i]);
...
mdarr6_t mdarr6_truncate_im( imdir_t idx, ord_t order, mdarr6_t* arr){
    ...
    mdarr6_truncate_im_to( idx, order, arr, &res);
...
void mdarr6_copy_to(mdarr6_t* arr, mdarr6_t* res){
    ...
    for (i=0; i<arr->size; i++){
        ...
        mdnum6_copy_to(&arr->p_data[i],&res->p_data[i]);
...
// ****************************************************************************************************
inline void mdarr6_set_all_r( coeff_t num, mdarr6_t* arr){
    
    uint64_t i;

    for (i = 0; i<arr->size; i++ ){
        mdarr6_set_item_i_r( num, i, arr);
    }
...
// ****************************************************************************************************
inline void mdarr6_set_r( coeff_t num, mdarr6_t* arr){
...
// ****************************************************************************************************
inline void mdarr6_set_item_i_r( coeff_t num, uint64_t i, mdarr6_t* arr){
        
    if( i<arr->size ){
        
        mdnum6_set_r( num, &arr->p_data[i]);

    } else {

        // res = mdnum6_init();
        
        printf("ERROR: Index out of bounds in mdarr6_get_item_i(...)\n Exiting...\n");
        exit(OTI_BadIndx);
...
// ****************************************************************************************************
inline void mdarr6_set_item_ij_r( coeff_t num, uint64_t i, uint64_t j, mdarr6_t* arr){

    mdarr6_set_item_i_r( num, j + i*arr->ncols, arr);

}
// ----------------------------------------------------------------------------------------------------

// ****************************************************************************************************
inline void mdarr6_set_all_o( mdnum6_t* num, mdarr6_t* arr){

    uint64_t i;

    for (i = 0; i<arr->size; i++ ){
        mdarr6_set_item_i_o( num, i, arr);
    }
...
// ****************************************************************************************************
inline void mdarr6_set_o( mdnum6_t* num, mdarr6_t* arr){
...
// ****************************************************************************************************
inline void mdarr6_set_item_i_o( mdnum6_t* src, uint64_t i, mdarr6_t* arr){
    
    if (i < arr->size){

        mdnum6_copy_to(src, &arr->p_data[i]);
...
// ****************************************************************************************************
inline void mdarr6_set_item_ij_o( mdnum6_t* num, uint64_t i, uint64_t j, mdarr6_t* arr){

    if ( i < arr->nrows && j < arr->ncols ){

        mdarr6_set_item_i_o( num, j + i*arr->ncols, arr);

    } else {

        printf("ERROR: Index out of bounds in mdarr6_get_item_ij(...)\n Exiting...\n");
        exit(OTI_BadIndx);
...
// ****************************************************************************************************
void mdarr6_set_slice_O( mdarr6_t* arr, 
    ...
    for ( i = 0; i < nrows; i++){
        ...
        for ( j = 0; j < ncols; j++){
            ...
            mdnum6_copy_to( &arr->p_data[  j +  i * arr->ncols ], 
...
// ****************************************************************************************************
void mdarr6_set_slice_o( mdnum6_t* num, 
                        int64_t starti, int64_t stopi, int64_t stepi,
                        int64_t startj, int64_t stopj, int64_t stepj,
                         mdarr6_t* res){
...
darr_t mdarr6_get_im(imdir_t idx, ord_t order, mdarr6_t* arr){
    ...
    for( i = 0; i < arr->size ; i++ ){
        ...
        darr_set_item_i(  
            mdnum6_get_item( idx, order, &arr->p_data[i]), 
            i, &res);
...
mdarr6_t mdarr6_extract_im(imdir_t idx, ord_t order, mdarr6_t* arr){
    ...
    mdarr6_t res = mdarr6_zeros( arr->nrows, arr->ncols);
    
    mdarr6_extract_im_to( idx, order, arr, &res);
...
void mdarr6_extract_im_to(imdir_t idx, ord_t order, mdarr6_t* arr, mdarr6_t* res){
    ...
    for( i = 0; i < arr->size ; i++ ){
        ...
        mdnum6_extract_im_to( idx, order, &arr->p_data[i], &res->p_data[i]);
...
darr_t mdarr6_get_deriv(imdir_t idx, ord_t order, mdarr6_t* arr){
    ...
    for( i = 0; i < arr->size ; i++ ){
        ...
        darr_set_item_i(  
            mdnum6_get_deriv( idx, order, &arr->p_data[i]), 
            i, &res);
...
mdarr6_t mdarr6_get_im_o(imdir_t idx, ord_t order, mdarr6_t* arr){
    ...
    mdarr6_get_im_to( idx, order, arr, &res);
...
void mdarr6_get_im_to(imdir_t idx, ord_t order, mdarr6_t* arr, mdarr6_t* res){
    ...
    for( i = 0; i < arr->size ; i++ ){
        ...
        mdnum6_get_im_to_o( idx, order, &arr->p_data[i], &res->p_data[i]);
...
mdarr6_t mdarr6_get_deriv_o(imdir_t idx, ord_t order, mdarr6_t* arr){
    ...
    mdarr6_get_deriv_to( idx, order, arr, &res);
...
void mdarr6_get_deriv_to(imdir_t idx, ord_t order, mdarr6_t* arr, mdarr6_t* res){
    ...
    for( i = 0; i < arr->size ; i++ ){
        ...
        mdnum6_get_deriv_to( idx, order, &arr->p_data[i], &res->p_data[i]);
...
mdarr6_t mdarr6_extract_deriv(imdir_t idx, ord_t order, mdarr6_t* arr){
    ...
    mdarr6_extract_deriv_to( idx, order, arr, &res);
...
void mdarr6_extract_deriv_to(imdir_t idx, ord_t order, mdarr6_t* arr, mdarr6_t* res){
    ...
    for( i = 0; i < arr->size ; i++ ){
        ...
        mdnum6_extract_deriv_to( idx, order, &arr->p_data[i], &res->p_data[i]);
...
// Getters.
// ****************************************************************************************************
inline mdnum6_t mdarr6_get_item_i(mdarr6_t* arr, uint64_t i){
...
mdnum6_t mdarr6_get_item_ij(mdarr6_t* arr, uint64_t i, uint64_t j){
    ...
    mdnum6_t res = mdarr6_get_item_i(arr, j + i*arr->ncols );
...
void mdarr6_get_item_i_to(mdarr6_t* arr, uint64_t i, mdnum6_t* res){
    ...
    if (i < arr->size){
        ...
        mdnum6_copy_to( &arr->p_data[i], res);
        
    } else {
        // Raise error?
        printf("ERROR: Index out of bounds in mdarr6_get_item_i_to(...)\n");
        exit(OTI_BadIndx);
    }
...
void mdarr6_get_item_ij_to(mdarr6_t* arr, uint64_t i, uint64_t j, mdnum6_t* res){
    ...
    mdarr6_get_item_i_to(arr, j + i*arr->ncols, res);
...
mdarr6_t mdarr6_get_slice( mdarr6_t* arr, 
    ...
    res = mdarr6_zeros( nrows, ncols);

    mdarr6_get_slice_to( arr, starti, stopi, stepi, startj, stopj, stepj, &res);
...
void mdarr6_get_slice_to( mdarr6_t* arr, 
    ...
    for ( i = 0; i < nrows; i++){
        ...
        for ( j = 0; j < ncols; j++){
            ...
            mdnum6_copy_to( &arr->p_data[ jj + ii * arr->ncols ], 
...
mdarr6_t mdarr6_ones(uint64_t nrows, uint64_t ncols){
    ...
    res = mdarr6_createEmpty(nrows, ncols);

    for (i=0; i<res.size; i++ ){
        mdnum6_set_r(1.0,&res.p_data[i]);
    }
...
// ****************************************************************************************************
inline mdarr6_t mdarr6_empty_like(mdarr6_t* arr){

    mdarr6_t  res;
    
    res = mdarr6_createEmpty(arr->nrows, arr->ncols);    
...
// ****************************************************************************************************
inline mdarr6_t mdarr6_createEmpty(uint64_t nrows, uint64_t ncols){

    mdarr6_t  res ;
    uint64_t size = nrows * ncols;

    res.p_data = (mdnum6_t*) malloc( size * sizeof( mdnum6_t ) );

    if ( res.p_data == NULL ){
        printf("ERROR: Not enough memory to handle mdarr6.\n Exiting...\n");
...
// Initialization
// ****************************************************************************************************
inline mdarr6_t mdarr6_init(void){
