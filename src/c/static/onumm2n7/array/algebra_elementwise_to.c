...
// ****************************************************************************************************
void oarrm2n7_trunc_sum_OO_to(ord_t order, oarrm2n7_t* arr1, oarrm2n7_t* arr2, oarrm2n7_t* res){
    // Perform O + O.
    uint64_t i;
    ...
    // Loop for every element and add real to the oti number.
    for ( i = 0; i < arr1->size; i++){
        onumm2n7_trunc_sum_oo_to(order, &arr1->p_data[i], &arr2->p_data[i], &res->p_data[i]);
    }
...
// ****************************************************************************************************
void oarrm2n7_trunc_sub_OO_to(ord_t order, oarrm2n7_t* arr1, oarrm2n7_t* arr2, oarrm2n7_t* res){
    // Perform O + O.
    uint64_t i;
    ...
    // Loop for every element and add real to the oti number.
    for ( i = 0; i < arr1->size; i++){
        onumm2n7_trunc_sub_oo_to(order, &arr1->p_data[i], &arr2->p_data[i], &res->p_data[i]);
    }
