...
# cdef object __add__FX__(feomatm1n9 Flhs, object rhs, object out = None):
#   """
#   PURPOSE:  Addition between feomatm1n9 and object.
...
cdef object __add__OX__(omatm1n9 Olhs, object rhs, object out = None):
  """
  PURPOSE:  Addition between omatm1n9 and an object.
  ...
  #   if res_flag:
  #     Fres = out
  #     feonumm1n9_sum_Of_to( &Orhs.arr, &flhs.num ,&Fres.arr)
  #   else:      
  #     cFres = feonumm1n9_sum_Of( &Orhs.arr, &flhs.num)
  #     res = feomatm1n9.create(&cFres)
  #   # end if
    ...
    if res_flag:
      ...
      cOres = oarrm1n9_sum_OO( &Orhs.arr, &Orhs.arr)
      res = omatm1n9.create( &cOres )
    # end if
...
cdef object __add__RX__(dmat Rlhs, object rhs, object out = None):
  """
  PURPOSE:  Addition between onumm1n9 and an object.
  ...
  #   if res_flag:
  #     ores = out
  #     onumm1n9_sum_Ro_to( &Rlhs.arr, &orhs.num ,&ores.num)
  #   else:
  #     cores = onumm1n9_sum_Ro( &Rlhs.arr, &orhs.num )
  ...
  #   if res_flag:
  #     fres = out
  #     feonumm1n9_sum_Rf_to( &Rlhs.arr, &frhs.num ,&fres.num)
  #   else:      
  #     cfres = feonumm1n9_sum_Rf( &Rlhs.arr, &frhs.num)
...
cdef object __add__fX__(feonumm1n9 flhs, object rhs, object out = None):
  """
  PURPOSE:  Addition between feonumm1n9 and an object.
  ...
  #   if res_flag:
  #     Rres = out
  #     feonumm1n9_sum_Rf_to( &Rrhs.arr, &flhs.num ,&Fres.arr)
  #   else:      
  #     cFres = feonumm1n9_sum_Rf( &Rrhs.arr, &flhs.num)
  #     res = feomatm1n9.create(&cFres)
  #   # end if
...
cdef object __add__oX__(onumm1n9 olhs, object rhs, object out = None):
  ...
  #   if res_flag:
  #     Ores = out
  #     onumm1n9_sum_oR_to( &olhs.num, &Rrhs.arr ,&Ores.arr)
  #   else:      
  #     cOres = onumm1n9_sum_oR( &olhs.num, &Rrhs.arr)
  #     res = omatm1n9.create(&cOres)
  #   # end if
