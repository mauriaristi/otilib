...
cdef class omatm3n2:
  ...
  def __init__(self, realArray): 
    """
    PURPOSE:      Python level constructor of the omatm3n2 class.
    ...
    if isinstance( realArray, np.ndarray):
      ...
      if ( ndim >= 3 ):
        ...
        self.arr = oarrm3n2_zeros( nrows, ncols)

        for i in range(self.arr.nrows):
      
          val = realArray[i]
          oarrm3n2_set_item_i_r( val, i, &self.arr)
        ...
        for i in range(self.arr.nrows):      
          for j in range(self.arr.ncols):
            ...
            val = realArray[i,j]
            oarrm3n2_set_item_ij_r( val, i, j, &self.arr)
  ...
  def T(self): 
    ...
    res = oarrm3n2_transpose( &self.arr)

    return omatm3n2.create(&res)
  ...
  def order(self): 
    ...
    return oarrm3n2_get_order(&self.arr)
  ...
  #***************************************************************************************************
  @staticmethod
  cdef omatm3n2 create(oarrm3n2_t* arr, uint8_t FLAGS = 1):
    """
    ...
    cdef omatm3n2 mat = <omatm3n2> omatm3n2.__new__(omatm3n2)
  ...
  def __repr__(self):
    ...
    #   out += "["
    #   for j in range(self.arr.ncols):
    #     d_onumm3n2 = oarrm3n2_get_item_ij(&self.arr, i, j)
    #     out+= (onumm3n2.create(&d_onumm3n2,FLAGS=0)).__str__()+", "
    #   # end for 
    #   out = out[:-2] + "],\n"
    # # end for 
    # out =out[:-2] + "]"
  ...
  def  __getitem__(self, val):
    ...
    if tval == int:
      ...
      if val < self.arr.nrows:
        ...
        Ores = oarrm3n2_get_slice( &self.arr, starti, stopi, stepi, startj, stopj, stepj)
        res  = omatm3n2.create(&Ores)
    ...
    #   res  = onumm3n2.create( &ores, FLAGS = 0 )
  ...
  def __setitem__(self, val, value):
    ...
    if ( tvalue == onumm3n2 ):
      ...
      raise IndexError("ERROR: Cant set item of type {0} in omatm3n2 object.".format(tvalue))
  ...
  cdef __setitem__r(self, object val, coeff_t value):
    ...
    if tval == int:
      ...
      if val < self.arr.nrows:
        ...
        oarrm3n2_set_slice_r( value, starti, stopi, stepi, startj, stopj, stepj, &self.arr)
      ...
      if len(val) == 2:
        ...
        if ( tval0 == int and tval1 == int ):
          ...
          if val[0] < self.arr.nrows and val[1] < self.arr.ncols:
            ...
            oarrm3n2_set_item_ij_r( value, val[0], val[1], &self.arr)
  ...
  #***************************************************************************************************
  cdef __setitem__o(self,  object val, onumm3n2 value):
    """
    PURPOSE: Set item from onumm3n2 value.
    """
    #*************************************************************************************************
    ...
    if tval == int:
      ...
      if val < self.arr.nrows:
        ...
        oarrm3n2_set_slice_o( &value.num, starti, stopi, stepi, startj, stopj, stepj, &self.arr)
      ...
      if len(val) == 2:
        ...
        if ( tval0 == int and tval1 == int ):
          ...
          if val[0] < self.arr.nrows and val[1] < self.arr.ncols:
            ...
            oarrm3n2_set_item_ij_o( &value.num, val[0], val[1], &self.arr)
  ...
  #***************************************************************************************************
  cdef __setitem__O(self,  object val, omatm3n2 value):
    """
    ...
    if tval == int:
      ...
      if val < self.arr.nrows:
        ...
        oarrm3n2_set_slice_O( &value.arr, starti, stopi, stepi, startj, stopj, stepj, &self.arr)
  ...
  def copy(self):
    ...
    cdef oarrm3n2_t res = oarrm3n2_copy(&self.arr)
  ...
  def __neg__(self):
    ...
    cdef oarrm3n2_t res = oarrm3n2_neg(&self.arr)
  ...
  def __add__(self, other):
    ...
    cdef oarrm3n2_t res 
    cdef omatm3n2 lhs,rhs
    cdef dmat dlhs,drhs
    cdef onumm3n2 olhs,orhs
    ...
    if (tlhs == trhs):
      ...
      res = oarrm3n2_sum_OO(&lhs.arr,&rhs.arr)
      ...
      res = oarrm3n2_sum_oO(&olhs.num,&rhs.arr)
      ...
      res = oarrm3n2_sum_oO(&orhs.num,&lhs.arr)
    
    elif (tlhs in number_types):
      
      rhs = other
      res = oarrm3n2_sum_rO(self, &rhs.arr)

    elif (trhs in number_types):
        
      lhs = self
      res = oarrm3n2_sum_rO(other, &lhs.arr)
      ...
      res = oarrm3n2_sum_RO(&dlhs.arr,&rhs.arr)
      ...
      res = oarrm3n2_sum_RO(&drhs.arr,&lhs.arr)
  ...
  def __sub__(self, other):
    ...
    if (tlhs == trhs):
      ...
      res = oarrm3n2_sub_OO(&lhs.arr,&rhs.arr)
      ...
      res = oarrm3n2_sub_oO(&olhs.num,&rhs.arr)
      ...
      res = oarrm3n2_sub_Oo(&lhs.arr, &orhs.num)
    
    elif (tlhs in number_types):
      
      rhs = other
      res = oarrm3n2_sub_rO(self, &rhs.arr)

    elif (trhs in number_types):
        
      lhs = self
      res = oarrm3n2_sub_Or(&lhs.arr, other)
      ...
      res = oarrm3n2_sub_RO(&dlhs.arr,&rhs.arr)
      ...
      res = oarrm3n2_sub_OR(&lhs.arr, &drhs.arr)
  ...
  def __mul__(self, other):
    ...
    if (tlhs == trhs):
      ...
      res = oarrm3n2_mul_OO(&lhs.arr,&rhs.arr)
      ...
      res = oarrm3n2_mul_oO(&olhs.num,&rhs.arr)
      ...
      res = oarrm3n2_mul_oO(&orhs.num,&lhs.arr)
    
    elif (tlhs in number_types):
      
      rhs = other
      res = oarrm3n2_mul_rO(self, &rhs.arr)

    elif (trhs in number_types):
        
      lhs = self
      res = oarrm3n2_mul_rO(other, &lhs.arr)
      ...
      res = oarrm3n2_mul_RO(&dlhs.arr,&rhs.arr)
      ...
      res = oarrm3n2_mul_RO(&drhs.arr,&lhs.arr)
  ...
  def __truediv__(self, other):
    ...
    if (tlhs == trhs):
      ...
      res = oarrm3n2_div_OO(&lhs.arr,&rhs.arr)
      ...
      res = oarrm3n2_div_oO(&olhs.num,&rhs.arr)
      ...
      res = oarrm3n2_div_Oo(&lhs.arr, &orhs.num)
    
    elif (tlhs in number_types):
      
      rhs = other
      res = oarrm3n2_div_rO(self, &rhs.arr)

    elif (trhs in number_types):
        
      lhs = self
      res = oarrm3n2_div_Or(&lhs.arr, other)
      ...
      res = oarrm3n2_div_RO(&dlhs.arr,&rhs.arr)
      ...
      res = oarrm3n2_div_OR(&lhs.arr, &drhs.arr)
  ...
  def __pow__(self, n,z):
    ...
    cdef oarrm3n2_t res 
    cdef omatm3n2 S = self

    res = oarrm3n2_pow( &S.arr, n)
  ...
  cpdef get_deriv(self, object hum_dir):
    """
    PURPOSE: Get the corresponding imaginary direction in the omatm3n2 object.
    """
    #*************************************************************************************************
    ...
    res_darr = oarrm3n2_get_deriv( item[ZERO],  item[ONE], &self.arr)
  ...
  cpdef get_im(self, object hum_dir):
    ...
    res_darr = oarrm3n2_get_im( item[ZERO],  item[ONE], &self.arr)
  ...
  cpdef extract_im(self, object hum_dir):
    ...
    res = oarrm3n2_extract_im( item[ZERO],  item[ONE], &self.arr)
  ...
  cpdef  extract_deriv(self, object hum_dir):
    """
    PURPOSE: Get the corresponding derivative in the omatm3n2 object, as OTI number.
    """
    #*************************************************************************************************
    ...
    res = oarrm3n2_extract_deriv( item[ZERO],  item[ONE], &self.arr)
  ...
  cpdef  get_order_im(self, ord_t order):
    ...
    res = oarrm3n2_get_order_im( order, &self.arr)
  ...
  cpdef  truncate( self, object humdir):
    ...
    res = oarrm3n2_truncate_im( indx, order, &self.arr) 
  ...
  cpdef set(self, object rhs):
    ...
    if   trhs is onumm3n2:
      ...
      orhs = rhs
      oarrm3n2_set_o( &orhs.num, &self.arr)

    elif trhs is omatm3n2:

      Orhs = rhs
      oarrm3n2_set_O( &Orhs.arr, &self.arr)      

    elif trhs in number_types:

      rrhs = rhs
      oarrm3n2_set_r( rrhs, &self.arr)

    else:

      raise ValueError( "Cant assign '{0}' into a omatm3n2 object.".format(trhs) )
  ...
  def get_active_bases(self):
    ...
    oarrm3n2_get_active_bases( &self.arr, bases_list)
  ...
  def taylor_integrate(self, object bases, object deltas):
    ...
    res = oarrm3n2_taylor_integrate( c_deltas, &self.arr)
  ...
  #***************************************************************************************************
  @staticmethod
  def dot( omatm3n2 lhs, omatm3n2 rhs, omatm3n2 out = None): 
    """
    ...
    if out is not None:
      ...
      oarrm3n2_matmul_OO_to( &lhs.arr, &rhs.arr ,&out.arr)

    else:

      res = oarrm3n2_matmul_OO( &lhs.arr, &rhs.arr )
  ...
  #***************************************************************************************************
  @staticmethod
  def inv( omatm3n2 arr,  omatm3n2 out = None): 
    """
    ...
    if out is not None:
      ...
      oarrm3n2_invert_to( &arr.arr,&out.arr)

    else:

      res = oarrm3n2_invert( &arr.arr)
  ...
  #***************************************************************************************************
  @staticmethod
  def transpose( omatm3n2 arr,  omatm3n2 out = None ): 
    """
    ...
    if out is not None:
      ...
      oarrm3n2_transpose_to( &arr.arr, &out.arr)

    else:

      res = oarrm3n2_transpose( &arr.arr)
  ...
  #***************************************************************************************************
  @staticmethod
  def add( omatm3n2 lhs, omatm3n2 rhs, omatm3n2 out = None): 
    """
    ...
    if out is not None:
      ...
      oarrm3n2_sum_OO_to( &lhs.arr, &rhs.arr ,&out.arr)
