...
onumm1n7_t onumm1n7_div_ro(coeff_t num, onumm1n7_t* den){
    ...
    onumm1n7_t inv = onumm1n7_pow(den,-1);
    onumm1n7_t res = onumm1n7_mul_ro(num,&inv);
...
onumm1n7_t onumm1n7_div_oo(onumm1n7_t* num, onumm1n7_t* den){
    ...
    onumm1n7_t res = onumm1n7_mul_oo(num,&inv);
...
onumm1n7_t onumm1n7_div_or(onumm1n7_t* num, coeff_t val){
    ...
    return onumm1n7_mul_ro(1.0/val,num);
...
void onumm1n7_trunc_sum_oo_to(ord_t order, onumm1n7_t* lhs,onumm1n7_t* rhs, onumm1n7_t* res){
  // Addition like function 'lhs + rhs'
  switch(order){
    case(0):
      //  Real
...
void onumm1n7_trunc_sub_oo_to(ord_t order, onumm1n7_t* lhs,onumm1n7_t* rhs, onumm1n7_t* res){
  // Addition like function 'lhs - rhs'
  switch(order){
    case(0):
      //  Real
...
onumm1n7_t onumm1n7_feval(coeff_t* feval_re, onumm1n7_t* x){
  ...
  onumm1n7_t deltax = (*x), deltax_power = (*x);
  deltax.r = 0.0;
  deltax_power.r = 0.0;
  onumm1n7_set_r(0.0, &res);
  //  Real
  res.r = feval_re[0];
  // Order 1
  factor *=1;
  coef    = feval_re[1]/ factor;;
  onumm1n7_gem_ro_to( coef, &deltax_power, &res, &res);
  deltax_power = onumm1n7_mul_oo(&deltax_power,&deltax);
  // Order 2
  factor *=2;
