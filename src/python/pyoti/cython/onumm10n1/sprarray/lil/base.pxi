...
cdef class lil_omatm10n1:
  ...
  def __init__(self, shape): 
    """
    PURPOSE:      Python level constructor of the lil_omatm10n1 class.

    DESCRIPTION:  Creates a new empty lil_omatm10n1 matrix.
  ...
  def copy(self):
    ...
    cdef lil_omatm10n1 res = lil_omatm10n1(self.shape)
    cdef uint64_t i, k
  ...
  def tocsr(self):
    ...
    """
    return csr_omatm10n1(self,shape=self.shape)
