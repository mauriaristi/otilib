#*****************************************************************************************************
cdef object __div__FX__(feomatm3n2 Flhs, object rhs, object out = None):
  """
  PORPUSE: Division between feomatm3n2 and object.
...
#*****************************************************************************************************
cdef object __div__OX__(omatm3n2 Olhs, object rhs, object out = None):
  """
  PORPUSE: Division between omatm3n2 and object.
...
#*****************************************************************************************************
cdef object __div__oX__(onumm3n2 olhs, object rhs, object out = None):
  """
  PORPUSE: Division between onumm3n2 and object.
...
#*****************************************************************************************************
cdef object __div__fX__(feonumm3n2 flhs, object rhs, object out = None):
  """
  PORPUSE: Division between feonumm3n2 and object.
