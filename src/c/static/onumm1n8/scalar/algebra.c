...
onumm1n8_t onumm1n8_div_ro(coeff_t num, onumm1n8_t* den){
    ...
    onumm1n8_t inv = onumm1n8_pow(den,-1);
    onumm1n8_t res = onumm1n8_mul_ro(num,&inv);
...
onumm1n8_t onumm1n8_div_oo(onumm1n8_t* num, onumm1n8_t* den){
    ...
    onumm1n8_t res = onumm1n8_mul_oo(num,&inv);
...
onumm1n8_t onumm1n8_div_or(onumm1n8_t* num, coeff_t val){
    ...
    return onumm1n8_mul_ro(1.0/val,num);
...
onumm1n8_t onumm1n8_feval(coeff_t* feval_re, onumm1n8_t* x){
  ...
  onumm1n8_t deltax = (*x), deltax_power = (*x);
  deltax.r = 0.0;
  deltax_power.r = 0.0;
  onumm1n8_set_r(0.0, &res);
  //  Real
  res.r = feval_re[0];
  // Order 1
  factor *=1;
  coef    = feval_re[1]/ factor;;
  onumm1n8_gem_ro_to( coef, &deltax_power, &res, &res);
  deltax_power = onumm1n8_mul_oo(&deltax_power,&deltax);
  // Order 2
  factor *=2;
