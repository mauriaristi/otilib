...
cdef object __add__OX__(omatm8n1 Olhs, object rhs, object out = None):
  """
  PORPUSE: Addition between omatm8n1 and object.
  ...
  if trhs == onumm8n1:
    ...
    if res_flag:
      ...
      cOres = oarrm8n1_sum_OO( &Olhs.arr, &Orhs.arr )
      res = omatm8n1.create( &cOres )
    # end if
  elif trhs == dmat:
    Rrhs = rhs
...
cdef object __add__oX__(onumm8n1 olhs, object rhs, object out = None):
  """
  PORPUSE: Addition between onumm8n1 and object.
...
cdef object __add__fX__(feonumm8n1 flhs, object rhs, object out = None):
  """
  PORPUSE: Addition between feonumm8n1 and object.
