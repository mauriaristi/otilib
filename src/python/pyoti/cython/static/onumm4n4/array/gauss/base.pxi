...
cdef class feomatm4n4:
  ...
  def __init__(self, shape, uint64_t nip): 
    """
    PURPOSE:      Python level constructor of the feomatm4n4 class.
    ...
    if (isinstance(shape, tuple)):
      ...
      if( ndim == 1 ):
        ...
        raise ValueError("Cant create feomatm4n4 for dimensions greater than 2.")
    ...
    for i in range(self.arr.nrows):
      for j in range(self.arr.ncols):
        for k in range(self.arr.nip):
          ...
          fedarr_set_item_ijk_r( onumm4n4_tmp.r , i, j, k, &tmp.arr);
        # end for
      # end for
    # end for
  ...
  #***************************************************************************************************
  @staticmethod
  cdef feomatm4n4 create(feoarrm4n4_t* arr, uint8_t FLAGS = 1):
    """
    ...
    cdef feomatm4n4 res = <feomatm4n4> feomatm4n4.__new__(feomatm4n4)
  ...
  #***************************************************************************************************
  cdef __setitem__f(self,  object val, feonumm4n4 value):
    """
    PURPOSE: Set item from feonumm4n4 value.
    """
    #*************************************************************************************************
  ...
  #***************************************************************************************************
  cdef __setitem__F(self,  object val, feomatm4n4 value):
    """
    PURPOSE: Set item from feomatm4n4 value.
    """
    #*************************************************************************************************
  ...
  def __add__(self, other):
    ...
    cdef feomatm4n4 Flhs,Frhs
    cdef feonumm4n4  flhs,frhs
    cdef dmat    Dlhs,Drhs
    cdef onumm4n4 olhs,orhs
    cdef omatm4n4   Olhs,Orhs
  ...
  cpdef set_ijk(self, object rhs, uint64_t i, uint64_t j, uint64_t k):
    ...
    if   trhs is onumm4n4:
      ...
      orhs = rhs
      feoarrm4n4_set_item_ijk_o( &orhs.num, i, j, k, &self.arr)
      ...
      try:
        ...
        rrhs = rhs
        feoarrm4n4_set_item_ijk_r( rrhs, i, j, k, &self.arr)
      
      except:
      
        raise ValueError("Supported values are real scalar and onumm4n4.")
  ...
  cpdef set(self, object rhs):
    ...
    #   feoarrm4n4_set_F( &Frhs.arr, &self.arr)   
      ...
      try:
        ...
        raise ValueError("Supported values are real scalar, onumm4n4 and feonumm4n4.")
  ...
  #***************************************************************************************************
  cpdef  get_item_ij( self, int64_t i, int64_t j, feonumm4n4 out=None):
    """
    PURPOSE:      Get an item from feomatm4n4 array.
