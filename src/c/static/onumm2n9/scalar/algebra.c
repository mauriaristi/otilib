...
onumm2n9_t onumm2n9_div_ro(coeff_t num, onumm2n9_t* den){
    ...
    onumm2n9_t inv = onumm2n9_pow(den,-1);
    onumm2n9_t res = onumm2n9_mul_ro(num,&inv);
...
onumm2n9_t onumm2n9_div_oo(onumm2n9_t* num, onumm2n9_t* den){
    ...
    onumm2n9_t res = onumm2n9_mul_oo(num,&inv);
...
onumm2n9_t onumm2n9_div_or(onumm2n9_t* num, coeff_t val){
    ...
    return onumm2n9_mul_ro(1.0/val,num);
...
void onumm2n9_trunc_sum_oo_to(ord_t order, onumm2n9_t* lhs,onumm2n9_t* rhs, onumm2n9_t* res){
  // Addition like function 'lhs + rhs'
  switch(order){
    case(0):
      //  Real
...
void onumm2n9_trunc_sub_oo_to(ord_t order, onumm2n9_t* lhs,onumm2n9_t* rhs, onumm2n9_t* res){
  // Addition like function 'lhs - rhs'
  switch(order){
    case(0):
      //  Real
...
onumm2n9_t onumm2n9_feval(coeff_t* feval_re, onumm2n9_t* x){
  ...
  onumm2n9_t deltax = (*x), deltax_power = (*x);
  deltax.r = 0.0;
  deltax_power.r = 0.0;
  onumm2n9_set_r(0.0, &res);
  //  Real
  res.r = feval_re[0];
  // Order 1
  factor *=1;
  coef    = feval_re[1]/ factor;;
  onumm2n9_gem_ro_to( coef, &deltax_power, &res, &res);
  deltax_power = onumm2n9_mul_oo(&deltax_power,&deltax);
  // Order 2
  factor *=2;
