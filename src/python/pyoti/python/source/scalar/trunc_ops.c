...
// ****************************************************************************************************
void soti_trunc_smul_real(coeff_t a, ord_t ord, sotinum_t* res){{
...
// ****************************************************************************************************
void soti_trunc_ssum(sotinum_t* num1, ord_t ord, sotinum_t* res ){{
...
// ****************************************************************************************************
void soti_set_trunc( sotinum_t* src, ord_t ord, sotinum_t* dest){{
