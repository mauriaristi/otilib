...
ord_t feonumm3n1_get_order( feonumm3n1_t* num ){
    ...
    for( i = 0; i<num->nip; i++ ){
        ...
        order = MAX(order, onumm3n1_get_order(&num->p_data[i]) );
...
void feonumm3n1_get_order_im_to( ord_t order, feonumm3n1_t* num, feonumm3n1_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm3n1_get_order_im_to( order, &num->p_data[k], &res->p_data[k]);
...
feonumm3n1_t feonumm3n1_get_order_im( ord_t order, feonumm3n1_t* num){
    ...
    res = feonumm3n1_zeros( num->nip);

    feonumm3n1_get_order_im_to( order, num, &res);
...
void feonumm3n1_extract_im_to( imdir_t idx, ord_t order, feonumm3n1_t* num, feonumm3n1_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm3n1_extract_im_to( idx, order, &num->p_data[k], &res->p_data[k]);
...
feonumm3n1_t feonumm3n1_extract_im( imdir_t idx, ord_t order, feonumm3n1_t* num){
    ...
    feonumm3n1_extract_im_to( idx, order, num, &res);
...
void feonumm3n1_extract_deriv_to( imdir_t idx, ord_t order, feonumm3n1_t* num, feonumm3n1_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm3n1_extract_deriv_to( idx, order, &num->p_data[k], &res->p_data[k]);
...
feonumm3n1_t feonumm3n1_extract_deriv( imdir_t idx, ord_t order, feonumm3n1_t* num){
    ...
    feonumm3n1_extract_deriv_to( idx, order, num, &res);
...
void feonumm3n1_get_deriv_to( imdir_t idx, ord_t order, feonumm3n1_t* num, feonumm3n1_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm3n1_get_deriv_to( idx, order, &num->p_data[k], &res->p_data[k]);
...
feonumm3n1_t feonumm3n1_get_deriv( imdir_t idx, ord_t order, feonumm3n1_t* num){
    ...
    feonumm3n1_get_deriv_to( idx, order, num, &res);
...
void feonumm3n1_get_im_to( imdir_t idx, ord_t order, feonumm3n1_t* num, feonumm3n1_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm3n1_get_im_to_o( idx, order, &num->p_data[k], &res->p_data[k]);
...
feonumm3n1_t feonumm3n1_get_im( imdir_t idx, ord_t order, feonumm3n1_t* num){
    ...
    feonumm3n1_get_im_to( idx, order, num, &res);
...
void feonumm3n1_truncate_im_to( imdir_t idx, ord_t order, feonumm3n1_t* num,  feonumm3n1_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm3n1_truncate_im_to( idx, order, &num->p_data[k], &res->p_data[k]);
...
feonumm3n1_t feonumm3n1_truncate_im( imdir_t idx, ord_t order, feonumm3n1_t* num){
    ...
    feonumm3n1_truncate_im_to( idx, order, num, &res);
...
void feonumm3n1_set_im_r( coeff_t val, imdir_t idx, ord_t order, feonumm3n1_t* num){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm3n1_set_im_r( val, idx, order, &num->p_data[k]);
...
void feonumm3n1_set_im_o( onumm3n1_t* val, imdir_t idx, ord_t order, feonumm3n1_t* num){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm3n1_set_im_o( val, idx, order, &num->p_data[k]);
...
void feonumm3n1_set_im_f( feonumm3n1_t* val, imdir_t idx, ord_t order, feonumm3n1_t* num){
    ...
    feonumm3n1_dimCheck(val,num);

    for (k = 0; k<num->nip; k++ ){
        
        onumm3n1_set_im_o( &val->p_data[k], idx, order, &num->p_data[k]);
...
void feonumm3n1_set_deriv_r( coeff_t val, imdir_t idx, ord_t order, feonumm3n1_t* num){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm3n1_set_deriv_r( val, idx, order, &num->p_data[k]);
...
void feonumm3n1_set_deriv_o( onumm3n1_t* val, imdir_t idx, ord_t order, feonumm3n1_t* num){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm3n1_set_deriv_o( val, idx, order, &num->p_data[k]);
...
void feonumm3n1_set_deriv_f( feonumm3n1_t* val, imdir_t idx, ord_t order, feonumm3n1_t* num){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm3n1_set_deriv_o( &val->p_data[k], idx, order, &num->p_data[k]);
...
// ****************************************************************************************************
void feonumm3n1_set_to( feonumm3n1_t* src, feonumm3n1_t* dst){
    
    uint64_t i;

    feonumm3n1_dimCheck(src,dst);

    for (i = 0; i<src->nip; i++ ){
        
        onumm3n1_copy_to( &src->p_data[i], &dst->p_data[i]);
...
feonumm3n1_t feonumm3n1_copy( feonumm3n1_t* src){
    ...
    res = feonumm3n1_createEmpty(src->nip);

    feonumm3n1_copy_to( src, &res);
...
void feonumm3n1_set_o( onumm3n1_t* num, feonumm3n1_t* res){
    ...
    for (i = 0; i<res->nip; i++ ){
        ...
        onumm3n1_set_o( num, &res->p_data[i]);
...
void feonumm3n1_set_r( coeff_t num, feonumm3n1_t* res){
    ...
    for (i = 0; i<res->nip; i++ ){
        ...
        onumm3n1_set_r( num, &res->p_data[i]);
...
void feonumm3n1_set_item_k_o( onumm3n1_t* num, uint64_t k, feonumm3n1_t* res){
    ...
    if (k < res->nip){
        ...
        onumm3n1_set_o(num, &res->p_data[k]); 

    } else {

        printf("ERROR: Index out of bounds in feonumm3n1_get_item_k.\n");
...
void feonumm3n1_set_item_k_r(   coeff_t  num, uint64_t k, feonumm3n1_t* res){
    ...
    if (k < res->nip){
        ...
        onumm3n1_set_r(num, &res->p_data[k]); 
...
void feonumm3n1_get_item_k_to(feonumm3n1_t* num, uint64_t k, onumm3n1_t* res){
    ...
    if (k < num->nip){
        ...
        onumm3n1_copy_to( &num->p_data[k], res);
...
// ****************************************************************************************************
feonumm3n1_t feonumm3n1_zeros(uint64_t nip){

    feonumm3n1_t  res  = feonumm3n1_createEmpty(nip);
    
    feonumm3n1_set_r( 0.0, &res);
...
// ****************************************************************************************************
inline feonumm3n1_t feonumm3n1_createEmpty(uint64_t nip){

    feonumm3n1_t  res ;  
    void * memory = NULL;

    // Allocate memory and check if correctly allocated.
    memory = malloc( nip * sizeof( onumm3n1_t ) );

    if ( memory == NULL ){
        printf("ERROR: Not enough memory to handle array of feonumm3n1.\n Exiting...\n");
        exit(OTI_OutOfMemory); // TODO: Raise error instead of quitting the program.
    }
    
    res.p_data = ( onumm3n1_t* ) memory;
    res.nip = nip;
...
// ****************************************************************************************************
inline feonumm3n1_t feonumm3n1_init(void){
...
// ****************************************************************************************************
inline feonumm3n1_t feonumm3n1_empty_like(feonumm3n1_t* arr){

    feonumm3n1_t res = feonumm3n1_createEmpty(arr->nip);
