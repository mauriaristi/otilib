...
cdef object __add__OX__(mdarr3_t Olhs, object rhs, object out = None):
  """
  PORPUSE: Addition between mdarr3_t and object.
  ...
  if trhs == mdnum3_t:
    ...
    if res_flag:
      ...
      cOres = mdarr3_sum_OO( &Olhs.arr, &Orhs.arr )
      res = mdarr3_t.create( &cOres )
    # end if
  elif trhs == dmat:
    Rrhs = rhs
...
cdef object __add__oX__(mdnum3_t olhs, object rhs, object out = None):
  """
  PORPUSE: Addition between mdnum3_t and object.
...
cdef object __add__fX__(femdnum3_t flhs, object rhs, object out = None):
  """
  PORPUSE: Addition between femdnum3_t and object.
