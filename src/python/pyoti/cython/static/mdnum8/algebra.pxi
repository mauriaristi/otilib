...
cpdef sum(object lhs, object rhs, object out = None):
  ...
  elif tlhs is mdnumfe8:
    res = __add__fX__(lhs, rhs, out = out)
  elif tlhs is mdmat8:
    res = __add__OX__(lhs, rhs, out = out)
  elif tlhs is mdmatfe8:
    res = __add__FX__(lhs, rhs, out = out)
  elif tlhs is dmat:
...
#*****************************************************************************************************
cpdef trunc_sub(ord_t order, mdmat8 Olhs, mdmat8 Orhs, mdmat8 out = None):
  """
  PURPOSE:  Subtraction between two objects.
  """
  #***************************************************************************************************
  ...
  if res_flag:    
    mdarr8_trunc_sub_OO_to( order, &Olhs.arr, &Orhs.arr, &out.arr )
  # else:
  #   cOres = mdarr8_trunc_sub_OO( order, &Olhs.arr, &Orhs.arr )
