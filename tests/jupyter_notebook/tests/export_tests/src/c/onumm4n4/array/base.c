...
oarrm4n4_t oarrm4n4_taylor_integrate( coeff_t* deltas, oarrm4n4_t* arr){
    ...
    res = oarrm4n4_zeros( arr->nrows, arr->ncols, 0, 0);
...
oarrm4n4_t oarrm4n4_extract_im(imdir_t idx, ord_t order, oarrm4n4_t* arr){
    ...
    oarrm4n4_t res = oarrm4n4_zeros( arr->nrows, arr->ncols, 0, 0);
...
oarrm4n4_t oarrm4n4_get_slice( oarrm4n4_t* arr, 
    ...
    res = oarrm4n4_zeros( nrows, ncols, 0, 0);
...
// ****************************************************************************************************
oarrm4n4_t oarrm4n4_eye(uint64_t nrows, ndir_t* p_nnz, ord_t order){

    oarrm4n4_t  res = oarrm4n4_zeros( nrows, nrows, p_nnz, order);
    uint64_t i;
...
// ****************************************************************************************************
oarrm4n4_t oarrm4n4_ones(uint64_t nrows, uint64_t ncols, ndir_t* p_nnz, ord_t order){

    oarrm4n4_t  res = oarrm4n4_createEmpty(nrows, ncols, p_nnz, order);
    uint64_t i;
...
// ****************************************************************************************************
oarrm4n4_t oarrm4n4_zeros(uint64_t nrows, uint64_t ncols, ndir_t* p_nnz, ord_t order){
...
inline oarrm4n4_t oarrm4n4_empty_like(oarrm4n4_t* arr){
    ...
    if (arr->size!=0){
        ...
        res = oarrm4n4_createEmpty(arr->nrows, arr->ncols, arr->p_data[0].p_size, 
            arr->p_data[0].order);    

    }else{

        res = oarrm4n4_createEmpty(arr->nrows, arr->ncols, NULL, 0);    
