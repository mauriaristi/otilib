#ifndef OTI_ONUMM7N1_SCALAR_GAUSS_BASE_H
#define OTI_ONUMM7N1_SCALAR_GAUSS_BASE_H
...
@param[in] num FEonumm7n1 to free
******************************************************************************************************/
...
@param[in] num FEonumm7n1
******************************************************************************************************/
ord_t feonumm7n1_get_order( feonumm7n1_t* num );
// ----------------------------------------------------------------------------------------------------

/**************************************************************************************************//**
@brief Initialize a feonumm7n1 structure.

******************************************************************************************************/
feonumm7n1_t feonumm7n1_init(void);
// ----------------------------------------------------------------------------------------------------
