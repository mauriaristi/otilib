#ifndef OTI_ONUMM1N7_SCALAR_GAUSS_BASE_H
#define OTI_ONUMM1N7_SCALAR_GAUSS_BASE_H
...
@param[in] num FEonumm1n7 to free
******************************************************************************************************/
...
@param[in] num FEonumm1n7
******************************************************************************************************/
ord_t feonumm1n7_get_order( feonumm1n7_t* num );
// ----------------------------------------------------------------------------------------------------

/**************************************************************************************************//**
@brief Initialize a feonumm1n7 structure.

******************************************************************************************************/
feonumm1n7_t feonumm1n7_init(void);
// ----------------------------------------------------------------------------------------------------
