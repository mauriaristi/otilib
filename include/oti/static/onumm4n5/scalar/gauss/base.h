#ifndef OTI_ONUMM4N5_SCALAR_GAUSS_BASE_H
#define OTI_ONUMM4N5_SCALAR_GAUSS_BASE_H
...
@param[in] num FEonumm4n5 to free
******************************************************************************************************/
...
@param[in] num FEonumm4n5
******************************************************************************************************/
ord_t feonumm4n5_get_order( feonumm4n5_t* num );
// ----------------------------------------------------------------------------------------------------

/**************************************************************************************************//**
@brief Initialize a feonumm4n5 structure.

******************************************************************************************************/
feonumm4n5_t feonumm4n5_init(void);
// ----------------------------------------------------------------------------------------------------
