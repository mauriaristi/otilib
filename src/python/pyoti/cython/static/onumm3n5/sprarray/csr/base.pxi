...
cdef class csr_matrix:
    ...
    if targ1 == lil_matrix :
      ...
      if len(arg1) == 3: # Same as in scipy csr sparse.
        ...
        for i in range(data.size):
          ...
          if type(data) == onumm3n5:

            self.data[i] = data[i].copy()

          else:
            
            self.data[i] = onumm3n5( data[i] )
  ...
  def __pow__(self, n,z):
    ...
    for i in range(self.data.size):
      ...
      ores = res.data[i]
      oval = self.data[i]
      onumm3n5_pow_to( &oval.num, n, &ores.num)
  ...
  cpdef get_deriv(self, object hum_dir ):
    ...
    for i in range(self.data.size):
      ...
      ores = res.data[i]
      oval = self.data[i]
      onumm3n5_get_deriv_to( indx, order, &oval.num, &ores.num)
  ...
  cpdef get_im(self, object hum_dir ):
    ...
    for i in range(self.data.size):
      ...
      ores = res.data[i]
      oval = self.data[i]
      onumm3n5_get_im_to_o( indx, order, &oval.num, &ores.num)
  ...
  cpdef extract_im(self, object hum_dir):
    ...
    for i in range(self.data.size):
      ...
      ores = res.data[i]
      oval = self.data[i]
      onumm3n5_extract_im_to( indx, order, &oval.num, &ores.num)
  ...
  cpdef  extract_deriv(self, object hum_dir):
    ...
    for i in range(self.data.size):
      ...
      ores = res.data[i]
      oval = self.data[i]
      onumm3n5_extract_deriv_to( indx, order, &oval.num, &ores.num)
  ...
  cpdef  get_order_im(self, ord_t order):
    ...
    for i in range(self.data.size):
      ...
      ores = res.data[i]
      oval = self.data[i]
      onumm3n5_get_order_im_to( order, &oval.num, &ores.num)
  ...
  cpdef  truncate( self, object hum_dir):
    ...
    for i in range(self.data.size):
      ...
      ores = res.data[i]
      oval = self.data[i]
      onumm3n5_truncate_im_to( indx, order, &oval.num, &ores.num)
  ...
  def get_active_bases(self):
    ...
    for i in range(self.data.size):
      ...
      oval = self.data[i]
      onumm3n5_get_active_bases( &oval.num, bases_list)
...
# ****************************************************************************************************
cdef void csrmatrix_matmul_SO_to(csr_matrix lhs, omatm3n5 rhs, omatm3n5 res):
  """
  ...
  for i in range(lhs.nrows):
    ...
    for j in range(rhs.ncols):
      ...
      for l in range( lhs.indptr[i], lhs.indptr[i+1] ):
        ...
        onumm3n5_gem_oo_to( &olhs.num,
                        &rhs.arr.p_data[ j + k * rhs.ncols ],
                        &tmp, &tmp)

      # end for

      oarrm3n5_set_item_ij_o( &tmp, i, j, &res.arr)
...
# ****************************************************************************************************
cdef omatm3n5 csrmatrix_matmul_SO(csr_matrix lhs, omatm3n5 rhs):
  """
  PORPUSE:  Perform matrix-matrix multiplication between csr matrix and dense matrix.
...
# ****************************************************************************************************
cdef void csrmatrix_trunc_matmul_SO_to(ord_t ord_lhs, csr_matrix lhs, ord_t ord_rhs, omatm3n5 rhs, omatm3n5 res):
  """
  PORPUSE:  Perform matrix-matrix multiplication between csr matrix and dense matrix.
  ...
  for i in range(lhs.nrows):
    ...
    for j in range(rhs.ncols):
      ...
      for l in range( lhs.indptr[i], lhs.indptr[i+1] ):
        ...
        onumm3n5_trunc_gem_oo_to( ord_lhs, &olhs.num, ord_rhs,
                        &rhs.arr.p_data[ j + k * rhs.ncols ],
                        &tmp, &tmp)
...
# ****************************************************************************************************
cdef omatm3n5 csrmatrix_trunc_matmul_SO(ord_t ord_lhs, csr_matrix lhs, ord_t ord_rhs, omatm3n5 rhs):
  """
  PORPUSE:  Perform matrix-matrix multiplication between csr matrix and dense matrix.
