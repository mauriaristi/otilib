...
void onumm7n2_set_im_o(onumm7n2_t* num, imdir_t idx, ord_t order, onumm7n2_t* res){
    onumm7n2_set_item(num->r,idx,order,res);
}
...
void onumm7n2_get_im_to_o(imdir_t idx, ord_t order, onumm7n2_t* num, onumm7n2_t* res){
    coeff_t rres = onumm7n2_get_item(idx, order, num);
    onumm7n2_set_r(rres,res);
}
...
void onumm7n2_get_im_to_r(imdir_t idx, ord_t order, onumm7n2_t* num, coeff_t* res){
    *res = onumm7n2_get_item(idx, order, num);
}

inline ord_t onumm7n2_get_order(onumm7n2_t* lhs){
...
onumm7n2_t onumm7n2_get_deriv_o( imdir_t idx, ord_t order, onumm7n2_t* num){
    ...
    onumm7n2_get_deriv_to( idx, order, num, &res);
...
void onumm7n2_get_deriv_to( imdir_t idx, ord_t order, onumm7n2_t* num, onumm7n2_t* res){
    ...
    coeff_t deriv = onumm7n2_get_deriv(idx,order,num);

    onumm7n2_set_r( deriv, res);

}

void onumm7n2_set_im_r(coeff_t num, imdir_t idx, ord_t order, onumm7n2_t* res){

    onumm7n2_set_item(num, idx,order,res);
...
onumm7n2_t onumm7n2_taylor_integrate(coeff_t* deltas,onumm7n2_t* lhs){
  ...
  res.r += factor*lhs->e7;
  // Order 2;
  factor = pow(deltas[0],2)*pow(deltas[1],0)*pow(deltas[2],0)*pow(deltas[3],0)*pow(deltas[4],0)*pow(deltas[5],0)*pow(deltas[6],0);
  ...
  factor = pow(deltas[0],0)*pow(deltas[1],2)*pow(deltas[2],0)*pow(deltas[3],0)*pow(deltas[4],0)*pow(deltas[5],0)*pow(deltas[6],0);
  ...
  factor = pow(deltas[0],0)*pow(deltas[1],0)*pow(deltas[2],2)*pow(deltas[3],0)*pow(deltas[4],0)*pow(deltas[5],0)*pow(deltas[6],0);
  ...
  factor = pow(deltas[0],0)*pow(deltas[1],0)*pow(deltas[2],0)*pow(deltas[3],2)*pow(deltas[4],0)*pow(deltas[5],0)*pow(deltas[6],0);
  ...
  factor = pow(deltas[0],0)*pow(deltas[1],0)*pow(deltas[2],0)*pow(deltas[3],0)*pow(deltas[4],2)*pow(deltas[5],0)*pow(deltas[6],0);
  ...
  factor = pow(deltas[0],0)*pow(deltas[1],0)*pow(deltas[2],0)*pow(deltas[3],0)*pow(deltas[4],0)*pow(deltas[5],2)*pow(deltas[6],0);
  ...
  factor = pow(deltas[0],0)*pow(deltas[1],0)*pow(deltas[2],0)*pow(deltas[3],0)*pow(deltas[4],0)*pow(deltas[5],0)*pow(deltas[6],2);
