...
cdef class csr_oarrm2n5_t:
  ...
  def __init__(self, arg1, shape=None, copy = True): 
    """
    PURPOSE:      Python level constructor of the csr_oarrm2n5_t class.

    DESCRIPTION:  Creates a new empty csr_oarrm2n5_t matrix.
                 
    """
    #*************************************************************************************************
    
    cdef uint64_t i, j, k, ncols, nrows
    cdef lil_oarrm2n5_t lil
    
    targ1 = type(arg1)

    if targ1 == lil_oarrm2n5_t :
      ...
      if len(arg1) == 3: # Same as in scipy csr sparse.
        ...
        for i in range(data.size):
          ...
          if type(data) == onumm2n5_t:

            self.data[i] = data[i].copy()

          else:
            
            self.data[i] = onumm2n5_t( data[i] )
  ...
  def copy(self):
    ...
    cdef csr_oarrm2n5_t res = <csr_oarrm2n5_t> csr_oarrm2n5_t.__new__(csr_oarrm2n5_t)
    cdef object[:]   data
...
# ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
# :::::::::::::::::::::::::::::::::::: END OF CLASS csr_oarrm2n5_t ::::::::::::::::::::::::::::::::::::::::
# ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::

# ****************************************************************************************************
cdef void csroarrm2n5_t_matmul_SO_to(csr_oarrm2n5_t lhs, oarrm2n5_t rhs, oarrm2n5_t res):
  """
...
# ****************************************************************************************************
cdef oarrm2n5_t csroarrm2n5_t_matmul_SO(csr_oarrm2n5_t lhs, oarrm2n5_t rhs):
  """
  PORPUSE:  Perform matrix-matrix multiplication between csr matrix and dense matrix.
  ...
  csroarrm2n5_t_matmul_SO_to( lhs, rhs, res)
