...
cdef class oarrm2n5_t:
  ...
  def __init__(self, realArray, ord_t order = 0, bases_t nbases = 0, object nnz = None): 
    """
    PURPOSE:      Python level constructor of the oarrm2n5_t class.
  ...
  #***************************************************************************************************
  @staticmethod
  cdef oarrm2n5_t create(oarrm2n5_t* arr, uint8_t FLAGS = 1):
    """
    ...
    cdef oarrm2n5_t mat = <oarrm2n5_t> oarrm2n5_t.__new__(oarrm2n5_t)
  ...
  def __repr__(self):
    ...
    #     out+= (onumm2n5_t.create(&d_onumm2n5,FLAGS=0)).__str__()+", "
    #   # end for 
    #   out = out[:-2] + "],\n"
    # # end for 
    # out =out[:-2] + "]"
  ...
  cpdef set(self, object rhs):
    ...
    if   trhs is onumm2n5_t:
      ...
      raise ValueError( "Cant assign '{0}' into a oarrm2n5_t object.".format(trhs) )
  ...
  #***************************************************************************************************
  @staticmethod
  def dot( oarrm2n5_t lhs, oarrm2n5_t rhs, oarrm2n5_t out = None): 
    """
  ...
  #***************************************************************************************************
  @staticmethod
  def inv( oarrm2n5_t arr,  oarrm2n5_t out = None): 
    """
  ...
  #***************************************************************************************************
  @staticmethod
  def transpose( oarrm2n5_t arr,  oarrm2n5_t out = None ): 
    """
  ...
  #***************************************************************************************************
  @staticmethod
  def add( oarrm2n5_t lhs, oarrm2n5_t rhs, oarrm2n5_t out = None): 
    """
