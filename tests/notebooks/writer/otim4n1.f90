MODULE OTIM4N1
   ...
   INTEGER, PARAMETER :: N_IMDIR_ORDER(2) = [1,4]
   ...
   INTERFACE PPRINT
      MODULE PROCEDURE ONUMM4N1_PPRINT_S,ONUMM4N1_PPRINT_V,ONUMM4N1_PPRINT_M
   END INTERFACE
   ...
   INTERFACE DOT_PRODUCT
      MODULE PROCEDURE ONUMM4N1_DOT_PRODUCT_ONUMM4N1,R_DOT_PRODUCT_ONUMM4N1,ONUMM4N1_DOT_PRODUCT_R
   END INTERFACE
   ...
   INTERFACE DET2X2
      MODULE PROCEDURE ONUMM4N1_det2x2
   END INTERFACE

   INTERFACE DET3X3
      MODULE PROCEDURE ONUMM4N1_det3x3
   END INTERFACE

   INTERFACE DET4X4
      MODULE PROCEDURE ONUMM4N1_det4x4
   END INTERFACE

   INTERFACE INV2X2
      MODULE PROCEDURE ONUMM4N1_INV2X2
   END INTERFACE

   INTERFACE INV3X3
      MODULE PROCEDURE ONUMM4N1_INV3X3
   END INTERFACE

   INTERFACE INV4X4
      MODULE PROCEDURE ONUMM4N1_INV4X4
   END INTERFACE

   INTERFACE GETIM
      MODULE PROCEDURE ONUMM4N1_GETIM_S,ONUMM4N1_GETIM_V,ONUMM4N1_GETIM_M
   END INTERFACE

   INTERFACE SETIM
      MODULE PROCEDURE ONUMM4N1_SETIM_S,ONUMM4N1_SETIM_V,ONUMM4N1_SETIM_M
   END INTERFACE
...
ELEMENTAL    FUNCTION ONUMM4N1_GEM_ORO(A,B,C)&
   ...
   FUNCTION ONUMM4N1_DOT_PRODUCT_ONUMM4N1(LHS,RHS)&
      RESULT(RES)
      IMPLICIT NONE
      TYPE(ONUMM4N1), INTENT(IN) :: LHS(:)
      TYPE(ONUMM4N1), INTENT(IN) :: RHS(SIZE(LHS))
      TYPE(ONUMM4N1) :: RES
   ...
   END FUNCTION ONUMM4N1_DOT_PRODUCT_ONUMM4N1

   FUNCTION R_DOT_PRODUCT_ONUMM4N1(LHS,RHS)&
      RESULT(RES)
      IMPLICIT NONE
      REAL(DP), INTENT(IN) :: LHS(:)
      TYPE(ONUMM4N1), INTENT(IN) :: RHS(SIZE(LHS))
   ...
   END FUNCTION R_DOT_PRODUCT_ONUMM4N1

   FUNCTION ONUMM4N1_DOT_PRODUCT_R(LHS,RHS)&
      RESULT(RES)
      IMPLICIT NONE
      TYPE(ONUMM4N1), INTENT(IN) :: LHS(:)
   ...
   END FUNCTION ONUMM4N1_DOT_PRODUCT_R
...
FUNCTION ONUMM4N1_TO_CR_MAT_M(VAL) RESULT(RES)
   ...
   END FUNCTION ONUMM4N1_TO_CR_MAT_M
      ...
      SUBROUTINE ONUMM4N1_SETIM_S(VAL,IDX,RES)
      IMPLICIT NONE
      TYPE(ONUMM4N1), INTENT(INOUT) :: VAL
      ...
      END SELECT
   END SUBROUTINE ONUMM4N1_SETIM_S

      SUBROUTINE ONUMM4N1_SETIM_V(VAL,IDX,RES)
      IMPLICIT NONE
      TYPE(ONUMM4N1), INTENT(INOUT) :: VAL(:)
      ...
      END SELECT
   END SUBROUTINE ONUMM4N1_SETIM_V

      SUBROUTINE ONUMM4N1_SETIM_M(VAL,IDX,RES)
      IMPLICIT NONE
      TYPE(ONUMM4N1), INTENT(INOUT) :: VAL(:,:)
      ...
      END SELECT
   END SUBROUTINE ONUMM4N1_SETIM_M

FUNCTION ONUMM4N1_GETIM_S(VAL,IDX) RESULT(RES)
      IMPLICIT NONE
      TYPE(ONUMM4N1), INTENT(IN) :: VAL
      REAL(DP) :: RES 
      INTEGER, INTENT(IN) :: IDX
      ...
      END SELECT
   END FUNCTION ONUMM4N1_GETIM_S

FUNCTION ONUMM4N1_GETIM_V(VAL,IDX) RESULT(RES)
      IMPLICIT NONE
      TYPE(ONUMM4N1), INTENT(IN) :: VAL(:)
      ...
      END SELECT
   END FUNCTION ONUMM4N1_GETIM_V

FUNCTION ONUMM4N1_GETIM_M(VAL,IDX) RESULT(RES)
      IMPLICIT NONE
      TYPE(ONUMM4N1), INTENT(IN) :: VAL(:,:)
      ...
      END SELECT
   END FUNCTION ONUMM4N1_GETIM_M

   SUBROUTINE ONUMM4N1_PPRINT_S(VAR,FMT,UNIT)
      IMPLICIT NONE
      TYPE(ONUMM4N1), INTENT(IN) :: VAR
   ...
   END SUBROUTINE ONUMM4N1_PPRINT_S

   SUBROUTINE ONUMM4N1_PPRINT_V(VAR,FMT,UNIT)
      IMPLICIT NONE
      TYPE(ONUMM4N1), INTENT(IN) :: VAR(:)
      CHARACTER(len=*), INTENT(IN), OPTIONAL :: fmt
      INTEGER, INTENT(IN), OPTIONAL :: unit
   ...
   END SUBROUTINE ONUMM4N1_PPRINT_V

   SUBROUTINE ONUMM4N1_PPRINT_M(VAR,FMT,UNIT)
      IMPLICIT NONE
      TYPE(ONUMM4N1), INTENT(IN) :: VAR(:,:)
      CHARACTER(len=*), INTENT(IN), OPTIONAL :: fmt
      INTEGER, INTENT(IN), OPTIONAL :: unit
   ...
   END SUBROUTINE ONUMM4N1_PPRINT_M
  ...
  !!
  !***************************************************************************************************!
  PURE FUNCTION ONUMM4N1_det2x2(A) RESULT(det)

    IMPLICIT NONE

    TYPE(ONUMM4N1), INTENT(IN) :: A(2,2)   !! Matrix
    TYPE(ONUMM4N1)             :: det
  ...
  !!
  !***************************************************************************************************!
  PURE FUNCTION ONUMM4N1_det3x3(A) RESULT(det)
      
    IMPLICIT NONE

    TYPE(ONUMM4N1), INTENT(IN) :: A(3,3)   !! Matrix
    TYPE(ONUMM4N1)             :: det
  ...
  !!
  !***************************************************************************************************!
  PURE FUNCTION ONUMM4N1_det4x4(A) RESULT(det)
      
    IMPLICIT NONE

    TYPE(ONUMM4N1), INTENT(IN) :: A(4,4)   !! Matrix
    TYPE(ONUMM4N1)             :: det
  ...
  !!
  !***************************************************************************************************!
  PURE FUNCTION ONUMM4N1_cross3(a,b) RESULT(v)
      
    IMPLICIT NONE 

    TYPE(ONUMM4N1), DIMENSION (3),INTENT(IN) :: a,b
    TYPE(ONUMM4N1), DIMENSION (3) :: v
    
    v(1) = a(2) * b(3) - a(3) * b(2)
    v(2) = a(3) * b(1) - a(1) * b(3)
    v(3) = a(1) * b(2) - a(2) * b(1)

  END FUNCTION ONUMM4N1_cross3
  !===================================================================================================! 
  ...
  !!
  !***************************************************************************************************!
  FUNCTION ONUMM4N1_norm2_3(v) RESULT(n)
     
    IMPLICIT NONE 

    TYPE(ONUMM4N1), INTENT(IN) :: v(3)
    TYPE(ONUMM4N1) :: n
     
    n = SQRT( v(1)*v(1) + v(2)*v(2) + v(3)*v(3) )

  END FUNCTION ONUMM4N1_norm2_3
  !===================================================================================================! 

  ELEMENTAL FUNCTION ONUMM4N1_DIVISION_OO(X,Y) RESULT(RES)
      IMPLICIT NONE
  ...
  ELEMENTAL FUNCTION ONUMM4N1_DIVISION_OR(X,Y) RESULT(RES)
      IMPLICIT NONE
      ! REAL(DP) :: DERIVS(TORDER + 1) 
      TYPE(ONUMM4N1), INTENT(IN) :: X
      REAL(DP), INTENT(IN) :: Y
  ...
  ELEMENTAL FUNCTION ONUMM4N1_DIVISION_RO(X,Y) RESULT(RES)
      IMPLICIT NONE
      ! REAL(DP) :: DERIVS(TORDER + 1) 
      REAL(DP), INTENT(IN) :: X
      TYPE(ONUMM4N1), INTENT(IN) :: Y
  ...
  END FUNCTION ONUMM4N1_SQRT
   ...
   FUNCTION ONUMM4N1_INV2X2(A,det)&
      RESULT(RES)
      IMPLICIT NONE
      TYPE(ONUMM4N1) , INTENT(IN) :: A(2,2) 
      TYPE(ONUMM4N1) , INTENT(IN), OPTIONAL :: det
      REAL(DP) :: detCalc
      TYPE(ONUMM4N1) :: RES(SIZE(A,1),SIZE(A,2)) 
   ...
   END FUNCTION ONUMM4N1_INV2X2

   FUNCTION ONUMM4N1_INV3X3(A,det)&
      RESULT(RES)
      IMPLICIT NONE
      TYPE(ONUMM4N1) , INTENT(IN) :: A(3,3) 
      TYPE(ONUMM4N1) , INTENT(IN), OPTIONAL :: det
      REAL(DP) :: detCalc
      TYPE(ONUMM4N1) :: RES(SIZE(A,1),SIZE(A,2)) 
   ...
   END FUNCTION ONUMM4N1_INV3X3

   FUNCTION ONUMM4N1_INV4X4(A,det)&
      RESULT(RES)
      IMPLICIT NONE
      TYPE(ONUMM4N1) , INTENT(IN) :: A(4,4) 
      TYPE(ONUMM4N1) , INTENT(IN), OPTIONAL :: det
      REAL(DP) :: detCalc
      TYPE(ONUMM4N1) :: RES(SIZE(A,1),SIZE(A,2)) 
