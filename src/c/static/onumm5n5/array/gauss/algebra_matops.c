...
feonumm5n5_t feoarrm5n5_dotproduct_FF(feoarrm5n5_t* lhs, feoarrm5n5_t* rhs){
    ...
    res = feonumm5n5_createEmpty( rhs->nip);

    feoarrm5n5_dotproduct_FF_to(lhs, rhs, &res);
...
void feoarrm5n5_dotproduct_FF_to(feoarrm5n5_t* lhs, feoarrm5n5_t* rhs, feonumm5n5_t* res){
    ...
    // Check Dimensions
    feoarrm5n5_dimCheck_FF_samesize(lhs, rhs, res);

    for (i = 0; i<res->nip; i++){

        oarrm5n5_dotproduct_OO_to( &lhs->p_data[i], &rhs->p_data[i], &res->p_data[i] );
...
feonumm5n5_t feoarrm5n5_dotproduct_OF(oarrm5n5_t* lhs, feoarrm5n5_t* rhs){
    ...
    feoarrm5n5_dotproduct_OF_to( lhs, rhs, &res);
...
void feoarrm5n5_dotproduct_OF_to( oarrm5n5_t* lhs, feoarrm5n5_t* rhs, feonumm5n5_t* res){
    ...
    // Check Dimensions
    feoarrm5n5_dimCheck_OF_samesize(lhs, rhs, res);

    for (i = 0; i < res->nip; i++){

        oarrm5n5_dotproduct_OO_to( lhs, &rhs->p_data[i], &res->p_data[i] );
...
feonumm5n5_t feoarrm5n5_dotproduct_RF( darr_t* lhs, feoarrm5n5_t* rhs){
    ...
    feoarrm5n5_dotproduct_RF_to( lhs, rhs, &res);
...
void feoarrm5n5_dotproduct_RF_to( darr_t* lhs, feoarrm5n5_t* rhs, feonumm5n5_t* res){
    ...
    // Check Dimensions
    feoarrm5n5_dimCheck_RF_samesize(lhs, rhs, res);

    for (i = 0; i < res->nip; i++){

        oarrm5n5_dotproduct_RO_to( lhs, &rhs->p_data[i], &res->p_data[i] );
...
feoarrm5n5_t feoarrm5n5_matmul_FF(feoarrm5n5_t* lhs, feoarrm5n5_t* rhs){
    ...
    // Check dimensions.
    res = feoarrm5n5_createEmpty( lhs->nrows, rhs->ncols, lhs->nip);

    feoarrm5n5_matmul_FF_to( lhs, rhs, &res);
...
void feoarrm5n5_matmul_FF_to(feoarrm5n5_t* lhs, feoarrm5n5_t* rhs, feoarrm5n5_t* res){
    ...
    // Check Dimensions
    feoarrm5n5_dimCheck_FF_matmul(lhs, rhs, res);

    for (i = 0; i<res->nip; i++){

        oarrm5n5_matmul_OO_to( &lhs->p_data[i], &rhs->p_data[i], &res->p_data[i] );
...
feoarrm5n5_t feoarrm5n5_matmul_OF(oarrm5n5_t* lhs, feoarrm5n5_t* rhs){
    ...
    // Check dimensions.
    res = feoarrm5n5_createEmpty( lhs->nrows, rhs->ncols, rhs->nip);

    feoarrm5n5_matmul_OF_to( lhs, rhs, &res);
...
void feoarrm5n5_matmul_OF_to(oarrm5n5_t* lhs, feoarrm5n5_t* rhs, feoarrm5n5_t* res){
    ...
    // Check Dimensions
    feoarrm5n5_dimCheck_OF_matmul(lhs, rhs, res);

    for (i = 0; i<res->nip; i++){

        oarrm5n5_matmul_OO_to( lhs, &rhs->p_data[i], &res->p_data[i] );
...
feoarrm5n5_t feoarrm5n5_matmul_FO(feoarrm5n5_t* lhs, oarrm5n5_t* rhs){
    ...
    feoarrm5n5_matmul_FO_to( lhs, rhs, &res);
...
void feoarrm5n5_matmul_FO_to(feoarrm5n5_t* lhs, oarrm5n5_t* rhs, feoarrm5n5_t* res){
    ...
    // Check Dimensions
    feoarrm5n5_dimCheck_FO_matmul(lhs, rhs, res);

    for (i = 0; i<res->nip; i++){

        oarrm5n5_matmul_OO_to( &lhs->p_data[i], rhs, &res->p_data[i] );
...
feoarrm5n5_t feoarrm5n5_matmul_RF(darr_t* lhs, feoarrm5n5_t* rhs){
    ...
    feoarrm5n5_matmul_RF_to( lhs, rhs, &res);
...
void feoarrm5n5_matmul_RF_to(darr_t* lhs, feoarrm5n5_t* rhs, feoarrm5n5_t* res){
    ...
    // Check Dimensions
    feoarrm5n5_dimCheck_RF_matmul(lhs, rhs, res);

    for (i = 0; i<res->nip; i++){

        oarrm5n5_matmul_RO_to( lhs, &rhs->p_data[i], &res->p_data[i] );
...
feoarrm5n5_t feoarrm5n5_matmul_FR(feoarrm5n5_t* lhs, darr_t* rhs){
    ...
    feoarrm5n5_matmul_FR_to( lhs, rhs, &res);
...
void feoarrm5n5_matmul_FR_to(feoarrm5n5_t* lhs, darr_t* rhs, feoarrm5n5_t* res){
    ...
    // Check Dimensions
    feoarrm5n5_dimCheck_FR_matmul(lhs, rhs, res);

    for (i = 0; i<res->nip; i++){

        oarrm5n5_matmul_OR_to( &lhs->p_data[i], rhs, &res->p_data[i] );
...
feonumm5n5_t feoarrm5n5_norm(feoarrm5n5_t* arr){
    ...
    res = feonumm5n5_createEmpty( arr->nip);

    feoarrm5n5_norm_to( arr, &res );
...
void feoarrm5n5_norm_to(feoarrm5n5_t* arr, feonumm5n5_t* res){
    ...
    for (i = 0; i<arr->nip; i++){
        ...
        oarrm5n5_pnorm_to( &arr->p_data[i], 2.0, &res->p_data[i]);
...
void feoarrm5n5_pnorm_to(feoarrm5n5_t* arr, coeff_t p, feonumm5n5_t* res){
    ...
    for (i = 0; i<arr->nip; i++){
        ...
        oarrm5n5_pnorm_to( &arr->p_data[i], p, &res->p_data[i]);
...
void feoarrm5n5_det_to(feoarrm5n5_t* arr, feonumm5n5_t* res){
    ...
    // Check dimensions (squareness)
    feoarrm5n5_dimCheck_F_squareness( arr, arr);
    feoarrm5n5_dimCheck_fF_elementwise(res,arr,arr);

    for (i = 0; i<arr->nip; i++){
        
        oarrm5n5_det_to( &arr->p_data[i], &res->p_data[i]);
...
void feoarrm5n5_invert_to(feoarrm5n5_t* arr, feoarrm5n5_t* res){
    ...
    feoarrm5n5_dimCheck_F_squareness( arr, res);
    
    for (i = 0; i<arr->nip; i++){

        oarrm5n5_invert_to( &arr->p_data[i], &res->p_data[i]);
...
feoarrm5n5_t feoarrm5n5_transpose(feoarrm5n5_t* arr){
    ...
    res = feoarrm5n5_createEmpty( arr->ncols, arr->nrows, arr->nip);
    
    feoarrm5n5_transpose_to( arr, &res );
...
void feoarrm5n5_transpose_to(feoarrm5n5_t* arr, feoarrm5n5_t* res){
    ...
    // Check dimensions.
    feoarrm5n5_dimCheck_F_transpose( arr, res);
    
    for (i = 0; i<arr->nip; i++){

        oarrm5n5_transpose_to( &arr->p_data[i], &res->p_data[i]);
