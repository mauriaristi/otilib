...
cpdef dot(object lhs, object rhs, object out = None):
  ...
  elif tlhs is csr_omatm2n2:

    # Slhs = lhs
    if   trhs is omatm2n2: # SO
      if res_flag:
        Ores = out
        csromatm2n2_matmul_SO_to( lhs, rhs, Ores)
      else:
        res = csromatm2n2_matmul_SO( lhs, rhs)
      # end if 
...
#*****************************************************************************************************
cdef solve_sparse(csr_omatm2n2 K_in, omatm2n2 b_in, omatm2n2 out = None):
  """
  PURPOSE:   Solve OTI linear system of equations for a dense K_in.
  """
  #***************************************************************************************************
...
cpdef set_order_im_from_array(ord_t ordi, np.ndarray arr, omatm2n2 tmp):
  ...
  #     tmp[i,j] += onumm2n2.create( &otmp, FLAGS = 0)
