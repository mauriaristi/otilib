...
# cdef object __add__FX__(mdmatfe1 Flhs, object rhs, object out = None):
#   """
#   PURPOSE:  Addition between mdmatfe1 and object.
...
cdef object __add__OX__(mdmat1 Olhs, object rhs, object out = None):
  """
  PURPOSE:  Addition between mdmat1 and an object.
  ...
  #   if res_flag:
  #     Fres = out
  #     femdnum1_sum_Of_to( &Orhs.arr, &flhs.num ,&Fres.arr)
  #   else:      
  #     cFres = femdnum1_sum_Of( &Orhs.arr, &flhs.num)
  #     res = mdmatfe1.create(&cFres)
  #   # end if
    ...
    if res_flag:
      ...
      cOres = mdarr1_sum_OO( &Orhs.arr, &Orhs.arr)
      res = mdmat1.create( &cOres )
    # end if
...
cdef object __add__RX__(dmat Rlhs, object rhs, object out = None):
  """
  PURPOSE:  Addition between mdnum1 and an object.
  ...
  #   if res_flag:
  #     ores = out
  #     mdnum1_sum_Ro_to( &Rlhs.arr, &orhs.num ,&ores.num)
  #   else:
  #     cores = mdnum1_sum_Ro( &Rlhs.arr, &orhs.num )
  ...
  #   if res_flag:
  #     fres = out
  #     femdnum1_sum_Rf_to( &Rlhs.arr, &frhs.num ,&fres.num)
  #   else:      
  #     cfres = femdnum1_sum_Rf( &Rlhs.arr, &frhs.num)
...
cdef object __add__fX__(mdnumfe1 flhs, object rhs, object out = None):
  """
  PURPOSE:  Addition between mdnumfe1 and an object.
  ...
  #   if res_flag:
  #     Rres = out
  #     femdnum1_sum_Rf_to( &Rrhs.arr, &flhs.num ,&Fres.arr)
  #   else:      
  #     cFres = femdnum1_sum_Rf( &Rrhs.arr, &flhs.num)
  #     res = mdmatfe1.create(&cFres)
  #   # end if
...
cdef object __add__oX__(mdnum1 olhs, object rhs, object out = None):
  ...
  #   if res_flag:
  #     Ores = out
  #     mdnum1_sum_oR_to( &olhs.num, &Rrhs.arr ,&Ores.arr)
  #   else:      
  #     cOres = mdnum1_sum_oR( &olhs.num, &Rrhs.arr)
  #     res = mdmat1.create(&cOres)
  #   # end if
