...
cdef class somat:
  ...
  #***************************************************************************************************
  @staticmethod
  cdef somat create(oarr_t* arr, uint8_t FLAGS = 1):
    """
    ...
    cdef somat mat = <somat> somat.__new__(somat)
...
#*****************************************************************************************************
cpdef somat eye(uint64_t size, bases_t nbases=0, ord_t order=0):
...
#*****************************************************************************************************
cpdef somat zeros( uint64_t nrows, uint64_t ncols, bases_t nbases=0, ord_t order=0):
...
#*****************************************************************************************************
cpdef somat ones(uint64_t nrows,uint64_t ncols, bases_t nbases=0, ord_t order=0):
