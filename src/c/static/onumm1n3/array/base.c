...
void oarrm1n3_taylor_integrate_to( coeff_t* deltas, oarrm1n3_t* arr, oarrm1n3_t* res){
    ...
    oarrm1n3_dimCheck_OO_elementwise(arr,res,res);

    for (i = 0; i<arr->size; i++ ){
        
        onumm1n3_taylor_integrate_to( deltas, &arr->p_data[i], &res->p_data[i]);
...
oarrm1n3_t oarrm1n3_taylor_integrate( coeff_t* deltas, oarrm1n3_t* arr){
    ...
    oarrm1n3_taylor_integrate_to( deltas, arr, &res);
...
void oarrm1n3_get_order_im_to( ord_t order, oarrm1n3_t* arr, oarrm1n3_t* res){
    ...
    for (i = 0; i<arr->size; i++ ){
        ...
        onumm1n3_get_order_im_to( order, &arr->p_data[i], &res->p_data[i]);
...
oarrm1n3_t oarrm1n3_get_order_im( ord_t order, oarrm1n3_t* arr){
    ...
    oarrm1n3_get_order_im_to( order, arr, &res);
...
void oarrm1n3_truncate_im_to( imdir_t idx, ord_t order, oarrm1n3_t* arr, oarrm1n3_t* res){
    ...
    for (i = 0; i<arr->size; i++ ){
        ...
        onumm1n3_truncate_im_to( idx, order, &arr->p_data[i], &res->p_data[i]);
...
oarrm1n3_t oarrm1n3_truncate_im( imdir_t idx, ord_t order, oarrm1n3_t* arr){
    ...
    oarrm1n3_truncate_im_to( idx, order, arr, &res);
...
void oarrm1n3_copy_to(oarrm1n3_t* arr, oarrm1n3_t* res){
    ...
    for (i=0; i<arr->size; i++){
        ...
        onumm1n3_copy_to(&arr->p_data[i],&res->p_data[i]);
...
// ****************************************************************************************************
inline void oarrm1n3_set_all_r( coeff_t num, oarrm1n3_t* arr){
    
    uint64_t i;

    for (i = 0; i<arr->size; i++ ){
        oarrm1n3_set_item_i_r( num, i, arr);
    }
...
// ****************************************************************************************************
inline void oarrm1n3_set_r( coeff_t num, oarrm1n3_t* arr){
...
// ****************************************************************************************************
inline void oarrm1n3_set_item_i_r( coeff_t num, uint64_t i, oarrm1n3_t* arr){
        
    if( i<arr->size ){
        
        onumm1n3_set_r( num, &arr->p_data[i]);

    } else {

        // res = onumm1n3_init();
        
        printf("ERROR: Index out of bounds in oarrm1n3_get_item_i(...)\n Exiting...\n");
        exit(OTI_BadIndx);
...
// ****************************************************************************************************
inline void oarrm1n3_set_item_ij_r( coeff_t num, uint64_t i, uint64_t j, oarrm1n3_t* arr){

    oarrm1n3_set_item_i_r( num, j + i*arr->ncols, arr);

}
// ----------------------------------------------------------------------------------------------------

// ****************************************************************************************************
inline void oarrm1n3_set_all_o( onumm1n3_t* num, oarrm1n3_t* arr){

    uint64_t i;

    for (i = 0; i<arr->size; i++ ){
        oarrm1n3_set_item_i_o( num, i, arr);
    }
...
// ****************************************************************************************************
inline void oarrm1n3_set_o( onumm1n3_t* num, oarrm1n3_t* arr){
...
// ****************************************************************************************************
inline void oarrm1n3_set_item_i_o( onumm1n3_t* src, uint64_t i, oarrm1n3_t* arr){
    
    if (i < arr->size){

        onumm1n3_copy_to(src, &arr->p_data[i]);
...
// ****************************************************************************************************
inline void oarrm1n3_set_item_ij_o( onumm1n3_t* num, uint64_t i, uint64_t j, oarrm1n3_t* arr){

    if ( i < arr->nrows && j < arr->ncols ){

        oarrm1n3_set_item_i_o( num, j + i*arr->ncols, arr);

    } else {

        printf("ERROR: Index out of bounds in oarrm1n3_get_item_ij(...)\n Exiting...\n");
        exit(OTI_BadIndx);
...
// ****************************************************************************************************
void oarrm1n3_set_slice_O( oarrm1n3_t* arr, 
    ...
    for ( i = 0; i < nrows; i++){
        ...
        for ( j = 0; j < ncols; j++){
            ...
            onumm1n3_copy_to( &arr->p_data[  j +  i * arr->ncols ], 
...
// ****************************************************************************************************
void oarrm1n3_set_slice_o( onumm1n3_t* num, 
                        int64_t starti, int64_t stopi, int64_t stepi,
                        int64_t startj, int64_t stopj, int64_t stepj,
                         oarrm1n3_t* res){
...
darr_t oarrm1n3_get_im(imdir_t idx, ord_t order, oarrm1n3_t* arr){
    ...
    for( i = 0; i < arr->size ; i++ ){
        ...
        darr_set_item_i(  
            onumm1n3_get_item( idx, order, &arr->p_data[i]), 
            i, &res);
...
oarrm1n3_t oarrm1n3_extract_im(imdir_t idx, ord_t order, oarrm1n3_t* arr){
    ...
    oarrm1n3_t res = oarrm1n3_zeros( arr->nrows, arr->ncols);
    
    oarrm1n3_extract_im_to( idx, order, arr, &res);
...
void oarrm1n3_extract_im_to(imdir_t idx, ord_t order, oarrm1n3_t* arr, oarrm1n3_t* res){
    ...
    for( i = 0; i < arr->size ; i++ ){
        ...
        onumm1n3_extract_im_to( idx, order, &arr->p_data[i], &res->p_data[i]);
...
darr_t oarrm1n3_get_deriv(imdir_t idx, ord_t order, oarrm1n3_t* arr){
    ...
    for( i = 0; i < arr->size ; i++ ){
        ...
        darr_set_item_i(  
            onumm1n3_get_deriv( idx, order, &arr->p_data[i]), 
            i, &res);
...
oarrm1n3_t oarrm1n3_get_im_o(imdir_t idx, ord_t order, oarrm1n3_t* arr){
    ...
    oarrm1n3_get_im_to( idx, order, arr, &res);
...
void oarrm1n3_get_im_to(imdir_t idx, ord_t order, oarrm1n3_t* arr, oarrm1n3_t* res){
    ...
    for( i = 0; i < arr->size ; i++ ){
        ...
        onumm1n3_get_im_to_o( idx, order, &arr->p_data[i], &res->p_data[i]);
...
oarrm1n3_t oarrm1n3_get_deriv_o(imdir_t idx, ord_t order, oarrm1n3_t* arr){
    ...
    oarrm1n3_get_deriv_to( idx, order, arr, &res);
...
void oarrm1n3_get_deriv_to(imdir_t idx, ord_t order, oarrm1n3_t* arr, oarrm1n3_t* res){
    ...
    for( i = 0; i < arr->size ; i++ ){
        ...
        onumm1n3_get_deriv_to( idx, order, &arr->p_data[i], &res->p_data[i]);
...
oarrm1n3_t oarrm1n3_extract_deriv(imdir_t idx, ord_t order, oarrm1n3_t* arr){
    ...
    oarrm1n3_extract_deriv_to( idx, order, arr, &res);
...
void oarrm1n3_extract_deriv_to(imdir_t idx, ord_t order, oarrm1n3_t* arr, oarrm1n3_t* res){
    ...
    for( i = 0; i < arr->size ; i++ ){
        ...
        onumm1n3_extract_deriv_to( idx, order, &arr->p_data[i], &res->p_data[i]);
...
// Getters.
// ****************************************************************************************************
inline onumm1n3_t oarrm1n3_get_item_i(oarrm1n3_t* arr, uint64_t i){
...
onumm1n3_t oarrm1n3_get_item_ij(oarrm1n3_t* arr, uint64_t i, uint64_t j){
    ...
    onumm1n3_t res = oarrm1n3_get_item_i(arr, j + i*arr->ncols );
...
void oarrm1n3_get_item_i_to(oarrm1n3_t* arr, uint64_t i, onumm1n3_t* res){
    ...
    if (i < arr->size){
        ...
        onumm1n3_copy_to( &arr->p_data[i], res);
        
    } else {
        // Raise error?
        printf("ERROR: Index out of bounds in oarrm1n3_get_item_i_to(...)\n");
        exit(OTI_BadIndx);
    }
...
void oarrm1n3_get_item_ij_to(oarrm1n3_t* arr, uint64_t i, uint64_t j, onumm1n3_t* res){
    ...
    oarrm1n3_get_item_i_to(arr, j + i*arr->ncols, res);
...
oarrm1n3_t oarrm1n3_get_slice( oarrm1n3_t* arr, 
    ...
    res = oarrm1n3_zeros( nrows, ncols);

    oarrm1n3_get_slice_to( arr, starti, stopi, stepi, startj, stopj, stepj, &res);
...
void oarrm1n3_get_slice_to( oarrm1n3_t* arr, 
    ...
    for ( i = 0; i < nrows; i++){
        ...
        for ( j = 0; j < ncols; j++){
            ...
            onumm1n3_copy_to( &arr->p_data[ jj + ii * arr->ncols ], 
...
oarrm1n3_t oarrm1n3_eye(uint64_t nrows){
    ...
    res = oarrm1n3_zeros( nrows, nrows);
...
oarrm1n3_t oarrm1n3_ones(uint64_t nrows, uint64_t ncols){
    ...
    res = oarrm1n3_createEmpty(nrows, ncols);

    for (i=0; i<res.size; i++ ){
        onumm1n3_set_r(1.0,&res.p_data[i]);
    }
...
oarrm1n3_t oarrm1n3_zeros(uint64_t nrows, uint64_t ncols){
    ...
    for (i=0; i<res.size; i++ ){
        onumm1n3_set_r(0.0,&res.p_data[i]);
    }
...
// ****************************************************************************************************
inline oarrm1n3_t oarrm1n3_empty_like(oarrm1n3_t* arr){

    oarrm1n3_t  res;
    
    res = oarrm1n3_createEmpty(arr->nrows, arr->ncols);    
...
// ****************************************************************************************************
inline oarrm1n3_t oarrm1n3_createEmpty(uint64_t nrows, uint64_t ncols){

    oarrm1n3_t  res ;
    uint64_t size = nrows * ncols;

    res.p_data = (onumm1n3_t*) malloc( size * sizeof( onumm1n3_t ) );

    if ( res.p_data == NULL ){
        printf("ERROR: Not enough memory to handle oarrm1n3.\n Exiting...\n");
...
// Initialization
// ****************************************************************************************************
inline oarrm1n3_t oarrm1n3_init(void){
