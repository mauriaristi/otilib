...
cdef class mdnum2:
  ...
  def __init__(self, coeff_t re_coeff):
    ...
    self.num = mdnum2_create_r(re_coeff)
  ...
  def  order(self): 
    ...
    return mdnum2_get_order(&self.num)
  ...
  #***************************************************************************************************
  @staticmethod
  cdef mdnum2 create( mdnum2_t* num, uint8_t FLAGS = 1 ):
    """
    ...
    cdef mdnum2 otin = <mdnum2> mdnum2.__new__(mdnum2)

    otin.num     = mdnum2_copy(num)
  ...
  def __repr__(self):
    """
    PURPOSE:  To print a representation of the mdnum2 object in a compact form.
    """
    #*************************************************************************************************
    ...
    for ordi in range(1,self.order+1):
      ...
      for i in range( mdnum2_get_ndir_order(ordi,&self.num) ):
        
        idx = mdnum2_get_indx(i, ordi) 
        num = '%+.4f'%( mdnum2_get_item(idx,ordi,&self.num) )
  ...
  def short_repr(self):
    ...
    head = 'mdnum2('
    body = str(self.num.r) + ", nnz: " + str(mdnum2_get_ndir_total(&self.num)) + ', order: ' + str(self.order)
    tail = ')'
  ...
  def __str__(self):
    """
    PURPOSE: To print a representation of the mdnum2 object that could 
  ...
  def __getitem__(self, list index):
    """
    PURPOSE:  To get the value of a mdnum2 coefficient.
  ...
  def __setitem__(self, list item, coeff_t value):
    """
    PURPOSE:  To set the value of a mdnum2 coefficient.
  ...
  def __add__(self, other_in):
    """
    PURPOSE:      Add mdnum2 with other things.
  ...
  def __truediv__(self, other_in):
    """
    PURPOSE:      To define how to divide two mdnum2 numbers.
  ...
  def get_active_bases(self):
    ...
    mdnum2_get_active_bases( &self.num, bases_list)
