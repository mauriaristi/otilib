...
onumm6n1_t onumm6n1_div_ro(coeff_t num, onumm6n1_t* den){
    ...
    onumm6n1_t inv = onumm6n1_pow(den,-1);
    onumm6n1_t res = onumm6n1_mul_ro(num,&inv);
...
onumm6n1_t onumm6n1_div_oo(onumm6n1_t* num, onumm6n1_t* den){
    ...
    onumm6n1_t res = onumm6n1_mul_oo(num,&inv);
...
onumm6n1_t onumm6n1_div_or(onumm6n1_t* num, coeff_t val){
    ...
    return onumm6n1_mul_ro(1.0/val,num);
...
void onumm6n1_trunc_sum_oo_to(ord_t order, onumm6n1_t* lhs,onumm6n1_t* rhs, onumm6n1_t* res){
  // Addition like function 'lhs + rhs'
  switch(order){
    case(0):
      //  Real
...
void onumm6n1_trunc_sub_oo_to(ord_t order, onumm6n1_t* lhs,onumm6n1_t* rhs, onumm6n1_t* res){
  // Addition like function 'lhs - rhs'
  switch(order){
    case(0):
      //  Real
...
onumm6n1_t onumm6n1_feval(coeff_t* feval_re, onumm6n1_t* x){
  ...
  onumm6n1_t deltax = (*x), deltax_power = (*x);
  deltax.r = 0.0;
  deltax_power.r = 0.0;
  onumm6n1_set_r(0.0, &res);
  //  Real
  res.r = feval_re[0];
  // Order 1
  factor *=1;
  coef    = feval_re[1]/ factor;;
  onumm6n1_gem_ro_to( coef, &deltax_power, &res, &res);
