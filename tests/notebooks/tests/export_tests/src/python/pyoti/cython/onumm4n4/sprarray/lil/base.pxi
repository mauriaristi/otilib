...
cdef class lil_oarrm4n4_t:
  ...
  def __init__(self, shape): 
    """
    PURPOSE:      Python level constructor of the lil_oarrm4n4_t class.

    DESCRIPTION:  Creates a new empty lil_oarrm4n4_t matrix.
  ...
  def copy(self):
    ...
    cdef lil_oarrm4n4_t res = lil_oarrm4n4_t(self.shape)
    cdef uint64_t i, k
  ...
  def tocsr(self):
    ...
    """
    return csr_oarrm4n4_t(self,shape=self.shape)
