...
cpdef dot(object lhs, object rhs, object out = None):
  ...
  elif tlhs is csr_mdmat2:

    # Slhs = lhs
    if   trhs is mdmat2: # SO
      if res_flag:
        Ores = out
        csrmdmat2_matmul_SO_to( lhs, rhs, Ores)
      else:
        res = csrmdmat2_matmul_SO( lhs, rhs)
      # end if 
...
#*****************************************************************************************************
cdef solve_sparse(csr_mdmat2 K_in, mdmat2 b_in, mdmat2 out = None):
  """
  PURPOSE:   Solve OTI linear system of equations for a dense K_in.
  """
  #***************************************************************************************************
...
cpdef set_order_im_from_array(ord_t ordi, np.ndarray arr, mdmat2 tmp):
  ...
  #     tmp[i,j] += mdnum2.create( &otmp, FLAGS = 0)
