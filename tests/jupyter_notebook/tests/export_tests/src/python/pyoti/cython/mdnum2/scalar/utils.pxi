...
#     res = mdnum2_createReal(0.0, order)

#     # Set the coefficient to 1.
#     mdnum2_set_item(1.0, indx_hd, order_hd, &res)

#   else:

#     res = mdnum2_createReal(0.0, order_hd)
...
#   """
#   PURPOSE:  Return the derivative selected from a numpy array of mdnum2_ts.
