...
cdef object __add__OX__(omatm3n2 Olhs, object rhs, object out = None):
  """
  PORPUSE: Addition between omatm3n2 and object.
  ...
  if trhs == onumm3n2:
    ...
    if res_flag:
      ...
      cOres = oarrm3n2_sum_OO( &Olhs.arr, &Orhs.arr )
      res = omatm3n2.create( &cOres )
    # end if
  elif trhs == dmat:
    Rrhs = rhs
...
cdef object __add__oX__(onumm3n2 olhs, object rhs, object out = None):
  """
  PORPUSE: Addition between onumm3n2 and object.
...
cdef object __add__fX__(feonumm3n2 flhs, object rhs, object out = None):
  """
  PORPUSE: Addition between feonumm3n2 and object.
