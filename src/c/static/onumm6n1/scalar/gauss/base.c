...
ord_t feonumm6n1_get_order( feonumm6n1_t* num ){
    ...
    for( i = 0; i<num->nip; i++ ){
        ...
        order = MAX(order, onumm6n1_get_order(&num->p_data[i]) );
...
void feonumm6n1_get_order_im_to( ord_t order, feonumm6n1_t* num, feonumm6n1_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm6n1_get_order_im_to( order, &num->p_data[k], &res->p_data[k]);
...
feonumm6n1_t feonumm6n1_get_order_im( ord_t order, feonumm6n1_t* num){
    ...
    res = feonumm6n1_zeros( num->nip);

    feonumm6n1_get_order_im_to( order, num, &res);
...
void feonumm6n1_extract_im_to( imdir_t idx, ord_t order, feonumm6n1_t* num, feonumm6n1_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm6n1_extract_im_to( idx, order, &num->p_data[k], &res->p_data[k]);
...
feonumm6n1_t feonumm6n1_extract_im( imdir_t idx, ord_t order, feonumm6n1_t* num){
    ...
    feonumm6n1_extract_im_to( idx, order, num, &res);
...
void feonumm6n1_extract_deriv_to( imdir_t idx, ord_t order, feonumm6n1_t* num, feonumm6n1_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm6n1_extract_deriv_to( idx, order, &num->p_data[k], &res->p_data[k]);
...
feonumm6n1_t feonumm6n1_extract_deriv( imdir_t idx, ord_t order, feonumm6n1_t* num){
    ...
    feonumm6n1_extract_deriv_to( idx, order, num, &res);
...
void feonumm6n1_get_deriv_to( imdir_t idx, ord_t order, feonumm6n1_t* num, feonumm6n1_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm6n1_get_deriv_to( idx, order, &num->p_data[k], &res->p_data[k]);
...
feonumm6n1_t feonumm6n1_get_deriv( imdir_t idx, ord_t order, feonumm6n1_t* num){
    ...
    feonumm6n1_get_deriv_to( idx, order, num, &res);
...
void feonumm6n1_get_im_to( imdir_t idx, ord_t order, feonumm6n1_t* num, feonumm6n1_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm6n1_get_im_to_o( idx, order, &num->p_data[k], &res->p_data[k]);
...
feonumm6n1_t feonumm6n1_get_im( imdir_t idx, ord_t order, feonumm6n1_t* num){
    ...
    feonumm6n1_get_im_to( idx, order, num, &res);
...
void feonumm6n1_truncate_im_to( imdir_t idx, ord_t order, feonumm6n1_t* num,  feonumm6n1_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm6n1_truncate_im_to( idx, order, &num->p_data[k], &res->p_data[k]);
...
feonumm6n1_t feonumm6n1_truncate_im( imdir_t idx, ord_t order, feonumm6n1_t* num){
    ...
    feonumm6n1_truncate_im_to( idx, order, num, &res);
...
void feonumm6n1_set_im_r( coeff_t val, imdir_t idx, ord_t order, feonumm6n1_t* num){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm6n1_set_im_r( val, idx, order, &num->p_data[k]);
...
void feonumm6n1_set_im_o( onumm6n1_t* val, imdir_t idx, ord_t order, feonumm6n1_t* num){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm6n1_set_im_o( val, idx, order, &num->p_data[k]);
...
void feonumm6n1_set_im_f( feonumm6n1_t* val, imdir_t idx, ord_t order, feonumm6n1_t* num){
    ...
    feonumm6n1_dimCheck(val,num);

    for (k = 0; k<num->nip; k++ ){
        
        onumm6n1_set_im_o( &val->p_data[k], idx, order, &num->p_data[k]);
...
void feonumm6n1_set_deriv_r( coeff_t val, imdir_t idx, ord_t order, feonumm6n1_t* num){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm6n1_set_deriv_r( val, idx, order, &num->p_data[k]);
...
void feonumm6n1_set_deriv_o( onumm6n1_t* val, imdir_t idx, ord_t order, feonumm6n1_t* num){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm6n1_set_deriv_o( val, idx, order, &num->p_data[k]);
...
void feonumm6n1_set_deriv_f( feonumm6n1_t* val, imdir_t idx, ord_t order, feonumm6n1_t* num){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm6n1_set_deriv_o( &val->p_data[k], idx, order, &num->p_data[k]);
...
// ****************************************************************************************************
void feonumm6n1_set_to( feonumm6n1_t* src, feonumm6n1_t* dst){
    
    uint64_t i;

    feonumm6n1_dimCheck(src,dst);

    for (i = 0; i<src->nip; i++ ){
        
        onumm6n1_copy_to( &src->p_data[i], &dst->p_data[i]);
...
feonumm6n1_t feonumm6n1_copy( feonumm6n1_t* src){
    ...
    res = feonumm6n1_createEmpty(src->nip);

    feonumm6n1_copy_to( src, &res);
...
void feonumm6n1_set_o( onumm6n1_t* num, feonumm6n1_t* res){
    ...
    for (i = 0; i<res->nip; i++ ){
        ...
        onumm6n1_set_o( num, &res->p_data[i]);
...
void feonumm6n1_set_r( coeff_t num, feonumm6n1_t* res){
    ...
    for (i = 0; i<res->nip; i++ ){
        ...
        onumm6n1_set_r( num, &res->p_data[i]);
...
void feonumm6n1_set_item_k_o( onumm6n1_t* num, uint64_t k, feonumm6n1_t* res){
    ...
    if (k < res->nip){
        ...
        onumm6n1_set_o(num, &res->p_data[k]); 

    } else {

        printf("ERROR: Index out of bounds in feonumm6n1_get_item_k.\n");
...
void feonumm6n1_set_item_k_r(   coeff_t  num, uint64_t k, feonumm6n1_t* res){
    ...
    if (k < res->nip){
        ...
        onumm6n1_set_r(num, &res->p_data[k]); 
...
void feonumm6n1_get_item_k_to(feonumm6n1_t* num, uint64_t k, onumm6n1_t* res){
    ...
    if (k < num->nip){
        ...
        onumm6n1_copy_to( &num->p_data[k], res);
...
// ****************************************************************************************************
feonumm6n1_t feonumm6n1_zeros(uint64_t nip){

    feonumm6n1_t  res  = feonumm6n1_createEmpty(nip);
    
    feonumm6n1_set_r( 0.0, &res);
...
// ****************************************************************************************************
inline feonumm6n1_t feonumm6n1_createEmpty(uint64_t nip){

    feonumm6n1_t  res ;  
    void * memory = NULL;

    // Allocate memory and check if correctly allocated.
    memory = malloc( nip * sizeof( onumm6n1_t ) );

    if ( memory == NULL ){
        printf("ERROR: Not enough memory to handle array of feonumm6n1.\n Exiting...\n");
        exit(OTI_OutOfMemory); // TODO: Raise error instead of quitting the program.
    }
    
    res.p_data = ( onumm6n1_t* ) memory;
    res.nip = nip;
...
// ****************************************************************************************************
inline feonumm6n1_t feonumm6n1_init(void){
...
// ****************************************************************************************************
inline feonumm6n1_t feonumm6n1_empty_like(feonumm6n1_t* arr){

    feonumm6n1_t res = feonumm6n1_createEmpty(arr->nip);
