...
cdef class lil_omatm3n3:
  ...
  def __init__(self, shape): 
    """
    PURPOSE:      Python level constructor of the lil_omatm3n3 class.

    DESCRIPTION:  Creates a new empty lil_omatm3n3 matrix.
  ...
  def copy(self):
    ...
    cdef lil_omatm3n3 res = lil_omatm3n3(self.shape)
    cdef uint64_t i, k
  ...
  def tocsr(self):
    ...
    """
    return csr_omatm3n3(self,shape=self.shape)
