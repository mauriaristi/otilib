...
cdef class oarrm3n2_t:
  ...
  def __init__(self, realArray, ord_t order = 0, bases_t nbases = 0, object nnz = None): 
    """
    PURPOSE:      Python level constructor of the oarrm3n2_t class.
  ...
  #***************************************************************************************************
  @staticmethod
  cdef oarrm3n2_t create(oarrm3n2_t* arr, uint8_t FLAGS = 1):
    """
    ...
    cdef oarrm3n2_t mat = <oarrm3n2_t> oarrm3n2_t.__new__(oarrm3n2_t)
  ...
  def __repr__(self):
    ...
    #     out+= (onumm3n2_t.create(&d_onumm3n2,FLAGS=0)).__str__()+", "
    #   # end for 
    #   out = out[:-2] + "],\n"
    # # end for 
    # out =out[:-2] + "]"
  ...
  cpdef get_im(self, object hum_dir):
    """
    PURPOSE: Get the corresponding imaginary direction in the oarrm3n2_t object.
    """
    #*************************************************************************************************
  ...
  cpdef set(self, object rhs):
    ...
    if   trhs is onumm3n2_t:
      ...
      raise ValueError( "Cant assign '{0}' into a oarrm3n2_t object.".format(trhs) )
  ...
  #***************************************************************************************************
  @staticmethod
  def dot( oarrm3n2_t lhs, oarrm3n2_t rhs, oarrm3n2_t out = None): 
    """
  ...
  #***************************************************************************************************
  @staticmethod
  def inv( oarrm3n2_t arr,  oarrm3n2_t out = None): 
    """
  ...
  #***************************************************************************************************
  @staticmethod
  def transpose( oarrm3n2_t arr,  oarrm3n2_t out = None ): 
    """
  ...
  #***************************************************************************************************
  @staticmethod
  def add( oarrm3n2_t lhs, oarrm3n2_t rhs, oarrm3n2_t out = None): 
    """
