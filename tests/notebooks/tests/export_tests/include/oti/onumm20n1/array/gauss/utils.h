#ifndef OTI_ONUMM20N1_ARRAY_GAUSS_UTILS_H
#define OTI_ONUMM20N1_ARRAY_GAUSS_UTILS_H
...
@param[in] res Result
******************************************************************************************************/ 
void feoarrm20n1_dimCheck_FF_samesize(feoarrm20n1_t* arr1, feoarrm20n1_t* arr2, feonumm20n1_t* res);
void feoarrm20n1_dimCheck_OF_samesize(  oarrm20n1_t* arr1, feoarrm20n1_t* arr2, feonumm20n1_t* res);
void feoarrm20n1_dimCheck_RF_samesize(   darr_t* arr1, feoarrm20n1_t* arr2, feonumm20n1_t* res);
// ----------------------------------------------------------------------------------------------------
...
void feoarrm20n1_dimCheck_fF_elementwise( feonumm20n1_t* num1, feoarrm20n1_t* arr2, feoarrm20n1_t* res);
void feoarrm20n1_dimCheck_Ff_elementwise(feoarrm20n1_t* arr1,  feonumm20n1_t* num2, feoarrm20n1_t* res);
// ----------------------------------------------------------------------------------------------------
...
@param[in] res Result
******************************************************************************************************/ 
void feoarrm20n1_dimCheck_FfO_integrate(feoarrm20n1_t* arr, feonumm20n1_t* num,oarrm20n1_t* res);
// ----------------------------------------------------------------------------------------------------
