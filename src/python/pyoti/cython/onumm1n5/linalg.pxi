...
cpdef dot(object lhs, object rhs, object out = None):
  ...
  elif tlhs is csr_omatm1n5:

    # Slhs = lhs
    if   trhs is omatm1n5: # SO
      if res_flag:
        Ores = out
        csromatm1n5_matmul_SO_to( lhs, rhs, Ores)
      else:
        res = csromatm1n5_matmul_SO( lhs, rhs)
      # end if 
...
#*****************************************************************************************************
cdef solve_sparse(csr_omatm1n5 K_in, omatm1n5 b_in, omatm1n5 out = None):
  """
  PURPOSE:   Solve OTI linear system of equations for a dense K_in.
  """
  #***************************************************************************************************
...
cpdef set_order_im_from_array(ord_t ordi, np.ndarray arr, omatm1n5 tmp):
  ...
  #     tmp[i,j] += onumm1n5.create( &otmp, FLAGS = 0)
