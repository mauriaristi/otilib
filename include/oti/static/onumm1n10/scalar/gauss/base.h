#ifndef OTI_ONUMM1N10_SCALAR_GAUSS_BASE_H
#define OTI_ONUMM1N10_SCALAR_GAUSS_BASE_H
...
@param[in] num FEonumm1n10 to free
******************************************************************************************************/
...
@param[in] num FEonumm1n10
******************************************************************************************************/
ord_t feonumm1n10_get_order( feonumm1n10_t* num );
// ----------------------------------------------------------------------------------------------------

/**************************************************************************************************//**
@brief Initialize a feonumm1n10 structure.

******************************************************************************************************/
feonumm1n10_t feonumm1n10_init(void);
// ----------------------------------------------------------------------------------------------------
