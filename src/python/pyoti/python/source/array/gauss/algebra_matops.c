...
// ****************************************************************************************************
fesoti_t fearrso_dotproduct_FF(fearrso_t* lhs, fearrso_t* rhs){{
...
// ****************************************************************************************************
void fearrso_dotproduct_FF_to(fearrso_t* lhs, fearrso_t* rhs, fesoti_t* res){{
...
// ****************************************************************************************************
fesoti_t fearrso_dotproduct_OF(arrso_t* lhs, fearrso_t* rhs){{
...
// ****************************************************************************************************
void fearrso_dotproduct_OF_to( arrso_t* lhs, fearrso_t* rhs, fesoti_t* res){{
...
// ****************************************************************************************************
fesoti_t fearrso_dotproduct_RF( darr_t* lhs, fearrso_t* rhs){{
...
// ****************************************************************************************************
void fearrso_dotproduct_RF_to( darr_t* lhs, fearrso_t* rhs, fesoti_t* res){{
...
// ****************************************************************************************************
fearrso_t fearrso_matmul_FF(fearrso_t* lhs, fearrso_t* rhs){{
...
// ****************************************************************************************************
void fearrso_matmul_FF_to(fearrso_t* lhs, fearrso_t* rhs, fearrso_t* res){{
...
// ****************************************************************************************************
fearrso_t fearrso_matmul_OF(arrso_t* lhs, fearrso_t* rhs){{
...
// ****************************************************************************************************
void fearrso_matmul_OF_to(arrso_t* lhs, fearrso_t* rhs, fearrso_t* res){{
...
// ****************************************************************************************************
fearrso_t fearrso_matmul_FO(fearrso_t* lhs, arrso_t* rhs){{
...
// ****************************************************************************************************
void fearrso_matmul_FO_to(fearrso_t* lhs, arrso_t* rhs, fearrso_t* res){{
...
// ****************************************************************************************************
fearrso_t fearrso_matmul_RF(darr_t* lhs, fearrso_t* rhs){{
...
// ****************************************************************************************************
void fearrso_matmul_RF_to(darr_t* lhs, fearrso_t* rhs, fearrso_t* res){{
...
// ****************************************************************************************************
fearrso_t fearrso_matmul_FR(fearrso_t* lhs, darr_t* rhs){{
...
// ****************************************************************************************************
void fearrso_matmul_FR_to(fearrso_t* lhs, darr_t* rhs, fearrso_t* res){{
...
// ****************************************************************************************************
fesoti_t fearrso_norm(fearrso_t* arr){{
...
// ****************************************************************************************************
void fearrso_norm_to(fearrso_t* arr, fesoti_t* res){{
...
// ****************************************************************************************************
fesoti_t fearrso_pnorm(fearrso_t* arr, coeff_t p){{
...
// ****************************************************************************************************
void fearrso_pnorm_to(fearrso_t* arr, coeff_t p, fesoti_t* res){{
...
// ****************************************************************************************************
fesoti_t fearrso_det(fearrso_t* arr){{
...
// ****************************************************************************************************
void fearrso_det_to(fearrso_t* arr, fesoti_t* res){{
...
// ****************************************************************************************************
fearrso_t fearrso_invert(fearrso_t* arr){{
...
// ****************************************************************************************************
void fearrso_invert_to(fearrso_t* arr, fearrso_t* res){{
...
// ****************************************************************************************************
fearrso_t fearrso_transpose(fearrso_t* arr){{
...
// ****************************************************************************************************
void fearrso_transpose_to(fearrso_t* arr, fearrso_t* res){{
