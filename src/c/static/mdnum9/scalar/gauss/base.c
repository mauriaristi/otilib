...
ord_t femdnum9_get_order( femdnum9_t* num ){
    ...
    for( i = 0; i<num->nip; i++ ){
        ...
        order = MAX(order, mdnum9_get_order(&num->p_data[i]) );
...
void femdnum9_get_order_im_to( ord_t order, femdnum9_t* num, femdnum9_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        mdnum9_get_order_im_to( order, &num->p_data[k], &res->p_data[k]);
...
femdnum9_t femdnum9_get_order_im( ord_t order, femdnum9_t* num){
    ...
    res = femdnum9_zeros( num->nip);

    femdnum9_get_order_im_to( order, num, &res);
...
void femdnum9_extract_im_to( imdir_t idx, ord_t order, femdnum9_t* num, femdnum9_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        mdnum9_extract_im_to( idx, order, &num->p_data[k], &res->p_data[k]);
...
femdnum9_t femdnum9_extract_im( imdir_t idx, ord_t order, femdnum9_t* num){
    ...
    femdnum9_extract_im_to( idx, order, num, &res);
...
void femdnum9_extract_deriv_to( imdir_t idx, ord_t order, femdnum9_t* num, femdnum9_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        mdnum9_extract_deriv_to( idx, order, &num->p_data[k], &res->p_data[k]);
...
femdnum9_t femdnum9_extract_deriv( imdir_t idx, ord_t order, femdnum9_t* num){
    ...
    femdnum9_extract_deriv_to( idx, order, num, &res);
...
void femdnum9_get_deriv_to( imdir_t idx, ord_t order, femdnum9_t* num, femdnum9_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        mdnum9_get_deriv_to( idx, order, &num->p_data[k], &res->p_data[k]);
...
femdnum9_t femdnum9_get_deriv( imdir_t idx, ord_t order, femdnum9_t* num){
    ...
    femdnum9_get_deriv_to( idx, order, num, &res);
...
void femdnum9_get_im_to( imdir_t idx, ord_t order, femdnum9_t* num, femdnum9_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        mdnum9_get_im_to_o( idx, order, &num->p_data[k], &res->p_data[k]);
...
femdnum9_t femdnum9_get_im( imdir_t idx, ord_t order, femdnum9_t* num){
    ...
    femdnum9_get_im_to( idx, order, num, &res);
...
void femdnum9_truncate_im_to( imdir_t idx, ord_t order, femdnum9_t* num,  femdnum9_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        mdnum9_truncate_im_to( idx, order, &num->p_data[k], &res->p_data[k]);
...
femdnum9_t femdnum9_truncate_im( imdir_t idx, ord_t order, femdnum9_t* num){
    ...
    femdnum9_truncate_im_to( idx, order, num, &res);
...
void femdnum9_set_im_r( coeff_t val, imdir_t idx, ord_t order, femdnum9_t* num){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        mdnum9_set_im_r( val, idx, order, &num->p_data[k]);
...
void femdnum9_set_im_o( mdnum9_t* val, imdir_t idx, ord_t order, femdnum9_t* num){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        mdnum9_set_im_o( val, idx, order, &num->p_data[k]);
...
void femdnum9_set_im_f( femdnum9_t* val, imdir_t idx, ord_t order, femdnum9_t* num){
    ...
    femdnum9_dimCheck(val,num);

    for (k = 0; k<num->nip; k++ ){
        
        mdnum9_set_im_o( &val->p_data[k], idx, order, &num->p_data[k]);
...
void femdnum9_set_deriv_r( coeff_t val, imdir_t idx, ord_t order, femdnum9_t* num){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        mdnum9_set_deriv_r( val, idx, order, &num->p_data[k]);
...
void femdnum9_set_deriv_o( mdnum9_t* val, imdir_t idx, ord_t order, femdnum9_t* num){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        mdnum9_set_deriv_o( val, idx, order, &num->p_data[k]);
...
void femdnum9_set_deriv_f( femdnum9_t* val, imdir_t idx, ord_t order, femdnum9_t* num){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        mdnum9_set_deriv_o( &val->p_data[k], idx, order, &num->p_data[k]);
...
// ****************************************************************************************************
void femdnum9_set_to( femdnum9_t* src, femdnum9_t* dst){
    
    uint64_t i;

    femdnum9_dimCheck(src,dst);

    for (i = 0; i<src->nip; i++ ){
        
        mdnum9_copy_to( &src->p_data[i], &dst->p_data[i]);
...
femdnum9_t femdnum9_copy( femdnum9_t* src){
    ...
    res = femdnum9_createEmpty(src->nip);

    femdnum9_copy_to( src, &res);
...
void femdnum9_set_item_k_o( mdnum9_t* num, uint64_t k, femdnum9_t* res){
    ...
    if (k < res->nip){
        ...
        mdnum9_set_o(num, &res->p_data[k]); 

    } else {

        printf("ERROR: Index out of bounds in femdnum9_get_item_k.\n");
...
void femdnum9_get_item_k_to(femdnum9_t* num, uint64_t k, mdnum9_t* res){
    ...
    if (k < num->nip){
        ...
        mdnum9_copy_to( &num->p_data[k], res);
...
// ****************************************************************************************************
femdnum9_t femdnum9_zeros(uint64_t nip){

    femdnum9_t  res  = femdnum9_createEmpty(nip);
    
    femdnum9_set_r( 0.0, &res);
...
// ****************************************************************************************************
inline femdnum9_t femdnum9_createEmpty(uint64_t nip){

    femdnum9_t  res ;  
    void * memory = NULL;

    // Allocate memory and check if correctly allocated.
    memory = malloc( nip * sizeof( mdnum9_t ) );

    if ( memory == NULL ){
        printf("ERROR: Not enough memory to handle array of femdnum9.\n Exiting...\n");
        exit(OTI_OutOfMemory); // TODO: Raise error instead of quitting the program.
    }
    
    res.p_data = ( mdnum9_t* ) memory;
    res.nip = nip;
...
// ****************************************************************************************************
inline femdnum9_t femdnum9_init(void){
...
// ****************************************************************************************************
inline femdnum9_t femdnum9_empty_like(femdnum9_t* arr){

    femdnum9_t res = femdnum9_createEmpty(arr->nip);
