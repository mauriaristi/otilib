...
cpdef truncate(object humdir, object val, object out = None):
  ...
  # Array Types
    ...
    if res_flag:
      ...
      Sres = out
      oarrm2n5_truncate_im_to( indx, order, &S.arr, &Sres.arr)
...
cpdef extract_im(object humdir, object val, object out = None):
  ...
  # Array Types
    ...
    if res_flag:
      ...
      Sres = out
      oarrm2n5_extract_im_to( indx, order, &S.arr, &Sres.arr)
...
cpdef extract_deriv(object humdir, object val, object out = None):
  ...
  # Array Types
    ...
    if res_flag:
      ...
      Sres = out
      oarrm2n5_extract_deriv_to( indx, order, &S.arr, &Sres.arr)
...
cpdef get_im(object humdir, object val, object out = None):
  ...
  # Array Types
    ...
    if res_flag:
      ...
      Sres = out
      oarrm2n5_get_im_to( indx, order, &S.arr, &Sres.arr)
...
cpdef get_deriv(object humdir, object val, object out = None):
  ...
  # Array Types
    ...
    if res_flag:
      ...
      Sres = out
      oarrm2n5_get_deriv_to( indx, order, &S.arr, &Sres.arr)
...
cpdef get_order_im(ord_t order, object val, object out = None):
  ...
  # Array Types
    ...
    if res_flag:
      ...
      Sres = out
      oarrm2n5_get_order_im_to( order, &S.arr, &Sres.arr)
