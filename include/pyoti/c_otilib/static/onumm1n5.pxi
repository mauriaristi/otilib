cdef extern from "oti/oti.h" nogil:
  ...
  # From ../../../include/oti/static/onumm1n5/scalar/structures.h
  
  ctypedef struct  onumm1n5_t : # {
    coeff_t r;
    coeff_t e1;
    coeff_t e11;
    coeff_t e111;
  ...
  # From ../../../include/oti/static/onumm1n5/array/structures.h
  
  ctypedef struct  oarrm1n5_t : # {
      onumm1n5_t*    p_data;
      uint64_t       nrows;
      uint64_t       ncols;
      uint64_t        size;
  ...
  # From ../../../include/oti/static/onumm1n5/scalar/gauss/structures.h
  
  ctypedef struct  feonumm1n5_t: # {
      onumm1n5_t*  p_data;
      uint64_t    nip;
  # } feonumm1n5_t;
  
  
  # From ../../../include/oti/static/onumm1n5/array/gauss/structures.h
  
  ctypedef struct  feoarrm1n5_t: # {
      oarrm1n5_t*      p_data;
      uint64_t      nrows;
      uint64_t      ncols;
      uint64_t       size;
  ...
  # =========================================================================================
  # From ../../../include/oti/static/onumm1n5/scalar/functions.h
  ...
  # From ../../../include/oti/static/onumm1n5/scalar/base.h
  ...
  # From ../../../include/oti/static/onumm1n5/scalar/utils.h
  
  void onumm1n5_get_active_bases(onumm1n5_t* num, imdir_t* list);
  
  
  # From ../../../include/oti/static/onumm1n5/scalar/algebra.h
  ...
  # From ../../../include/oti/static/onumm1n5/scalar/gauss.h
  
  
  
  # From ../../../include/oti/static/onumm1n5/scalar/gauss/functions.h
  ...
  # From ../../../include/oti/static/onumm1n5/scalar/gauss/base.h
  ...
  feonumm1n5_t feonumm1n5_init();
  
  
  # From ../../../include/oti/static/onumm1n5/scalar/gauss/utils.h
  
  void feonumm1n5_dimCheck(feonumm1n5_t* arr1,feonumm1n5_t* arr2);
  void feonumm1n5_get_active_bases(feonumm1n5_t* num, imdir_t* list_vals);
  
  
  # From ../../../include/oti/static/onumm1n5/scalar/gauss/algebra.h
  ...
  # From ../../../include/oti/static/onumm1n5/array/functions.h
  ...
  # From ../../../include/oti/static/onumm1n5/array/algebra_elementwise.h
  
  oarrm1n5_t oarrm1n5_neg(oarrm1n5_t* arr);
  void oarrm1n5_neg_to(oarrm1n5_t* rhs, oarrm1n5_t* res);
  oarrm1n5_t oarrm1n5_sum_OO(oarrm1n5_t*   lhs, oarrm1n5_t* rhs);
  oarrm1n5_t oarrm1n5_sum_RO(darr_t*    lhs, oarrm1n5_t* rhs);
  oarrm1n5_t oarrm1n5_sum_oO(onumm1n5_t* lhs, oarrm1n5_t* rhs);
  oarrm1n5_t oarrm1n5_sum_rO(coeff_t    lhs, oarrm1n5_t* rhs);
  void oarrm1n5_sum_OO_to(oarrm1n5_t*   lhs, oarrm1n5_t* rhs, oarrm1n5_t* res);
  void oarrm1n5_sum_RO_to(darr_t*    lhs, oarrm1n5_t* rhs, oarrm1n5_t* res);
  void oarrm1n5_sum_oO_to(onumm1n5_t* lhs, oarrm1n5_t* rhs, oarrm1n5_t* res);
  void oarrm1n5_sum_rO_to(coeff_t    lhs, oarrm1n5_t* rhs, oarrm1n5_t* res);
  void oarrm1n5_trunc_sum_OO_to(ord_t order, oarrm1n5_t* arr1, oarrm1n5_t* arr2, oarrm1n5_t* res);
  oarrm1n5_t oarrm1n5_sub_OO(oarrm1n5_t*   lhs, oarrm1n5_t*   rhs);
  oarrm1n5_t oarrm1n5_sub_RO(darr_t*    lhs, oarrm1n5_t*   rhs);
  oarrm1n5_t oarrm1n5_sub_OR(oarrm1n5_t*   lhs, darr_t*    rhs);
  oarrm1n5_t oarrm1n5_sub_oO(onumm1n5_t* lhs, oarrm1n5_t*   rhs);
  oarrm1n5_t oarrm1n5_sub_Oo(oarrm1n5_t*   lhs, onumm1n5_t* rhs);
  oarrm1n5_t oarrm1n5_sub_rO(coeff_t    lhs, oarrm1n5_t*   rhs);
  oarrm1n5_t oarrm1n5_sub_Or(oarrm1n5_t*   lhs, coeff_t    rhs);
  void oarrm1n5_sub_OO_to( oarrm1n5_t*   lhs, oarrm1n5_t*   rhs, oarrm1n5_t* res);
  void oarrm1n5_sub_RO_to( darr_t*    lhs, oarrm1n5_t*   rhs, oarrm1n5_t* res);
  void oarrm1n5_sub_OR_to( oarrm1n5_t*   lhs, darr_t*    rhs, oarrm1n5_t* res);
  void oarrm1n5_sub_oO_to( onumm1n5_t* lhs, oarrm1n5_t*   rhs, oarrm1n5_t* res);
  void oarrm1n5_sub_Oo_to( oarrm1n5_t*   lhs, onumm1n5_t* rhs, oarrm1n5_t* res);
  void oarrm1n5_sub_rO_to( coeff_t    lhs, oarrm1n5_t*   rhs, oarrm1n5_t* res);
  void oarrm1n5_sub_Or_to( oarrm1n5_t*   lhs, coeff_t    rhs, oarrm1n5_t* res);
  void oarrm1n5_trunc_sub_OO_to(ord_t order, oarrm1n5_t* arr1, oarrm1n5_t* arr2, oarrm1n5_t* res);
  oarrm1n5_t oarrm1n5_mul_OO(oarrm1n5_t*   lhs, oarrm1n5_t* rhs);
  oarrm1n5_t oarrm1n5_mul_RO(darr_t*    lhs, oarrm1n5_t* rhs);
  oarrm1n5_t oarrm1n5_mul_oO(onumm1n5_t* lhs, oarrm1n5_t* rhs);
  oarrm1n5_t oarrm1n5_mul_rO(coeff_t    lhs, oarrm1n5_t* rhs);
  void oarrm1n5_mul_OO_to(oarrm1n5_t*   lhs, oarrm1n5_t* rhs, oarrm1n5_t* res);
  void oarrm1n5_mul_RO_to(darr_t*    lhs, oarrm1n5_t* rhs, oarrm1n5_t* res);
  void oarrm1n5_mul_oO_to(onumm1n5_t* lhs, oarrm1n5_t* rhs, oarrm1n5_t* res);
  void oarrm1n5_mul_rO_to(coeff_t    lhs, oarrm1n5_t* rhs, oarrm1n5_t* res);
  void oarrm1n5_gem_OO_to(  oarrm1n5_t* arr1, oarrm1n5_t* arr2, oarrm1n5_t* arr3, oarrm1n5_t* res);
  void oarrm1n5_gem_oO_to(onumm1n5_t* arr1, oarrm1n5_t* arr2, oarrm1n5_t* arr3, oarrm1n5_t* res);
  oarrm1n5_t oarrm1n5_div_OO(oarrm1n5_t*   lhs, oarrm1n5_t*   rhs);
  oarrm1n5_t oarrm1n5_div_OR(oarrm1n5_t*   lhs, darr_t*    rhs);
  oarrm1n5_t oarrm1n5_div_RO(darr_t*    lhs, oarrm1n5_t*   rhs);
  oarrm1n5_t oarrm1n5_div_oO(onumm1n5_t* lhs, oarrm1n5_t*   rhs);
  oarrm1n5_t oarrm1n5_div_Oo(oarrm1n5_t*   lhs, onumm1n5_t* rhs);
  oarrm1n5_t oarrm1n5_div_rO(coeff_t    lhs, oarrm1n5_t*   rhs);
  oarrm1n5_t oarrm1n5_div_Or(oarrm1n5_t*   lhs, coeff_t    rhs);
  void oarrm1n5_div_OO_to(oarrm1n5_t*   lhs, oarrm1n5_t*   rhs, oarrm1n5_t* res);
  void oarrm1n5_div_RO_to(darr_t*    lhs, oarrm1n5_t*   rhs, oarrm1n5_t* res);
  void oarrm1n5_div_OR_to(oarrm1n5_t*   lhs, darr_t*    rhs, oarrm1n5_t* res);
  void oarrm1n5_div_oO_to(onumm1n5_t* lhs, oarrm1n5_t*   rhs, oarrm1n5_t* res);
  void oarrm1n5_div_Oo_to(oarrm1n5_t*   lhs, onumm1n5_t* rhs, oarrm1n5_t* res);
  void oarrm1n5_div_rO_to(coeff_t    lhs, oarrm1n5_t*   rhs, oarrm1n5_t* res);
  void oarrm1n5_div_Or_to(oarrm1n5_t*   lhs, coeff_t    rhs, oarrm1n5_t* res);
  
  
  # From ../../../include/oti/static/onumm1n5/array/base.h
  
  void    oarrm1n5_taylor_integrate_to( coeff_t* deltas, oarrm1n5_t* arr, oarrm1n5_t* res);
  oarrm1n5_t oarrm1n5_taylor_integrate(    coeff_t* deltas, oarrm1n5_t* arr);
  void    oarrm1n5_get_order_im_to( ord_t order, oarrm1n5_t* arr, oarrm1n5_t* res);
  oarrm1n5_t oarrm1n5_get_order_im(    ord_t order, oarrm1n5_t* arr);
  void oarrm1n5_set_slice_r( coeff_t val,
                          int64_t starti, int64_t stopi, int64_t stepi,
                          int64_t startj, int64_t stopj, int64_t stepj,
                           oarrm1n5_t* res);
  void oarrm1n5_set_slice_O( oarrm1n5_t* val,
                          int64_t starti, int64_t stopi, int64_t stepi,
                          int64_t startj, int64_t stopj, int64_t stepj,
                           oarrm1n5_t* res);
  void oarrm1n5_set_slice_o( onumm1n5_t* val,
                          int64_t starti, int64_t stopi, int64_t stepi,
                          int64_t startj, int64_t stopj, int64_t stepj,
                           oarrm1n5_t* res);
  oarrm1n5_t oarrm1n5_get_slice( oarrm1n5_t* arr,
                          int64_t starti, int64_t stopi, int64_t stepi,
                          int64_t startj, int64_t stopj, int64_t stepj);
  void oarrm1n5_get_slice_to( oarrm1n5_t* arr,
                          int64_t starti, int64_t stopi, int64_t stepi,
                          int64_t startj, int64_t stopj, int64_t stepj,
                           oarrm1n5_t* res);
  oarrm1n5_t oarrm1n5_truncate_im(    imdir_t idx, ord_t order, oarrm1n5_t* arr);
  void    oarrm1n5_truncate_im_to( imdir_t idx, ord_t order, oarrm1n5_t* arr, oarrm1n5_t* res);
  oarrm1n5_t oarrm1n5_extract_im(   imdir_t idx, ord_t order, oarrm1n5_t* arr);
  void    oarrm1n5_extract_im_to(imdir_t idx, ord_t order, oarrm1n5_t* arr, oarrm1n5_t* res);
  darr_t  oarrm1n5_get_deriv(    imdir_t idx, ord_t order, oarrm1n5_t* arr);
  void    oarrm1n5_get_deriv_to( imdir_t idx, ord_t order, oarrm1n5_t* arr, oarrm1n5_t* res);
  oarrm1n5_t oarrm1n5_get_deriv_o(  imdir_t idx, ord_t order, oarrm1n5_t* arr);
  oarrm1n5_t oarrm1n5_extract_deriv(    imdir_t idx, ord_t order, oarrm1n5_t* arr);
  void    oarrm1n5_extract_deriv_to( imdir_t idx, ord_t order, oarrm1n5_t* arr, oarrm1n5_t* res);
  darr_t  oarrm1n5_get_im(   imdir_t idx, ord_t order, oarrm1n5_t* arr);
  oarrm1n5_t oarrm1n5_get_im_o( imdir_t idx, ord_t order, oarrm1n5_t* arr);
  void    oarrm1n5_get_im_to(imdir_t idx, ord_t order, oarrm1n5_t* arr, oarrm1n5_t* res);
  void    oarrm1n5_copy_to(oarrm1n5_t* arr, oarrm1n5_t* res);
  oarrm1n5_t oarrm1n5_copy(oarrm1n5_t* arr);
  void oarrm1n5_set_all_r( coeff_t num, oarrm1n5_t* arr);
  void oarrm1n5_set_item_i_r( coeff_t num, uint64_t i, oarrm1n5_t* arr);
  void oarrm1n5_set_item_ij_r( coeff_t num, uint64_t i, uint64_t j, oarrm1n5_t* arr);
  void oarrm1n5_set_r(   coeff_t  num,   oarrm1n5_t* arr);
  void oarrm1n5_set_o( onumm1n5_t* num,   oarrm1n5_t* arr);
  void oarrm1n5_set_O(   oarrm1n5_t* arrin, oarrm1n5_t* arr);
  void oarrm1n5_set_all_o( onumm1n5_t* src, oarrm1n5_t* arr);
  void oarrm1n5_set_item_i_o( onumm1n5_t* num, uint64_t i, oarrm1n5_t* arr);
  void oarrm1n5_set_item_ij_o( onumm1n5_t* num, uint64_t i, uint64_t j, oarrm1n5_t* arr);
  onumm1n5_t oarrm1n5_get_item_i(    oarrm1n5_t* arr, uint64_t i);
  void      oarrm1n5_get_item_i_to( oarrm1n5_t* arr, uint64_t i,             onumm1n5_t* res);
  onumm1n5_t oarrm1n5_get_item_ij(   oarrm1n5_t* arr, uint64_t i, uint64_t j);
  void      oarrm1n5_get_item_ij_to(oarrm1n5_t* arr, uint64_t i, uint64_t j, onumm1n5_t* res);
  oarrm1n5_t oarrm1n5_init();
  void oarrm1n5_free(oarrm1n5_t* arr);
  oarrm1n5_t oarrm1n5_empty_like(oarrm1n5_t* arr);
  oarrm1n5_t oarrm1n5_eye(uint64_t nrows);
  oarrm1n5_t oarrm1n5_ones(uint64_t nrows, uint64_t ncols);
  oarrm1n5_t oarrm1n5_zeros(uint64_t nrows, uint64_t ncols);
  oarrm1n5_t oarrm1n5_createEmpty(uint64_t nrows, uint64_t ncols);
  
  
  # From ../../../include/oti/static/onumm1n5/array/utils.h
  ...
  # From ../../../include/oti/static/onumm1n5/array/algebra_matops.h
  
  onumm1n5_t oarrm1n5_dotproduct_OO(    oarrm1n5_t* lhs, oarrm1n5_t* rhs);
  void      oarrm1n5_dotproduct_OO_to( oarrm1n5_t* lhs, oarrm1n5_t* rhs, onumm1n5_t* res);
  onumm1n5_t oarrm1n5_dotproduct_RO(     darr_t* lhs, oarrm1n5_t* rhs);
  void      oarrm1n5_dotproduct_RO_to(  darr_t* lhs, oarrm1n5_t* rhs, onumm1n5_t* res);
  oarrm1n5_t oarrm1n5_matmul_OO(    oarrm1n5_t* lhs, oarrm1n5_t* rhs);
  oarrm1n5_t oarrm1n5_matmul_OR(    oarrm1n5_t* lhs,  darr_t* rhs);
  oarrm1n5_t oarrm1n5_matmul_RO(     darr_t* lhs, oarrm1n5_t* rhs);
  void    oarrm1n5_matmul_OO_to( oarrm1n5_t* lhs, oarrm1n5_t* rhs, oarrm1n5_t* res);
  void    oarrm1n5_matmul_OR_to( oarrm1n5_t* lhs,  darr_t* rhs, oarrm1n5_t* res);
  void    oarrm1n5_matmul_RO_to(  darr_t* lhs, oarrm1n5_t* rhs, oarrm1n5_t* res);
  oarrm1n5_t oarrm1n5_transpose(    oarrm1n5_t* arr1);
  void    oarrm1n5_transpose_to( oarrm1n5_t* arr1, oarrm1n5_t* res);
  oarrm1n5_t oarrm1n5_invert(    oarrm1n5_t* arr1);
  void    oarrm1n5_invert_to( oarrm1n5_t* arr1, oarrm1n5_t* res);
  onumm1n5_t oarrm1n5_det(    oarrm1n5_t* arr1);
  void      oarrm1n5_det_to( oarrm1n5_t* arr1, onumm1n5_t* res);
  onumm1n5_t oarrm1n5_norm(    oarrm1n5_t* arr1);
  void      oarrm1n5_norm_to( oarrm1n5_t* arr1,  onumm1n5_t* res);
  onumm1n5_t oarrm1n5_pnorm(    oarrm1n5_t* arr1, coeff_t p);
  void      oarrm1n5_pnorm_to( oarrm1n5_t* arr1, coeff_t p, onumm1n5_t* res);
  
  
  # From ../../../include/oti/static/onumm1n5/array/gauss.h
  
  
  
  # From ../../../include/oti/static/onumm1n5/array/gauss/functions.h
  ...
  # From ../../../include/oti/static/onumm1n5/array/gauss/base.h
  
  void      feoarrm1n5_get_order_im_to( ord_t order, feoarrm1n5_t* arr, feoarrm1n5_t* res);
  feoarrm1n5_t feoarrm1n5_get_order_im(    ord_t order, feoarrm1n5_t* arr);
  feoarrm1n5_t feoarrm1n5_get_deriv(   imdir_t idx, ord_t order, feoarrm1n5_t* arr);
  void      feoarrm1n5_get_deriv_to(imdir_t idx, ord_t order, feoarrm1n5_t* arr, feoarrm1n5_t* res);
  feoarrm1n5_t feoarrm1n5_get_im(      imdir_t idx, ord_t order, feoarrm1n5_t* arr);
  void      feoarrm1n5_get_im_to(   imdir_t idx, ord_t order, feoarrm1n5_t* arr, feoarrm1n5_t* res);
  feoarrm1n5_t feoarrm1n5_truncate_im(   imdir_t idx, ord_t order, feoarrm1n5_t* arr);
  void      feoarrm1n5_truncate_im_to(imdir_t idx, ord_t order, feoarrm1n5_t* arr, feoarrm1n5_t* res);
  feoarrm1n5_t feoarrm1n5_copy(   feoarrm1n5_t* src);
  void      feoarrm1n5_copy_to(feoarrm1n5_t* src, feoarrm1n5_t* res);
  feoarrm1n5_t feoarrm1n5_get_im(    imdir_t idx, ord_t order, feoarrm1n5_t* arr);
  void      feoarrm1n5_get_im_to( imdir_t idx, ord_t order, feoarrm1n5_t* arr, feoarrm1n5_t* res);
  feoarrm1n5_t feoarrm1n5_get_deriv(    imdir_t idx, ord_t order, feoarrm1n5_t* arr);
  void      feoarrm1n5_get_deriv_to( imdir_t idx, ord_t order, feoarrm1n5_t* arr, feoarrm1n5_t* res);
  feoarrm1n5_t feoarrm1n5_extract_im(    imdir_t idx, ord_t order, feoarrm1n5_t* arr);
  void      feoarrm1n5_extract_im_to( imdir_t idx, ord_t order, feoarrm1n5_t* arr,  feoarrm1n5_t* res);
  feoarrm1n5_t feoarrm1n5_extract_deriv(    imdir_t idx, ord_t order, feoarrm1n5_t* arr);
  void      feoarrm1n5_extract_deriv_to( imdir_t idx, ord_t order, feoarrm1n5_t* arr, feoarrm1n5_t* res);
  oarrm1n5_t   feoarrm1n5_get_item_k(  feoarrm1n5_t* arr, uint64_t k);
  feonumm1n5_t  feoarrm1n5_get_item_ij( feoarrm1n5_t* arr, uint64_t i, uint64_t j);
  onumm1n5_t feoarrm1n5_get_item_ijk(feoarrm1n5_t* arr, uint64_t i, uint64_t j, uint64_t k);
  void feoarrm1n5_get_item_ij_to(  feoarrm1n5_t* arr, uint64_t i, uint64_t j,
                                 feonumm1n5_t* res);
  void feoarrm1n5_get_item_k_to(   feoarrm1n5_t* arr, uint64_t k,
                                  oarrm1n5_t* res);
  void feoarrm1n5_get_item_ijk_to( feoarrm1n5_t* arr, uint64_t i, uint64_t j, uint64_t k,
                                onumm1n5_t* res);
  feoarrm1n5_t feoarrm1n5_get_slice(feoarrm1n5_t* arr,
                            int64_t starti, int64_t stopi, int64_t stepi,
                            int64_t startj, int64_t stopj, int64_t stepj);
  void      feoarrm1n5_get_slice_to(feoarrm1n5_t* arr,
                            int64_t starti, int64_t stopi, int64_t stepi,
                            int64_t startj, int64_t stopj, int64_t stepj,
                            feoarrm1n5_t* res);
  void feoarrm1n5_set_item_ij_r(   coeff_t  elm, uint64_t i, uint64_t j,
                              feoarrm1n5_t* res);
  void feoarrm1n5_set_item_ij_o(  onumm1n5_t* elm, uint64_t i, uint64_t j,
                               feoarrm1n5_t* res);
  void feoarrm1n5_set_item_ij_f(  feonumm1n5_t* elm, uint64_t i, uint64_t j,
                              feoarrm1n5_t* res);
  void feoarrm1n5_set_item_k_r(    coeff_t  elm, uint64_t k,
                              feoarrm1n5_t* res);
  void feoarrm1n5_set_item_k_o(  onumm1n5_t* elm, uint64_t k,
                              feoarrm1n5_t* res);
  void feoarrm1n5_set_item_k_R(    oarrm1n5_t* elm, uint64_t k,
                            feoarrm1n5_t* res);
  void feoarrm1n5_set_item_k_O(    oarrm1n5_t* elm, uint64_t k,
                            feoarrm1n5_t* res);
  void feoarrm1n5_set_item_ijk_r(   coeff_t  elm, uint64_t i, uint64_t j, uint64_t k,
                               feoarrm1n5_t* res);
  void feoarrm1n5_set_item_ijk_o( onumm1n5_t* elm, uint64_t i, uint64_t j, uint64_t k,
                               feoarrm1n5_t* res);
  void feoarrm1n5_set_slice_r( coeff_t val,
                           int64_t starti, int64_t stopi, int64_t stepi,
                           int64_t startj, int64_t stopj, int64_t stepj,
                            feoarrm1n5_t* res);
  void feoarrm1n5_set_slice_o( onumm1n5_t* val,
                           int64_t starti, int64_t stopi, int64_t stepi,
                           int64_t startj, int64_t stopj, int64_t stepj,
                            feoarrm1n5_t* res);
  void feoarrm1n5_set_slice_f( feonumm1n5_t* val,
                           int64_t starti, int64_t stopi, int64_t stepi,
                           int64_t startj, int64_t stopj, int64_t stepj,
                            feoarrm1n5_t* res);
  void feoarrm1n5_set_slice_O( oarrm1n5_t* val,
                           int64_t starti, int64_t stopi, int64_t stepi,
                           int64_t startj, int64_t stopj, int64_t stepj,
                            feoarrm1n5_t* res);
  void feoarrm1n5_set_slice_F( feoarrm1n5_t* val,
                           int64_t starti, int64_t stopi, int64_t stepi,
                           int64_t startj, int64_t stopj, int64_t stepj,
                            feoarrm1n5_t* res);
  void feoarrm1n5_set_all_o( onumm1n5_t* num, feoarrm1n5_t* arr );
  void feoarrm1n5_set_all_r(   coeff_t  num, feoarrm1n5_t* arr );
  void feoarrm1n5_set_all_f(  feonumm1n5_t* num, feoarrm1n5_t* arr );
  void feoarrm1n5_set_r(    coeff_t src, feoarrm1n5_t* res );
  void feoarrm1n5_set_o( onumm1n5_t* src, feoarrm1n5_t* res );
  void feoarrm1n5_set_f(  feonumm1n5_t* src, feoarrm1n5_t* res );
  void feoarrm1n5_set_R(    darr_t* src, feoarrm1n5_t* res );
  void feoarrm1n5_set_O(   oarrm1n5_t* src, feoarrm1n5_t* res );
  void feoarrm1n5_set_F( feoarrm1n5_t* src, feoarrm1n5_t* res );
  feoarrm1n5_t feoarrm1n5_eye( uint64_t size,  uint64_t nip);
  feoarrm1n5_t feoarrm1n5_zeros(  uint64_t nrows,   uint64_t ncols, uint64_t nip    );
  feoarrm1n5_t feoarrm1n5_ones( uint64_t nrows,   uint64_t ncols, uint64_t nip     );
  feoarrm1n5_t feoarrm1n5_createEmpty( uint64_t nrows,   uint64_t ncols, uint64_t nIntPts);
  void feoarrm1n5_free(feoarrm1n5_t* arr);
  feoarrm1n5_t feoarrm1n5_init();
  ord_t feoarrm1n5_get_order(feoarrm1n5_t* arr);
  
  
  # From ../../../include/oti/static/onumm1n5/array/gauss/utils.h
  
  void feoarrm1n5_dimCheck_FF_samesize(feoarrm1n5_t* arr1, feoarrm1n5_t* arr2, feonumm1n5_t* res);
  void feoarrm1n5_dimCheck_OF_samesize(  oarrm1n5_t* arr1, feoarrm1n5_t* arr2, feonumm1n5_t* res);
  void feoarrm1n5_dimCheck_RF_samesize(   darr_t* arr1, feoarrm1n5_t* arr2, feonumm1n5_t* res);
  ...
  void feoarrm1n5_dimCheck_fF_elementwise( feonumm1n5_t* num1, feoarrm1n5_t* arr2, feoarrm1n5_t* res);
  void feoarrm1n5_dimCheck_Ff_elementwise(feoarrm1n5_t* arr1,  feonumm1n5_t* num2, feoarrm1n5_t* res);
  ...
  void feoarrm1n5_dimCheck_FfO_integrate(feoarrm1n5_t* arr, feonumm1n5_t* num,oarrm1n5_t* res);
  void feoarrm1n5_get_active_bases(feoarrm1n5_t* arr, imdir_t* list_vals);
  
  
  # From ../../../include/oti/static/onumm1n5/array/gauss/algebra.h
