...
cdef class csr_omatm1n2:
  ...
  def __init__(self, arg1, shape=None, copy = True): 
    """
    PURPOSE:      Python level constructor of the csr_omatm1n2 class.

    DESCRIPTION:  Creates a new empty csr_omatm1n2 matrix.
                 
    """
    #*************************************************************************************************
    
    cdef uint64_t i, j, k, ncols, nrows
    cdef lil_omatm1n2 lil
    
    targ1 = type(arg1)

    if targ1 == lil_omatm1n2 :
  ...
  def copy(self):
    ...
    cdef csr_omatm1n2 res = <csr_omatm1n2> csr_omatm1n2.__new__(csr_omatm1n2)
    cdef object[:]   data
...
# ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
# :::::::::::::::::::::::::::::::::::: END OF CLASS csr_omatm1n2 ::::::::::::::::::::::::::::::::::::::::
# ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::

# ****************************************************************************************************
cdef void csromatm1n2_matmul_SO_to(csr_omatm1n2 lhs, omatm1n2 rhs, omatm1n2 res):
  """
...
# ****************************************************************************************************
cdef omatm1n2 csromatm1n2_matmul_SO(csr_omatm1n2 lhs, omatm1n2 rhs):
  """
  PORPUSE:  Perform matrix-matrix multiplication between csr matrix and dense matrix.
  ...
  csromatm1n2_matmul_SO_to( lhs, rhs, res)
