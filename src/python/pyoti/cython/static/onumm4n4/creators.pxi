...
cpdef e( object hum_dir, uint64_t nip = 0):
  """
  PURPOSE:  To create a onumm4n4 with value 1 at the specified imaginary direction
  ...
  if nip == 0: 
    ...
    # Create a onumm4n4
    ores = onumm4n4_create_r(0.0)

    # Set the coefficient to 1.
    onumm4n4_set_item(1.0, indx_hd, order_hd, &ores) 
    res = onumm4n4.create(&ores)

  else:
    
    fres = feonumm4n4(0.0, nip)
...
cpdef one( uint64_t nip = 0):
  ...
  if nip == 0: 
    ...
    # Create a onumm4n4
    ores = onumm4n4_create_r(1.0)
    res = onumm4n4.create(&ores)

  else:
    
    fres = feonumm4n4(1.0, nip)
    res = fres
...
cpdef number( coeff_t num, uint64_t nip = 0):
  ...
  if nip == 0: 
    ...
    # Create a onumm4n4
    ores = onumm4n4_create_r(num)
    res = onumm4n4.create(&ores)

  else:
    
    fres = feonumm4n4(num, nip)
    res = fres
...
cpdef eye(uint64_t size, uint64_t nip = 0):
  ...
  if nip == 0:
    ...
    # This will create an omatm4n4.
    Ores = oarrm4n4_eye(size)

    return omatm4n4.create(&Ores)

  else:

    # This will create a feomatm4n4
    Fres = feoarrm4n4_eye(size,nip)

    return feomatm4n4.create(&Fres)
...
cpdef array( object arr,  uint64_t nip = 0):
  ...
  cdef omatm4n4     Ores
  cdef feomatm4n4   Fres
  cdef object res
  cdef np.ndarray np_arr

  tin = type(array)
  
  if (tin is omatm4n4) or (tin is feomatm4n4):
...
cpdef zeros( object shape_in, uint64_t nip = 0):
  ...
  if nip == 0:
    ...
    # This will create an omatm4n4.
    Ores = oarrm4n4_zeros(nrows,ncols)
    ...
    # This will create a feomatm4n4
    Fres = feoarrm4n4_zeros(nrows,ncols,nip)
...
cpdef ones( object shape_in,  uint64_t nip = 0):
  ...
  if nip == 0:
    ...
    # This will create an omatm4n4.
    Ores = oarrm4n4_ones(nrows,ncols)
    ...
    # This will create a feomatm4n4
    Fres = feoarrm4n4_ones(nrows,ncols,nip)
