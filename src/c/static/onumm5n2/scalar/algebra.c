...
onumm5n2_t onumm5n2_div_ro(coeff_t num, onumm5n2_t* den){
    ...
    onumm5n2_t inv = onumm5n2_pow(den,-1);
    onumm5n2_t res = onumm5n2_mul_ro(num,&inv);
...
onumm5n2_t onumm5n2_div_oo(onumm5n2_t* num, onumm5n2_t* den){
    ...
    onumm5n2_t res = onumm5n2_mul_oo(num,&inv);
...
onumm5n2_t onumm5n2_div_or(onumm5n2_t* num, coeff_t val){
    ...
    return onumm5n2_mul_ro(1.0/val,num);
...
onumm5n2_t onumm5n2_feval(coeff_t* feval_re, onumm5n2_t* x){
  ...
  onumm5n2_t deltax = (*x), deltax_power = (*x);
  deltax.r = 0.0;
  deltax_power.r = 0.0;
  onumm5n2_set_r(0.0, &res);
  //  Real
  res.r = feval_re[0];
  // Order 1
  factor *=1;
  coef    = feval_re[1]/ factor;;
  onumm5n2_gem_ro_to( coef, &deltax_power, &res, &res);
  deltax_power = onumm5n2_mul_oo(&deltax_power,&deltax);
  // Order 2
  factor *=2;
