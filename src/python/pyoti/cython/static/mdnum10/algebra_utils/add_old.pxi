...
# cdef object __add__FX__(mdmatfe10 Flhs, object rhs, object out = None):
#   """
#   PURPOSE:  Addition between mdmatfe10 and object.
...
cdef object __add__OX__(mdmat10 Olhs, object rhs, object out = None):
  """
  PURPOSE:  Addition between mdmat10 and an object.
  ...
  #   if res_flag:
  #     Fres = out
  #     femdnum10_sum_Of_to( &Orhs.arr, &flhs.num ,&Fres.arr)
  #   else:      
  #     cFres = femdnum10_sum_Of( &Orhs.arr, &flhs.num)
  #     res = mdmatfe10.create(&cFres)
  #   # end if
    ...
    if res_flag:
      ...
      cOres = mdarr10_sum_OO( &Orhs.arr, &Orhs.arr)
      res = mdmat10.create( &cOres )
    # end if
...
cdef object __add__RX__(dmat Rlhs, object rhs, object out = None):
  """
  PURPOSE:  Addition between mdnum10 and an object.
  ...
  #   if res_flag:
  #     ores = out
  #     mdnum10_sum_Ro_to( &Rlhs.arr, &orhs.num ,&ores.num)
  #   else:
  #     cores = mdnum10_sum_Ro( &Rlhs.arr, &orhs.num )
  ...
  #   if res_flag:
  #     fres = out
  #     femdnum10_sum_Rf_to( &Rlhs.arr, &frhs.num ,&fres.num)
  #   else:      
  #     cfres = femdnum10_sum_Rf( &Rlhs.arr, &frhs.num)
...
cdef object __add__fX__(mdnumfe10 flhs, object rhs, object out = None):
  """
  PURPOSE:  Addition between mdnumfe10 and an object.
  ...
  #   if res_flag:
  #     Rres = out
  #     femdnum10_sum_Rf_to( &Rrhs.arr, &flhs.num ,&Fres.arr)
  #   else:      
  #     cFres = femdnum10_sum_Rf( &Rrhs.arr, &flhs.num)
  #     res = mdmatfe10.create(&cFres)
  #   # end if
...
cdef object __add__oX__(mdnum10 olhs, object rhs, object out = None):
  ...
  #   if res_flag:
  #     Ores = out
  #     mdnum10_sum_oR_to( &olhs.num, &Rrhs.arr ,&Ores.arr)
  #   else:      
  #     cOres = mdnum10_sum_oR( &olhs.num, &Rrhs.arr)
  #     res = mdmat10.create(&cOres)
  #   # end if
