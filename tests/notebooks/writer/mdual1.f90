MODULE MDUAL1
   ...
   INTERFACE PPRINT
      MODULE PROCEDURE MDNUM1_PPRINT_S,MDNUM1_PPRINT_V,MDNUM1_PPRINT_M
   END INTERFACE
   ...
   INTERFACE DOT_PRODUCT
      MODULE PROCEDURE MDNUM1_DOT_PRODUCT_MDNUM1,R_DOT_PRODUCT_MDNUM1,MDNUM1_DOT_PRODUCT_R
   END INTERFACE
   ...
   INTERFACE DET2X2
      MODULE PROCEDURE MDNUM1_det2x2
   END INTERFACE

   INTERFACE DET3X3
      MODULE PROCEDURE MDNUM1_det3x3
   END INTERFACE

   INTERFACE DET4X4
      MODULE PROCEDURE MDNUM1_det4x4
   END INTERFACE

   INTERFACE INV2X2
      MODULE PROCEDURE MDNUM1_INV2X2
   END INTERFACE

   INTERFACE INV3X3
      MODULE PROCEDURE MDNUM1_INV3X3
   END INTERFACE

   INTERFACE INV4X4
      MODULE PROCEDURE MDNUM1_INV4X4
   END INTERFACE

   INTERFACE GETIM
      MODULE PROCEDURE MDNUM1_GETIM_S,MDNUM1_GETIM_V,MDNUM1_GETIM_M
   END INTERFACE

   INTERFACE SETIM
      MODULE PROCEDURE MDNUM1_SETIM_S,MDNUM1_SETIM_V,MDNUM1_SETIM_M
   END INTERFACE
...
ELEMENTAL    FUNCTION MDNUM1_GEM_ORO(A,B,C)&
   ...
   FUNCTION MDNUM1_DOT_PRODUCT_MDNUM1(LHS,RHS)&
      RESULT(RES)
      IMPLICIT NONE
      TYPE(MDNUM1), INTENT(IN) :: LHS(:)
      TYPE(MDNUM1), INTENT(IN) :: RHS(SIZE(LHS))
      TYPE(MDNUM1) :: RES
   ...
   END FUNCTION MDNUM1_DOT_PRODUCT_MDNUM1

   FUNCTION R_DOT_PRODUCT_MDNUM1(LHS,RHS)&
      RESULT(RES)
      IMPLICIT NONE
      REAL(DP), INTENT(IN) :: LHS(:)
      TYPE(MDNUM1), INTENT(IN) :: RHS(SIZE(LHS))
   ...
   END FUNCTION R_DOT_PRODUCT_MDNUM1

   FUNCTION MDNUM1_DOT_PRODUCT_R(LHS,RHS)&
      RESULT(RES)
      IMPLICIT NONE
      TYPE(MDNUM1), INTENT(IN) :: LHS(:)
   ...
   END FUNCTION MDNUM1_DOT_PRODUCT_R
...
FUNCTION MDNUM1_TO_CR_MAT_M(VAL) RESULT(RES)
   ...
   END FUNCTION MDNUM1_TO_CR_MAT_M
      ...
      SUBROUTINE MDNUM1_SETIM_S(VAL,IDX,RES)
      IMPLICIT NONE
      TYPE(MDNUM1), INTENT(INOUT) :: VAL
      ...
      END SELECT
   END SUBROUTINE MDNUM1_SETIM_S

      SUBROUTINE MDNUM1_SETIM_V(VAL,IDX,RES)
      IMPLICIT NONE
      TYPE(MDNUM1), INTENT(INOUT) :: VAL(:)
      ...
      END SELECT
   END SUBROUTINE MDNUM1_SETIM_V

      SUBROUTINE MDNUM1_SETIM_M(VAL,IDX,RES)
      IMPLICIT NONE
      TYPE(MDNUM1), INTENT(INOUT) :: VAL(:,:)
      ...
      END SELECT
   END SUBROUTINE MDNUM1_SETIM_M

FUNCTION MDNUM1_GETIM_S(VAL,IDX) RESULT(RES)
      IMPLICIT NONE
      TYPE(MDNUM1), INTENT(IN) :: VAL
      REAL(DP) :: RES 
      INTEGER, INTENT(IN) :: IDX
      ...
      END SELECT
   END FUNCTION MDNUM1_GETIM_S

FUNCTION MDNUM1_GETIM_V(VAL,IDX) RESULT(RES)
      IMPLICIT NONE
      TYPE(MDNUM1), INTENT(IN) :: VAL(:)
      ...
      END SELECT
   END FUNCTION MDNUM1_GETIM_V

FUNCTION MDNUM1_GETIM_M(VAL,IDX) RESULT(RES)
      IMPLICIT NONE
      TYPE(MDNUM1), INTENT(IN) :: VAL(:,:)
      ...
      END SELECT
   END FUNCTION MDNUM1_GETIM_M

   SUBROUTINE MDNUM1_PPRINT_S(VAR,FMT,UNIT)
      IMPLICIT NONE
      TYPE(MDNUM1), INTENT(IN) :: VAR
   ...
   END SUBROUTINE MDNUM1_PPRINT_S

   SUBROUTINE MDNUM1_PPRINT_V(VAR,FMT,UNIT)
      IMPLICIT NONE
      TYPE(MDNUM1), INTENT(IN) :: VAR(:)
      CHARACTER(len=*), INTENT(IN), OPTIONAL :: fmt
      INTEGER, INTENT(IN), OPTIONAL :: unit
   ...
   END SUBROUTINE MDNUM1_PPRINT_V

   SUBROUTINE MDNUM1_PPRINT_M(VAR,FMT,UNIT)
      IMPLICIT NONE
      TYPE(MDNUM1), INTENT(IN) :: VAR(:,:)
      CHARACTER(len=*), INTENT(IN), OPTIONAL :: fmt
      INTEGER, INTENT(IN), OPTIONAL :: unit
   ...
   END SUBROUTINE MDNUM1_PPRINT_M
  ...
  !!
  !***************************************************************************************************!
  PURE FUNCTION MDNUM1_det2x2(A) RESULT(det)

    IMPLICIT NONE

    TYPE(MDNUM1), INTENT(IN) :: A(2,2)   !! Matrix
    TYPE(MDNUM1)             :: det
  ...
  !!
  !***************************************************************************************************!
  PURE FUNCTION MDNUM1_det3x3(A) RESULT(det)
      
    IMPLICIT NONE

    TYPE(MDNUM1), INTENT(IN) :: A(3,3)   !! Matrix
    TYPE(MDNUM1)             :: det
  ...
  !!
  !***************************************************************************************************!
  PURE FUNCTION MDNUM1_det4x4(A) RESULT(det)
      
    IMPLICIT NONE

    TYPE(MDNUM1), INTENT(IN) :: A(4,4)   !! Matrix
    TYPE(MDNUM1)             :: det
  ...
  !!
  !***************************************************************************************************!
  PURE FUNCTION MDNUM1_cross3(a,b) RESULT(v)
      
    IMPLICIT NONE 

    TYPE(MDNUM1), DIMENSION (3),INTENT(IN) :: a,b
    TYPE(MDNUM1), DIMENSION (3) :: v
    
    v(1) = a(2) * b(3) - a(3) * b(2)
    v(2) = a(3) * b(1) - a(1) * b(3)
    v(3) = a(1) * b(2) - a(2) * b(1)

  END FUNCTION MDNUM1_cross3
  !===================================================================================================! 
  ...
  !!
  !***************************************************************************************************!
  FUNCTION MDNUM1_norm2_3(v) RESULT(n)
     
    IMPLICIT NONE 

    TYPE(MDNUM1), INTENT(IN) :: v(3)
    TYPE(MDNUM1) :: n
     
    n = SQRT( v(1)*v(1) + v(2)*v(2) + v(3)*v(3) )

  END FUNCTION MDNUM1_norm2_3
  !===================================================================================================! 
  ...
  END FUNCTION MDNUM1_SQRT
   ...
   FUNCTION MDNUM1_INV2X2(A,det)&
      RESULT(RES)
      IMPLICIT NONE
      TYPE(MDNUM1) , INTENT(IN) :: A(2,2) 
      TYPE(MDNUM1) , INTENT(IN), OPTIONAL :: det
      REAL(DP) :: detCalc
      TYPE(MDNUM1) :: RES(SIZE(A,1),SIZE(A,2)) 
   ...
   END FUNCTION MDNUM1_INV2X2

   FUNCTION MDNUM1_INV3X3(A,det)&
      RESULT(RES)
      IMPLICIT NONE
      TYPE(MDNUM1) , INTENT(IN) :: A(3,3) 
      TYPE(MDNUM1) , INTENT(IN), OPTIONAL :: det
      REAL(DP) :: detCalc
      TYPE(MDNUM1) :: RES(SIZE(A,1),SIZE(A,2)) 
   ...
   END FUNCTION MDNUM1_INV3X3

   FUNCTION MDNUM1_INV4X4(A,det)&
      RESULT(RES)
      IMPLICIT NONE
      TYPE(MDNUM1) , INTENT(IN) :: A(4,4) 
      TYPE(MDNUM1) , INTENT(IN), OPTIONAL :: det
      REAL(DP) :: detCalc
      TYPE(MDNUM1) :: RES(SIZE(A,1),SIZE(A,2)) 
