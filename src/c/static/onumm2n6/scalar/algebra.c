...
onumm2n6_t onumm2n6_div_ro(coeff_t num, onumm2n6_t* den){
    ...
    onumm2n6_t inv = onumm2n6_pow(den,-1);
    onumm2n6_t res = onumm2n6_mul_ro(num,&inv);
...
onumm2n6_t onumm2n6_div_oo(onumm2n6_t* num, onumm2n6_t* den){
    ...
    onumm2n6_t res = onumm2n6_mul_oo(num,&inv);
...
onumm2n6_t onumm2n6_div_or(onumm2n6_t* num, coeff_t val){
    ...
    return onumm2n6_mul_ro(1.0/val,num);
...
onumm2n6_t onumm2n6_feval(coeff_t* feval_re, onumm2n6_t* x){
  ...
  onumm2n6_t deltax = (*x), deltax_power = (*x);
  deltax.r = 0.0;
  deltax_power.r = 0.0;
  onumm2n6_set_r(0.0, &res);
  //  Real
  res.r = feval_re[0];
  // Order 1
  factor *=1;
  coef    = feval_re[1]/ factor;;
  onumm2n6_gem_ro_to( coef, &deltax_power, &res, &res);
  deltax_power = onumm2n6_mul_oo(&deltax_power,&deltax);
  // Order 2
  factor *=2;
