...
ord_t feonumm9n2_get_order( feonumm9n2_t* num ){
    ...
    for( i = 0; i<num->nip; i++ ){
        ...
        order = MAX(order, onumm9n2_get_order(&num->p_data[i]) );
...
void feonumm9n2_get_order_im_to( ord_t order, feonumm9n2_t* num, feonumm9n2_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm9n2_get_order_im_to( order, &num->p_data[k], &res->p_data[k]);
...
feonumm9n2_t feonumm9n2_get_order_im( ord_t order, feonumm9n2_t* num){
    ...
    res = feonumm9n2_zeros( num->nip);

    feonumm9n2_get_order_im_to( order, num, &res);
...
void feonumm9n2_extract_im_to( imdir_t idx, ord_t order, feonumm9n2_t* num, feonumm9n2_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm9n2_extract_im_to( idx, order, &num->p_data[k], &res->p_data[k]);
...
feonumm9n2_t feonumm9n2_extract_im( imdir_t idx, ord_t order, feonumm9n2_t* num){
    ...
    feonumm9n2_extract_im_to( idx, order, num, &res);
...
void feonumm9n2_extract_deriv_to( imdir_t idx, ord_t order, feonumm9n2_t* num, feonumm9n2_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm9n2_extract_deriv_to( idx, order, &num->p_data[k], &res->p_data[k]);
...
feonumm9n2_t feonumm9n2_extract_deriv( imdir_t idx, ord_t order, feonumm9n2_t* num){
    ...
    feonumm9n2_extract_deriv_to( idx, order, num, &res);
...
void feonumm9n2_get_deriv_to( imdir_t idx, ord_t order, feonumm9n2_t* num, feonumm9n2_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm9n2_get_deriv_to( idx, order, &num->p_data[k], &res->p_data[k]);
...
feonumm9n2_t feonumm9n2_get_deriv( imdir_t idx, ord_t order, feonumm9n2_t* num){
    ...
    feonumm9n2_get_deriv_to( idx, order, num, &res);
...
void feonumm9n2_get_im_to( imdir_t idx, ord_t order, feonumm9n2_t* num, feonumm9n2_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm9n2_get_im_to_o( idx, order, &num->p_data[k], &res->p_data[k]);
...
feonumm9n2_t feonumm9n2_get_im( imdir_t idx, ord_t order, feonumm9n2_t* num){
    ...
    feonumm9n2_get_im_to( idx, order, num, &res);
...
void feonumm9n2_truncate_im_to( imdir_t idx, ord_t order, feonumm9n2_t* num,  feonumm9n2_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm9n2_truncate_im_to( idx, order, &num->p_data[k], &res->p_data[k]);
...
feonumm9n2_t feonumm9n2_truncate_im( imdir_t idx, ord_t order, feonumm9n2_t* num){
    ...
    feonumm9n2_truncate_im_to( idx, order, num, &res);
...
void feonumm9n2_set_im_r( coeff_t val, imdir_t idx, ord_t order, feonumm9n2_t* num){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm9n2_set_im_r( val, idx, order, &num->p_data[k]);
...
void feonumm9n2_set_im_o( onumm9n2_t* val, imdir_t idx, ord_t order, feonumm9n2_t* num){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm9n2_set_im_o( val, idx, order, &num->p_data[k]);
...
void feonumm9n2_set_im_f( feonumm9n2_t* val, imdir_t idx, ord_t order, feonumm9n2_t* num){
    ...
    feonumm9n2_dimCheck(val,num);

    for (k = 0; k<num->nip; k++ ){
        
        onumm9n2_set_im_o( &val->p_data[k], idx, order, &num->p_data[k]);
...
void feonumm9n2_set_deriv_r( coeff_t val, imdir_t idx, ord_t order, feonumm9n2_t* num){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm9n2_set_deriv_r( val, idx, order, &num->p_data[k]);
...
void feonumm9n2_set_deriv_o( onumm9n2_t* val, imdir_t idx, ord_t order, feonumm9n2_t* num){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm9n2_set_deriv_o( val, idx, order, &num->p_data[k]);
...
void feonumm9n2_set_deriv_f( feonumm9n2_t* val, imdir_t idx, ord_t order, feonumm9n2_t* num){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm9n2_set_deriv_o( &val->p_data[k], idx, order, &num->p_data[k]);
...
// ****************************************************************************************************
void feonumm9n2_set_to( feonumm9n2_t* src, feonumm9n2_t* dst){
    
    uint64_t i;

    feonumm9n2_dimCheck(src,dst);

    for (i = 0; i<src->nip; i++ ){
        
        onumm9n2_copy_to( &src->p_data[i], &dst->p_data[i]);
...
feonumm9n2_t feonumm9n2_copy( feonumm9n2_t* src){
    ...
    res = feonumm9n2_createEmpty(src->nip);

    feonumm9n2_copy_to( src, &res);
...
void feonumm9n2_set_o( onumm9n2_t* num, feonumm9n2_t* res){
    ...
    for (i = 0; i<res->nip; i++ ){
        ...
        onumm9n2_set_o( num, &res->p_data[i]);
...
void feonumm9n2_set_r( coeff_t num, feonumm9n2_t* res){
    ...
    for (i = 0; i<res->nip; i++ ){
        ...
        onumm9n2_set_r( num, &res->p_data[i]);
...
void feonumm9n2_set_item_k_o( onumm9n2_t* num, uint64_t k, feonumm9n2_t* res){
    ...
    if (k < res->nip){
        ...
        onumm9n2_set_o(num, &res->p_data[k]); 

    } else {

        printf("ERROR: Index out of bounds in feonumm9n2_get_item_k.\n");
...
void feonumm9n2_set_item_k_r(   coeff_t  num, uint64_t k, feonumm9n2_t* res){
    ...
    if (k < res->nip){
        ...
        onumm9n2_set_r(num, &res->p_data[k]); 
...
void feonumm9n2_get_item_k_to(feonumm9n2_t* num, uint64_t k, onumm9n2_t* res){
    ...
    if (k < num->nip){
        ...
        onumm9n2_copy_to( &num->p_data[k], res);
...
// ****************************************************************************************************
feonumm9n2_t feonumm9n2_zeros(uint64_t nip){

    feonumm9n2_t  res  = feonumm9n2_createEmpty(nip);
    
    feonumm9n2_set_r( 0.0, &res);
...
// ****************************************************************************************************
inline feonumm9n2_t feonumm9n2_createEmpty(uint64_t nip){

    feonumm9n2_t  res ;  
    void * memory = NULL;

    // Allocate memory and check if correctly allocated.
    memory = malloc( nip * sizeof( onumm9n2_t ) );

    if ( memory == NULL ){
        printf("ERROR: Not enough memory to handle array of feonumm9n2.\n Exiting...\n");
        exit(OTI_OutOfMemory); // TODO: Raise error instead of quitting the program.
    }
    
    res.p_data = ( onumm9n2_t* ) memory;
    res.nip = nip;
...
// ****************************************************************************************************
inline feonumm9n2_t feonumm9n2_init(void){
...
// ****************************************************************************************************
inline feonumm9n2_t feonumm9n2_empty_like(feonumm9n2_t* arr){

    feonumm9n2_t res = feonumm9n2_createEmpty(arr->nip);
