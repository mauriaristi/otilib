...
cdef class lil_mdmat5:
  ...
  def __init__(self, shape): 
    """
    PURPOSE:      Python level constructor of the lil_mdmat5 class.

    DESCRIPTION:  Creates a new empty lil_mdmat5 matrix.
  ...
  def copy(self):
    ...
    cdef lil_mdmat5 res = lil_mdmat5(self.shape)
    cdef uint64_t i, k
  ...
  def tocsr(self):
    ...
    """
    return csr_mdmat5(self,shape=self.shape)
