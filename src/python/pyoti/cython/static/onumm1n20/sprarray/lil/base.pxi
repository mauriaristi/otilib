  ...
  cpdef get_deriv(self, object hum_dir ):
    ...
    for i in range(self.nrows):
      ...
      for j in range(len(self.data[i])):
        ...
        ores = res.data[i][j]
        oval = self.data[i][j]
        onumm1n20_get_deriv_to( indx, order, &oval.num, &ores.num)
  ...
  cpdef get_im(self, object hum_dir ):
    ...
    for i in range(self.nrows):
      ...
      for j in range(len(self.data[i])):
        ...
        ores = res.data[i][j]
        oval = self.data[i][j]
        onumm1n20_get_im_to_o( indx, order, &oval.num, &ores.num)
  ...
  cpdef extract_im(self, object hum_dir):
    ...
    for i in range(self.nrows):
      ...
      for j in range(len(self.data[i])):
        ...
        ores = res.data[i][j]
        oval = self.data[i][j]
        onumm1n20_extract_im_to( indx, order, &oval.num, &ores.num)
  ...
  cpdef  extract_deriv(self, object hum_dir):
    ...
    for i in range(self.nrows):
      ...
      for j in range(len(self.data[i])):
        ...
        ores = res.data[i][j]
        oval = self.data[i][j]
        onumm1n20_extract_deriv_to( indx, order, &oval.num, &ores.num)
  ...
  cpdef  get_order_im(self, ord_t order):
    ...
    for i in range(self.nrows):
      ...
      for j in range(len(self.data[i])):
        ...
        ores = res.data[i][j]
        oval = self.data[i][j]
        onumm1n20_get_order_im_to( order, &oval.num, &ores.num)
  ...
  cpdef  truncate( self, object hum_dir):
    ...
    for i in range(self.nrows):
      ...
      for j in range(len(self.data[i])):
        ...
        ores = res.data[i][j]
        oval = self.data[i][j]
        onumm1n20_truncate_im_to( indx, order, &oval.num, &ores.num)
  ...
  def get_active_bases(self):
    ...
    for i in range(self.nrows):
      ...
      for j in range(len(self.data[i])):
        ...
        oval = self.data[i][j]
        onumm1n20_get_active_bases( &oval.num, bases_list)
