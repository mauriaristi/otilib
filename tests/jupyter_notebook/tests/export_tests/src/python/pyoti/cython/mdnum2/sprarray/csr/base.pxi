...
cdef class csr_mdarr2_t:
  ...
  def __init__(self, arg1, shape=None, copy = True): 
    """
    PURPOSE:      Python level constructor of the csr_mdarr2_t class.

    DESCRIPTION:  Creates a new empty csr_mdarr2_t matrix.
                 
    """
    #*************************************************************************************************
    
    cdef uint64_t i, j, k, ncols, nrows
    cdef lil_mdarr2_t lil
    
    targ1 = type(arg1)

    if targ1 == lil_mdarr2_t :
      ...
      if len(arg1) == 3: # Same as in scipy csr sparse.
        ...
        for i in range(data.size):
          ...
          if type(data) == mdnum2_t:

            self.data[i] = data[i].copy()

          else:
            
            self.data[i] = mdnum2_t( data[i] )
  ...
  def copy(self):
    ...
    cdef csr_mdarr2_t res = <csr_mdarr2_t> csr_mdarr2_t.__new__(csr_mdarr2_t)
    cdef object[:]   data
  ...
  def __pow__(self, n,z):
    ...
    cdef mdnum2_t ores, oval
    cdef uint64_t i
    cdef csr_mdarr2_t res
    ...
    for i in range(self.data.size):
      ...
      ores = res.data[i]
      oval = self.data[i]
      mdnum2_pow_to( &oval.num, n, &ores.num)
  ...
  cpdef get_deriv(self, object hum_dir ):
    ...
    for i in range(self.data.size):
      ...
      ores = res.data[i]
      oval = self.data[i]
      mdnum2_get_deriv_to( indx, order, &oval.num, &ores.num)
  ...
  cpdef get_im(self, object hum_dir ):
    ...
    for i in range(self.data.size):
      ...
      ores = res.data[i]
      oval = self.data[i]
      mdnum2_get_im_to_o( indx, order, &oval.num, &ores.num)
  ...
  cpdef extract_im(self, object hum_dir):
    """
    PURPOSE: Get the corresponding imaginary direction in the mdarr2_t object.
    """
    #*************************************************************************************************
    ...
    for i in range(self.data.size):
      ...
      ores = res.data[i]
      oval = self.data[i]
      mdnum2_extract_im_to( indx, order, &oval.num, &ores.num)
  ...
  cpdef  extract_deriv(self, object hum_dir):
    ...
    for i in range(self.data.size):
      ...
      ores = res.data[i]
      oval = self.data[i]
      mdnum2_extract_deriv_to( indx, order, &oval.num, &ores.num)
  ...
  cpdef  get_order_im(self, ord_t order):
    ...
    for i in range(self.data.size):
      ...
      ores = res.data[i]
      oval = self.data[i]
      mdnum2_get_order_im_to( order, &oval.num, &ores.num)
  ...
  cpdef  truncate( self, object hum_dir):
    ...
    for i in range(self.data.size):
      ...
      ores = res.data[i]
      oval = self.data[i]
      mdnum2_truncate_im_to( indx, order, &oval.num, &ores.num)
  ...
  def get_active(self):
    ...
    for i in range(self.data.size):
      ...
      oval = self.data[i]
      mdnum2_get_active( &oval.num, bases_list)
...
# ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
# :::::::::::::::::::::::::::::::::::: END OF CLASS csr_mdarr2_t ::::::::::::::::::::::::::::::::::::::::
# ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::

# ****************************************************************************************************
cdef void csrmdarr2_t_matmul_SO_to(csr_mdarr2_t lhs, mdarr2_t rhs, mdarr2_t res):
  """
  ...
  for i in range(lhs.nrows):
    ...
    for j in range(rhs.ncols):
      ...
      for l in range( lhs.indptr[i], lhs.indptr[i+1] ):
        ...
        mdnum2_gem_oo_to( &olhs.num,
                        &rhs.arr.p_data[ j + k * rhs.ncols ],
                        &tmp, &tmp)

      # end for

      mdarr2_set_item_ij_o( &tmp, i, j, &res.arr)
...
# ****************************************************************************************************
cdef mdarr2_t csrmdarr2_t_matmul_SO(csr_mdarr2_t lhs, mdarr2_t rhs):
  """
  PORPUSE:  Perform matrix-matrix multiplication between csr matrix and dense matrix.
  ...
  csrmdarr2_t_matmul_SO_to( lhs, rhs, res)
