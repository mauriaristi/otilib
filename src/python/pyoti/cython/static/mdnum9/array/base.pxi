...
cdef class mdmat9:
  ...
  def __init__(self, realArray): 
    """
    PURPOSE:      Python level constructor of the mdmat9 class.
    ...
    if isinstance( realArray, np.ndarray):
      ...
      if ( ndim >= 3 ):
        ...
        self.arr = mdarr9_zeros( nrows, ncols)

        for i in range(self.arr.nrows):
      
          val = realArray[i]
          mdarr9_set_item_i_r( val, i, &self.arr)
        ...
        for i in range(self.arr.nrows):      
          for j in range(self.arr.ncols):
            ...
            val = realArray[i,j]
            mdarr9_set_item_ij_r( val, i, j, &self.arr)
  ...
  def order(self): 
    ...
    return mdarr9_get_order(&self.arr)
  ...
  #***************************************************************************************************
  @staticmethod
  cdef mdmat9 create(mdarr9_t* arr, uint8_t FLAGS = 1):
    """
    ...
    cdef mdmat9 mat = <mdmat9> mdmat9.__new__(mdmat9)
  ...
  def __repr__(self):
    ...
    #   out += "["
    #   for j in range(self.arr.ncols):
    #     d_mdnum9 = mdarr9_get_item_ij(&self.arr, i, j)
    #     out+= (mdnum9.create(&d_mdnum9,FLAGS=0)).__str__()+", "
    #   # end for 
    #   out = out[:-2] + "],\n"
    # # end for 
    # out =out[:-2] + "]"
  ...
  def  __getitem__(self, val):
    ...
    if tval == int:
      ...
      if val < self.arr.nrows:
        ...
        Ores = mdarr9_get_slice( &self.arr, starti, stopi, stepi, startj, stopj, stepj)
        res  = mdmat9.create(&Ores)
  ...
  cdef __setitem__r(self, object val, coeff_t value):
    ...
    if tval == int:
      ...
      if val < self.arr.nrows:
        ...
        mdarr9_set_slice_r( value, starti, stopi, stepi, startj, stopj, stepj, &self.arr)
      ...
      if len(val) == 2:
        ...
        if ( tval0 == int and tval1 == int ):
          ...
          if val[0] < self.arr.nrows and val[1] < self.arr.ncols:
            ...
            mdarr9_set_item_ij_r( value, val[0], val[1], &self.arr)
  ...
  cdef __setitem__o(self,  object val, mdnum9 value):
    ...
    if tval == int:
      ...
      if val < self.arr.nrows:
        ...
        mdarr9_set_slice_o( &value.num, starti, stopi, stepi, startj, stopj, stepj, &self.arr)
      ...
      if len(val) == 2:
        ...
        if ( tval0 == int and tval1 == int ):
          ...
          if val[0] < self.arr.nrows and val[1] < self.arr.ncols:
            ...
            mdarr9_set_item_ij_o( &value.num, val[0], val[1], &self.arr)
  ...
  cdef __setitem__O(self,  object val, mdmat9 value):
    ...
    if tval == int:
      ...
      if val < self.arr.nrows:
        ...
        mdarr9_set_slice_O( &value.arr, starti, stopi, stepi, startj, stopj, stepj, &self.arr)
  ...
  def copy(self):
    ...
    cdef mdarr9_t res = mdarr9_copy(&self.arr)
  ...
  def __neg__(self):
    ...
    cdef mdarr9_t res = mdarr9_neg(&self.arr)
  ...
  def __add__(self, other):
    ...
    if (tlhs == trhs):
      ...
      res = mdarr9_sum_OO(&lhs.arr,&rhs.arr)
      ...
      res = mdarr9_sum_oO(&olhs.num,&rhs.arr)
      ...
      res = mdarr9_sum_oO(&orhs.num,&lhs.arr)
    
    elif (tlhs in number_types):
      
      rhs = other
      res = mdarr9_sum_rO(self, &rhs.arr)

    elif (trhs in number_types):
        
      lhs = self
      res = mdarr9_sum_rO(other, &lhs.arr)
      ...
      res = mdarr9_sum_RO(&dlhs.arr,&rhs.arr)
      ...
      res = mdarr9_sum_RO(&drhs.arr,&lhs.arr)
  ...
  def __sub__(self, other):
    ...
    if (tlhs == trhs):
      ...
      res = mdarr9_sub_OO(&lhs.arr,&rhs.arr)
      ...
      res = mdarr9_sub_oO(&olhs.num,&rhs.arr)
      ...
      res = mdarr9_sub_Oo(&lhs.arr, &orhs.num)
    
    elif (tlhs in number_types):
      
      rhs = other
      res = mdarr9_sub_rO(self, &rhs.arr)

    elif (trhs in number_types):
        
      lhs = self
      res = mdarr9_sub_Or(&lhs.arr, other)
      ...
      res = mdarr9_sub_RO(&dlhs.arr,&rhs.arr)
      ...
      res = mdarr9_sub_OR(&lhs.arr, &drhs.arr)
  ...
  def __mul__(self, other):
    ...
    if (tlhs == trhs):
      ...
      res = mdarr9_mul_OO(&lhs.arr,&rhs.arr)
      ...
      res = mdarr9_mul_oO(&olhs.num,&rhs.arr)
      ...
      res = mdarr9_mul_oO(&orhs.num,&lhs.arr)
    
    elif (tlhs in number_types):
      
      rhs = other
      res = mdarr9_mul_rO(self, &rhs.arr)

    elif (trhs in number_types):
        
      lhs = self
      res = mdarr9_mul_rO(other, &lhs.arr)
      ...
      res = mdarr9_mul_RO(&dlhs.arr,&rhs.arr)
      ...
      res = mdarr9_mul_RO(&drhs.arr,&lhs.arr)
  ...
  def __truediv__(self, other):
    ...
    if (tlhs == trhs):
      ...
      res = mdarr9_div_OO(&lhs.arr,&rhs.arr)
      ...
      res = mdarr9_div_oO(&olhs.num,&rhs.arr)
      ...
      res = mdarr9_div_Oo(&lhs.arr, &orhs.num)
    
    elif (tlhs in number_types):
      
      rhs = other
      res = mdarr9_div_rO(self, &rhs.arr)

    elif (trhs in number_types):
        
      lhs = self
      res = mdarr9_div_Or(&lhs.arr, other)
      ...
      res = mdarr9_div_RO(&dlhs.arr,&rhs.arr)
      ...
      res = mdarr9_div_OR(&lhs.arr, &drhs.arr)
  ...
  cpdef get_deriv(self, object hum_dir):
    """
    PURPOSE: Get the corresponding imaginary direction in the mdmat9 object.
    """
    #*************************************************************************************************
    ...
    res_darr = mdarr9_get_deriv( item[ZERO],  item[ONE], &self.arr)
  ...
  cpdef get_im(self, object hum_dir):
    ...
    res_darr = mdarr9_get_im( item[ZERO],  item[ONE], &self.arr)
  ...
  cpdef extract_im(self, object hum_dir):
    ...
    res = mdarr9_extract_im( item[ZERO],  item[ONE], &self.arr)
  ...
  cpdef  extract_deriv(self, object hum_dir):
    ...
    res = mdarr9_extract_deriv( item[ZERO],  item[ONE], &self.arr)
  ...
  cpdef  get_order_im(self, ord_t order):
    ...
    res = mdarr9_get_order_im( order, &self.arr)
  ...
  cpdef  truncate( self, object humdir):
    ...
    res = mdarr9_truncate_im( indx, order, &self.arr) 
  ...
  cpdef set(self, object rhs):
    ...
    if   trhs is mdnum9:
      ...
      orhs = rhs
      mdarr9_set_o( &orhs.num, &self.arr)

    elif trhs is mdmat9:

      Orhs = rhs
      mdarr9_set_O( &Orhs.arr, &self.arr)      

    elif trhs in number_types:

      rrhs = rhs
      mdarr9_set_r( rrhs, &self.arr)

    else:

      raise ValueError( "Cant assign '{0}' into a mdmat9 object.".format(trhs) )
  ...
  def get_active_bases(self):
    ...
    mdarr9_get_active_bases( &self.arr, bases_list)
  ...
  def taylor_integrate(self, object bases, object deltas):
    ...
    res = mdarr9_taylor_integrate( c_deltas, &self.arr)
  ...
  #***************************************************************************************************
  @staticmethod
  def dot( mdmat9 lhs, mdmat9 rhs, mdmat9 out = None): 
    """
    ...
    if out is not None:
      ...
      mdarr9_matmul_OO_to( &lhs.arr, &rhs.arr ,&out.arr)

    else:

      res = mdarr9_matmul_OO( &lhs.arr, &rhs.arr )
  ...
  #***************************************************************************************************
  @staticmethod
  def inv( mdmat9 arr,  mdmat9 out = None): 
    """
    ...
    if out is not None:
      ...
      mdarr9_invert_to( &arr.arr,&out.arr)

    else:

      res = mdarr9_invert( &arr.arr)
  ...
  #***************************************************************************************************
  @staticmethod
  def transpose( mdmat9 arr,  mdmat9 out = None ): 
    """
    ...
    if out is not None:
      ...
      mdarr9_transpose_to( &arr.arr, &out.arr)

    else:

      res = mdarr9_transpose( &arr.arr)
  ...
  #***************************************************************************************************
  @staticmethod
  def add( mdmat9 lhs, mdmat9 rhs, mdmat9 out = None): 
    """
    ...
    if out is not None:
      ...
      mdarr9_sum_OO_to( &lhs.arr, &rhs.arr ,&out.arr)
