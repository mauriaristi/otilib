...
SUBROUTINE oarrm2n2_div_aa_f(lhs,rhs,res) BIND(C)

   IMPLICIT NONE

   TYPE(oarrm2n2_t), INTENT(IN)  :: lhs 
   TYPE(oarrm2n2_t), INTENT(IN)  :: rhs
   TYPE(oarrm2n2_t), INTENT(INOUT) :: res 
   TYPE(onumm2n2), POINTER :: lhsarray(:), resarray(:), rhsarray(:)
   INTEGER :: i
...
END SUBROUTINE oarrm2n2_div_aa_f

SUBROUTINE oarrm2n2_mul_aa_f(lhs,rhs,res) BIND(C)
...
END SUBROUTINE oarrm2n2_mul_aa_f
...
SUBROUTINE oarrm2n2_sqrt_f(lhs,res) BIND(C)
...
END SUBROUTINE oarrm2n2_sqrt_f
