...
void onumm2n10_set_im_o(onumm2n10_t* num, imdir_t idx, ord_t order, onumm2n10_t* res){
    onumm2n10_set_item(num->r,idx,order,res);
}
...
void onumm2n10_get_im_to_o(imdir_t idx, ord_t order, onumm2n10_t* num, onumm2n10_t* res){
    coeff_t rres = onumm2n10_get_item(idx, order, num);
    onumm2n10_set_r(rres,res);
}
...
void onumm2n10_get_im_to_r(imdir_t idx, ord_t order, onumm2n10_t* num, coeff_t* res){
    *res = onumm2n10_get_item(idx, order, num);
}

inline ord_t onumm2n10_get_order(onumm2n10_t* lhs){
...
onumm2n10_t onumm2n10_get_deriv_o( imdir_t idx, ord_t order, onumm2n10_t* num){
    ...
    onumm2n10_get_deriv_to( idx, order, num, &res);
...
void onumm2n10_get_deriv_to( imdir_t idx, ord_t order, onumm2n10_t* num, onumm2n10_t* res){
    ...
    coeff_t deriv = onumm2n10_get_deriv(idx,order,num);

    onumm2n10_set_r( deriv, res);

}

void onumm2n10_set_im_r(coeff_t num, imdir_t idx, ord_t order, onumm2n10_t* res){

    onumm2n10_set_item(num, idx,order,res);
  ...
  switch (order){
    ...
    case 10:
      switch (idx){
        ...
        case 1:
          factor = 3.6288000000000000e+05;
          res = lhs->e1111111112*factor;
          break;
        case 2:
          factor = 8.0640000000000000e+04;
          res = lhs->e1111111122*factor;
          break;
        case 3:
          factor = 3.0240000000000000e+04;
          res = lhs->e1111111222*factor;
          break;
        case 4:
          factor = 1.7280000000000000e+04;
          res = lhs->e1111112222*factor;
          break;
        case 5:
          factor = 1.4400000000000000e+04;
          res = lhs->e1111122222*factor;
          break;
        case 6:
          factor = 1.7280000000000000e+04;
          res = lhs->e1111222222*factor;
          break;
        case 7:
          factor = 3.0240000000000000e+04;
          res = lhs->e1112222222*factor;
          break;
        case 8:
          factor = 8.0640000000000000e+04;
          res = lhs->e1122222222*factor;
          break;
        case 9:
          factor = 3.6288000000000000e+05;
          res = lhs->e1222222222*factor;
          break;
        case 10:
          factor = 3.6288000000000000e+06;
          res = lhs->e2222222222*factor;
          break;
      }
      break;
  }
...
onumm2n10_t onumm2n10_taylor_integrate(coeff_t* deltas,onumm2n10_t* lhs){
  ...
  // Order 10;
  factor = pow(deltas[0],10)*pow(deltas[1],0);
  res.r += factor*lhs->e1111111111;
  factor = pow(deltas[0],9)*pow(deltas[1],1);
  res.r += factor*lhs->e1111111112;
  factor = pow(deltas[0],8)*pow(deltas[1],2);
  res.r += factor*lhs->e1111111122;
  factor = pow(deltas[0],7)*pow(deltas[1],3);
  res.r += factor*lhs->e1111111222;
  factor = pow(deltas[0],6)*pow(deltas[1],4);
  res.r += factor*lhs->e1111112222;
  factor = pow(deltas[0],5)*pow(deltas[1],5);
  res.r += factor*lhs->e1111122222;
  factor = pow(deltas[0],4)*pow(deltas[1],6);
  res.r += factor*lhs->e1111222222;
  factor = pow(deltas[0],3)*pow(deltas[1],7);
  res.r += factor*lhs->e1112222222;
  factor = pow(deltas[0],2)*pow(deltas[1],8);
  res.r += factor*lhs->e1122222222;
  factor = pow(deltas[0],1)*pow(deltas[1],9);
  res.r += factor*lhs->e1222222222;
  factor = pow(deltas[0],0)*pow(deltas[1],10);
  res.r += factor*lhs->e2222222222;
...
void onumm2n10_print(  onumm2n10_t* lhs){
  ...
  printf(" %+.8g*e1111111112",lhs->e1111111112);
  printf(" %+.8g*e1111111122",lhs->e1111111122);
  printf(" %+.8g*e1111111222",lhs->e1111111222);
  printf(" %+.8g*e1111112222",lhs->e1111112222);
  printf(" %+.8g*e1111122222",lhs->e1111122222);
  printf(" %+.8g*e1111222222",lhs->e1111222222);
  printf(" %+.8g*e1112222222",lhs->e1112222222);
  printf(" %+.8g*e1122222222",lhs->e1122222222);
  printf(" %+.8g*e1222222222",lhs->e1222222222);
  printf(" %+.8g*e2222222222",lhs->e2222222222);
  printf("\n");
