...
cdef class lil_mdarr2_t:
  ...
  def __init__(self, shape): 
    """
    PURPOSE:      Python level constructor of the lil_mdarr2_t class.

    DESCRIPTION:  Creates a new empty lil_mdarr2_t matrix.
  ...
  def copy(self):
    ...
    cdef lil_mdarr2_t res = lil_mdarr2_t(self.shape)
    cdef uint64_t i, k
  ...
  def tocsr(self):
    ...
    """
    return csr_mdarr2_t(self,shape=self.shape)
