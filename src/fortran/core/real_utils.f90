...
CONTAINS
   ...
   SUBROUTINE RPrint(val,fmt, unit, advance)
      ...
      write(unt,output_format,advance=advance_option) val
   ...
   !!
   !***************************************************************************************************! 
   SUBROUTINE RmatPrint(arr,fmt,unit,advance)
      IMPLICIT NONE
   ...
   !!
   !***************************************************************************************************! 
   SUBROUTINE RvecPrint(arr,fmt, unit, advance)
      IMPLICIT NONE
      REAL(dp),   INTENT(IN) :: arr(:)
      CHARACTER(len=*), INTENT(IN), OPTIONAL :: fmt
      CHARACTER(len=*), INTENT(IN), OPTIONAL :: advance
   ...
   !!
   !***************************************************************************************************! 
   SUBROUTINE IPrint(val,fmt,unit,advance)
      IMPLICIT NONE
   ...
   !!
   !***************************************************************************************************! 
   SUBROUTINE ImatPrint(arr,fmt,unit,advance)
      IMPLICIT NONE
   ...
   !!
   !***************************************************************************************************! 
   SUBROUTINE IvecPrint(arr,fmt,unit,advance)
      IMPLICIT NONE
      INTEGER,   INTENT(IN) :: arr(:)
      CHARACTER(len=*), INTENT(IN), OPTIONAL :: fmt
      CHARACTER(len=*), INTENT(IN), OPTIONAL :: advance
