...
cdef class lil_omatm2n5:
  ...
  def __init__(self, shape): 
    """
    PURPOSE:      Python level constructor of the lil_omatm2n5 class.

    DESCRIPTION:  Creates a new empty lil_omatm2n5 matrix.
  ...
  def copy(self):
    ...
    cdef lil_omatm2n5 res = lil_omatm2n5(self.shape)
    cdef uint64_t i, k
  ...
  def tocsr(self):
    ...
    """
    return csr_omatm2n5(self,shape=self.shape)
