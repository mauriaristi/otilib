...
cdef class onumm3n2:
  ...
  def __init__(self, coeff_t re_coeff):
    ...
    self.num = onumm3n2_create_r(re_coeff)
  ...
  def  order(self): 
    ...
    return onumm3n2_get_order(&self.num)
  ...
  #***************************************************************************************************
  @staticmethod
  cdef onumm3n2 create( onumm3n2_t* num, uint8_t FLAGS = 1 ):
    """
    ...
    cdef onumm3n2 otin = <onumm3n2> onumm3n2.__new__(onumm3n2)

    otin.num     = onumm3n2_copy(num)
  ...
  def __repr__(self):
    """
    PURPOSE:  To print a representation of the onumm3n2 object in a compact form.
    """
    #*************************************************************************************************
    ...
    for ordi in range(1,self.order+1):
      ...
      for i in range( onumm3n2_get_ndir_order(ordi,&self.num) ):
        
        idx = onumm3n2_get_indx(i, ordi) 
        num = '%+.4f'%( onumm3n2_get_item(idx,ordi,&self.num) )
  ...
  def short_repr(self):
    ...
    head = 'onumm3n2('
    body = str(self.num.r) + ", nnz: " + str(onumm3n2_get_ndir_total(&self.num)) + ', order: ' + str(self.order)
    tail = ')'
  ...
  def __str__(self):
    """
    PURPOSE: To print a representation of the onumm3n2 object that could 
  ...
  def __getitem__(self, list index):
    """
    PURPOSE:  To get the value of a onumm3n2 coefficient.
  ...
  def __setitem__(self, list item, coeff_t value):
    """
    PURPOSE:  To set the value of a onumm3n2 coefficient.
  ...
  def __add__(self, other_in):
    """
    PURPOSE:      Add onumm3n2 with other things.
  ...
  def __truediv__(self, other_in):
    """
    PURPOSE:      To define how to divide two onumm3n2 numbers.
