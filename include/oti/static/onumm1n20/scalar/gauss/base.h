#ifndef OTI_ONUMM1N20_SCALAR_GAUSS_BASE_H
#define OTI_ONUMM1N20_SCALAR_GAUSS_BASE_H
...
@param[in] num FEonumm1n20 to free
******************************************************************************************************/
...
@param[in] num FEonumm1n20
******************************************************************************************************/
ord_t feonumm1n20_get_order( feonumm1n20_t* num );
// ----------------------------------------------------------------------------------------------------

/**************************************************************************************************//**
@brief Initialize a feonumm1n20 structure.

******************************************************************************************************/
feonumm1n20_t feonumm1n20_init(void);
// ----------------------------------------------------------------------------------------------------
