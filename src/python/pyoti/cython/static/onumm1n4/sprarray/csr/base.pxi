...
cdef class csr_matrix:
    ...
    if targ1 == lil_matrix :
      ...
      for i in range(self.nrows):
        ...
        for j in range(len(lil.rows[i])):
          ...
          onumm1n4_copy_to( &onum.num, &self.arr.p_data[k])
      ...
      if len(arg1) == 3: # Same as in scipy csr sparse.
        ...
        for i in range(nnz):
          ...
          if type(data[i]) == onumm1n4:

            onum = data[i]
            onumm1n4_copy_to( &onum.num, &self.arr.p_data[i])

          else:
            
            self.arr.p_data[i] = onumm1n4_create_r( data[i] )
  ...
  def data(self): 
    ...
    return omatm1n4.create(&self.arr, FLAGS=0)
  ...
  def order(self): 
    ...
    order = oarrm1n4_get_order(&self.arr)
  ...
  def __str__(self):
    ...
    cdef onumm1n4   onum = onumm1n4(0.0)
    cdef uint64_t i, j, k
    out  = ""
  ...
  def copy(self):
    ...
    res.arr       = oarrm1n4_zeros( self.nnz, 1)
    ...
    oarrm1n4_copy_to( &self.arr, &res.arr)
  ...
  def __pow__(self, n,z):
    ...
    oarrm1n4_pow_to( &S.arr, n, &res.arr)
  ...
  cpdef get_deriv(self, object hum_dir ):
    ...
    oarrm1n4_get_deriv_to( indx, order, &self.arr, &res.arr)
  ...
  cpdef get_im(self, object hum_dir ):
    ...
    oarrm1n4_get_im_to( indx, order, &self.arr, &res.arr)
  ...
  cpdef extract_im(self, object hum_dir):
    ...
    oarrm1n4_extract_im_to( indx, order, &self.arr, &res.arr)
  ...
  cpdef  extract_deriv(self, object hum_dir):
    ...
    oarrm1n4_extract_deriv_to( indx, order, &self.arr, &res.arr)
  ...
  cpdef  get_order_im(self, ord_t order):
    ...
    oarrm1n4_get_order_im_to( order, &self.arr, &res.arr)
  ...
  cpdef  truncate( self, object hum_dir):
    ...
    oarrm1n4_truncate_im_to( indx, order, &self.arr, &res.arr)
  ...
  def get_active_bases(self):
    ...
    tmp = omatm1n4.create(&self.arr,FLAGS=0)
  ...
  for i in range(lhs.nrows):
    ...
    for j in range(rhs.ncols):
      ...
      for l in range( lhs.p_indptr[i], lhs.p_indptr[i+1] ):
        ...
        onumm1n4_gem_oo_to( &lhs.arr.p_data[l],
  ...
  for i in range(lhs.nrows):
    ...
    for j in range(rhs.ncols):
      ...
      for l in range( lhs.p_indptr[i], lhs.p_indptr[i+1] ):
        ...
        onumm1n4_trunc_gem_oo_to( ord_lhs, &lhs.arr.p_data[l], 
