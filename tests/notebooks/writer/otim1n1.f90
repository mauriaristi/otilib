...
ELEMENTAL   FUNCTION ONUMM1N1_GEM_ORO(A,B,C)&
  ...
  FUNCTION ONUMM1N1_FEVAL(X,DERIVS)&
    RESULT(RES)
    IMPLICIT NONE
    !  Definitions
    REAL(DP) :: FACTOR, COEF
...
FUNCTION ONUMM1N1_TO_CR_MAT_M(VAL) RESULT(RES)
  ...
  FUNCTION ONUMM1N1_SIN(X) RESULT(RES)
      IMPLICIT NONE
      REAL(DP) :: DERIVS(TORDER + 1) 
      TYPE(ONUMM1N1), INTENT(IN) :: X
      TYPE(ONUMM1N1) :: RES
  ...
  FUNCTION ONUMM1N1_COS(X) RESULT(RES)
      IMPLICIT NONE
      REAL(DP) :: DERIVS(TORDER + 1) 
      TYPE(ONUMM1N1), INTENT(IN) :: X
      TYPE(ONUMM1N1) :: RES
  ...
  FUNCTION ONUMM1N1_LOG(X) RESULT(RES)
      IMPLICIT NONE
      REAL(DP) :: DERIVS(TORDER + 1) 
      TYPE(ONUMM1N1), INTENT(IN) :: X
      TYPE(ONUMM1N1) :: RES
  ...
  FUNCTION ONUMM1N1_EXP(X) RESULT(RES)
      IMPLICIT NONE
      REAL(DP) :: DERIVS(TORDER + 1) 
      TYPE(ONUMM1N1), INTENT(IN) :: X
      TYPE(ONUMM1N1) :: RES
  ...
  FUNCTION ONUMM1N1_POW(X,E) RESULT(RES)
      IMPLICIT NONE
      REAL(DP) :: DERIVS(TORDER + 1) 
      TYPE(ONUMM1N1), INTENT(IN) :: X
      REAL(DP), INTENT(IN) :: E
