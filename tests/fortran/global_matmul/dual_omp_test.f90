MODULE OTIM1N1
  ...
  TYPE ONUMM1N1 ! Scalar Order 1 and 1 imdir
    ! Real
    REAL(DP) :: R
    ! Order 1
    REAL(DP) :: E1
  ...
  INTERFACE OPERATOR(*)
    MODULE PROCEDURE ONUMM1N1_MUL_ONUMM1N1,R_MUL_ONUMM1N1,ONUMM1N1_MUL_R
  END INTERFACE

  INTERFACE OPERATOR(+)
    MODULE PROCEDURE ONUMM1N1_ADD_ONUMM1N1,R_ADD_ONUMM1N1,ONUMM1N1_ADD_R
  END INTERFACE

  INTERFACE OPERATOR(-)
    MODULE PROCEDURE ONUMM1N1_NEG,ONUMM1N1_SUB_ONUMM1N1,R_SUB_ONUMM1N1,ONUMM1N1_SUB_R
  END INTERFACE
  ...
  ELEMENTAL FUNCTION ONUMM1N1_ADD_ONUMM1N1(LHS,RHS)&
    RESULT(RES)
    IMPLICIT NONE
  ...
  END FUNCTION ONUMM1N1_ADD_ONUMM1N1

  ELEMENTAL FUNCTION R_ADD_ONUMM1N1(LHS,RHS)&
    RESULT(RES)
    IMPLICIT NONE
    REAL(DP), INTENT(IN) :: LHS 
    TYPE(ONUMM1N1), INTENT(IN) :: RHS 
  ...
  END FUNCTION R_ADD_ONUMM1N1

  ELEMENTAL FUNCTION ONUMM1N1_ADD_R(LHS,RHS)&
    RESULT(RES)
    IMPLICIT NONE
    TYPE(ONUMM1N1), INTENT(IN) :: LHS 
  ...
  ELEMENTAL FUNCTION ONUMM1N1_SUB_ONUMM1N1(LHS,RHS)&
    RESULT(RES)
    IMPLICIT NONE
    TYPE(ONUMM1N1), INTENT(IN) :: LHS 
    TYPE(ONUMM1N1), INTENT(IN) :: RHS 
  ...
  END FUNCTION ONUMM1N1_SUB_ONUMM1N1

  ELEMENTAL FUNCTION R_SUB_ONUMM1N1(LHS,RHS)&
    RESULT(RES)
    IMPLICIT NONE
    REAL(DP), INTENT(IN) :: LHS 
    TYPE(ONUMM1N1), INTENT(IN) :: RHS 
  ...
  END FUNCTION R_SUB_ONUMM1N1

  ELEMENTAL FUNCTION ONUMM1N1_SUB_R(LHS,RHS)&
    RESULT(RES)
    IMPLICIT NONE
    TYPE(ONUMM1N1), INTENT(IN) :: LHS 
    REAL(DP), INTENT(IN) :: RHS 
  ...
  END FUNCTION ONUMM1N1_SUB_R

  ELEMENTAL FUNCTION ONUMM1N1_MUL_ONUMM1N1(LHS,RHS)&
    RESULT(RES)
    IMPLICIT NONE
    TYPE(ONUMM1N1), INTENT(IN) :: LHS 
    TYPE(ONUMM1N1), INTENT(IN) :: RHS 
  ...
  END FUNCTION ONUMM1N1_MUL_ONUMM1N1

  ELEMENTAL FUNCTION R_MUL_ONUMM1N1(LHS,RHS)&
    RESULT(RES)
    IMPLICIT NONE
    REAL(DP), INTENT(IN) :: LHS 
    TYPE(ONUMM1N1), INTENT(IN) :: RHS 
  ...
  END FUNCTION R_MUL_ONUMM1N1

  ELEMENTAL FUNCTION ONUMM1N1_MUL_R(LHS,RHS)&
    RESULT(RES)
    IMPLICIT NONE
    TYPE(ONUMM1N1), INTENT(IN) :: LHS 
    REAL(DP), INTENT(IN) :: RHS 
