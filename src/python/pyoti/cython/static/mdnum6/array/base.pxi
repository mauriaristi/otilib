...
cdef class mdmat6:
  ...
  def __init__(self, realArray): 
    """
    PURPOSE:      Python level constructor of the mdmat6 class.
    ...
    if isinstance( realArray, np.ndarray):
      ...
      if ( ndim >= 3 ):
        ...
        self.arr = mdarr6_zeros( nrows, ncols)

        for i in range(self.arr.nrows):
      
          val = realArray[i]
          mdarr6_set_item_i_r( val, i, &self.arr)
        ...
        for i in range(self.arr.nrows):      
          for j in range(self.arr.ncols):
            ...
            val = realArray[i,j]
            mdarr6_set_item_ij_r( val, i, j, &self.arr)
  ...
  def order(self): 
    ...
    return mdarr6_get_order(&self.arr)
  ...
  #***************************************************************************************************
  @staticmethod
  cdef mdmat6 create(mdarr6_t* arr, uint8_t FLAGS = 1):
    """
    ...
    cdef mdmat6 mat = <mdmat6> mdmat6.__new__(mdmat6)
  ...
  def __repr__(self):
    ...
    #   out += "["
    #   for j in range(self.arr.ncols):
    #     d_mdnum6 = mdarr6_get_item_ij(&self.arr, i, j)
    #     out+= (mdnum6.create(&d_mdnum6,FLAGS=0)).__str__()+", "
    #   # end for 
    #   out = out[:-2] + "],\n"
    # # end for 
    # out =out[:-2] + "]"
  ...
  def  __getitem__(self, val):
    ...
    if tval == int:
      ...
      if val < self.arr.nrows:
        ...
        Ores = mdarr6_get_slice( &self.arr, starti, stopi, stepi, startj, stopj, stepj)
        res  = mdmat6.create(&Ores)
  ...
  cdef __setitem__r(self, object val, coeff_t value):
    ...
    if tval == int:
      ...
      if val < self.arr.nrows:
        ...
        mdarr6_set_slice_r( value, starti, stopi, stepi, startj, stopj, stepj, &self.arr)
      ...
      if len(val) == 2:
        ...
        if ( tval0 == int and tval1 == int ):
          ...
          if val[0] < self.arr.nrows and val[1] < self.arr.ncols:
            ...
            mdarr6_set_item_ij_r( value, val[0], val[1], &self.arr)
  ...
  cdef __setitem__o(self,  object val, mdnum6 value):
    ...
    if tval == int:
      ...
      if val < self.arr.nrows:
        ...
        mdarr6_set_slice_o( &value.num, starti, stopi, stepi, startj, stopj, stepj, &self.arr)
      ...
      if len(val) == 2:
        ...
        if ( tval0 == int and tval1 == int ):
          ...
          if val[0] < self.arr.nrows and val[1] < self.arr.ncols:
            ...
            mdarr6_set_item_ij_o( &value.num, val[0], val[1], &self.arr)
  ...
  cdef __setitem__O(self,  object val, mdmat6 value):
    ...
    if tval == int:
      ...
      if val < self.arr.nrows:
        ...
        mdarr6_set_slice_O( &value.arr, starti, stopi, stepi, startj, stopj, stepj, &self.arr)
  ...
  def copy(self):
    ...
    cdef mdarr6_t res = mdarr6_copy(&self.arr)
  ...
  def __neg__(self):
    ...
    cdef mdarr6_t res = mdarr6_neg(&self.arr)
  ...
  def __add__(self, other):
    ...
    if (tlhs == trhs):
      ...
      res = mdarr6_sum_OO(&lhs.arr,&rhs.arr)
      ...
      res = mdarr6_sum_oO(&olhs.num,&rhs.arr)
      ...
      res = mdarr6_sum_oO(&orhs.num,&lhs.arr)
    
    elif (tlhs in number_types):
      
      rhs = other
      res = mdarr6_sum_rO(self, &rhs.arr)

    elif (trhs in number_types):
        
      lhs = self
      res = mdarr6_sum_rO(other, &lhs.arr)
      ...
      res = mdarr6_sum_RO(&dlhs.arr,&rhs.arr)
      ...
      res = mdarr6_sum_RO(&drhs.arr,&lhs.arr)
  ...
  def __sub__(self, other):
    ...
    if (tlhs == trhs):
      ...
      res = mdarr6_sub_OO(&lhs.arr,&rhs.arr)
      ...
      res = mdarr6_sub_oO(&olhs.num,&rhs.arr)
      ...
      res = mdarr6_sub_Oo(&lhs.arr, &orhs.num)
    
    elif (tlhs in number_types):
      
      rhs = other
      res = mdarr6_sub_rO(self, &rhs.arr)

    elif (trhs in number_types):
        
      lhs = self
      res = mdarr6_sub_Or(&lhs.arr, other)
      ...
      res = mdarr6_sub_RO(&dlhs.arr,&rhs.arr)
      ...
      res = mdarr6_sub_OR(&lhs.arr, &drhs.arr)
  ...
  def __mul__(self, other):
    ...
    if (tlhs == trhs):
      ...
      res = mdarr6_mul_OO(&lhs.arr,&rhs.arr)
      ...
      res = mdarr6_mul_oO(&olhs.num,&rhs.arr)
      ...
      res = mdarr6_mul_oO(&orhs.num,&lhs.arr)
    
    elif (tlhs in number_types):
      
      rhs = other
      res = mdarr6_mul_rO(self, &rhs.arr)

    elif (trhs in number_types):
        
      lhs = self
      res = mdarr6_mul_rO(other, &lhs.arr)
      ...
      res = mdarr6_mul_RO(&dlhs.arr,&rhs.arr)
      ...
      res = mdarr6_mul_RO(&drhs.arr,&lhs.arr)
  ...
  def __truediv__(self, other):
    ...
    if (tlhs == trhs):
      ...
      res = mdarr6_div_OO(&lhs.arr,&rhs.arr)
      ...
      res = mdarr6_div_oO(&olhs.num,&rhs.arr)
      ...
      res = mdarr6_div_Oo(&lhs.arr, &orhs.num)
    
    elif (tlhs in number_types):
      
      rhs = other
      res = mdarr6_div_rO(self, &rhs.arr)

    elif (trhs in number_types):
        
      lhs = self
      res = mdarr6_div_Or(&lhs.arr, other)
      ...
      res = mdarr6_div_RO(&dlhs.arr,&rhs.arr)
      ...
      res = mdarr6_div_OR(&lhs.arr, &drhs.arr)
  ...
  cpdef get_deriv(self, object hum_dir):
    """
    PURPOSE: Get the corresponding imaginary direction in the mdmat6 object.
    """
    #*************************************************************************************************
    ...
    res_darr = mdarr6_get_deriv( item[ZERO],  item[ONE], &self.arr)
  ...
  cpdef get_im(self, object hum_dir):
    ...
    res_darr = mdarr6_get_im( item[ZERO],  item[ONE], &self.arr)
  ...
  cpdef extract_im(self, object hum_dir):
    ...
    res = mdarr6_extract_im( item[ZERO],  item[ONE], &self.arr)
  ...
  cpdef  extract_deriv(self, object hum_dir):
    ...
    res = mdarr6_extract_deriv( item[ZERO],  item[ONE], &self.arr)
  ...
  cpdef  get_order_im(self, ord_t order):
    ...
    res = mdarr6_get_order_im( order, &self.arr)
  ...
  cpdef  truncate( self, object humdir):
    ...
    res = mdarr6_truncate_im( indx, order, &self.arr) 
  ...
  cpdef set(self, object rhs):
    ...
    if   trhs is mdnum6:
      ...
      orhs = rhs
      mdarr6_set_o( &orhs.num, &self.arr)

    elif trhs is mdmat6:

      Orhs = rhs
      mdarr6_set_O( &Orhs.arr, &self.arr)      

    elif trhs in number_types:

      rrhs = rhs
      mdarr6_set_r( rrhs, &self.arr)

    else:

      raise ValueError( "Cant assign '{0}' into a mdmat6 object.".format(trhs) )
  ...
  def get_active_bases(self):
    ...
    mdarr6_get_active_bases( &self.arr, bases_list)
  ...
  def taylor_integrate(self, object bases, object deltas):
    ...
    res = mdarr6_taylor_integrate( c_deltas, &self.arr)
  ...
  #***************************************************************************************************
  @staticmethod
  def dot( mdmat6 lhs, mdmat6 rhs, mdmat6 out = None): 
    """
    ...
    if out is not None:
      ...
      mdarr6_matmul_OO_to( &lhs.arr, &rhs.arr ,&out.arr)

    else:

      res = mdarr6_matmul_OO( &lhs.arr, &rhs.arr )
  ...
  #***************************************************************************************************
  @staticmethod
  def inv( mdmat6 arr,  mdmat6 out = None): 
    """
    ...
    if out is not None:
      ...
      mdarr6_invert_to( &arr.arr,&out.arr)

    else:

      res = mdarr6_invert( &arr.arr)
  ...
  #***************************************************************************************************
  @staticmethod
  def transpose( mdmat6 arr,  mdmat6 out = None ): 
    """
    ...
    if out is not None:
      ...
      mdarr6_transpose_to( &arr.arr, &out.arr)

    else:

      res = mdarr6_transpose( &arr.arr)
  ...
  #***************************************************************************************************
  @staticmethod
  def add( mdmat6 lhs, mdmat6 rhs, mdmat6 out = None): 
    """
    ...
    if out is not None:
      ...
      mdarr6_sum_OO_to( &lhs.arr, &rhs.arr ,&out.arr)
