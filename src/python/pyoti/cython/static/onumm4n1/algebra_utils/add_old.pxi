...
# cdef object __add__FX__(feomatm4n1 Flhs, object rhs, object out = None):
#   """
#   PURPOSE:  Addition between feomatm4n1 and object.
...
cdef object __add__OX__(omatm4n1 Olhs, object rhs, object out = None):
  """
  PURPOSE:  Addition between omatm4n1 and an object.
  ...
  #   if res_flag:
  #     Fres = out
  #     feonumm4n1_sum_Of_to( &Orhs.arr, &flhs.num ,&Fres.arr)
  #   else:      
  #     cFres = feonumm4n1_sum_Of( &Orhs.arr, &flhs.num)
  #     res = feomatm4n1.create(&cFres)
  #   # end if
    ...
    if res_flag:
      ...
      cOres = oarrm4n1_sum_OO( &Orhs.arr, &Orhs.arr)
      res = omatm4n1.create( &cOres )
    # end if
...
cdef object __add__RX__(dmat Rlhs, object rhs, object out = None):
  """
  PURPOSE:  Addition between onumm4n1 and an object.
  ...
  #   if res_flag:
  #     ores = out
  #     onumm4n1_sum_Ro_to( &Rlhs.arr, &orhs.num ,&ores.num)
  #   else:
  #     cores = onumm4n1_sum_Ro( &Rlhs.arr, &orhs.num )
  ...
  #   if res_flag:
  #     fres = out
  #     feonumm4n1_sum_Rf_to( &Rlhs.arr, &frhs.num ,&fres.num)
  #   else:      
  #     cfres = feonumm4n1_sum_Rf( &Rlhs.arr, &frhs.num)
...
cdef object __add__fX__(feonumm4n1 flhs, object rhs, object out = None):
  """
  PURPOSE:  Addition between feonumm4n1 and an object.
  ...
  #   if res_flag:
  #     Rres = out
  #     feonumm4n1_sum_Rf_to( &Rrhs.arr, &flhs.num ,&Fres.arr)
  #   else:      
  #     cFres = feonumm4n1_sum_Rf( &Rrhs.arr, &flhs.num)
  #     res = feomatm4n1.create(&cFres)
  #   # end if
...
cdef object __add__oX__(onumm4n1 olhs, object rhs, object out = None):
  ...
  #   if res_flag:
  #     Ores = out
  #     onumm4n1_sum_oR_to( &olhs.num, &Rrhs.arr ,&Ores.arr)
  #   else:      
  #     cOres = onumm4n1_sum_oR( &olhs.num, &Rrhs.arr)
  #     res = omatm4n1.create(&cOres)
  #   # end if
