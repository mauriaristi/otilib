...
feonumm1n10_t feoarrm1n10_dotproduct_FF(feoarrm1n10_t* lhs, feoarrm1n10_t* rhs){
    ...
    res = feonumm1n10_createEmpty( rhs->nip);

    feoarrm1n10_dotproduct_FF_to(lhs, rhs, &res);
...
void feoarrm1n10_dotproduct_FF_to(feoarrm1n10_t* lhs, feoarrm1n10_t* rhs, feonumm1n10_t* res){
    ...
    // Check Dimensions
    feoarrm1n10_dimCheck_FF_samesize(lhs, rhs, res);

    for (i = 0; i<res->nip; i++){

        oarrm1n10_dotproduct_OO_to( &lhs->p_data[i], &rhs->p_data[i], &res->p_data[i] );
...
feonumm1n10_t feoarrm1n10_dotproduct_OF(oarrm1n10_t* lhs, feoarrm1n10_t* rhs){
    ...
    feoarrm1n10_dotproduct_OF_to( lhs, rhs, &res);
...
void feoarrm1n10_dotproduct_OF_to( oarrm1n10_t* lhs, feoarrm1n10_t* rhs, feonumm1n10_t* res){
    ...
    // Check Dimensions
    feoarrm1n10_dimCheck_OF_samesize(lhs, rhs, res);

    for (i = 0; i < res->nip; i++){

        oarrm1n10_dotproduct_OO_to( lhs, &rhs->p_data[i], &res->p_data[i] );
...
feonumm1n10_t feoarrm1n10_dotproduct_RF( darr_t* lhs, feoarrm1n10_t* rhs){
    ...
    feoarrm1n10_dotproduct_RF_to( lhs, rhs, &res);
...
void feoarrm1n10_dotproduct_RF_to( darr_t* lhs, feoarrm1n10_t* rhs, feonumm1n10_t* res){
    ...
    // Check Dimensions
    feoarrm1n10_dimCheck_RF_samesize(lhs, rhs, res);

    for (i = 0; i < res->nip; i++){

        oarrm1n10_dotproduct_RO_to( lhs, &rhs->p_data[i], &res->p_data[i] );
...
feoarrm1n10_t feoarrm1n10_matmul_FF(feoarrm1n10_t* lhs, feoarrm1n10_t* rhs){
    ...
    // Check dimensions.
    res = feoarrm1n10_createEmpty( lhs->nrows, rhs->ncols, lhs->nip);

    feoarrm1n10_matmul_FF_to( lhs, rhs, &res);
...
void feoarrm1n10_matmul_FF_to(feoarrm1n10_t* lhs, feoarrm1n10_t* rhs, feoarrm1n10_t* res){
    ...
    // Check Dimensions
    feoarrm1n10_dimCheck_FF_matmul(lhs, rhs, res);

    for (i = 0; i<res->nip; i++){

        oarrm1n10_matmul_OO_to( &lhs->p_data[i], &rhs->p_data[i], &res->p_data[i] );
...
feoarrm1n10_t feoarrm1n10_matmul_OF(oarrm1n10_t* lhs, feoarrm1n10_t* rhs){
    ...
    // Check dimensions.
    res = feoarrm1n10_createEmpty( lhs->nrows, rhs->ncols, rhs->nip);

    feoarrm1n10_matmul_OF_to( lhs, rhs, &res);
...
void feoarrm1n10_matmul_OF_to(oarrm1n10_t* lhs, feoarrm1n10_t* rhs, feoarrm1n10_t* res){
    ...
    // Check Dimensions
    feoarrm1n10_dimCheck_OF_matmul(lhs, rhs, res);

    for (i = 0; i<res->nip; i++){

        oarrm1n10_matmul_OO_to( lhs, &rhs->p_data[i], &res->p_data[i] );
...
feoarrm1n10_t feoarrm1n10_matmul_FO(feoarrm1n10_t* lhs, oarrm1n10_t* rhs){
    ...
    feoarrm1n10_matmul_FO_to( lhs, rhs, &res);
...
void feoarrm1n10_matmul_FO_to(feoarrm1n10_t* lhs, oarrm1n10_t* rhs, feoarrm1n10_t* res){
    ...
    // Check Dimensions
    feoarrm1n10_dimCheck_FO_matmul(lhs, rhs, res);

    for (i = 0; i<res->nip; i++){

        oarrm1n10_matmul_OO_to( &lhs->p_data[i], rhs, &res->p_data[i] );
...
feoarrm1n10_t feoarrm1n10_matmul_RF(darr_t* lhs, feoarrm1n10_t* rhs){
    ...
    feoarrm1n10_matmul_RF_to( lhs, rhs, &res);
...
void feoarrm1n10_matmul_RF_to(darr_t* lhs, feoarrm1n10_t* rhs, feoarrm1n10_t* res){
    ...
    // Check Dimensions
    feoarrm1n10_dimCheck_RF_matmul(lhs, rhs, res);

    for (i = 0; i<res->nip; i++){

        oarrm1n10_matmul_RO_to( lhs, &rhs->p_data[i], &res->p_data[i] );
...
feoarrm1n10_t feoarrm1n10_matmul_FR(feoarrm1n10_t* lhs, darr_t* rhs){
    ...
    feoarrm1n10_matmul_FR_to( lhs, rhs, &res);
...
void feoarrm1n10_matmul_FR_to(feoarrm1n10_t* lhs, darr_t* rhs, feoarrm1n10_t* res){
    ...
    // Check Dimensions
    feoarrm1n10_dimCheck_FR_matmul(lhs, rhs, res);

    for (i = 0; i<res->nip; i++){

        oarrm1n10_matmul_OR_to( &lhs->p_data[i], rhs, &res->p_data[i] );
...
feonumm1n10_t feoarrm1n10_norm(feoarrm1n10_t* arr){
    ...
    res = feonumm1n10_createEmpty( arr->nip);

    feoarrm1n10_norm_to( arr, &res );
...
void feoarrm1n10_norm_to(feoarrm1n10_t* arr, feonumm1n10_t* res){
    ...
    for (i = 0; i<arr->nip; i++){
        ...
        oarrm1n10_pnorm_to( &arr->p_data[i], 2.0, &res->p_data[i]);
...
feonumm1n10_t feoarrm1n10_pnorm(feoarrm1n10_t* arr, coeff_t p){
    ...
    feoarrm1n10_pnorm_to( arr, p, &res );
...
void feoarrm1n10_pnorm_to(feoarrm1n10_t* arr, coeff_t p, feonumm1n10_t* res){
    ...
    for (i = 0; i<arr->nip; i++){
        ...
        oarrm1n10_pnorm_to( &arr->p_data[i], p, &res->p_data[i]);
...
void feoarrm1n10_det_to(feoarrm1n10_t* arr, feonumm1n10_t* res){
    ...
    // Check dimensions (squareness)
    feoarrm1n10_dimCheck_F_squareness( arr, arr);
    feoarrm1n10_dimCheck_fF_elementwise(res,arr,arr);

    for (i = 0; i<arr->nip; i++){
        
        oarrm1n10_det_to( &arr->p_data[i], &res->p_data[i]);
...
void feoarrm1n10_invert_to(feoarrm1n10_t* arr, feoarrm1n10_t* res){
    ...
    feoarrm1n10_dimCheck_F_squareness( arr, res);
    
    for (i = 0; i<arr->nip; i++){

        oarrm1n10_invert_to( &arr->p_data[i], &res->p_data[i]);
...
feoarrm1n10_t feoarrm1n10_transpose(feoarrm1n10_t* arr){
    ...
    res = feoarrm1n10_createEmpty( arr->ncols, arr->nrows, arr->nip);
    
    feoarrm1n10_transpose_to( arr, &res );
...
void feoarrm1n10_transpose_to(feoarrm1n10_t* arr, feoarrm1n10_t* res){
    ...
    // Check dimensions.
    feoarrm1n10_dimCheck_F_transpose( arr, res);
    
    for (i = 0; i<arr->nip; i++){

        oarrm1n10_transpose_to( &arr->p_data[i], &res->p_data[i]);
