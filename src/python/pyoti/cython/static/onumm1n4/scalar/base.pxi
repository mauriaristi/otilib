...
cdef class onumm1n4:
  ...
  def __init__(self, coeff_t re_coeff):
    ...
    self.num = onumm1n4_create_r(re_coeff)
  ...
  def  order(self): 
    ...
    return onumm1n4_get_order(&self.num)
  ...
  #***************************************************************************************************
  @staticmethod
  cdef onumm1n4 create( onumm1n4_t* num, uint8_t FLAGS = 1 ):
    """
    ...
    cdef onumm1n4 otin = <onumm1n4> onumm1n4.__new__(onumm1n4)

    otin.num     = onumm1n4_copy(num)
  ...
  def __repr__(self):
    """
    PURPOSE:  To print a representation of the onumm1n4 object in a compact form.
    """
    #*************************************************************************************************
    ...
    for ordi in range(1,self.order+1):
      ...
      for i in range( onumm1n4_get_ndir_order(ordi,&self.num) ):
        
        idx = onumm1n4_get_indx(i, ordi) 
        num = '%+.4f'%( onumm1n4_get_item(idx,ordi,&self.num) )
  ...
  def short_repr(self):
    ...
    head = 'onumm1n4('
    body = str(self.num.r) + ", nnz: " + str(onumm1n4_get_ndir_total(&self.num)) + ', order: ' + str(self.order)
    tail = ')'
  ...
  def __str__(self):
    """
    PURPOSE: To print a representation of the onumm1n4 object that could 
  ...
  def __getitem__(self, list index):
    """
    PURPOSE:  To get the value of a onumm1n4 coefficient.
    ...
    return onumm1n4_get_item( idx, order, &self.num)
  ...
  def __setitem__(self, list item, coeff_t value):
    """
    PURPOSE:  To set the value of a onumm1n4 coefficient.
    ...
    onumm1n4_set_item( value, index, order, &self.num)
  ...
  def __neg__(self):
    ...
    cdef onumm1n4_t res = onumm1n4_neg(&self.num)
  ...
  def __add__(self, other_in):
    """
    PURPOSE:      Add onumm1n4 with other things.
  ...
  #************************************************************************
    ...
    if ( type1 is type2) : # Case Sum between OTIs.
      tmp1 = self
      tmp2 = other_in
      res =  onumm1n4_sub_oo(&tmp1.num, &tmp2.num);
    
    elif (type2 in number_types): # Case Sum to real number. Very slow, consider changing this...
      
      tmp1 = self
      res = onumm1n4_sub_or(&tmp1.num, other_in);

    elif (type1 in number_types): # Case 1.5. reverse Sum to real number.
      
      tmp1 = other_in
      res = onumm1n4_sub_ro(self, &tmp1.num);   
  ...
  def __mul__(self, other_in):
    ...
    if ( type1 is type2) : # Case Sum between OTIs.
      ...
      tmp1 = self
      tmp2 = other_in
      res = onumm1n4_mul_oo( &tmp1.num, &tmp2.num)
    
    elif (type2 in number_types): # Case Sum to real number. Very slow, consider changing this...
      
      tmp1 = self
      res = onumm1n4_mul_ro( other_in, &tmp1.num);

    elif (type1 in number_types): # Case 1.5. reverse Sum to real number.
      
      tmp1 = other_in
      res = onumm1n4_mul_ro( self, &tmp1.num);       
  ...
  def __truediv__(self, other_in):
    """
    PURPOSE:      To define how to divide two onumm1n4 numbers.
  ...
  def __pow__(self, n,z):
    ...
    cdef onumm1n4_t res
    cdef onumm1n4 S = self

    res = onumm1n4_pow(&S.num, n)
  ...
  cpdef set(self, object rhs):
    ...
    if trhs is onumm1n4:
      ...
      orhs = rhs
      onumm1n4_set_o( &orhs.num, &self.num)

    else:
      rrhs = rhs
      onumm1n4_set_r( rrhs, &self.num)      
  ...
  cpdef  set_im( self,  object val, object humdir):
    ...
    if tval is onumm1n4:
      ...
      oval = val
      onumm1n4_set_im_o( &oval.num, indx, order, &self.num) 

    else:

      rval = val
      onumm1n4_set_im_r( val, indx, order, &self.num) 
  ...
  cpdef  set_deriv( self,  object val, object humdir):
    ...
    if tval is onumm1n4:
      ...
      oval = val
      onumm1n4_set_deriv_o( &oval.num, indx, order, &self.num) 

    else:

      rval = val
      onumm1n4_set_deriv_r( val, indx, order, &self.num) 
  ...
  cpdef  truncate( self, object humdir):
    ...
    res = onumm1n4_truncate_im( indx, order, &self.num) 
  ...
  cpdef get_deriv( self, object humdir):
    ...
    indx, order = imdir(humdir)
    return onumm1n4_get_deriv(indx,order, &self.num) 
  ...
  cpdef get_im( self, object humdir):
    ...
    indx, order = imdir(humdir)
    return onumm1n4_get_item(indx,order, &self.num) 
  ...
  cpdef extract_im( self, object humdir):
    ...
    res = onumm1n4_extract_im(indx,order, &self.num) 
  ...
  cpdef extract_deriv( self, object humdir):
    ...
    res = onumm1n4_extract_deriv(indx,order, &self.num)
  ...
  cpdef get_order_im( self, ord_t order):
    ...
    res = onumm1n4_get_order_im( order, &self.num)
  ...
  def copy(self):
    ...
    cdef onumm1n4_t res = onumm1n4_copy( &self.num )
    return onumm1n4.create(&res)
  ...
  def get_active_bases(self):
    ...
    onumm1n4_get_active_bases( &self.num, bases_list)
  ...
  def taylor_integrate(self, object bases, object deltas):
    ...
    res = onumm1n4_taylor_integrate( c_deltas, &self.num)
