#ifndef OTI_ONUMM2N3_SCALAR_GAUSS_BASE_H
#define OTI_ONUMM2N3_SCALAR_GAUSS_BASE_H
...
@param[in] num FEonumm2n3 to free
******************************************************************************************************/
...
@param[in] num FEonumm2n3
******************************************************************************************************/
ord_t feonumm2n3_get_order( feonumm2n3_t* num );
// ----------------------------------------------------------------------------------------------------

/**************************************************************************************************//**
@brief Initialize a feonumm2n3 structure.

******************************************************************************************************/
feonumm2n3_t feonumm2n3_init(void);
// ----------------------------------------------------------------------------------------------------
