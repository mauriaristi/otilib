...
cdef class omatm2n8:
  ...
  def __init__(self, realArray): 
    """
    PURPOSE:      Python level constructor of the omatm2n8 class.
    ...
    if isinstance( realArray, np.ndarray):
      ...
      if ( ndim >= 3 ):
        ...
        self.arr = oarrm2n8_zeros( nrows, ncols)

        for i in range(self.arr.nrows):
      
          val = realArray[i]
          oarrm2n8_set_item_i_r( val, i, &self.arr)
        ...
        for i in range(self.arr.nrows):      
          for j in range(self.arr.ncols):
            ...
            val = realArray[i,j]
            oarrm2n8_set_item_ij_r( val, i, j, &self.arr)
  ...
  def T(self): 
    ...
    res = oarrm2n8_transpose( &self.arr)
  ...
  def order(self): 
    ...
    return oarrm2n8_get_order(&self.arr)
  ...
  #***************************************************************************************************
  @staticmethod
  cdef omatm2n8 create(oarrm2n8_t* arr, uint8_t FLAGS = 1):
    """
    ...
    cdef omatm2n8 mat = <omatm2n8> omatm2n8.__new__(omatm2n8)
  ...
  def __repr__(self):
    ...
    #   out += "["
    #   for j in range(self.arr.ncols):
    #     d_onumm2n8 = oarrm2n8_get_item_ij(&self.arr, i, j)
    #     out+= (onumm2n8.create(&d_onumm2n8,FLAGS=0)).__str__()+", "
    #   # end for 
    #   out = out[:-2] + "],\n"
    # # end for 
    # out =out[:-2] + "]"
  ...
  def  __getitem__(self, val):
    ...
    if tval == int:
      ...
      if val < self.arr.nrows:
        ...
        Ores = oarrm2n8_get_slice( &self.arr, starti, stopi, stepi, startj, stopj, stepj)
        res  = omatm2n8.create(&Ores)
  ...
  cdef __setitem__r(self, object val, coeff_t value):
    ...
    if tval == int:
      ...
      if val < self.arr.nrows:
        ...
        oarrm2n8_set_slice_r( value, starti, stopi, stepi, startj, stopj, stepj, &self.arr)
      ...
      if len(val) == 2:
        ...
        if ( tval0 == int and tval1 == int ):
          ...
          if val[0] < self.arr.nrows and val[1] < self.arr.ncols:
            ...
            oarrm2n8_set_item_ij_r( value, val[0], val[1], &self.arr)
  ...
  cdef __setitem__o(self,  object val, onumm2n8 value):
    ...
    if tval == int:
      ...
      if val < self.arr.nrows:
        ...
        oarrm2n8_set_slice_o( &value.num, starti, stopi, stepi, startj, stopj, stepj, &self.arr)
      ...
      if len(val) == 2:
        ...
        if ( tval0 == int and tval1 == int ):
          ...
          if val[0] < self.arr.nrows and val[1] < self.arr.ncols:
            ...
            oarrm2n8_set_item_ij_o( &value.num, val[0], val[1], &self.arr)
  ...
  cdef __setitem__O(self,  object val, omatm2n8 value):
    ...
    if tval == int:
      ...
      if val < self.arr.nrows:
        ...
        oarrm2n8_set_slice_O( &value.arr, starti, stopi, stepi, startj, stopj, stepj, &self.arr)
  ...
  def copy(self):
    ...
    cdef oarrm2n8_t res = oarrm2n8_copy(&self.arr)
  ...
  def __neg__(self):
    ...
    cdef oarrm2n8_t res = oarrm2n8_neg(&self.arr)
  ...
  def __add__(self, other):
    ...
    if (tlhs == trhs):
      ...
      res = oarrm2n8_sum_OO(&lhs.arr,&rhs.arr)
      ...
      res = oarrm2n8_sum_oO(&olhs.num,&rhs.arr)
      ...
      res = oarrm2n8_sum_oO(&orhs.num,&lhs.arr)
    
    elif (tlhs in number_types):
      
      rhs = other
      res = oarrm2n8_sum_rO(self, &rhs.arr)

    elif (trhs in number_types):
        
      lhs = self
      res = oarrm2n8_sum_rO(other, &lhs.arr)
      ...
      res = oarrm2n8_sum_RO(&dlhs.arr,&rhs.arr)
      ...
      res = oarrm2n8_sum_RO(&drhs.arr,&lhs.arr)
  ...
  def __sub__(self, other):
    ...
    if (tlhs == trhs):
      ...
      res = oarrm2n8_sub_OO(&lhs.arr,&rhs.arr)
      ...
      res = oarrm2n8_sub_oO(&olhs.num,&rhs.arr)
      ...
      res = oarrm2n8_sub_Oo(&lhs.arr, &orhs.num)
    
    elif (tlhs in number_types):
      
      rhs = other
      res = oarrm2n8_sub_rO(self, &rhs.arr)

    elif (trhs in number_types):
        
      lhs = self
      res = oarrm2n8_sub_Or(&lhs.arr, other)
      ...
      res = oarrm2n8_sub_RO(&dlhs.arr,&rhs.arr)
      ...
      res = oarrm2n8_sub_OR(&lhs.arr, &drhs.arr)
  ...
  def __mul__(self, other):
    ...
    if (tlhs == trhs):
      ...
      res = oarrm2n8_mul_OO(&lhs.arr,&rhs.arr)
      ...
      res = oarrm2n8_mul_oO(&olhs.num,&rhs.arr)
      ...
      res = oarrm2n8_mul_oO(&orhs.num,&lhs.arr)
    
    elif (tlhs in number_types):
      
      rhs = other
      res = oarrm2n8_mul_rO(self, &rhs.arr)

    elif (trhs in number_types):
        
      lhs = self
      res = oarrm2n8_mul_rO(other, &lhs.arr)
      ...
      res = oarrm2n8_mul_RO(&dlhs.arr,&rhs.arr)
      ...
      res = oarrm2n8_mul_RO(&drhs.arr,&lhs.arr)
  ...
  def __truediv__(self, other):
    ...
    if (tlhs == trhs):
      ...
      res = oarrm2n8_div_OO(&lhs.arr,&rhs.arr)
      ...
      res = oarrm2n8_div_oO(&olhs.num,&rhs.arr)
      ...
      res = oarrm2n8_div_Oo(&lhs.arr, &orhs.num)
    
    elif (tlhs in number_types):
      
      rhs = other
      res = oarrm2n8_div_rO(self, &rhs.arr)

    elif (trhs in number_types):
        
      lhs = self
      res = oarrm2n8_div_Or(&lhs.arr, other)
      ...
      res = oarrm2n8_div_RO(&dlhs.arr,&rhs.arr)
      ...
      res = oarrm2n8_div_OR(&lhs.arr, &drhs.arr)
  ...
  def __pow__(self, n,z):
    ...
    cdef oarrm2n8_t res 
    cdef omatm2n8 S = self

    res = oarrm2n8_pow( &S.arr, n)
  ...
  cpdef get_deriv(self, object hum_dir):
    """
    PURPOSE: Get the corresponding imaginary direction in the omatm2n8 object.
    """
    #*************************************************************************************************
    ...
    res_darr = oarrm2n8_get_deriv( item[ZERO],  item[ONE], &self.arr)
  ...
  cpdef get_im(self, object hum_dir):
    ...
    res_darr = oarrm2n8_get_im( item[ZERO],  item[ONE], &self.arr)
  ...
  cpdef extract_im(self, object hum_dir):
    ...
    res = oarrm2n8_extract_im( item[ZERO],  item[ONE], &self.arr)
  ...
  cpdef  extract_deriv(self, object hum_dir):
    ...
    res = oarrm2n8_extract_deriv( item[ZERO],  item[ONE], &self.arr)
  ...
  cpdef  get_order_im(self, ord_t order):
    ...
    res = oarrm2n8_get_order_im( order, &self.arr)
  ...
  cpdef  truncate( self, object humdir):
    ...
    res = oarrm2n8_truncate_im( indx, order, &self.arr) 
  ...
  cpdef set(self, object rhs):
    ...
    if   trhs is onumm2n8:
      ...
      orhs = rhs
      oarrm2n8_set_o( &orhs.num, &self.arr)

    elif trhs is omatm2n8:

      Orhs = rhs
      oarrm2n8_set_O( &Orhs.arr, &self.arr)      

    elif trhs in number_types:

      rrhs = rhs
      oarrm2n8_set_r( rrhs, &self.arr)

    else:

      raise ValueError( "Cant assign '{0}' into a omatm2n8 object.".format(trhs) )
  ...
  def get_active_bases(self):
    ...
    oarrm2n8_get_active_bases( &self.arr, bases_list)
  ...
  def taylor_integrate(self, object bases, object deltas):
    ...
    res = oarrm2n8_taylor_integrate( c_deltas, &self.arr)
  ...
  #***************************************************************************************************
  @staticmethod
  def dot( omatm2n8 lhs, omatm2n8 rhs, omatm2n8 out = None): 
    """
    ...
    if out is not None:
      ...
      oarrm2n8_matmul_OO_to( &lhs.arr, &rhs.arr ,&out.arr)

    else:

      res = oarrm2n8_matmul_OO( &lhs.arr, &rhs.arr )
  ...
  #***************************************************************************************************
  @staticmethod
  def inv( omatm2n8 arr,  omatm2n8 out = None): 
    """
    ...
    if out is not None:
      ...
      oarrm2n8_invert_to( &arr.arr,&out.arr)

    else:

      res = oarrm2n8_invert( &arr.arr)
  ...
  #***************************************************************************************************
  @staticmethod
  def transpose( omatm2n8 arr,  omatm2n8 out = None ): 
    """
    ...
    if out is not None:
      ...
      oarrm2n8_transpose_to( &arr.arr, &out.arr)

    else:

      res = oarrm2n8_transpose( &arr.arr)
  ...
  #***************************************************************************************************
  @staticmethod
  def add( omatm2n8 lhs, omatm2n8 rhs, omatm2n8 out = None): 
    """
    ...
    if out is not None:
      ...
      oarrm2n8_sum_OO_to( &lhs.arr, &rhs.arr ,&out.arr)
