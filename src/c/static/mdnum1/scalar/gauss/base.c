...
ord_t femdnum1_get_order( femdnum1_t* num ){
    ...
    for( i = 0; i<num->nip; i++ ){
        ...
        order = MAX(order, mdnum1_get_order(&num->p_data[i]) );
...
void femdnum1_get_order_im_to( ord_t order, femdnum1_t* num, femdnum1_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        mdnum1_get_order_im_to( order, &num->p_data[k], &res->p_data[k]);
...
femdnum1_t femdnum1_get_order_im( ord_t order, femdnum1_t* num){
    ...
    res = femdnum1_zeros( num->nip);

    femdnum1_get_order_im_to( order, num, &res);
...
void femdnum1_extract_im_to( imdir_t idx, ord_t order, femdnum1_t* num, femdnum1_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        mdnum1_extract_im_to( idx, order, &num->p_data[k], &res->p_data[k]);
...
femdnum1_t femdnum1_extract_im( imdir_t idx, ord_t order, femdnum1_t* num){
    ...
    femdnum1_extract_im_to( idx, order, num, &res);
...
void femdnum1_extract_deriv_to( imdir_t idx, ord_t order, femdnum1_t* num, femdnum1_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        mdnum1_extract_deriv_to( idx, order, &num->p_data[k], &res->p_data[k]);
...
femdnum1_t femdnum1_extract_deriv( imdir_t idx, ord_t order, femdnum1_t* num){
    ...
    femdnum1_extract_deriv_to( idx, order, num, &res);
...
void femdnum1_get_deriv_to( imdir_t idx, ord_t order, femdnum1_t* num, femdnum1_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        mdnum1_get_deriv_to( idx, order, &num->p_data[k], &res->p_data[k]);
...
femdnum1_t femdnum1_get_deriv( imdir_t idx, ord_t order, femdnum1_t* num){
    ...
    femdnum1_get_deriv_to( idx, order, num, &res);
...
void femdnum1_get_im_to( imdir_t idx, ord_t order, femdnum1_t* num, femdnum1_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        mdnum1_get_im_to_o( idx, order, &num->p_data[k], &res->p_data[k]);
...
femdnum1_t femdnum1_get_im( imdir_t idx, ord_t order, femdnum1_t* num){
    ...
    femdnum1_get_im_to( idx, order, num, &res);
...
void femdnum1_truncate_im_to( imdir_t idx, ord_t order, femdnum1_t* num,  femdnum1_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        mdnum1_truncate_im_to( idx, order, &num->p_data[k], &res->p_data[k]);
...
femdnum1_t femdnum1_truncate_im( imdir_t idx, ord_t order, femdnum1_t* num){
    ...
    femdnum1_truncate_im_to( idx, order, num, &res);
...
void femdnum1_set_im_r( coeff_t val, imdir_t idx, ord_t order, femdnum1_t* num){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        mdnum1_set_im_r( val, idx, order, &num->p_data[k]);
...
void femdnum1_set_im_o( mdnum1_t* val, imdir_t idx, ord_t order, femdnum1_t* num){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        mdnum1_set_im_o( val, idx, order, &num->p_data[k]);
...
void femdnum1_set_im_f( femdnum1_t* val, imdir_t idx, ord_t order, femdnum1_t* num){
    ...
    femdnum1_dimCheck(val,num);

    for (k = 0; k<num->nip; k++ ){
        
        mdnum1_set_im_o( &val->p_data[k], idx, order, &num->p_data[k]);
...
void femdnum1_set_deriv_r( coeff_t val, imdir_t idx, ord_t order, femdnum1_t* num){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        mdnum1_set_deriv_r( val, idx, order, &num->p_data[k]);
...
void femdnum1_set_deriv_o( mdnum1_t* val, imdir_t idx, ord_t order, femdnum1_t* num){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        mdnum1_set_deriv_o( val, idx, order, &num->p_data[k]);
...
void femdnum1_set_deriv_f( femdnum1_t* val, imdir_t idx, ord_t order, femdnum1_t* num){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        mdnum1_set_deriv_o( &val->p_data[k], idx, order, &num->p_data[k]);
...
// ****************************************************************************************************
void femdnum1_set_to( femdnum1_t* src, femdnum1_t* dst){
    
    uint64_t i;

    femdnum1_dimCheck(src,dst);

    for (i = 0; i<src->nip; i++ ){
        
        mdnum1_copy_to( &src->p_data[i], &dst->p_data[i]);
...
femdnum1_t femdnum1_copy( femdnum1_t* src){
    ...
    res = femdnum1_createEmpty(src->nip);

    femdnum1_copy_to( src, &res);
...
void femdnum1_set_item_k_o( mdnum1_t* num, uint64_t k, femdnum1_t* res){
    ...
    if (k < res->nip){
        ...
        mdnum1_set_o(num, &res->p_data[k]); 

    } else {

        printf("ERROR: Index out of bounds in femdnum1_get_item_k.\n");
...
void femdnum1_get_item_k_to(femdnum1_t* num, uint64_t k, mdnum1_t* res){
    ...
    if (k < num->nip){
        ...
        mdnum1_copy_to( &num->p_data[k], res);
...
// ****************************************************************************************************
femdnum1_t femdnum1_zeros(uint64_t nip){

    femdnum1_t  res  = femdnum1_createEmpty(nip);
    
    femdnum1_set_r( 0.0, &res);
...
// ****************************************************************************************************
inline femdnum1_t femdnum1_createEmpty(uint64_t nip){

    femdnum1_t  res ;  
    void * memory = NULL;

    // Allocate memory and check if correctly allocated.
    memory = malloc( nip * sizeof( mdnum1_t ) );

    if ( memory == NULL ){
        printf("ERROR: Not enough memory to handle array of femdnum1.\n Exiting...\n");
        exit(OTI_OutOfMemory); // TODO: Raise error instead of quitting the program.
    }
    
    res.p_data = ( mdnum1_t* ) memory;
    res.nip = nip;
...
// ****************************************************************************************************
inline femdnum1_t femdnum1_init(void){
...
// ****************************************************************************************************
inline femdnum1_t femdnum1_empty_like(femdnum1_t* arr){

    femdnum1_t res = femdnum1_createEmpty(arr->nip);
