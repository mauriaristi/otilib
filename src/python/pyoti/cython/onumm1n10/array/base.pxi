...
cdef class omatm1n10:
  ...
  def __init__(self, realArray): 
    """
    PURPOSE:      Python level constructor of the omatm1n10 class.
    ...
    if isinstance( realArray, np.ndarray):
      ...
      if ( ndim >= 3 ):
        ...
        self.arr = oarrm1n10_zeros( nrows, ncols)

        for i in range(self.arr.nrows):
      
          val = realArray[i]
          oarrm1n10_set_item_i_r( val, i, &self.arr)
        ...
        for i in range(self.arr.nrows):      
          for j in range(self.arr.ncols):
            ...
            val = realArray[i,j]
            oarrm1n10_set_item_ij_r( val, i, j, &self.arr)
  ...
  def T(self): 
    ...
    res = oarrm1n10_transpose( &self.arr)
  ...
  def order(self): 
    ...
    return oarrm1n10_get_order(&self.arr)
  ...
  #***************************************************************************************************
  @staticmethod
  cdef omatm1n10 create(oarrm1n10_t* arr, uint8_t FLAGS = 1):
    """
    ...
    cdef omatm1n10 mat = <omatm1n10> omatm1n10.__new__(omatm1n10)
  ...
  def __repr__(self):
    ...
    #   out += "["
    #   for j in range(self.arr.ncols):
    #     d_onumm1n10 = oarrm1n10_get_item_ij(&self.arr, i, j)
    #     out+= (onumm1n10.create(&d_onumm1n10,FLAGS=0)).__str__()+", "
    #   # end for 
    #   out = out[:-2] + "],\n"
    # # end for 
    # out =out[:-2] + "]"
  ...
  def  __getitem__(self, val):
    ...
    if tval == int:
      ...
      if val < self.arr.nrows:
        ...
        Ores = oarrm1n10_get_slice( &self.arr, starti, stopi, stepi, startj, stopj, stepj)
        res  = omatm1n10.create(&Ores)
  ...
  cdef __setitem__r(self, object val, coeff_t value):
    ...
    if tval == int:
      ...
      if val < self.arr.nrows:
        ...
        oarrm1n10_set_slice_r( value, starti, stopi, stepi, startj, stopj, stepj, &self.arr)
      ...
      if len(val) == 2:
        ...
        if ( tval0 == int and tval1 == int ):
          ...
          if val[0] < self.arr.nrows and val[1] < self.arr.ncols:
            ...
            oarrm1n10_set_item_ij_r( value, val[0], val[1], &self.arr)
  ...
  cdef __setitem__o(self,  object val, onumm1n10 value):
    ...
    if tval == int:
      ...
      if val < self.arr.nrows:
        ...
        oarrm1n10_set_slice_o( &value.num, starti, stopi, stepi, startj, stopj, stepj, &self.arr)
      ...
      if len(val) == 2:
        ...
        if ( tval0 == int and tval1 == int ):
          ...
          if val[0] < self.arr.nrows and val[1] < self.arr.ncols:
            ...
            oarrm1n10_set_item_ij_o( &value.num, val[0], val[1], &self.arr)
  ...
  cdef __setitem__O(self,  object val, omatm1n10 value):
    ...
    if tval == int:
      ...
      if val < self.arr.nrows:
        ...
        oarrm1n10_set_slice_O( &value.arr, starti, stopi, stepi, startj, stopj, stepj, &self.arr)
  ...
  def copy(self):
    ...
    cdef oarrm1n10_t res = oarrm1n10_copy(&self.arr)
  ...
  def __neg__(self):
    ...
    cdef oarrm1n10_t res = oarrm1n10_neg(&self.arr)
  ...
  def __add__(self, other):
    ...
    if (tlhs == trhs):
      ...
      res = oarrm1n10_sum_OO(&lhs.arr,&rhs.arr)
      ...
      res = oarrm1n10_sum_oO(&olhs.num,&rhs.arr)
      ...
      res = oarrm1n10_sum_oO(&orhs.num,&lhs.arr)
    
    elif (tlhs in number_types):
      
      rhs = other
      res = oarrm1n10_sum_rO(self, &rhs.arr)

    elif (trhs in number_types):
        
      lhs = self
      res = oarrm1n10_sum_rO(other, &lhs.arr)
      ...
      res = oarrm1n10_sum_RO(&dlhs.arr,&rhs.arr)
      ...
      res = oarrm1n10_sum_RO(&drhs.arr,&lhs.arr)
  ...
  def __sub__(self, other):
    ...
    if (tlhs == trhs):
      ...
      res = oarrm1n10_sub_OO(&lhs.arr,&rhs.arr)
      ...
      res = oarrm1n10_sub_oO(&olhs.num,&rhs.arr)
      ...
      res = oarrm1n10_sub_Oo(&lhs.arr, &orhs.num)
    
    elif (tlhs in number_types):
      
      rhs = other
      res = oarrm1n10_sub_rO(self, &rhs.arr)

    elif (trhs in number_types):
        
      lhs = self
      res = oarrm1n10_sub_Or(&lhs.arr, other)
      ...
      res = oarrm1n10_sub_RO(&dlhs.arr,&rhs.arr)
      ...
      res = oarrm1n10_sub_OR(&lhs.arr, &drhs.arr)
  ...
  def __mul__(self, other):
    ...
    if (tlhs == trhs):
      ...
      res = oarrm1n10_mul_OO(&lhs.arr,&rhs.arr)
      ...
      res = oarrm1n10_mul_oO(&olhs.num,&rhs.arr)
      ...
      res = oarrm1n10_mul_oO(&orhs.num,&lhs.arr)
    
    elif (tlhs in number_types):
      
      rhs = other
      res = oarrm1n10_mul_rO(self, &rhs.arr)

    elif (trhs in number_types):
        
      lhs = self
      res = oarrm1n10_mul_rO(other, &lhs.arr)
      ...
      res = oarrm1n10_mul_RO(&dlhs.arr,&rhs.arr)
      ...
      res = oarrm1n10_mul_RO(&drhs.arr,&lhs.arr)
  ...
  def __truediv__(self, other):
    ...
    if (tlhs == trhs):
      ...
      res = oarrm1n10_div_OO(&lhs.arr,&rhs.arr)
      ...
      res = oarrm1n10_div_oO(&olhs.num,&rhs.arr)
      ...
      res = oarrm1n10_div_Oo(&lhs.arr, &orhs.num)
    
    elif (tlhs in number_types):
      
      rhs = other
      res = oarrm1n10_div_rO(self, &rhs.arr)

    elif (trhs in number_types):
        
      lhs = self
      res = oarrm1n10_div_Or(&lhs.arr, other)
      ...
      res = oarrm1n10_div_RO(&dlhs.arr,&rhs.arr)
      ...
      res = oarrm1n10_div_OR(&lhs.arr, &drhs.arr)
  ...
  def __pow__(self, n,z):
    ...
    cdef oarrm1n10_t res 
    cdef omatm1n10 S = self

    res = oarrm1n10_pow( &S.arr, n)
  ...
  cpdef get_deriv(self, object hum_dir):
    """
    PURPOSE: Get the corresponding imaginary direction in the omatm1n10 object.
    """
    #*************************************************************************************************
    ...
    res_darr = oarrm1n10_get_deriv( item[ZERO],  item[ONE], &self.arr)
  ...
  cpdef get_im(self, object hum_dir):
    ...
    res_darr = oarrm1n10_get_im( item[ZERO],  item[ONE], &self.arr)
  ...
  cpdef extract_im(self, object hum_dir):
    ...
    res = oarrm1n10_extract_im( item[ZERO],  item[ONE], &self.arr)
  ...
  cpdef  extract_deriv(self, object hum_dir):
    ...
    res = oarrm1n10_extract_deriv( item[ZERO],  item[ONE], &self.arr)
  ...
  cpdef  get_order_im(self, ord_t order):
    ...
    res = oarrm1n10_get_order_im( order, &self.arr)
  ...
  cpdef  truncate( self, object humdir):
    ...
    res = oarrm1n10_truncate_im( indx, order, &self.arr) 
  ...
  cpdef set(self, object rhs):
    ...
    if   trhs is onumm1n10:
      ...
      orhs = rhs
      oarrm1n10_set_o( &orhs.num, &self.arr)

    elif trhs is omatm1n10:

      Orhs = rhs
      oarrm1n10_set_O( &Orhs.arr, &self.arr)      

    elif trhs in number_types:

      rrhs = rhs
      oarrm1n10_set_r( rrhs, &self.arr)

    else:

      raise ValueError( "Cant assign '{0}' into a omatm1n10 object.".format(trhs) )
  ...
  def get_active_bases(self):
    ...
    oarrm1n10_get_active_bases( &self.arr, bases_list)
  ...
  def taylor_integrate(self, object bases, object deltas):
    ...
    res = oarrm1n10_taylor_integrate( c_deltas, &self.arr)
  ...
  #***************************************************************************************************
  @staticmethod
  def dot( omatm1n10 lhs, omatm1n10 rhs, omatm1n10 out = None): 
    """
    ...
    if out is not None:
      ...
      oarrm1n10_matmul_OO_to( &lhs.arr, &rhs.arr ,&out.arr)

    else:

      res = oarrm1n10_matmul_OO( &lhs.arr, &rhs.arr )
  ...
  #***************************************************************************************************
  @staticmethod
  def inv( omatm1n10 arr,  omatm1n10 out = None): 
    """
    ...
    if out is not None:
      ...
      oarrm1n10_invert_to( &arr.arr,&out.arr)

    else:

      res = oarrm1n10_invert( &arr.arr)
  ...
  #***************************************************************************************************
  @staticmethod
  def transpose( omatm1n10 arr,  omatm1n10 out = None ): 
    """
    ...
    if out is not None:
      ...
      oarrm1n10_transpose_to( &arr.arr, &out.arr)

    else:

      res = oarrm1n10_transpose( &arr.arr)
  ...
  #***************************************************************************************************
  @staticmethod
  def add( omatm1n10 lhs, omatm1n10 rhs, omatm1n10 out = None): 
    """
    ...
    if out is not None:
      ...
      oarrm1n10_sum_OO_to( &lhs.arr, &rhs.arr ,&out.arr)
