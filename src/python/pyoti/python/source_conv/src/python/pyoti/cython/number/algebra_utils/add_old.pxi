...
# cdef object __add__FX__({fearr_pytype} Flhs, object rhs, object out = None):
#   """
#   PURPOSE:  Addition between {fearr_pytype} and object.
...
cdef object __add__OX__({arr_pytype} Olhs, object rhs, object out = None):
  """
  PURPOSE:  Addition between {arr_pytype} and an object.
  ...
  #   if res_flag:
  #     Fres = out
  #     {fenum_func}_sum_Of_to( &Orhs.arr, &flhs.num ,&Fres.arr)
  #   else:      
  #     cFres = {fenum_func}_sum_Of( &Orhs.arr, &flhs.num)
  #     res = {fearr_pytype}.create(&cFres)
  #   # end if
    ...
    if res_flag:
      ...
      cOres = {arr_func}_sum_OO( &Orhs.arr, &Orhs.arr)
      res = {arr_pytype}.create( &cOres )
    # end if
...
cdef object __add__RX__(dmat Rlhs, object rhs, object out = None):
  """
  PURPOSE:  Addition between {num_pytype} and an object.
  ...
  #   if res_flag:
  #     ores = out
  #     {num_func}_sum_Ro_to( &Rlhs.arr, &orhs.num ,&ores.num)
  #   else:
  #     cores = {num_func}_sum_Ro( &Rlhs.arr, &orhs.num )
  ...
  #   if res_flag:
  #     fres = out
  #     {fenum_func}_sum_Rf_to( &Rlhs.arr, &frhs.num ,&fres.num)
  #   else:      
  #     cfres = {fenum_func}_sum_Rf( &Rlhs.arr, &frhs.num)
...
cdef object __add__fX__({fenum_pytype} flhs, object rhs, object out = None):
  """
  PURPOSE:  Addition between {fenum_pytype} and an object.
  ...
  #   if res_flag:
  #     Rres = out
  #     {fenum_func}_sum_Rf_to( &Rrhs.arr, &flhs.num ,&Fres.arr)
  #   else:      
  #     cFres = {fenum_func}_sum_Rf( &Rrhs.arr, &flhs.num)
  #     res = {fearr_pytype}.create(&cFres)
  #   # end if
...
cdef object __add__oX__({num_pytype} olhs, object rhs, object out = None):
  ...
  #   if res_flag:
  #     Ores = out
  #     {num_func}_sum_oR_to( &olhs.num, &Rrhs.arr ,&Ores.arr)
  #   else:      
  #     cOres = {num_func}_sum_oR( &olhs.num, &Rrhs.arr)
  #     res = {arr_pytype}.create(&cOres)
  #   # end if
