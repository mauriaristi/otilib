...
onumm1n9_t onumm1n9_div_ro(coeff_t num, onumm1n9_t* den){
    ...
    onumm1n9_t inv = onumm1n9_pow(den,-1);
    onumm1n9_t res = onumm1n9_mul_ro(num,&inv);
...
onumm1n9_t onumm1n9_div_oo(onumm1n9_t* num, onumm1n9_t* den){
    ...
    onumm1n9_t res = onumm1n9_mul_oo(num,&inv);
...
onumm1n9_t onumm1n9_div_or(onumm1n9_t* num, coeff_t val){
    ...
    return onumm1n9_mul_ro(1.0/val,num);
...
onumm1n9_t onumm1n9_feval(coeff_t* feval_re, onumm1n9_t* x){
  ...
  onumm1n9_t deltax = (*x), deltax_power = (*x);
  deltax.r = 0.0;
  deltax_power.r = 0.0;
  onumm1n9_set_r(0.0, &res);
  //  Real
  res.r = feval_re[0];
  // Order 1
  factor *=1;
  coef    = feval_re[1]/ factor;;
  onumm1n9_gem_ro_to( coef, &deltax_power, &res, &res);
  deltax_power = onumm1n9_mul_oo(&deltax_power,&deltax);
  // Order 2
  factor *=2;
