...
cdef object __add__OX__(omatm9n2 Olhs, object rhs, object out = None):
  """
  PORPUSE: Addition between omatm9n2 and object.
  ...
  if trhs == onumm9n2:
    ...
    if res_flag:
      ...
      cOres = oarrm9n2_sum_OO( &Olhs.arr, &Orhs.arr )
      res = omatm9n2.create( &cOres )
    # end if
  elif trhs == dmat:
    Rrhs = rhs
...
cdef object __add__oX__(onumm9n2 olhs, object rhs, object out = None):
  """
  PORPUSE: Addition between onumm9n2 and object.
...
cdef object __add__fX__(feonumm9n2 flhs, object rhs, object out = None):
  """
  PORPUSE: Addition between feonumm9n2 and object.
