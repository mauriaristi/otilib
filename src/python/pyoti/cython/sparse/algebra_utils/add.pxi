...
cdef object __add__OX__(matso Olhs, object rhs, object out = None):
  """
  PORPUSE: Addition between matso and object.
  ...
  if trhs == sotinum:
    ...
    if res_flag:
      ...
      cOres = arrso_sum_OO( &Olhs.arr, &Orhs.arr, dhl )
      res = matso.create( &cOres )
    # end if
  elif trhs == dmat:
    Rrhs = rhs
...
cdef object __add__oX__(sotinum olhs, object rhs, object out = None):
  """
  PORPUSE: Addition between sotinum and object.
...
cdef object __add__fX__(sotife flhs, object rhs, object out = None):
  """
  PORPUSE: Addition between sotife and object.
