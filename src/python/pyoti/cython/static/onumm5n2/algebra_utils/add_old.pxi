...
# cdef object __add__FX__(feomatm5n2 Flhs, object rhs, object out = None):
#   """
#   PURPOSE:  Addition between feomatm5n2 and object.
...
cdef object __add__OX__(omatm5n2 Olhs, object rhs, object out = None):
  """
  PURPOSE:  Addition between omatm5n2 and an object.
  ...
  #   if res_flag:
  #     Fres = out
  #     feonumm5n2_sum_Of_to( &Orhs.arr, &flhs.num ,&Fres.arr)
  #   else:      
  #     cFres = feonumm5n2_sum_Of( &Orhs.arr, &flhs.num)
  #     res = feomatm5n2.create(&cFres)
  #   # end if
    ...
    if res_flag:
      ...
      cOres = oarrm5n2_sum_OO( &Orhs.arr, &Orhs.arr)
      res = omatm5n2.create( &cOres )
    # end if
...
cdef object __add__RX__(dmat Rlhs, object rhs, object out = None):
  """
  PURPOSE:  Addition between onumm5n2 and an object.
  ...
  #   if res_flag:
  #     ores = out
  #     onumm5n2_sum_Ro_to( &Rlhs.arr, &orhs.num ,&ores.num)
  #   else:
  #     cores = onumm5n2_sum_Ro( &Rlhs.arr, &orhs.num )
  ...
  #   if res_flag:
  #     fres = out
  #     feonumm5n2_sum_Rf_to( &Rlhs.arr, &frhs.num ,&fres.num)
  #   else:      
  #     cfres = feonumm5n2_sum_Rf( &Rlhs.arr, &frhs.num)
...
cdef object __add__fX__(feonumm5n2 flhs, object rhs, object out = None):
  """
  PURPOSE:  Addition between feonumm5n2 and an object.
  ...
  #   if res_flag:
  #     Rres = out
  #     feonumm5n2_sum_Rf_to( &Rrhs.arr, &flhs.num ,&Fres.arr)
  #   else:      
  #     cFres = feonumm5n2_sum_Rf( &Rrhs.arr, &flhs.num)
  #     res = feomatm5n2.create(&cFres)
  #   # end if
...
cdef object __add__oX__(onumm5n2 olhs, object rhs, object out = None):
  ...
  #   if res_flag:
  #     Ores = out
  #     onumm5n2_sum_oR_to( &olhs.num, &Rrhs.arr ,&Ores.arr)
  #   else:      
  #     cOres = onumm5n2_sum_oR( &olhs.num, &Rrhs.arr)
  #     res = omatm5n2.create(&cOres)
  #   # end if
