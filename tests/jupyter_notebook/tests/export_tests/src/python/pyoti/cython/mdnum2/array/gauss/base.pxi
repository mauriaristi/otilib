...
cdef class femdarr2_t:
  ...
  def __init__(self, shape, uint64_t nip, ord_t order = 0, bases_t nbases = 0): 
    """
    PURPOSE:      Python level constructor of the femdarr2_t class.
    ...
    if (isinstance(shape, tuple)):
      ...
      if( ndim == 1 ):
        ...
        raise ValueError("Cant create femdarr2_t for dimensions greater than 2.")
  ...
  #***************************************************************************************************
  @staticmethod
  cdef femdarr2_t create(femdarr2_t* arr, uint8_t FLAGS = 1):
    """
    ...
    cdef femdarr2_t res = <femdarr2_t> femdarr2_t.__new__(femdarr2_t)
  ...
  def  __getitem__(self, val):
    ...
    #   res  = mdnum2_t.create( &ores, FLAGS = 0 )
  ...
  def __setitem__(self, indices, value):
    ...
    if ( tvalue == mdnum2_t ):
    ...
    elif ( tvalue == femdnum2_t ):

      self.__setitem__f( indices, value )

    elif ( tvalue == mdarr2_t ):

      self.__setitem__O( indices, value )

    elif ( tvalue == femdarr2_t ):
      ...
      raise IndexError("ERROR: Cant set item of type {0} in mdarr2_t object.".format(tvalue))
    # end if 
  ...
  cdef __setitem__o(self,  object val, mdnum2_t value):
    """
    PURPOSE: Set item from mdnum2_t value.
    """
    #*************************************************************************************************
  ...
  #***************************************************************************************************
  cdef __setitem__f(self,  object val, femdnum2_t value):
    """
    PURPOSE: Set item from femdnum2_t value.
    """
    #*************************************************************************************************
  ...
  #***************************************************************************************************
  cdef __setitem__F(self,  object val, femdarr2_t value):
    """
    PURPOSE: Set item from femdarr2_t value.
    """
    #*************************************************************************************************
  ...
  def __add__(self, other):
    ...
    cdef femdarr2_t res 
    cdef femdarr2_t Flhs,Frhs
    cdef femdnum2_t  flhs,frhs
    cdef dmat    Dlhs,Drhs
    cdef mdnum2_t olhs,orhs
    cdef mdarr2_t   Olhs,Orhs
  ...
  cpdef set(self, object rhs):
    ...
    # elif trhs is mdarr2_t:

    #   Orhs = rhs
    #   femdarr2_set_O( &Orhs.arr, &self.arr)   

    # elif trhs is femdarr2_t:
    ...
    #   femdarr2_set_F( &Frhs.arr, &self.arr)   
      ...
      try:
        ...
        raise ValueError("Supported values are real scalar, mdnum2_t and femdnum2_t.")
  ...
  #***************************************************************************************************
  cpdef  get_item_ij( self, int64_t i, int64_t j, femdnum2_t out=None):
    """
    PURPOSE:      Get an item from femdarr2_t array.
  ...
  cpdef  get_order_im(self, ord_t order):
    """
    PURPOSE: Get the corresponding derivative in the mdarr2_t object, as OTI number.
    """
    #*************************************************************************************************
  ...
  def get_active(self):
    ...
    femdarr2_get_active( &self.arr, bases_list)
