...
cdef class csr_omatm2n5:
  ...
  def __init__(self, arg1, shape=None, copy = True): 
    """
    PURPOSE:      Python level constructor of the csr_omatm2n5 class.

    DESCRIPTION:  Creates a new empty csr_omatm2n5 matrix.
                 
    """
    #*************************************************************************************************
    
    cdef uint64_t i, j, k, ncols, nrows
    cdef lil_omatm2n5 lil
    
    targ1 = type(arg1)

    if targ1 == lil_omatm2n5 :
      ...
      if len(arg1) == 3: # Same as in scipy csr sparse.
        ...
        for i in range(data.size):
          ...
          if type(data) == onumm2n5:

            self.data[i] = data[i].copy()

          else:
            
            self.data[i] = onumm2n5( data[i] )
  ...
  def copy(self):
    ...
    cdef csr_omatm2n5 res = <csr_omatm2n5> csr_omatm2n5.__new__(csr_omatm2n5)
    cdef object[:]   data
  ...
  def __pow__(self, n,z):
    ...
    cdef onumm2n5 ores, oval
    cdef uint64_t i
    cdef csr_omatm2n5 res
    ...
    for i in range(self.data.size):
      ...
      ores = res.data[i]
      oval = self.data[i]
      onumm2n5_pow_to( &oval.num, n, &ores.num)
...
# ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
# :::::::::::::::::::::::::::::::::::: END OF CLASS csr_omatm2n5 ::::::::::::::::::::::::::::::::::::::::
# ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::

# ****************************************************************************************************
cdef void csromatm2n5_matmul_SO_to(csr_omatm2n5 lhs, omatm2n5 rhs, omatm2n5 res):
  """
...
# ****************************************************************************************************
cdef omatm2n5 csromatm2n5_matmul_SO(csr_omatm2n5 lhs, omatm2n5 rhs):
  """
  PORPUSE:  Perform matrix-matrix multiplication between csr matrix and dense matrix.
  ...
  csromatm2n5_matmul_SO_to( lhs, rhs, res)
