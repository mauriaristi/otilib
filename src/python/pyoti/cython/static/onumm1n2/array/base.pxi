...
cdef class omatm1n2:
  ...
  def __init__(self, realArray): 
    """
    PURPOSE:      Python level constructor of the omatm1n2 class.
    ...
    if isinstance( realArray, np.ndarray):
      ...
      if ( ndim >= 3 ):
        ...
        self.arr = oarrm1n2_zeros( nrows, ncols)

        for i in range(self.arr.nrows):
      
          val = realArray[i]
          oarrm1n2_set_item_i_r( val, i, &self.arr)
        ...
        for i in range(self.arr.nrows):      
          for j in range(self.arr.ncols):
            ...
            val = realArray[i,j]
            oarrm1n2_set_item_ij_r( val, i, j, &self.arr)
  ...
  def T(self): 
    ...
    res = oarrm1n2_transpose( &self.arr)
  ...
  def order(self): 
    ...
    return oarrm1n2_get_order(&self.arr)
  ...
  #***************************************************************************************************
  @staticmethod
  cdef omatm1n2 create(oarrm1n2_t* arr, uint8_t FLAGS = 1):
    """
    ...
    cdef omatm1n2 mat = <omatm1n2> omatm1n2.__new__(omatm1n2)
  ...
  def __repr__(self):
    ...
    #   out += "["
    #   for j in range(self.arr.ncols):
    #     d_onumm1n2 = oarrm1n2_get_item_ij(&self.arr, i, j)
    #     out+= (onumm1n2.create(&d_onumm1n2,FLAGS=0)).__str__()+", "
    #   # end for 
    #   out = out[:-2] + "],\n"
    # # end for 
    # out =out[:-2] + "]"
  ...
  def  __getitem__(self, val):
    ...
    if tval == int:
      ...
      if val < self.arr.nrows:
        ...
        Ores = oarrm1n2_get_slice( &self.arr, starti, stopi, stepi, startj, stopj, stepj)
        res  = omatm1n2.create(&Ores)
  ...
  cdef __setitem__r(self, object val, coeff_t value):
    ...
    if tval == int:
      ...
      if val < self.arr.nrows:
        ...
        oarrm1n2_set_slice_r( value, starti, stopi, stepi, startj, stopj, stepj, &self.arr)
      ...
      if len(val) == 2:
        ...
        if ( tval0 == int and tval1 == int ):
          ...
          if val[0] < self.arr.nrows and val[1] < self.arr.ncols:
            ...
            oarrm1n2_set_item_ij_r( value, val[0], val[1], &self.arr)
  ...
  cdef __setitem__o(self,  object val, onumm1n2 value):
    ...
    if tval == int:
      ...
      if val < self.arr.nrows:
        ...
        oarrm1n2_set_slice_o( &value.num, starti, stopi, stepi, startj, stopj, stepj, &self.arr)
      ...
      if len(val) == 2:
        ...
        if ( tval0 == int and tval1 == int ):
          ...
          if val[0] < self.arr.nrows and val[1] < self.arr.ncols:
            ...
            oarrm1n2_set_item_ij_o( &value.num, val[0], val[1], &self.arr)
  ...
  cdef __setitem__O(self,  object val, omatm1n2 value):
    ...
    if tval == int:
      ...
      if val < self.arr.nrows:
        ...
        oarrm1n2_set_slice_O( &value.arr, starti, stopi, stepi, startj, stopj, stepj, &self.arr)
  ...
  def copy(self):
    ...
    cdef oarrm1n2_t res = oarrm1n2_copy(&self.arr)
  ...
  def __pow__(self, n,z):
    ...
    cdef oarrm1n2_t res 
    cdef omatm1n2 S = self

    res = oarrm1n2_pow( &S.arr, n)
  ...
  cpdef get_deriv(self, object hum_dir):
    ...
    res_darr = oarrm1n2_get_deriv( item[ZERO],  item[ONE], &self.arr)
  ...
  cpdef get_im(self, object hum_dir):
    ...
    res_darr = oarrm1n2_get_im( item[ZERO],  item[ONE], &self.arr)
  ...
  cpdef extract_im(self, object hum_dir):
    ...
    res = oarrm1n2_extract_im( item[ZERO],  item[ONE], &self.arr)
  ...
  cpdef  extract_deriv(self, object hum_dir):
    ...
    res = oarrm1n2_extract_deriv( item[ZERO],  item[ONE], &self.arr)
  ...
  cpdef  get_order_im(self, ord_t order):
    ...
    res = oarrm1n2_get_order_im( order, &self.arr)
  ...
  cpdef  truncate( self, object humdir):
    ...
    res = oarrm1n2_truncate_im( indx, order, &self.arr) 
  ...
  cpdef set(self, object rhs):
    ...
    if   trhs is onumm1n2:
      ...
      orhs = rhs
      oarrm1n2_set_o( &orhs.num, &self.arr)

    elif trhs is omatm1n2:

      Orhs = rhs
      oarrm1n2_set_O( &Orhs.arr, &self.arr)      

    elif trhs in number_types:

      rrhs = rhs
      oarrm1n2_set_r( rrhs, &self.arr)

    else:

      raise ValueError( "Cant assign '{0}' into a omatm1n2 object.".format(trhs) )
  ...
  def get_active_bases(self):
    ...
    oarrm1n2_get_active_bases( &self.arr, bases_list)
  ...
  def taylor_integrate(self, object bases, object deltas):
    ...
    res = oarrm1n2_taylor_integrate( c_deltas, &self.arr)
  ...
  #***************************************************************************************************
  @staticmethod
  def dot( omatm1n2 lhs, omatm1n2 rhs, omatm1n2 out = None): 
    """
    ...
    if out is not None:
      ...
      oarrm1n2_matmul_OO_to( &lhs.arr, &rhs.arr ,&out.arr)

    else:

      res = oarrm1n2_matmul_OO( &lhs.arr, &rhs.arr )
  ...
  #***************************************************************************************************
  @staticmethod
  def inv( omatm1n2 arr,  omatm1n2 out = None): 
    """
    ...
    if out is not None:
      ...
      oarrm1n2_invert_to( &arr.arr,&out.arr)

    else:

      res = oarrm1n2_invert( &arr.arr)
  ...
  #***************************************************************************************************
  @staticmethod
  def transpose( omatm1n2 arr,  omatm1n2 out = None ): 
    """
    ...
    if out is not None:
      ...
      oarrm1n2_transpose_to( &arr.arr, &out.arr)

    else:

      res = oarrm1n2_transpose( &arr.arr)
  ...
  #***************************************************************************************************
  @staticmethod
  def add( omatm1n2 lhs, omatm1n2 rhs, omatm1n2 out = None): 
    """
    ...
    if out is not None:
      ...
      oarrm1n2_sum_OO_to( &lhs.arr, &rhs.arr ,&out.arr)
