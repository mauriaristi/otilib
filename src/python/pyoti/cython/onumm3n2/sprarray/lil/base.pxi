...
cdef class lil_oarrm3n2_t:
  ...
  def __init__(self, shape): 
    """
    PURPOSE:      Python level constructor of the lil_oarrm3n2_t class.

    DESCRIPTION:  Creates a new empty lil_oarrm3n2_t matrix.
  ...
  def copy(self):
    ...
    cdef lil_oarrm3n2_t res = lil_oarrm3n2_t(self.shape)
    cdef uint64_t i, k
  ...
  def tocsr(self):
    ...
    """
    return csr_oarrm3n2_t(self,shape=self.shape)
