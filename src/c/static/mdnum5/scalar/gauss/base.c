...
ord_t femdnum5_get_order( femdnum5_t* num ){
    ...
    for( i = 0; i<num->nip; i++ ){
        ...
        order = MAX(order, mdnum5_get_order(&num->p_data[i]) );
...
void femdnum5_get_order_im_to( ord_t order, femdnum5_t* num, femdnum5_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        mdnum5_get_order_im_to( order, &num->p_data[k], &res->p_data[k]);
...
femdnum5_t femdnum5_get_order_im( ord_t order, femdnum5_t* num){
    ...
    res = femdnum5_zeros( num->nip);

    femdnum5_get_order_im_to( order, num, &res);
...
void femdnum5_extract_im_to( imdir_t idx, ord_t order, femdnum5_t* num, femdnum5_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        mdnum5_extract_im_to( idx, order, &num->p_data[k], &res->p_data[k]);
...
femdnum5_t femdnum5_extract_im( imdir_t idx, ord_t order, femdnum5_t* num){
    ...
    femdnum5_extract_im_to( idx, order, num, &res);
...
void femdnum5_extract_deriv_to( imdir_t idx, ord_t order, femdnum5_t* num, femdnum5_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        mdnum5_extract_deriv_to( idx, order, &num->p_data[k], &res->p_data[k]);
...
femdnum5_t femdnum5_extract_deriv( imdir_t idx, ord_t order, femdnum5_t* num){
    ...
    femdnum5_extract_deriv_to( idx, order, num, &res);
...
void femdnum5_get_deriv_to( imdir_t idx, ord_t order, femdnum5_t* num, femdnum5_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        mdnum5_get_deriv_to( idx, order, &num->p_data[k], &res->p_data[k]);
...
femdnum5_t femdnum5_get_deriv( imdir_t idx, ord_t order, femdnum5_t* num){
    ...
    femdnum5_get_deriv_to( idx, order, num, &res);
...
void femdnum5_get_im_to( imdir_t idx, ord_t order, femdnum5_t* num, femdnum5_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        mdnum5_get_im_to_o( idx, order, &num->p_data[k], &res->p_data[k]);
...
femdnum5_t femdnum5_get_im( imdir_t idx, ord_t order, femdnum5_t* num){
    ...
    femdnum5_get_im_to( idx, order, num, &res);
...
void femdnum5_truncate_im_to( imdir_t idx, ord_t order, femdnum5_t* num,  femdnum5_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        mdnum5_truncate_im_to( idx, order, &num->p_data[k], &res->p_data[k]);
...
femdnum5_t femdnum5_truncate_im( imdir_t idx, ord_t order, femdnum5_t* num){
    ...
    femdnum5_truncate_im_to( idx, order, num, &res);
...
void femdnum5_set_im_r( coeff_t val, imdir_t idx, ord_t order, femdnum5_t* num){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        mdnum5_set_im_r( val, idx, order, &num->p_data[k]);
...
void femdnum5_set_im_o( mdnum5_t* val, imdir_t idx, ord_t order, femdnum5_t* num){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        mdnum5_set_im_o( val, idx, order, &num->p_data[k]);
...
void femdnum5_set_im_f( femdnum5_t* val, imdir_t idx, ord_t order, femdnum5_t* num){
    ...
    femdnum5_dimCheck(val,num);

    for (k = 0; k<num->nip; k++ ){
        
        mdnum5_set_im_o( &val->p_data[k], idx, order, &num->p_data[k]);
...
void femdnum5_set_deriv_r( coeff_t val, imdir_t idx, ord_t order, femdnum5_t* num){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        mdnum5_set_deriv_r( val, idx, order, &num->p_data[k]);
...
void femdnum5_set_deriv_o( mdnum5_t* val, imdir_t idx, ord_t order, femdnum5_t* num){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        mdnum5_set_deriv_o( val, idx, order, &num->p_data[k]);
...
void femdnum5_set_deriv_f( femdnum5_t* val, imdir_t idx, ord_t order, femdnum5_t* num){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        mdnum5_set_deriv_o( &val->p_data[k], idx, order, &num->p_data[k]);
...
// ****************************************************************************************************
void femdnum5_set_to( femdnum5_t* src, femdnum5_t* dst){
    
    uint64_t i;

    femdnum5_dimCheck(src,dst);

    for (i = 0; i<src->nip; i++ ){
        
        mdnum5_copy_to( &src->p_data[i], &dst->p_data[i]);
...
femdnum5_t femdnum5_copy( femdnum5_t* src){
    ...
    res = femdnum5_createEmpty(src->nip);

    femdnum5_copy_to( src, &res);
...
void femdnum5_set_item_k_o( mdnum5_t* num, uint64_t k, femdnum5_t* res){
    ...
    if (k < res->nip){
        ...
        mdnum5_set_o(num, &res->p_data[k]); 

    } else {

        printf("ERROR: Index out of bounds in femdnum5_get_item_k.\n");
...
void femdnum5_get_item_k_to(femdnum5_t* num, uint64_t k, mdnum5_t* res){
    ...
    if (k < num->nip){
        ...
        mdnum5_copy_to( &num->p_data[k], res);
...
// ****************************************************************************************************
femdnum5_t femdnum5_zeros(uint64_t nip){

    femdnum5_t  res  = femdnum5_createEmpty(nip);
    
    femdnum5_set_r( 0.0, &res);
...
// ****************************************************************************************************
inline femdnum5_t femdnum5_createEmpty(uint64_t nip){

    femdnum5_t  res ;  
    void * memory = NULL;

    // Allocate memory and check if correctly allocated.
    memory = malloc( nip * sizeof( mdnum5_t ) );

    if ( memory == NULL ){
        printf("ERROR: Not enough memory to handle array of femdnum5.\n Exiting...\n");
        exit(OTI_OutOfMemory); // TODO: Raise error instead of quitting the program.
    }
    
    res.p_data = ( mdnum5_t* ) memory;
    res.nip = nip;
...
// ****************************************************************************************************
inline femdnum5_t femdnum5_init(void){
...
// ****************************************************************************************************
inline femdnum5_t femdnum5_empty_like(femdnum5_t* arr){

    femdnum5_t res = femdnum5_createEmpty(arr->nip);
