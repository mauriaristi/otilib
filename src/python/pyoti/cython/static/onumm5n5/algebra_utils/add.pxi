...
cdef object __add__OX__(omatm5n5 Olhs, object rhs, object out = None):
  """
  PORPUSE: Addition between omatm5n5 and object.
  ...
  if trhs == onumm5n5:
    ...
    if res_flag:
      ...
      cOres = oarrm5n5_sum_OO( &Olhs.arr, &Orhs.arr )
      res = omatm5n5.create( &cOres )
    # end if
  elif trhs == dmat:
    Rrhs = rhs
...
cdef object __add__oX__(onumm5n5 olhs, object rhs, object out = None):
  """
  PORPUSE: Addition between onumm5n5 and object.
...
cdef object __add__fX__(feonumm5n5 flhs, object rhs, object out = None):
  """
  PORPUSE: Addition between feonumm5n5 and object.
