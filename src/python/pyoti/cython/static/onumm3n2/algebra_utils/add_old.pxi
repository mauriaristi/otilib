...
# ARRAY
#*****************************************************************************************************
cdef object __add__FX__(feomatm3n2 Flhs, object rhs, object out = None):
  """
  PORPUSE: Addition between feomatm3n2 and object.
...
# cdef object __add__FX__(feomatm3n2 Flhs, object rhs, object out = None):
#   """
#   PURPOSE:  Addition between feomatm3n2 and object.
...
#*****************************************************************************************************
cdef object __add__OX__(omatm3n2 Olhs, object rhs, object out = None):
  """
  PURPOSE:  Addition between omatm3n2 and an object.
...
cdef object __add__RX__(dmat Rlhs, object rhs, object out = None):
  """
  PURPOSE:  Addition between onumm3n2 and an object.
...
#*****************************************************************************************************
cdef object __add__fX__(feonumm3n2 flhs, object rhs, object out = None):
  """
  PURPOSE:  Addition between feonumm3n2 and an object.
...
#*****************************************************************************************************
cdef object __add__oX__(onumm3n2 olhs, object rhs, object out = None):
  """
  PURPOSE:  Addition between onumm3n2 and an object.
