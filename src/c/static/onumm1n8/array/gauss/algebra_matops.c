...
feonumm1n8_t feoarrm1n8_dotproduct_FF(feoarrm1n8_t* lhs, feoarrm1n8_t* rhs){
    ...
    res = feonumm1n8_createEmpty( rhs->nip);

    feoarrm1n8_dotproduct_FF_to(lhs, rhs, &res);
...
void feoarrm1n8_dotproduct_FF_to(feoarrm1n8_t* lhs, feoarrm1n8_t* rhs, feonumm1n8_t* res){
    ...
    // Check Dimensions
    feoarrm1n8_dimCheck_FF_samesize(lhs, rhs, res);

    for (i = 0; i<res->nip; i++){

        oarrm1n8_dotproduct_OO_to( &lhs->p_data[i], &rhs->p_data[i], &res->p_data[i] );
...
feonumm1n8_t feoarrm1n8_dotproduct_OF(oarrm1n8_t* lhs, feoarrm1n8_t* rhs){
    ...
    feoarrm1n8_dotproduct_OF_to( lhs, rhs, &res);
...
void feoarrm1n8_dotproduct_OF_to( oarrm1n8_t* lhs, feoarrm1n8_t* rhs, feonumm1n8_t* res){
    ...
    // Check Dimensions
    feoarrm1n8_dimCheck_OF_samesize(lhs, rhs, res);

    for (i = 0; i < res->nip; i++){

        oarrm1n8_dotproduct_OO_to( lhs, &rhs->p_data[i], &res->p_data[i] );
...
feonumm1n8_t feoarrm1n8_dotproduct_RF( darr_t* lhs, feoarrm1n8_t* rhs){
    ...
    feoarrm1n8_dotproduct_RF_to( lhs, rhs, &res);
...
void feoarrm1n8_dotproduct_RF_to( darr_t* lhs, feoarrm1n8_t* rhs, feonumm1n8_t* res){
    ...
    // Check Dimensions
    feoarrm1n8_dimCheck_RF_samesize(lhs, rhs, res);

    for (i = 0; i < res->nip; i++){

        oarrm1n8_dotproduct_RO_to( lhs, &rhs->p_data[i], &res->p_data[i] );
...
feoarrm1n8_t feoarrm1n8_matmul_FF(feoarrm1n8_t* lhs, feoarrm1n8_t* rhs){
    ...
    // Check dimensions.
    res = feoarrm1n8_createEmpty( lhs->nrows, rhs->ncols, lhs->nip);

    feoarrm1n8_matmul_FF_to( lhs, rhs, &res);
...
void feoarrm1n8_matmul_FF_to(feoarrm1n8_t* lhs, feoarrm1n8_t* rhs, feoarrm1n8_t* res){
    ...
    // Check Dimensions
    feoarrm1n8_dimCheck_FF_matmul(lhs, rhs, res);

    for (i = 0; i<res->nip; i++){

        oarrm1n8_matmul_OO_to( &lhs->p_data[i], &rhs->p_data[i], &res->p_data[i] );
...
feoarrm1n8_t feoarrm1n8_matmul_OF(oarrm1n8_t* lhs, feoarrm1n8_t* rhs){
    ...
    // Check dimensions.
    res = feoarrm1n8_createEmpty( lhs->nrows, rhs->ncols, rhs->nip);

    feoarrm1n8_matmul_OF_to( lhs, rhs, &res);
...
void feoarrm1n8_matmul_OF_to(oarrm1n8_t* lhs, feoarrm1n8_t* rhs, feoarrm1n8_t* res){
    ...
    // Check Dimensions
    feoarrm1n8_dimCheck_OF_matmul(lhs, rhs, res);

    for (i = 0; i<res->nip; i++){

        oarrm1n8_matmul_OO_to( lhs, &rhs->p_data[i], &res->p_data[i] );
...
feoarrm1n8_t feoarrm1n8_matmul_FO(feoarrm1n8_t* lhs, oarrm1n8_t* rhs){
    ...
    feoarrm1n8_matmul_FO_to( lhs, rhs, &res);
...
void feoarrm1n8_matmul_FO_to(feoarrm1n8_t* lhs, oarrm1n8_t* rhs, feoarrm1n8_t* res){
    ...
    // Check Dimensions
    feoarrm1n8_dimCheck_FO_matmul(lhs, rhs, res);

    for (i = 0; i<res->nip; i++){

        oarrm1n8_matmul_OO_to( &lhs->p_data[i], rhs, &res->p_data[i] );
...
feoarrm1n8_t feoarrm1n8_matmul_RF(darr_t* lhs, feoarrm1n8_t* rhs){
    ...
    feoarrm1n8_matmul_RF_to( lhs, rhs, &res);
...
void feoarrm1n8_matmul_RF_to(darr_t* lhs, feoarrm1n8_t* rhs, feoarrm1n8_t* res){
    ...
    // Check Dimensions
    feoarrm1n8_dimCheck_RF_matmul(lhs, rhs, res);

    for (i = 0; i<res->nip; i++){

        oarrm1n8_matmul_RO_to( lhs, &rhs->p_data[i], &res->p_data[i] );
...
feoarrm1n8_t feoarrm1n8_matmul_FR(feoarrm1n8_t* lhs, darr_t* rhs){
    ...
    feoarrm1n8_matmul_FR_to( lhs, rhs, &res);
...
void feoarrm1n8_matmul_FR_to(feoarrm1n8_t* lhs, darr_t* rhs, feoarrm1n8_t* res){
    ...
    // Check Dimensions
    feoarrm1n8_dimCheck_FR_matmul(lhs, rhs, res);

    for (i = 0; i<res->nip; i++){

        oarrm1n8_matmul_OR_to( &lhs->p_data[i], rhs, &res->p_data[i] );
...
feonumm1n8_t feoarrm1n8_norm(feoarrm1n8_t* arr){
    ...
    res = feonumm1n8_createEmpty( arr->nip);

    feoarrm1n8_norm_to( arr, &res );
...
void feoarrm1n8_norm_to(feoarrm1n8_t* arr, feonumm1n8_t* res){
    ...
    for (i = 0; i<arr->nip; i++){
        ...
        oarrm1n8_pnorm_to( &arr->p_data[i], 2.0, &res->p_data[i]);
...
void feoarrm1n8_pnorm_to(feoarrm1n8_t* arr, coeff_t p, feonumm1n8_t* res){
    ...
    for (i = 0; i<arr->nip; i++){
        ...
        oarrm1n8_pnorm_to( &arr->p_data[i], p, &res->p_data[i]);
...
void feoarrm1n8_det_to(feoarrm1n8_t* arr, feonumm1n8_t* res){
    ...
    // Check dimensions (squareness)
    feoarrm1n8_dimCheck_F_squareness( arr, arr);
    feoarrm1n8_dimCheck_fF_elementwise(res,arr,arr);

    for (i = 0; i<arr->nip; i++){
        
        oarrm1n8_det_to( &arr->p_data[i], &res->p_data[i]);
...
void feoarrm1n8_invert_to(feoarrm1n8_t* arr, feoarrm1n8_t* res){
    ...
    feoarrm1n8_dimCheck_F_squareness( arr, res);
    
    for (i = 0; i<arr->nip; i++){

        oarrm1n8_invert_to( &arr->p_data[i], &res->p_data[i]);
...
feoarrm1n8_t feoarrm1n8_transpose(feoarrm1n8_t* arr){
    ...
    res = feoarrm1n8_createEmpty( arr->ncols, arr->nrows, arr->nip);
    
    feoarrm1n8_transpose_to( arr, &res );
...
void feoarrm1n8_transpose_to(feoarrm1n8_t* arr, feoarrm1n8_t* res){
    ...
    // Check dimensions.
    feoarrm1n8_dimCheck_F_transpose( arr, res);
    
    for (i = 0; i<arr->nip; i++){

        oarrm1n8_transpose_to( &arr->p_data[i], &res->p_data[i]);
