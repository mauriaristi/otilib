...
#     res = onumm20n1_createReal(0.0, order)

#     # Set the coefficient to 1.
#     onumm20n1_set_item(1.0, indx_hd, order_hd, &res)

#   else:

#     res = onumm20n1_createReal(0.0, order_hd)
...
#   """
#   PURPOSE:  Return the derivative selected from a numpy array of onumm20n1_ts.
