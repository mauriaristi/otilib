...
void oarrm10n1_taylor_integrate_to( coeff_t* deltas, oarrm10n1_t* arr, oarrm10n1_t* res){
    ...
    oarrm10n1_dimCheck_OO_elementwise(arr,res,res);

    for (i = 0; i<arr->size; i++ ){
        
        onumm10n1_taylor_integrate_to( deltas, &arr->p_data[i], &res->p_data[i]);
...
oarrm10n1_t oarrm10n1_taylor_integrate( coeff_t* deltas, oarrm10n1_t* arr){
    ...
    oarrm10n1_taylor_integrate_to( deltas, arr, &res);
...
void oarrm10n1_get_order_im_to( ord_t order, oarrm10n1_t* arr, oarrm10n1_t* res){
    ...
    for (i = 0; i<arr->size; i++ ){
        ...
        onumm10n1_get_order_im_to( order, &arr->p_data[i], &res->p_data[i]);
...
oarrm10n1_t oarrm10n1_get_order_im( ord_t order, oarrm10n1_t* arr){
    ...
    oarrm10n1_get_order_im_to( order, arr, &res);
...
void oarrm10n1_truncate_im_to( imdir_t idx, ord_t order, oarrm10n1_t* arr, oarrm10n1_t* res){
    ...
    for (i = 0; i<arr->size; i++ ){
        ...
        onumm10n1_truncate_im_to( idx, order, &arr->p_data[i], &res->p_data[i]);
...
oarrm10n1_t oarrm10n1_truncate_im( imdir_t idx, ord_t order, oarrm10n1_t* arr){
    ...
    oarrm10n1_truncate_im_to( idx, order, arr, &res);
...
void oarrm10n1_copy_to(oarrm10n1_t* arr, oarrm10n1_t* res){
    ...
    for (i=0; i<arr->size; i++){
        ...
        onumm10n1_copy_to(&arr->p_data[i],&res->p_data[i]);
...
// ****************************************************************************************************
inline void oarrm10n1_set_all_r( coeff_t num, oarrm10n1_t* arr){
    
    uint64_t i;

    for (i = 0; i<arr->size; i++ ){
        oarrm10n1_set_item_i_r( num, i, arr);
    }
...
// ****************************************************************************************************
inline void oarrm10n1_set_r( coeff_t num, oarrm10n1_t* arr){
...
// ****************************************************************************************************
inline void oarrm10n1_set_item_i_r( coeff_t num, uint64_t i, oarrm10n1_t* arr){
        
    if( i<arr->size ){
        
        onumm10n1_set_r( num, &arr->p_data[i]);

    } else {

        // res = onumm10n1_init();
        
        printf("ERROR: Index out of bounds in oarrm10n1_get_item_i(...)\n Exiting...\n");
        exit(OTI_BadIndx);
...
// ****************************************************************************************************
inline void oarrm10n1_set_item_ij_r( coeff_t num, uint64_t i, uint64_t j, oarrm10n1_t* arr){

    oarrm10n1_set_item_i_r( num, j + i*arr->ncols, arr);

}
// ----------------------------------------------------------------------------------------------------

// ****************************************************************************************************
inline void oarrm10n1_set_all_o( onumm10n1_t* num, oarrm10n1_t* arr){

    uint64_t i;

    for (i = 0; i<arr->size; i++ ){
        oarrm10n1_set_item_i_o( num, i, arr);
    }
...
// ****************************************************************************************************
inline void oarrm10n1_set_o( onumm10n1_t* num, oarrm10n1_t* arr){
...
// ****************************************************************************************************
inline void oarrm10n1_set_item_i_o( onumm10n1_t* src, uint64_t i, oarrm10n1_t* arr){
    
    if (i < arr->size){

        onumm10n1_copy_to(src, &arr->p_data[i]);
...
// ****************************************************************************************************
inline void oarrm10n1_set_item_ij_o( onumm10n1_t* num, uint64_t i, uint64_t j, oarrm10n1_t* arr){

    if ( i < arr->nrows && j < arr->ncols ){

        oarrm10n1_set_item_i_o( num, j + i*arr->ncols, arr);

    } else {

        printf("ERROR: Index out of bounds in oarrm10n1_get_item_ij(...)\n Exiting...\n");
        exit(OTI_BadIndx);
...
// ****************************************************************************************************
void oarrm10n1_set_slice_O( oarrm10n1_t* arr, 
    ...
    for ( i = 0; i < nrows; i++){
        ...
        for ( j = 0; j < ncols; j++){
            ...
            onumm10n1_copy_to( &arr->p_data[  j +  i * arr->ncols ], 
...
// ****************************************************************************************************
void oarrm10n1_set_slice_o( onumm10n1_t* num, 
                        int64_t starti, int64_t stopi, int64_t stepi,
                        int64_t startj, int64_t stopj, int64_t stepj,
                         oarrm10n1_t* res){
...
darr_t oarrm10n1_get_im(imdir_t idx, ord_t order, oarrm10n1_t* arr){
    ...
    for( i = 0; i < arr->size ; i++ ){
        ...
        darr_set_item_i(  
            onumm10n1_get_item( idx, order, &arr->p_data[i]), 
            i, &res);
...
oarrm10n1_t oarrm10n1_extract_im(imdir_t idx, ord_t order, oarrm10n1_t* arr){
    ...
    oarrm10n1_t res = oarrm10n1_zeros( arr->nrows, arr->ncols);
    
    oarrm10n1_extract_im_to( idx, order, arr, &res);
...
void oarrm10n1_extract_im_to(imdir_t idx, ord_t order, oarrm10n1_t* arr, oarrm10n1_t* res){
    ...
    for( i = 0; i < arr->size ; i++ ){
        ...
        onumm10n1_extract_im_to( idx, order, &arr->p_data[i], &res->p_data[i]);
...
darr_t oarrm10n1_get_deriv(imdir_t idx, ord_t order, oarrm10n1_t* arr){
    ...
    for( i = 0; i < arr->size ; i++ ){
        ...
        darr_set_item_i(  
            onumm10n1_get_deriv( idx, order, &arr->p_data[i]), 
            i, &res);
...
oarrm10n1_t oarrm10n1_get_im_o(imdir_t idx, ord_t order, oarrm10n1_t* arr){
    ...
    oarrm10n1_get_im_to( idx, order, arr, &res);
...
void oarrm10n1_get_im_to(imdir_t idx, ord_t order, oarrm10n1_t* arr, oarrm10n1_t* res){
    ...
    for( i = 0; i < arr->size ; i++ ){
        ...
        onumm10n1_get_im_to_o( idx, order, &arr->p_data[i], &res->p_data[i]);
...
oarrm10n1_t oarrm10n1_get_deriv_o(imdir_t idx, ord_t order, oarrm10n1_t* arr){
    ...
    oarrm10n1_get_deriv_to( idx, order, arr, &res);
...
void oarrm10n1_get_deriv_to(imdir_t idx, ord_t order, oarrm10n1_t* arr, oarrm10n1_t* res){
    ...
    for( i = 0; i < arr->size ; i++ ){
        ...
        onumm10n1_get_deriv_to( idx, order, &arr->p_data[i], &res->p_data[i]);
...
oarrm10n1_t oarrm10n1_extract_deriv(imdir_t idx, ord_t order, oarrm10n1_t* arr){
    ...
    oarrm10n1_extract_deriv_to( idx, order, arr, &res);
...
void oarrm10n1_extract_deriv_to(imdir_t idx, ord_t order, oarrm10n1_t* arr, oarrm10n1_t* res){
    ...
    for( i = 0; i < arr->size ; i++ ){
        ...
        onumm10n1_extract_deriv_to( idx, order, &arr->p_data[i], &res->p_data[i]);
...
// Getters.
// ****************************************************************************************************
inline onumm10n1_t oarrm10n1_get_item_i(oarrm10n1_t* arr, uint64_t i){
...
onumm10n1_t oarrm10n1_get_item_ij(oarrm10n1_t* arr, uint64_t i, uint64_t j){
    ...
    onumm10n1_t res = oarrm10n1_get_item_i(arr, j + i*arr->ncols );
...
void oarrm10n1_get_item_i_to(oarrm10n1_t* arr, uint64_t i, onumm10n1_t* res){
    ...
    if (i < arr->size){
        ...
        onumm10n1_copy_to( &arr->p_data[i], res);
        
    } else {
        // Raise error?
        printf("ERROR: Index out of bounds in oarrm10n1_get_item_i_to(...)\n");
        exit(OTI_BadIndx);
    }
...
void oarrm10n1_get_item_ij_to(oarrm10n1_t* arr, uint64_t i, uint64_t j, onumm10n1_t* res){
    ...
    oarrm10n1_get_item_i_to(arr, j + i*arr->ncols, res);
...
oarrm10n1_t oarrm10n1_get_slice( oarrm10n1_t* arr, 
    ...
    res = oarrm10n1_zeros( nrows, ncols);

    oarrm10n1_get_slice_to( arr, starti, stopi, stepi, startj, stopj, stepj, &res);
...
void oarrm10n1_get_slice_to( oarrm10n1_t* arr, 
    ...
    for ( i = 0; i < nrows; i++){
        ...
        for ( j = 0; j < ncols; j++){
            ...
            onumm10n1_copy_to( &arr->p_data[ jj + ii * arr->ncols ], 
...
oarrm10n1_t oarrm10n1_eye(uint64_t nrows){
    ...
    res = oarrm10n1_zeros( nrows, nrows);
...
oarrm10n1_t oarrm10n1_ones(uint64_t nrows, uint64_t ncols){
    ...
    res = oarrm10n1_createEmpty(nrows, ncols);

    for (i=0; i<res.size; i++ ){
        onumm10n1_set_r(1.0,&res.p_data[i]);
    }
...
oarrm10n1_t oarrm10n1_zeros(uint64_t nrows, uint64_t ncols){
    ...
    for (i=0; i<res.size; i++ ){
        onumm10n1_set_r(0.0,&res.p_data[i]);
    }
...
// ****************************************************************************************************
inline oarrm10n1_t oarrm10n1_empty_like(oarrm10n1_t* arr){

    oarrm10n1_t  res;
    
    res = oarrm10n1_createEmpty(arr->nrows, arr->ncols);    
...
// ****************************************************************************************************
inline oarrm10n1_t oarrm10n1_createEmpty(uint64_t nrows, uint64_t ncols){

    oarrm10n1_t  res ;
    uint64_t size = nrows * ncols;

    res.p_data = (onumm10n1_t*) malloc( size * sizeof( onumm10n1_t ) );

    if ( res.p_data == NULL ){
        printf("ERROR: Not enough memory to handle oarrm10n1.\n Exiting...\n");
...
// Initialization
// ****************************************************************************************************
inline oarrm10n1_t oarrm10n1_init(void){
