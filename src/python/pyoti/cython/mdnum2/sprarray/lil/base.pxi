...
cdef class lil_mdmat2:
  ...
  def __init__(self, shape): 
    """
    PURPOSE:      Python level constructor of the lil_mdmat2 class.

    DESCRIPTION:  Creates a new empty lil_mdmat2 matrix.
  ...
  def copy(self):
    ...
    cdef lil_mdmat2 res = lil_mdmat2(self.shape)
    cdef uint64_t i, k
  ...
  def tocsr(self):
    ...
    """
    return csr_mdmat2(self,shape=self.shape)
