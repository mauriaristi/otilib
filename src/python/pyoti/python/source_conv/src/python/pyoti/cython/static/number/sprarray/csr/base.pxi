...
cdef class csr_matrix:
  ...
  def __init__(self, arg1, shape=None, copy = True, preserve_in = False): 
    ...
    if targ1 == lil_matrix :
      ...
      nnz = lil.nnz
      # Generate arrays.
      self.arr       = {arr_func}_zeros( nnz, 1)
      ...
      for i in range(self.nrows):
        ...
        for j in range(len(lil.rows[i])):
          ...
          {num_func}_copy_to( &onum.num, &self.arr.p_data[k])
      ...
      if len(arg1) == 3: # Same as in scipy csr sparse.
        ...
        for i in range(nnz):
          ...
          if type(data[i]) == {num_pytype}:

            onum = data[i]
            {num_func}_copy_to( &onum.num, &self.arr.p_data[i])

          else:
            
            self.arr.p_data[i] = {num_func}_create_r( data[i] )
  ...
  def data(self): 
    ...
    return {arr_pytype}.create(&self.arr, FLAGS=0)
  ...
  def order(self): 
    ...
    order = {arr_func}_get_order(&self.arr)
  ...
  def __str__(self):
    ...
    cdef {num_pytype}   onum = {num_pytype}(0.0)
    cdef uint64_t i, j, k
    out  = ""
  ...
  def copy(self):
    ...
    res.arr       = {arr_func}_zeros( self.nnz, 1)
    ...
    {arr_func}_copy_to( &self.arr, &res.arr)
  ...
  def __pow__(self, n,z):
    ...
    {arr_func}_pow_to( &S.arr, n, &res.arr)
  ...
  cpdef get_deriv(self, object hum_dir ):
    ...
    {arr_func}_get_deriv_to( indx, order, &self.arr, &res.arr)
  ...
  cpdef get_im(self, object hum_dir ):
    ...
    {arr_func}_get_im_to( indx, order, &self.arr, &res.arr)
  ...
  cpdef extract_im(self, object hum_dir):
    ...
    {arr_func}_extract_im_to( indx, order, &self.arr, &res.arr)
  ...
  cpdef  extract_deriv(self, object hum_dir):
    ...
    {arr_func}_extract_deriv_to( indx, order, &self.arr, &res.arr)
  ...
  cpdef  get_order_im(self, ord_t order):
    ...
    {arr_func}_get_order_im_to( order, &self.arr, &res.arr)
  ...
  cpdef  truncate( self, object hum_dir):
    ...
    {arr_func}_truncate_im_to( indx, order, &self.arr, &res.arr)
  ...
  def get_active_bases(self):
    ...
    tmp = {arr_pytype}.create(&self.arr,FLAGS=0)
  ...
  for i in range(lhs.nrows):
    ...
    for j in range(rhs.ncols):
      ...
      for l in range( lhs.p_indptr[i], lhs.p_indptr[i+1] ):
        ...
        {num_func}_gem_oo_to( &lhs.arr.p_data[l],
  ...
  for i in range(lhs.nrows):
    ...
    for j in range(rhs.ncols):
      ...
      for l in range( lhs.p_indptr[i], lhs.p_indptr[i+1] ):
        ...
        {num_func}_trunc_gem_oo_to( ord_lhs, &lhs.arr.p_data[l], 
