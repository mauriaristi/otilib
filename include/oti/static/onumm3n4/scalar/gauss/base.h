#ifndef OTI_ONUMM3N4_SCALAR_GAUSS_BASE_H
#define OTI_ONUMM3N4_SCALAR_GAUSS_BASE_H
...
@param[in] num FEonumm3n4 to free
******************************************************************************************************/
...
@param[in] num FEonumm3n4
******************************************************************************************************/
ord_t feonumm3n4_get_order( feonumm3n4_t* num );
// ----------------------------------------------------------------------------------------------------

/**************************************************************************************************//**
@brief Initialize a feonumm3n4 structure.

******************************************************************************************************/
feonumm3n4_t feonumm3n4_init(void);
// ----------------------------------------------------------------------------------------------------
