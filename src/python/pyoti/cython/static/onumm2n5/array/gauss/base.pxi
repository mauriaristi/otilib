...
cdef class feomatm2n5:
  ...
  def __init__(self, shape, uint64_t nip): 
    """
    PURPOSE:      Python level constructor of the feomatm2n5 class.
    ...
    if (isinstance(shape, tuple)):
      ...
      if( ndim == 1 ):
        ...
        raise ValueError("Cant create feomatm2n5 for dimensions greater than 2.")
    ...
    for i in range(self.arr.nrows):
      for j in range(self.arr.ncols):
        for k in range(self.arr.nip):
          ...
          fedarr_set_item_ijk_r( onumm2n5_tmp.r , i, j, k, &tmp.arr);
        # end for
      # end for
    # end for
  ...
  #***************************************************************************************************
  @staticmethod
  cdef feomatm2n5 create(feoarrm2n5_t* arr, uint8_t FLAGS = 1):
    """
    ...
    cdef feomatm2n5 res = <feomatm2n5> feomatm2n5.__new__(feomatm2n5)
  ...
  #***************************************************************************************************
  cdef __setitem__f(self,  object val, feonumm2n5 value):
    """
    PURPOSE: Set item from feonumm2n5 value.
    """
    #*************************************************************************************************
  ...
  #***************************************************************************************************
  cdef __setitem__F(self,  object val, feomatm2n5 value):
    """
    PURPOSE: Set item from feomatm2n5 value.
    """
    #*************************************************************************************************
  ...
  def __add__(self, other):
    ...
    cdef feomatm2n5 Flhs,Frhs
    cdef feonumm2n5  flhs,frhs
    cdef dmat    Dlhs,Drhs
    cdef onumm2n5 olhs,orhs
    cdef omatm2n5   Olhs,Orhs
  ...
  cpdef set_ijk(self, object rhs, uint64_t i, uint64_t j, uint64_t k):
    ...
    if   trhs is onumm2n5:
      ...
      orhs = rhs
      feoarrm2n5_set_item_ijk_o( &orhs.num, i, j, k, &self.arr)
      ...
      try:
        ...
        rrhs = rhs
        feoarrm2n5_set_item_ijk_r( rrhs, i, j, k, &self.arr)
      
      except:
      
        raise ValueError("Supported values are real scalar and onumm2n5.")
  ...
  cpdef set(self, object rhs):
    ...
    cdef feonumm2n5  frhs
    cdef onumm2n5 orhs
    cdef coeff_t rrhs

    cdef feomatm2n5 Frhs
    cdef omatm2n5   Orhs
    cdef dmat    Rrhs
    ...
    #   feoarrm2n5_set_F( &Frhs.arr, &self.arr)   
      ...
      try:
        ...
        raise ValueError("Supported values are real scalar, onumm2n5 and feonumm2n5.")
  ...
  #***************************************************************************************************
  def gauss_integrate(self, feonumm2n5 w  ):
    """
  ...
  #***************************************************************************************************
  cpdef  get_item_ij( self, int64_t i, int64_t j, feonumm2n5 out=None):
    """
    PURPOSE:      Get an item from feomatm2n5 array.
