...
cdef class mdmat7:
  ...
  def __init__(self, realArray): 
    """
    PURPOSE:      Python level constructor of the mdmat7 class.
    ...
    if isinstance( realArray, np.ndarray):
      ...
      if ( ndim >= 3 ):
        ...
        self.arr = mdarr7_zeros( nrows, ncols)

        for i in range(self.arr.nrows):
      
          val = realArray[i]
          mdarr7_set_item_i_r( val, i, &self.arr)
        ...
        for i in range(self.arr.nrows):      
          for j in range(self.arr.ncols):
            ...
            val = realArray[i,j]
            mdarr7_set_item_ij_r( val, i, j, &self.arr)
  ...
  def order(self): 
    ...
    return mdarr7_get_order(&self.arr)
  ...
  #***************************************************************************************************
  @staticmethod
  cdef mdmat7 create(mdarr7_t* arr, uint8_t FLAGS = 1):
    """
    ...
    cdef mdmat7 mat = <mdmat7> mdmat7.__new__(mdmat7)
  ...
  def __repr__(self):
    ...
    #   out += "["
    #   for j in range(self.arr.ncols):
    #     d_mdnum7 = mdarr7_get_item_ij(&self.arr, i, j)
    #     out+= (mdnum7.create(&d_mdnum7,FLAGS=0)).__str__()+", "
    #   # end for 
    #   out = out[:-2] + "],\n"
    # # end for 
    # out =out[:-2] + "]"
  ...
  def  __getitem__(self, val):
    ...
    if tval == int:
      ...
      if val < self.arr.nrows:
        ...
        Ores = mdarr7_get_slice( &self.arr, starti, stopi, stepi, startj, stopj, stepj)
        res  = mdmat7.create(&Ores)
  ...
  cdef __setitem__r(self, object val, coeff_t value):
    ...
    if tval == int:
      ...
      if val < self.arr.nrows:
        ...
        mdarr7_set_slice_r( value, starti, stopi, stepi, startj, stopj, stepj, &self.arr)
      ...
      if len(val) == 2:
        ...
        if ( tval0 == int and tval1 == int ):
          ...
          if val[0] < self.arr.nrows and val[1] < self.arr.ncols:
            ...
            mdarr7_set_item_ij_r( value, val[0], val[1], &self.arr)
  ...
  cdef __setitem__o(self,  object val, mdnum7 value):
    ...
    if tval == int:
      ...
      if val < self.arr.nrows:
        ...
        mdarr7_set_slice_o( &value.num, starti, stopi, stepi, startj, stopj, stepj, &self.arr)
      ...
      if len(val) == 2:
        ...
        if ( tval0 == int and tval1 == int ):
          ...
          if val[0] < self.arr.nrows and val[1] < self.arr.ncols:
            ...
            mdarr7_set_item_ij_o( &value.num, val[0], val[1], &self.arr)
  ...
  cdef __setitem__O(self,  object val, mdmat7 value):
    ...
    if tval == int:
      ...
      if val < self.arr.nrows:
        ...
        mdarr7_set_slice_O( &value.arr, starti, stopi, stepi, startj, stopj, stepj, &self.arr)
  ...
  def copy(self):
    ...
    cdef mdarr7_t res = mdarr7_copy(&self.arr)
  ...
  cpdef get_deriv(self, object hum_dir):
    ...
    res_darr = mdarr7_get_deriv( item[ZERO],  item[ONE], &self.arr)
  ...
  cpdef get_im(self, object hum_dir):
    ...
    res_darr = mdarr7_get_im( item[ZERO],  item[ONE], &self.arr)
  ...
  cpdef extract_im(self, object hum_dir):
    ...
    res = mdarr7_extract_im( item[ZERO],  item[ONE], &self.arr)
  ...
  cpdef  extract_deriv(self, object hum_dir):
    ...
    res = mdarr7_extract_deriv( item[ZERO],  item[ONE], &self.arr)
  ...
  cpdef  get_order_im(self, ord_t order):
    ...
    res = mdarr7_get_order_im( order, &self.arr)
  ...
  cpdef  truncate( self, object humdir):
    ...
    res = mdarr7_truncate_im( indx, order, &self.arr) 
  ...
  cpdef set(self, object rhs):
    ...
    if   trhs is mdnum7:
      ...
      orhs = rhs
      mdarr7_set_o( &orhs.num, &self.arr)

    elif trhs is mdmat7:

      Orhs = rhs
      mdarr7_set_O( &Orhs.arr, &self.arr)      

    elif trhs in number_types:

      rrhs = rhs
      mdarr7_set_r( rrhs, &self.arr)

    else:

      raise ValueError( "Cant assign '{0}' into a mdmat7 object.".format(trhs) )
  ...
  def get_active_bases(self):
    ...
    mdarr7_get_active_bases( &self.arr, bases_list)
  ...
  def taylor_integrate(self, object bases, object deltas):
    ...
    res = mdarr7_taylor_integrate( c_deltas, &self.arr)
  ...
  #***************************************************************************************************
  @staticmethod
  def dot( mdmat7 lhs, mdmat7 rhs, mdmat7 out = None): 
    """
    ...
    if out is not None:
      ...
      mdarr7_matmul_OO_to( &lhs.arr, &rhs.arr ,&out.arr)

    else:

      res = mdarr7_matmul_OO( &lhs.arr, &rhs.arr )
  ...
  #***************************************************************************************************
  @staticmethod
  def inv( mdmat7 arr,  mdmat7 out = None): 
    """
    ...
    if out is not None:
      ...
      mdarr7_invert_to( &arr.arr,&out.arr)

    else:

      res = mdarr7_invert( &arr.arr)
  ...
  #***************************************************************************************************
  @staticmethod
  def transpose( mdmat7 arr,  mdmat7 out = None ): 
    """
    ...
    if out is not None:
      ...
      mdarr7_transpose_to( &arr.arr, &out.arr)

    else:

      res = mdarr7_transpose( &arr.arr)
  ...
  #***************************************************************************************************
  @staticmethod
  def add( mdmat7 lhs, mdmat7 rhs, mdmat7 out = None): 
    """
    ...
    if out is not None:
      ...
      mdarr7_sum_OO_to( &lhs.arr, &rhs.arr ,&out.arr)
