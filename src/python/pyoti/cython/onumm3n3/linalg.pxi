...
cpdef dot(object lhs, object rhs, object out = None):
  ...
  elif tlhs is csr_omatm3n3:

    # Slhs = lhs
    if   trhs is omatm3n3: # SO
      if res_flag:
        Ores = out
        csromatm3n3_matmul_SO_to( lhs, rhs, Ores)
      else:
        res = csromatm3n3_matmul_SO( lhs, rhs)
      # end if 
...
#*****************************************************************************************************
cdef solve_sparse(csr_omatm3n3 K_in, omatm3n3 b_in, omatm3n3 out = None):
  """
  PURPOSE:   Solve OTI linear system of equations for a dense K_in.
  """
  #***************************************************************************************************
...
cpdef set_order_im_from_array(ord_t ordi, np.ndarray arr, omatm3n3 tmp):
  ...
  #     tmp[i,j] += onumm3n3.create( &otmp, FLAGS = 0)
