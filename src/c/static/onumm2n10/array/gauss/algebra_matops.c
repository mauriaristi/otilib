...
feonumm2n10_t feoarrm2n10_dotproduct_FF(feoarrm2n10_t* lhs, feoarrm2n10_t* rhs){
    ...
    res = feonumm2n10_createEmpty( rhs->nip);

    feoarrm2n10_dotproduct_FF_to(lhs, rhs, &res);
...
void feoarrm2n10_dotproduct_FF_to(feoarrm2n10_t* lhs, feoarrm2n10_t* rhs, feonumm2n10_t* res){
    ...
    // Check Dimensions
    feoarrm2n10_dimCheck_FF_samesize(lhs, rhs, res);

    for (i = 0; i<res->nip; i++){

        oarrm2n10_dotproduct_OO_to( &lhs->p_data[i], &rhs->p_data[i], &res->p_data[i] );
...
feonumm2n10_t feoarrm2n10_dotproduct_OF(oarrm2n10_t* lhs, feoarrm2n10_t* rhs){
    ...
    feoarrm2n10_dotproduct_OF_to( lhs, rhs, &res);
...
void feoarrm2n10_dotproduct_OF_to( oarrm2n10_t* lhs, feoarrm2n10_t* rhs, feonumm2n10_t* res){
    ...
    // Check Dimensions
    feoarrm2n10_dimCheck_OF_samesize(lhs, rhs, res);

    for (i = 0; i < res->nip; i++){

        oarrm2n10_dotproduct_OO_to( lhs, &rhs->p_data[i], &res->p_data[i] );
...
feonumm2n10_t feoarrm2n10_dotproduct_RF( darr_t* lhs, feoarrm2n10_t* rhs){
    ...
    feoarrm2n10_dotproduct_RF_to( lhs, rhs, &res);
...
void feoarrm2n10_dotproduct_RF_to( darr_t* lhs, feoarrm2n10_t* rhs, feonumm2n10_t* res){
    ...
    // Check Dimensions
    feoarrm2n10_dimCheck_RF_samesize(lhs, rhs, res);

    for (i = 0; i < res->nip; i++){

        oarrm2n10_dotproduct_RO_to( lhs, &rhs->p_data[i], &res->p_data[i] );
...
feoarrm2n10_t feoarrm2n10_matmul_FF(feoarrm2n10_t* lhs, feoarrm2n10_t* rhs){
    ...
    // Check dimensions.
    res = feoarrm2n10_createEmpty( lhs->nrows, rhs->ncols, lhs->nip);

    feoarrm2n10_matmul_FF_to( lhs, rhs, &res);
...
void feoarrm2n10_matmul_FF_to(feoarrm2n10_t* lhs, feoarrm2n10_t* rhs, feoarrm2n10_t* res){
    ...
    // Check Dimensions
    feoarrm2n10_dimCheck_FF_matmul(lhs, rhs, res);

    for (i = 0; i<res->nip; i++){

        oarrm2n10_matmul_OO_to( &lhs->p_data[i], &rhs->p_data[i], &res->p_data[i] );
...
feoarrm2n10_t feoarrm2n10_matmul_OF(oarrm2n10_t* lhs, feoarrm2n10_t* rhs){
    ...
    // Check dimensions.
    res = feoarrm2n10_createEmpty( lhs->nrows, rhs->ncols, rhs->nip);

    feoarrm2n10_matmul_OF_to( lhs, rhs, &res);
...
void feoarrm2n10_matmul_OF_to(oarrm2n10_t* lhs, feoarrm2n10_t* rhs, feoarrm2n10_t* res){
    ...
    // Check Dimensions
    feoarrm2n10_dimCheck_OF_matmul(lhs, rhs, res);

    for (i = 0; i<res->nip; i++){

        oarrm2n10_matmul_OO_to( lhs, &rhs->p_data[i], &res->p_data[i] );
...
feoarrm2n10_t feoarrm2n10_matmul_FO(feoarrm2n10_t* lhs, oarrm2n10_t* rhs){
    ...
    feoarrm2n10_matmul_FO_to( lhs, rhs, &res);
...
void feoarrm2n10_matmul_FO_to(feoarrm2n10_t* lhs, oarrm2n10_t* rhs, feoarrm2n10_t* res){
    ...
    // Check Dimensions
    feoarrm2n10_dimCheck_FO_matmul(lhs, rhs, res);

    for (i = 0; i<res->nip; i++){

        oarrm2n10_matmul_OO_to( &lhs->p_data[i], rhs, &res->p_data[i] );
...
feoarrm2n10_t feoarrm2n10_matmul_RF(darr_t* lhs, feoarrm2n10_t* rhs){
    ...
    feoarrm2n10_matmul_RF_to( lhs, rhs, &res);
...
void feoarrm2n10_matmul_RF_to(darr_t* lhs, feoarrm2n10_t* rhs, feoarrm2n10_t* res){
    ...
    // Check Dimensions
    feoarrm2n10_dimCheck_RF_matmul(lhs, rhs, res);

    for (i = 0; i<res->nip; i++){

        oarrm2n10_matmul_RO_to( lhs, &rhs->p_data[i], &res->p_data[i] );
...
feoarrm2n10_t feoarrm2n10_matmul_FR(feoarrm2n10_t* lhs, darr_t* rhs){
    ...
    feoarrm2n10_matmul_FR_to( lhs, rhs, &res);
...
void feoarrm2n10_matmul_FR_to(feoarrm2n10_t* lhs, darr_t* rhs, feoarrm2n10_t* res){
    ...
    // Check Dimensions
    feoarrm2n10_dimCheck_FR_matmul(lhs, rhs, res);

    for (i = 0; i<res->nip; i++){

        oarrm2n10_matmul_OR_to( &lhs->p_data[i], rhs, &res->p_data[i] );
...
feonumm2n10_t feoarrm2n10_norm(feoarrm2n10_t* arr){
    ...
    res = feonumm2n10_createEmpty( arr->nip);

    feoarrm2n10_norm_to( arr, &res );
...
void feoarrm2n10_norm_to(feoarrm2n10_t* arr, feonumm2n10_t* res){
    ...
    for (i = 0; i<arr->nip; i++){
        ...
        oarrm2n10_pnorm_to( &arr->p_data[i], 2.0, &res->p_data[i]);
...
feonumm2n10_t feoarrm2n10_pnorm(feoarrm2n10_t* arr, coeff_t p){
    ...
    feoarrm2n10_pnorm_to( arr, p, &res );
...
void feoarrm2n10_pnorm_to(feoarrm2n10_t* arr, coeff_t p, feonumm2n10_t* res){
    ...
    for (i = 0; i<arr->nip; i++){
        ...
        oarrm2n10_pnorm_to( &arr->p_data[i], p, &res->p_data[i]);
...
void feoarrm2n10_det_to(feoarrm2n10_t* arr, feonumm2n10_t* res){
    ...
    // Check dimensions (squareness)
    feoarrm2n10_dimCheck_F_squareness( arr, arr);
    feoarrm2n10_dimCheck_fF_elementwise(res,arr,arr);

    for (i = 0; i<arr->nip; i++){
        
        oarrm2n10_det_to( &arr->p_data[i], &res->p_data[i]);
...
void feoarrm2n10_invert_to(feoarrm2n10_t* arr, feoarrm2n10_t* res){
    ...
    feoarrm2n10_dimCheck_F_squareness( arr, res);
    
    for (i = 0; i<arr->nip; i++){

        oarrm2n10_invert_to( &arr->p_data[i], &res->p_data[i]);
...
feoarrm2n10_t feoarrm2n10_transpose(feoarrm2n10_t* arr){
    ...
    res = feoarrm2n10_createEmpty( arr->ncols, arr->nrows, arr->nip);
    
    feoarrm2n10_transpose_to( arr, &res );
...
void feoarrm2n10_transpose_to(feoarrm2n10_t* arr, feoarrm2n10_t* res){
    ...
    // Check dimensions.
    feoarrm2n10_dimCheck_F_transpose( arr, res);
    
    for (i = 0; i<arr->nip; i++){

        oarrm2n10_transpose_to( &arr->p_data[i], &res->p_data[i]);
