...
void {arr_type}ranspose_to({arr_type}* arr1, {arr_type}* res){{
    ...
    for ( i = 0; i<arr1->nrows; i++){{
        ...
        for ( j = 0; j<arr1->ncols; j++){{
            ...
            {arr_func}_set_item_ij_o( &arr1->p_data[  j + i*arr1->ncols  ], 
                                 j, i, res);
...
void {arr_func}_invert_to({arr_type}* arr1, {arr_type}* res){{
    ...
    if(arr1->ncols == 1){{
        ...
        {num_func}_set_o( &tmp1, &res->p_data[0]);

        // res->p_data[1] = -arr1->p_data[1]/det;
        {num_func}_div_oo_to(&arr1->p_data[1],&det,&tmp1);
        {num_func}_set_o( &tmp1, &res->p_data[1]);
        {num_func}_neg_to(&res->p_data[1],&res->p_data[1]);

        // res->p_data[2] = -arr1->p_data[2]/det;
        {num_func}_div_oo_to(&arr1->p_data[2],&det,&tmp1);
        {num_func}_set_o( &tmp1, &res->p_data[2]);
        {num_func}_neg_to(&res->p_data[2],&res->p_data[2]);

        // res->p_data[3] =  arr1->p_data[0]/det;
        {num_func}_div_oo_to(&arr1->p_data[0],&det,&tmp1);
        {num_func}_set_o( &tmp1, &res->p_data[3]);

    }} else if (arr1->ncols == 3){{
        
        tmpA1 = {arr_func}_zeros( 2, 2, 0, 0 );
        tmpA1.p_data[0] = {num_func}_get_tmp(  9, order);
        tmpA1.p_data[1] = {num_func}_get_tmp( 10, order);
        tmpA1.p_data[2] = {num_func}_get_tmp( 11, order);
        tmpA1.p_data[3] = {num_func}_get_tmp( 12, order);
        
        {arr_func}_det_to( arr1, &det); // Get determinant.
        
        // Set position 0,0
        // tmpA1.p_data[0] = arr1->p_data[4];
        {num_func}_set_o( &arr1->p_data[4], &tmpA1.p_data[0]);
        // tmpA1.p_data[1] = arr1->p_data[5];
        {num_func}_set_o( &arr1->p_data[5], &tmpA1.p_data[1]);
        // tmpA1.p_data[2] = arr1->p_data[7];
        {num_func}_set_o( &arr1->p_data[7], &tmpA1.p_data[2]);
        // tmpA1.p_data[3] = arr1->p_data[8];
        {num_func}_set_o( &arr1->p_data[8], &tmpA1.p_data[3]);
        ...
        {num_func}_set_o( &arr1->p_data[2], &tmpA1.p_data[0]);
        // tmpA1.p_data[1] = arr1->p_data[1];
        {num_func}_set_o( &arr1->p_data[1], &tmpA1.p_data[1]);
        // tmpA1.p_data[2] = arr1->p_data[8];
        {num_func}_set_o( &arr1->p_data[8], &tmpA1.p_data[2]);
        // tmpA1.p_data[3] = arr1->p_data[7];
        {num_func}_set_o( &arr1->p_data[7], &tmpA1.p_data[3]);
        ...
        {num_func}_set_o( &arr1->p_data[1], &tmpA1.p_data[0]);
        // tmpA1.p_data[1] = arr1->p_data[2];
        {num_func}_set_o( &arr1->p_data[2], &tmpA1.p_data[1]);
        // tmpA1.p_data[2] = arr1->p_data[4];
        {num_func}_set_o( &arr1->p_data[4], &tmpA1.p_data[2]);
        // tmpA1.p_data[3] = arr1->p_data[5];
        {num_func}_set_o( &arr1->p_data[5], &tmpA1.p_data[3]);
        ...
        {num_func}_set_o( &arr1->p_data[5], &tmpA1.p_data[0]);
        // tmpA1.p_data[1] = arr1->p_data[3];
        {num_func}_set_o( &arr1->p_data[3], &tmpA1.p_data[1]);
        // tmpA1.p_data[2] = arr1->p_data[8];
        {num_func}_set_o( &arr1->p_data[8], &tmpA1.p_data[2]);
        // tmpA1.p_data[3] = arr1->p_data[6];
        {num_func}_set_o( &arr1->p_data[6], &tmpA1.p_data[3]);
        ...
        {num_func}_set_o( &arr1->p_data[0], &tmpA1.p_data[0]);
        // tmpA1.p_data[1] = arr1->p_data[2];
        {num_func}_set_o( &arr1->p_data[2], &tmpA1.p_data[1]);
        // tmpA1.p_data[2] = arr1->p_data[6];
        {num_func}_set_o( &arr1->p_data[6], &tmpA1.p_data[2]);
        // tmpA1.p_data[3] = arr1->p_data[8];
        {num_func}_set_o( &arr1->p_data[8], &tmpA1.p_data[3]);
        ...
        {num_func}_set_o( &arr1->p_data[0], &tmpA1.p_data[1]);
        // tmpA1.p_data[2] = arr1->p_data[5];
        {num_func}_set_o( &arr1->p_data[5], &tmpA1.p_data[2]);
        // tmpA1.p_data[3] = arr1->p_data[3];
        {num_func}_set_o( &arr1->p_data[3], &tmpA1.p_data[3]);
        ...
        {num_func}_set_o( &arr1->p_data[3], &tmpA1.p_data[0]);
        // tmpA1.p_data[1] = arr1->p_data[4];
        {num_func}_set_o( &arr1->p_data[4], &tmpA1.p_data[1]);
        // tmpA1.p_data[2] = arr1->p_data[6];
        {num_func}_set_o( &arr1->p_data[6], &tmpA1.p_data[2]);
        // tmpA1.p_data[3] = arr1->p_data[7];
        {num_func}_set_o( &arr1->p_data[7], &tmpA1.p_data[3]);
        ...
        {num_func}_set_o( &arr1->p_data[3], &tmpA1.p_data[2]);
        // tmpA1.p_data[3] = arr1->p_data[4];
        {num_func}_set_o( &arr1->p_data[4], &tmpA1.p_data[3]);
...
void {arr_func}_det_to({arr_type}* arr1, {num_type}* res){{
    ...
    if ( arr1->ncols == 1 ){{
        ...
        {num_func}_copy_to(&arr1->p_data[0], res);
        ...
        // tmp3 = 0
        {num_func}_set_r( 0.0, &tmp3);

        for (j=0; j<arr1->ncols; j++){{
            
            // tmp1 = arr1->p_data[j]
            {num_func}_set_o(&arr1->p_data[j], &tmp1);
        ...
        for ( j = 0; j<arr1->ncols; j++){{
            ...
            {num_func}_set_o(&arr1->p_data[arr1->ncols-1-j], &tmp1);
