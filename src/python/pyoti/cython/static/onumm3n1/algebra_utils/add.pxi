...
cdef object __add__OX__(omatm3n1 Olhs, object rhs, object out = None):
  """
  PORPUSE: Addition between omatm3n1 and object.
  ...
  if trhs == onumm3n1:
    ...
    if res_flag:
      ...
      cOres = oarrm3n1_sum_OO( &Olhs.arr, &Orhs.arr )
      res = omatm3n1.create( &cOres )
    # end if
  elif trhs == dmat:
    Rrhs = rhs
...
cdef object __add__oX__(onumm3n1 olhs, object rhs, object out = None):
  """
  PORPUSE: Addition between onumm3n1 and object.
...
cdef object __add__fX__(feonumm3n1 flhs, object rhs, object out = None):
  """
  PORPUSE: Addition between feonumm3n1 and object.
