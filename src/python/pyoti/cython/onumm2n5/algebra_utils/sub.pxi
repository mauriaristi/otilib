#*****************************************************************************************************
cdef object __sub__FX__(feomatm2n5 Flhs, object rhs, object out = None):
  """
  PORPUSE: Subtraction between feomatm2n5 and object.
...
#*****************************************************************************************************
cdef object __sub__OX__(omatm2n5 Olhs, object rhs, object out = None):
  """
  PORPUSE: Subtraction between omatm2n5 and object.
...
#*****************************************************************************************************
cdef object __sub__oX__(onumm2n5 olhs, object rhs, object out = None):
  """
  PORPUSE: Subtraction between onumm2n5 and object.
...
#*****************************************************************************************************
cdef object __sub__fX__(feonumm2n5 flhs, object rhs, object out = None):
  """
  PORPUSE: Subtraction between feonumm2n5 and object.
