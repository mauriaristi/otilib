#ifndef OTI_ONUMM5N2_SCALAR_GAUSS_BASE_H
#define OTI_ONUMM5N2_SCALAR_GAUSS_BASE_H
...
@param[in] num FEonumm5n2 to free
******************************************************************************************************/
...
@param[in] num FEonumm5n2
******************************************************************************************************/
ord_t feonumm5n2_get_order( feonumm5n2_t* num );
// ----------------------------------------------------------------------------------------------------

/**************************************************************************************************//**
@brief Initialize a feonumm5n2 structure.

******************************************************************************************************/
feonumm5n2_t feonumm5n2_init(void);
// ----------------------------------------------------------------------------------------------------
