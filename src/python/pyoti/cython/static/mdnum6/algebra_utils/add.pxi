...
cdef object __add__OX__(mdmat6 Olhs, object rhs, object out = None):
  """
  PORPUSE: Addition between mdmat6 and object.
  ...
  if trhs == mdnum6:
    ...
    if res_flag:
      ...
      cOres = mdarr6_sum_OO( &Olhs.arr, &Orhs.arr )
      res = mdmat6.create( &cOres )
    # end if
  elif trhs == dmat:
    Rrhs = rhs
...
cdef object __add__oX__(mdnum6 olhs, object rhs, object out = None):
  """
  PORPUSE: Addition between mdnum6 and object.
...
cdef object __add__fX__(mdnumfe6 flhs, object rhs, object out = None):
  """
  PORPUSE: Addition between mdnumfe6 and object.
