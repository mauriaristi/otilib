...
CONTAINS
    ...
    SUBROUTINE pytorch_graph_eval_m3n1(graph, stack_size, c_arr, c_size,x_matso,w_matso) BIND(C)
        ! Test to pass a graph as a rank-2 int64 array from C.
        IMPLICIT NONE

        ! subroutine inputs.
        INTEGER, INTENT(IN) :: stack_size, c_size  !< Array dimensions.
        TYPE(oarrm3n1_t), INTENT(IN) :: x_matso      !< input arrays. (Contains dimensions)
        TYPE(oarrm3n1_t), INTENT(INOUT) :: w_matso   !< output arrays. (Contains dimensions)
        ...
        TYPE(onumm3n1), POINTER :: x_arr(:,:)
        TYPE(onumm3n1), POINTER :: w_arr(:,:)

        ! type(onumm3n1) :: a_lhs, a_rhs
        TYPE(onumm3n1), POINTER :: p1_ptr(:) ! %%%%%% added new pointer variable.
        TYPE(onumm3n1), POINTER :: p2_ptr(:) ! %%%%%% added new pointer variable.
    ...
    END SUBROUTINE pytorch_graph_eval_m3n1

    SUBROUTINE sub_oo_vv_to(lhs,rhs,res)
      IMPLICIT NONE
      TYPE(onumm3n1), INTENT(IN) :: lhs(:)
      TYPE(onumm3n1), INTENT(IN) :: rhs(SIZE(lhs,1))
      TYPE(onumm3n1), INTENT(INOUT) :: res(SIZE(lhs,1))
   ...
   SUBROUTINE sin_v_to(X,RES)
      ...
      TYPE(onumm3n1), INTENT(INOUT) :: RES(SIZE(x,1))
...
END MODULE array_interface_m3n1