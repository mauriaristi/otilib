...
cdef object __add__OX__(omatm6n2 Olhs, object rhs, object out = None):
  """
  PORPUSE: Addition between omatm6n2 and object.
  ...
  if trhs == onumm6n2:
    ...
    if res_flag:
      ...
      cOres = oarrm6n2_sum_OO( &Olhs.arr, &Orhs.arr )
      res = omatm6n2.create( &cOres )
    # end if
  elif trhs == dmat:
    Rrhs = rhs
...
cdef object __add__oX__(onumm6n2 olhs, object rhs, object out = None):
  """
  PORPUSE: Addition between onumm6n2 and object.
...
cdef object __add__fX__(feonumm6n2 flhs, object rhs, object out = None):
  """
  PORPUSE: Addition between feonumm6n2 and object.
