...
def plot_curva(x,y,T,u,x_0,x_2,y_0,y_2):
    ...
    plt.plot(x,y, ls='-', lw=2, label="Estado de carga "+str(u))
    if x_0.any() != None:
        plt.plot(x_0,y_0, ':', lw=4, color="orange" ,label="Estado de carga 0 MOR")
        plt.plot(x_2,y_2, ':', lw=4, color="r" ,label="Estado de carga 2 MOR")
    plt.legend(loc="upper center")
    plt.plot(xf,yf, 'bo', markersize="8", zorder=1000)
