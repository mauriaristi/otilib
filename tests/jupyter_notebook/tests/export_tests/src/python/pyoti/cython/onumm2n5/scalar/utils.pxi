...
#     res = onumm2n5_createReal(0.0, order)

#     # Set the coefficient to 1.
#     onumm2n5_set_item(1.0, indx_hd, order_hd, &res)

#   else:

#     res = onumm2n5_createReal(0.0, order_hd)
...
#   """
#   PURPOSE:  Return the derivative selected from a numpy array of onumm2n5_ts.
