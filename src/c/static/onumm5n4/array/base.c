...
void oarrm5n4_taylor_integrate_to( coeff_t* deltas, oarrm5n4_t* arr, oarrm5n4_t* res){
    ...
    oarrm5n4_dimCheck_OO_elementwise(arr,res,res);

    for (i = 0; i<arr->size; i++ ){
        
        onumm5n4_taylor_integrate_to( deltas, &arr->p_data[i], &res->p_data[i]);
...
oarrm5n4_t oarrm5n4_taylor_integrate( coeff_t* deltas, oarrm5n4_t* arr){
    ...
    oarrm5n4_taylor_integrate_to( deltas, arr, &res);
...
void oarrm5n4_get_order_im_to( ord_t order, oarrm5n4_t* arr, oarrm5n4_t* res){
    ...
    for (i = 0; i<arr->size; i++ ){
        ...
        onumm5n4_get_order_im_to( order, &arr->p_data[i], &res->p_data[i]);
...
oarrm5n4_t oarrm5n4_get_order_im( ord_t order, oarrm5n4_t* arr){
    ...
    oarrm5n4_get_order_im_to( order, arr, &res);
...
void oarrm5n4_truncate_im_to( imdir_t idx, ord_t order, oarrm5n4_t* arr, oarrm5n4_t* res){
    ...
    for (i = 0; i<arr->size; i++ ){
        ...
        onumm5n4_truncate_im_to( idx, order, &arr->p_data[i], &res->p_data[i]);
...
oarrm5n4_t oarrm5n4_truncate_im( imdir_t idx, ord_t order, oarrm5n4_t* arr){
    ...
    oarrm5n4_truncate_im_to( idx, order, arr, &res);
...
void oarrm5n4_copy_to(oarrm5n4_t* arr, oarrm5n4_t* res){
    ...
    for (i=0; i<arr->size; i++){
        ...
        onumm5n4_copy_to(&arr->p_data[i],&res->p_data[i]);
...
// ****************************************************************************************************
inline void oarrm5n4_set_all_r( coeff_t num, oarrm5n4_t* arr){
    
    uint64_t i;

    for (i = 0; i<arr->size; i++ ){
        oarrm5n4_set_item_i_r( num, i, arr);
    }
...
// ****************************************************************************************************
inline void oarrm5n4_set_r( coeff_t num, oarrm5n4_t* arr){
...
// ****************************************************************************************************
inline void oarrm5n4_set_item_i_r( coeff_t num, uint64_t i, oarrm5n4_t* arr){
        
    if( i<arr->size ){
        
        onumm5n4_set_r( num, &arr->p_data[i]);

    } else {

        // res = onumm5n4_init();
        
        printf("ERROR: Index out of bounds in oarrm5n4_get_item_i(...)\n Exiting...\n");
        exit(OTI_BadIndx);
...
// ****************************************************************************************************
inline void oarrm5n4_set_item_ij_r( coeff_t num, uint64_t i, uint64_t j, oarrm5n4_t* arr){

    oarrm5n4_set_item_i_r( num, j + i*arr->ncols, arr);

}
// ----------------------------------------------------------------------------------------------------

// ****************************************************************************************************
inline void oarrm5n4_set_all_o( onumm5n4_t* num, oarrm5n4_t* arr){

    uint64_t i;

    for (i = 0; i<arr->size; i++ ){
        oarrm5n4_set_item_i_o( num, i, arr);
    }
...
// ****************************************************************************************************
inline void oarrm5n4_set_o( onumm5n4_t* num, oarrm5n4_t* arr){
...
// ****************************************************************************************************
inline void oarrm5n4_set_item_i_o( onumm5n4_t* src, uint64_t i, oarrm5n4_t* arr){
    
    if (i < arr->size){

        onumm5n4_copy_to(src, &arr->p_data[i]);
...
// ****************************************************************************************************
inline void oarrm5n4_set_item_ij_o( onumm5n4_t* num, uint64_t i, uint64_t j, oarrm5n4_t* arr){

    if ( i < arr->nrows && j < arr->ncols ){

        oarrm5n4_set_item_i_o( num, j + i*arr->ncols, arr);

    } else {

        printf("ERROR: Index out of bounds in oarrm5n4_get_item_ij(...)\n Exiting...\n");
        exit(OTI_BadIndx);
...
// ****************************************************************************************************
void oarrm5n4_set_slice_O( oarrm5n4_t* arr, 
    ...
    for ( i = 0; i < nrows; i++){
        ...
        for ( j = 0; j < ncols; j++){
            ...
            onumm5n4_copy_to( &arr->p_data[  j +  i * arr->ncols ], 
...
// ****************************************************************************************************
void oarrm5n4_set_slice_o( onumm5n4_t* num, 
                        int64_t starti, int64_t stopi, int64_t stepi,
                        int64_t startj, int64_t stopj, int64_t stepj,
                         oarrm5n4_t* res){
...
darr_t oarrm5n4_get_im(imdir_t idx, ord_t order, oarrm5n4_t* arr){
    ...
    for( i = 0; i < arr->size ; i++ ){
        ...
        darr_set_item_i(  
            onumm5n4_get_item( idx, order, &arr->p_data[i]), 
            i, &res);
...
oarrm5n4_t oarrm5n4_extract_im(imdir_t idx, ord_t order, oarrm5n4_t* arr){
    ...
    oarrm5n4_t res = oarrm5n4_zeros( arr->nrows, arr->ncols);
    
    oarrm5n4_extract_im_to( idx, order, arr, &res);
...
void oarrm5n4_extract_im_to(imdir_t idx, ord_t order, oarrm5n4_t* arr, oarrm5n4_t* res){
    ...
    for( i = 0; i < arr->size ; i++ ){
        ...
        onumm5n4_extract_im_to( idx, order, &arr->p_data[i], &res->p_data[i]);
...
darr_t oarrm5n4_get_deriv(imdir_t idx, ord_t order, oarrm5n4_t* arr){
    ...
    for( i = 0; i < arr->size ; i++ ){
        ...
        darr_set_item_i(  
            onumm5n4_get_deriv( idx, order, &arr->p_data[i]), 
            i, &res);
...
oarrm5n4_t oarrm5n4_get_im_o(imdir_t idx, ord_t order, oarrm5n4_t* arr){
    ...
    oarrm5n4_get_im_to( idx, order, arr, &res);
...
void oarrm5n4_get_im_to(imdir_t idx, ord_t order, oarrm5n4_t* arr, oarrm5n4_t* res){
    ...
    for( i = 0; i < arr->size ; i++ ){
        ...
        onumm5n4_get_im_to_o( idx, order, &arr->p_data[i], &res->p_data[i]);
...
oarrm5n4_t oarrm5n4_get_deriv_o(imdir_t idx, ord_t order, oarrm5n4_t* arr){
    ...
    oarrm5n4_get_deriv_to( idx, order, arr, &res);
...
void oarrm5n4_get_deriv_to(imdir_t idx, ord_t order, oarrm5n4_t* arr, oarrm5n4_t* res){
    ...
    for( i = 0; i < arr->size ; i++ ){
        ...
        onumm5n4_get_deriv_to( idx, order, &arr->p_data[i], &res->p_data[i]);
...
oarrm5n4_t oarrm5n4_extract_deriv(imdir_t idx, ord_t order, oarrm5n4_t* arr){
    ...
    oarrm5n4_extract_deriv_to( idx, order, arr, &res);
...
void oarrm5n4_extract_deriv_to(imdir_t idx, ord_t order, oarrm5n4_t* arr, oarrm5n4_t* res){
    ...
    for( i = 0; i < arr->size ; i++ ){
        ...
        onumm5n4_extract_deriv_to( idx, order, &arr->p_data[i], &res->p_data[i]);
...
// Getters.
// ****************************************************************************************************
inline onumm5n4_t oarrm5n4_get_item_i(oarrm5n4_t* arr, uint64_t i){
...
onumm5n4_t oarrm5n4_get_item_ij(oarrm5n4_t* arr, uint64_t i, uint64_t j){
    ...
    onumm5n4_t res = oarrm5n4_get_item_i(arr, j + i*arr->ncols );
...
void oarrm5n4_get_item_i_to(oarrm5n4_t* arr, uint64_t i, onumm5n4_t* res){
    ...
    if (i < arr->size){
        ...
        onumm5n4_copy_to( &arr->p_data[i], res);
        
    } else {
        // Raise error?
        printf("ERROR: Index out of bounds in oarrm5n4_get_item_i_to(...)\n");
        exit(OTI_BadIndx);
    }
...
void oarrm5n4_get_item_ij_to(oarrm5n4_t* arr, uint64_t i, uint64_t j, onumm5n4_t* res){
    ...
    oarrm5n4_get_item_i_to(arr, j + i*arr->ncols, res);
...
oarrm5n4_t oarrm5n4_get_slice( oarrm5n4_t* arr, 
    ...
    res = oarrm5n4_zeros( nrows, ncols);

    oarrm5n4_get_slice_to( arr, starti, stopi, stepi, startj, stopj, stepj, &res);
...
void oarrm5n4_get_slice_to( oarrm5n4_t* arr, 
    ...
    for ( i = 0; i < nrows; i++){
        ...
        for ( j = 0; j < ncols; j++){
            ...
            onumm5n4_copy_to( &arr->p_data[ jj + ii * arr->ncols ], 
...
oarrm5n4_t oarrm5n4_eye(uint64_t nrows){
    ...
    res = oarrm5n4_zeros( nrows, nrows);
...
oarrm5n4_t oarrm5n4_ones(uint64_t nrows, uint64_t ncols){
    ...
    res = oarrm5n4_createEmpty(nrows, ncols);

    for (i=0; i<res.size; i++ ){
        onumm5n4_set_r(1.0,&res.p_data[i]);
    }
...
oarrm5n4_t oarrm5n4_zeros(uint64_t nrows, uint64_t ncols){
    ...
    for (i=0; i<res.size; i++ ){
        onumm5n4_set_r(0.0,&res.p_data[i]);
    }
...
// ****************************************************************************************************
inline oarrm5n4_t oarrm5n4_empty_like(oarrm5n4_t* arr){

    oarrm5n4_t  res;
    
    res = oarrm5n4_createEmpty(arr->nrows, arr->ncols);    
...
// ****************************************************************************************************
inline oarrm5n4_t oarrm5n4_createEmpty(uint64_t nrows, uint64_t ncols){

    oarrm5n4_t  res ;
    uint64_t size = nrows * ncols;

    res.p_data = (onumm5n4_t*) malloc( size * sizeof( onumm5n4_t ) );

    if ( res.p_data == NULL ){
        printf("ERROR: Not enough memory to handle oarrm5n4.\n Exiting...\n");
...
// Initialization
// ****************************************************************************************************
inline oarrm5n4_t oarrm5n4_init(void){
