#ifndef OTI_ONUMM2N1_SCALAR_GAUSS_BASE_H
#define OTI_ONUMM2N1_SCALAR_GAUSS_BASE_H
...
@param[in] num FEonumm2n1 to free
******************************************************************************************************/
...
@param[in] num FEonumm2n1
******************************************************************************************************/
ord_t feonumm2n1_get_order( feonumm2n1_t* num );
// ----------------------------------------------------------------------------------------------------

/**************************************************************************************************//**
@brief Initialize a feonumm2n1 structure.

******************************************************************************************************/
feonumm2n1_t feonumm2n1_init(void);
// ----------------------------------------------------------------------------------------------------
