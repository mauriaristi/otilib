MODULE OTIM1N10
  ...
  INTERFACE OPERATOR(*)
    MODULE PROCEDURE ONUMM1N10_MUL_ONUMM1N10,R_MUL_ONUMM1N10,ONUMM1N10_MUL_R
  END INTERFACE

  INTERFACE OPERATOR(+)
    MODULE PROCEDURE ONUMM1N10_ADD_ONUMM1N10,R_ADD_ONUMM1N10,ONUMM1N10_ADD_R
  END INTERFACE

  INTERFACE OPERATOR(-)
    MODULE PROCEDURE ONUMM1N10_NEG,ONUMM1N10_SUB_ONUMM1N10,R_SUB_ONUMM1N10,ONUMM1N10_SUB_R
  END INTERFACE
  ...
  ELEMENTAL FUNCTION ONUMM1N10_ADD_ONUMM1N10(LHS,RHS)&
    RESULT(RES)
    IMPLICIT NONE
  ...
  END FUNCTION ONUMM1N10_ADD_ONUMM1N10

  ELEMENTAL FUNCTION R_ADD_ONUMM1N10(LHS,RHS)&
    RESULT(RES)
    IMPLICIT NONE
    REAL(DP), INTENT(IN) :: LHS 
    TYPE(ONUMM1N10), INTENT(IN) :: RHS 
  ...
  END FUNCTION R_ADD_ONUMM1N10

  ELEMENTAL FUNCTION ONUMM1N10_ADD_R(LHS,RHS)&
    RESULT(RES)
    IMPLICIT NONE
    TYPE(ONUMM1N10), INTENT(IN) :: LHS 
  ...
  ELEMENTAL FUNCTION ONUMM1N10_SUB_ONUMM1N10(LHS,RHS)&
    RESULT(RES)
    IMPLICIT NONE
    TYPE(ONUMM1N10), INTENT(IN) :: LHS 
    TYPE(ONUMM1N10), INTENT(IN) :: RHS 
  ...
  END FUNCTION ONUMM1N10_SUB_ONUMM1N10

  ELEMENTAL FUNCTION R_SUB_ONUMM1N10(LHS,RHS)&
    RESULT(RES)
    IMPLICIT NONE
    REAL(DP), INTENT(IN) :: LHS 
    TYPE(ONUMM1N10), INTENT(IN) :: RHS 
  ...
  END FUNCTION R_SUB_ONUMM1N10

  ELEMENTAL FUNCTION ONUMM1N10_SUB_R(LHS,RHS)&
    RESULT(RES)
    IMPLICIT NONE
    TYPE(ONUMM1N10), INTENT(IN) :: LHS 
    REAL(DP), INTENT(IN) :: RHS 
  ...
  END FUNCTION ONUMM1N10_SUB_R

  ELEMENTAL FUNCTION ONUMM1N10_MUL_ONUMM1N10(LHS,RHS)&
    RESULT(RES)
    IMPLICIT NONE
    TYPE(ONUMM1N10), INTENT(IN) :: LHS 
    TYPE(ONUMM1N10), INTENT(IN) :: RHS 
  ...
  END FUNCTION ONUMM1N10_MUL_ONUMM1N10

  ELEMENTAL FUNCTION R_MUL_ONUMM1N10(LHS,RHS)&
    RESULT(RES)
    IMPLICIT NONE
    REAL(DP), INTENT(IN) :: LHS 
    TYPE(ONUMM1N10), INTENT(IN) :: RHS 
  ...
  END FUNCTION R_MUL_ONUMM1N10

  ELEMENTAL FUNCTION ONUMM1N10_MUL_R(LHS,RHS)&
    RESULT(RES)
    IMPLICIT NONE
    TYPE(ONUMM1N10), INTENT(IN) :: LHS 
    REAL(DP), INTENT(IN) :: RHS 
