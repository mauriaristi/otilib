...
cpdef e( object hum_dir, bases_t nbases = 0 , ord_t order = 0, uint64_t nip = 0):
  """
  PURPOSE:  To create a onumm3n2_t with value 1 at the specified imaginary direction
  ...
  if nip == 0: 
    ...
    # Create a onumm3n2_t
    ores = onumm3n2_createReal(0.0, order_res)

    # Set the coefficient to 1.
    onumm3n2_set_item(1.0, indx_hd, order_hd, &ores) 

    res = onumm3n2_t.create(&ores)

  else:
    
    fres = feonumm3n2_t(0.0, nip, order = order_res, nbases = nbases)

    feonumm3n2_set_im_r( 1.0, indx_hd, order_hd, &fres.num)
...
cpdef zero( bases_t nbases = 0 , ord_t order = 0, uint64_t nip = 0):
  ...
  if nip == 0: 
    ...
    # Create a onumm3n2_t
    ores = onumm3n2_createReal(0.0)

    res = onumm3n2_t.create(&ores)

  else:
    
    fres = feonumm3n2_t(0.0, nip, order = order, nbases = nbases)
...
cpdef one( bases_t nbases = 0 , ord_t order = 0, uint64_t nip = 0):
  ...
  if nip == 0: 
    ...
    # Create a onumm3n2_t
    ores = onumm3n2_createReal(1.0)

    res = onumm3n2_t.create(&ores)

  else:
    
    fres = feonumm3n2_t(1.0, nip, order = order, nbases = nbases)
...
cpdef number( coeff_t num, bases_t nbases = 0 , ord_t order = 0, uint64_t nip = 0):
  ...
  if nip == 0: 
    ...
    # Create a onumm3n2_t
    ores = onumm3n2_createReal(num)

    res = onumm3n2_t.create(&ores)

  else:
    
    fres = feonumm3n2_t(num, nip, order = order, nbases = nbases)
...
cpdef eye(uint64_t size, bases_t nbases = 0, ord_t order = 0, uint64_t nip = 0):
  ...
  if nip == 0:
    ...
    # This will create an oarrm3n2_t.
    Ores = oarrm3n2_eye(size,nbases,order)

    return oarrm3n2_t.create(&Ores)

  else:

    # This will create a feoarrm3n2_t
    Fres = feoarrm3n2_eye(size,nip,nbases,order)

    return feoarrm3n2_t.create(&Fres)
...
cpdef array( object arr, bases_t nbases = 0, ord_t order = 0, uint64_t nip = 0):
  ...
  cdef oarrm3n2_t   Oarr
  cdef feoarrm3n2_t Farr
  cdef oarrm3n2_t     Ores
  cdef feoarrm3n2_t   Fres
  cdef object res
  ...
  if (tin is oarrm3n2_t) or (tin is feoarrm3n2_t):
    ...
    if   np_arr.ndim == 0:
      ...
      if nip == 0:
        ...
        Oarr = oarrm3n2_zeros( nrows, ncols)
        Ores = oarrm3n2_t.create(&Oarr)
        Ores[0,0] = np_arr.item(0)
        res = Ores

      else:
 
        Farr = feoarrm3n2_zeros( nrows, ncols, nip)
        Fres = feoarrm3n2_t.create(&Farr)
...
cpdef zeros( object shape_in, bases_t nbases = 0, ord_t order = 0, uint64_t nip = 0):
  ...
  if nip == 0:
    ...
    # This will create an oarrm3n2_t.
    Ores = oarrm3n2_zeros(nrows,ncols,nbases,order)
    ...
    # This will create a feoarrm3n2_t
    Fres = feoarrm3n2_zeros(nrows,ncols,nip,nbases,order)
...
cpdef ones( object shape_in, bases_t nbases = 0, ord_t order = 0, uint64_t nip = 0):
  ...
  if nip == 0:
    ...
    # This will create an oarrm3n2_t.
    Ores = oarrm3n2_ones(nrows,ncols,nbases,order)
    ...
    # This will create a feoarrm3n2_t
    Fres = feoarrm3n2_ones(nrows,ncols,nip,nbases,order)
           # feoarrm3n2_ones(nrows,ncols,nip,nbases,order)
