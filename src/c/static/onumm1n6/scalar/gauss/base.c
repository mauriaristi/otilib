...
ord_t feonumm1n6_get_order( feonumm1n6_t* num ){
    ...
    for( i = 0; i<num->nip; i++ ){
        ...
        order = MAX(order, onumm1n6_get_order(&num->p_data[i]) );
...
void feonumm1n6_get_order_im_to( ord_t order, feonumm1n6_t* num, feonumm1n6_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm1n6_get_order_im_to( order, &num->p_data[k], &res->p_data[k]);
...
feonumm1n6_t feonumm1n6_get_order_im( ord_t order, feonumm1n6_t* num){
    ...
    res = feonumm1n6_zeros( num->nip);

    feonumm1n6_get_order_im_to( order, num, &res);
...
void feonumm1n6_extract_im_to( imdir_t idx, ord_t order, feonumm1n6_t* num, feonumm1n6_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm1n6_extract_im_to( idx, order, &num->p_data[k], &res->p_data[k]);
...
feonumm1n6_t feonumm1n6_extract_im( imdir_t idx, ord_t order, feonumm1n6_t* num){
    ...
    feonumm1n6_extract_im_to( idx, order, num, &res);
...
void feonumm1n6_extract_deriv_to( imdir_t idx, ord_t order, feonumm1n6_t* num, feonumm1n6_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm1n6_extract_deriv_to( idx, order, &num->p_data[k], &res->p_data[k]);
...
feonumm1n6_t feonumm1n6_extract_deriv( imdir_t idx, ord_t order, feonumm1n6_t* num){
    ...
    feonumm1n6_extract_deriv_to( idx, order, num, &res);
...
void feonumm1n6_get_deriv_to( imdir_t idx, ord_t order, feonumm1n6_t* num, feonumm1n6_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm1n6_get_deriv_to( idx, order, &num->p_data[k], &res->p_data[k]);
...
feonumm1n6_t feonumm1n6_get_deriv( imdir_t idx, ord_t order, feonumm1n6_t* num){
    ...
    feonumm1n6_get_deriv_to( idx, order, num, &res);
...
void feonumm1n6_get_im_to( imdir_t idx, ord_t order, feonumm1n6_t* num, feonumm1n6_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm1n6_get_im_to_o( idx, order, &num->p_data[k], &res->p_data[k]);
...
feonumm1n6_t feonumm1n6_get_im( imdir_t idx, ord_t order, feonumm1n6_t* num){
    ...
    feonumm1n6_get_im_to( idx, order, num, &res);
...
void feonumm1n6_truncate_im_to( imdir_t idx, ord_t order, feonumm1n6_t* num,  feonumm1n6_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm1n6_truncate_im_to( idx, order, &num->p_data[k], &res->p_data[k]);
...
feonumm1n6_t feonumm1n6_truncate_im( imdir_t idx, ord_t order, feonumm1n6_t* num){
    ...
    feonumm1n6_truncate_im_to( idx, order, num, &res);
...
void feonumm1n6_set_im_r( coeff_t val, imdir_t idx, ord_t order, feonumm1n6_t* num){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm1n6_set_im_r( val, idx, order, &num->p_data[k]);
...
void feonumm1n6_set_im_o( onumm1n6_t* val, imdir_t idx, ord_t order, feonumm1n6_t* num){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm1n6_set_im_o( val, idx, order, &num->p_data[k]);
...
void feonumm1n6_set_im_f( feonumm1n6_t* val, imdir_t idx, ord_t order, feonumm1n6_t* num){
    ...
    feonumm1n6_dimCheck(val,num);

    for (k = 0; k<num->nip; k++ ){
        
        onumm1n6_set_im_o( &val->p_data[k], idx, order, &num->p_data[k]);
...
void feonumm1n6_set_deriv_r( coeff_t val, imdir_t idx, ord_t order, feonumm1n6_t* num){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm1n6_set_deriv_r( val, idx, order, &num->p_data[k]);
...
void feonumm1n6_set_deriv_o( onumm1n6_t* val, imdir_t idx, ord_t order, feonumm1n6_t* num){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm1n6_set_deriv_o( val, idx, order, &num->p_data[k]);
...
void feonumm1n6_set_deriv_f( feonumm1n6_t* val, imdir_t idx, ord_t order, feonumm1n6_t* num){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm1n6_set_deriv_o( &val->p_data[k], idx, order, &num->p_data[k]);
...
// ****************************************************************************************************
void feonumm1n6_set_to( feonumm1n6_t* src, feonumm1n6_t* dst){
    
    uint64_t i;

    feonumm1n6_dimCheck(src,dst);

    for (i = 0; i<src->nip; i++ ){
        
        onumm1n6_copy_to( &src->p_data[i], &dst->p_data[i]);
...
feonumm1n6_t feonumm1n6_copy( feonumm1n6_t* src){
    ...
    res = feonumm1n6_createEmpty(src->nip);

    feonumm1n6_copy_to( src, &res);
...
void feonumm1n6_set_o( onumm1n6_t* num, feonumm1n6_t* res){
    ...
    for (i = 0; i<res->nip; i++ ){
        ...
        onumm1n6_set_o( num, &res->p_data[i]);
...
void feonumm1n6_set_r( coeff_t num, feonumm1n6_t* res){
    ...
    for (i = 0; i<res->nip; i++ ){
        ...
        onumm1n6_set_r( num, &res->p_data[i]);
...
void feonumm1n6_set_item_k_o( onumm1n6_t* num, uint64_t k, feonumm1n6_t* res){
    ...
    if (k < res->nip){
        ...
        onumm1n6_set_o(num, &res->p_data[k]); 

    } else {

        printf("ERROR: Index out of bounds in feonumm1n6_get_item_k.\n");
...
void feonumm1n6_set_item_k_r(   coeff_t  num, uint64_t k, feonumm1n6_t* res){
    ...
    if (k < res->nip){
        ...
        onumm1n6_set_r(num, &res->p_data[k]); 
...
void feonumm1n6_get_item_k_to(feonumm1n6_t* num, uint64_t k, onumm1n6_t* res){
    ...
    if (k < num->nip){
        ...
        onumm1n6_copy_to( &num->p_data[k], res);
...
// ****************************************************************************************************
feonumm1n6_t feonumm1n6_zeros(uint64_t nip){

    feonumm1n6_t  res  = feonumm1n6_createEmpty(nip);
    
    feonumm1n6_set_r( 0.0, &res);
...
// ****************************************************************************************************
inline feonumm1n6_t feonumm1n6_createEmpty(uint64_t nip){

    feonumm1n6_t  res ;  
    void * memory = NULL;

    // Allocate memory and check if correctly allocated.
    memory = malloc( nip * sizeof( onumm1n6_t ) );

    if ( memory == NULL ){
        printf("ERROR: Not enough memory to handle array of feonumm1n6.\n Exiting...\n");
        exit(OTI_OutOfMemory); // TODO: Raise error instead of quitting the program.
    }
    
    res.p_data = ( onumm1n6_t* ) memory;
    res.nip = nip;
...
// ****************************************************************************************************
inline feonumm1n6_t feonumm1n6_init(void){
...
// ****************************************************************************************************
inline feonumm1n6_t feonumm1n6_empty_like(feonumm1n6_t* arr){

    feonumm1n6_t res = feonumm1n6_createEmpty(arr->nip);
