...
void mdnum7_trunc_sum_oo_to(ord_t order, mdnum7_t* lhs,mdnum7_t* rhs, mdnum7_t* res);
void mdnum7_trunc_sub_oo_to(ord_t order, mdnum7_t* lhs,mdnum7_t* rhs, mdnum7_t* res);
