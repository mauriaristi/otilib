...
cdef class oarrm20n1_t:
  ...
  def __init__(self, realArray, ord_t order = 0, bases_t nbases = 0, object nnz = None): 
    """
    PURPOSE:      Python level constructor of the oarrm20n1_t class.
    ...
    if isinstance( realArray, np.ndarray):
      ...
      if ( ndim >= 3 ):
        ...
        self.arr = oarrm20n1_zeros( nrows, ncols)

        for i in range(self.arr.nrows):
      
          val = realArray[i]
          oarrm20n1_set_item_i_r( val, i, &self.arr)
        ...
        for i in range(self.arr.nrows):      
          for j in range(self.arr.ncols):
            ...
            val = realArray[i,j]
            oarrm20n1_set_item_ij_r( val, i, j, &self.arr)
  ...
  def T(self): 
    ...
    res = oarrm20n1_transpose( &self.arr)
  ...
  def order(self): 
    ...
    return oarrm20n1_get_order(&self.arr)
  ...
  #***************************************************************************************************
  @staticmethod
  cdef oarrm20n1_t create(oarrm20n1_t* arr, uint8_t FLAGS = 1):
    """
    ...
    cdef oarrm20n1_t mat = <oarrm20n1_t> oarrm20n1_t.__new__(oarrm20n1_t)
  ...
  def __repr__(self):
    ...
    #   out += "["
    #   for j in range(self.arr.ncols):
    #     d_onumm20n1 = oarrm20n1_get_item_ij(&self.arr, i, j)
    #     out+= (onumm20n1_t.create(&d_onumm20n1,FLAGS=0)).__str__()+", "
    #   # end for 
    #   out = out[:-2] + "],\n"
    # # end for 
    # out =out[:-2] + "]"
  ...
  def  __getitem__(self, val):
    ...
    if tval == int:
      ...
      if val < self.arr.nrows:
        ...
        Ores = oarrm20n1_get_slice( &self.arr, starti, stopi, stepi, startj, stopj, stepj)
        res  = oarrm20n1_t.create(&Ores)
  ...
  cdef __setitem__r(self, object val, coeff_t value):
    ...
    if tval == int:
      ...
      if val < self.arr.nrows:
        ...
        oarrm20n1_set_slice_r( value, starti, stopi, stepi, startj, stopj, stepj, &self.arr)
      ...
      if len(val) == 2:
        ...
        if ( tval0 == int and tval1 == int ):
          ...
          if val[0] < self.arr.nrows and val[1] < self.arr.ncols:
            ...
            oarrm20n1_set_item_ij_r( value, val[0], val[1], &self.arr)
  ...
  cdef __setitem__o(self,  object val, onumm20n1_t value):
    ...
    if tval == int:
      ...
      if val < self.arr.nrows:
        ...
        oarrm20n1_set_slice_o( &value.num, starti, stopi, stepi, startj, stopj, stepj, &self.arr)
      ...
      if len(val) == 2:
        ...
        if ( tval0 == int and tval1 == int ):
          ...
          if val[0] < self.arr.nrows and val[1] < self.arr.ncols:
            ...
            oarrm20n1_set_item_ij_o( &value.num, val[0], val[1], &self.arr)
  ...
  cdef __setitem__O(self,  object val, oarrm20n1_t value):
    ...
    if tval == int:
      ...
      if val < self.arr.nrows:
        ...
        oarrm20n1_set_slice_O( &value.arr, starti, stopi, stepi, startj, stopj, stepj, &self.arr)
  ...
  def copy(self):
    ...
    cdef oarrm20n1_t res = oarrm20n1_copy(&self.arr)
  ...
  def __neg__(self):
    ...
    cdef oarrm20n1_t res = oarrm20n1_neg(&self.arr)
  ...
  def __add__(self, other):
    ...
    if (tlhs == trhs):
      ...
      res = oarrm20n1_sum_OO(&lhs.arr,&rhs.arr)
      ...
      res = oarrm20n1_sum_oO(&olhs.num,&rhs.arr)
      ...
      res = oarrm20n1_sum_oO(&orhs.num,&lhs.arr)
    
    elif (tlhs in number_types):
      
      rhs = other
      res = oarrm20n1_sum_rO(self, &rhs.arr)

    elif (trhs in number_types):
        
      lhs = self
      res = oarrm20n1_sum_rO(other, &lhs.arr)
      ...
      res = oarrm20n1_sum_RO(&dlhs.arr,&rhs.arr)
      ...
      res = oarrm20n1_sum_RO(&drhs.arr,&lhs.arr)
  ...
  def __sub__(self, other):
    ...
    if (tlhs == trhs):
      ...
      res = oarrm20n1_sub_OO(&lhs.arr,&rhs.arr)
      ...
      res = oarrm20n1_sub_oO(&olhs.num,&rhs.arr)
      ...
      res = oarrm20n1_sub_Oo(&lhs.arr, &orhs.num)
    
    elif (tlhs in number_types):
      
      rhs = other
      res = oarrm20n1_sub_rO(self, &rhs.arr)

    elif (trhs in number_types):
        
      lhs = self
      res = oarrm20n1_sub_Or(&lhs.arr, other)
      ...
      res = oarrm20n1_sub_RO(&dlhs.arr,&rhs.arr)
      ...
      res = oarrm20n1_sub_OR(&lhs.arr, &drhs.arr)
  ...
  def __mul__(self, other):
    ...
    if (tlhs == trhs):
      ...
      res = oarrm20n1_mul_OO(&lhs.arr,&rhs.arr)
      ...
      res = oarrm20n1_mul_oO(&olhs.num,&rhs.arr)
      ...
      res = oarrm20n1_mul_oO(&orhs.num,&lhs.arr)
    
    elif (tlhs in number_types):
      
      rhs = other
      res = oarrm20n1_mul_rO(self, &rhs.arr)

    elif (trhs in number_types):
        
      lhs = self
      res = oarrm20n1_mul_rO(other, &lhs.arr)
      ...
      res = oarrm20n1_mul_RO(&dlhs.arr,&rhs.arr)
      ...
      res = oarrm20n1_mul_RO(&drhs.arr,&lhs.arr)
  ...
  def __truediv__(self, other):
    ...
    if (tlhs == trhs):
      ...
      res = oarrm20n1_div_OO(&lhs.arr,&rhs.arr)
      ...
      res = oarrm20n1_div_oO(&olhs.num,&rhs.arr)
      ...
      res = oarrm20n1_div_Oo(&lhs.arr, &orhs.num)
    
    elif (tlhs in number_types):
      
      rhs = other
      res = oarrm20n1_div_rO(self, &rhs.arr)

    elif (trhs in number_types):
        
      lhs = self
      res = oarrm20n1_div_Or(&lhs.arr, other)
      ...
      res = oarrm20n1_div_RO(&dlhs.arr,&rhs.arr)
      ...
      res = oarrm20n1_div_OR(&lhs.arr, &drhs.arr)
  ...
  def __pow__(self, n,z):
    ...
    cdef oarrm20n1_t res 
    cdef oarrm20n1_t S = self

    res = oarrm20n1_pow( &S.arr, n)
  ...
  cpdef get_im(self, object hum_dir):
    """
    PURPOSE: Get the corresponding imaginary direction in the oarrm20n1_t object.
    """
    #*************************************************************************************************
    ...
    res_darr = oarrm20n1_get_im( item[ZERO],  item[ONE], &self.arr)
  ...
  cpdef extract_im(self, object hum_dir):
    ...
    res = oarrm20n1_extract_im( item[ZERO],  item[ONE], &self.arr)
  ...
  cpdef  extract_deriv(self, object hum_dir):
    ...
    res = oarrm20n1_extract_deriv( item[ZERO],  item[ONE], &self.arr)
  ...
  cpdef  get_order_im(self, ord_t order):
    ...
    res = oarrm20n1_get_order_im( order, &self.arr)
  ...
  cpdef  truncate( self, object humdir):
    ...
    res = oarrm20n1_truncate_im( indx, order, &self.arr) 
  ...
  cpdef set(self, object rhs):
    ...
    if   trhs is onumm20n1_t:
      ...
      orhs = rhs
      oarrm20n1_set_o( &orhs.num, &self.arr)

    elif trhs is oarrm20n1_t:

      Orhs = rhs
      oarrm20n1_set_O( &Orhs.arr, &self.arr)      

    elif trhs in number_types:

      rrhs = rhs
      oarrm20n1_set_r( rrhs, &self.arr)

    else:

      raise ValueError( "Cant assign '{0}' into a oarrm20n1_t object.".format(trhs) )
  ...
  def get_active_bases(self):
    ...
    oarrm20n1_get_active_bases( &self.arr, bases_list)
  ...
  def taylor_integrate(self, object bases, object deltas):
    ...
    res = oarrm20n1_taylor_integrate( c_deltas, &self.arr)
  ...
  #***************************************************************************************************
  @staticmethod
  def dot( oarrm20n1_t lhs, oarrm20n1_t rhs, oarrm20n1_t out = None): 
    """
    ...
    if out is not None:
      ...
      oarrm20n1_matmul_OO_to( &lhs.arr, &rhs.arr ,&out.arr)

    else:

      res = oarrm20n1_matmul_OO( &lhs.arr, &rhs.arr )
  ...
  #***************************************************************************************************
  @staticmethod
  def inv( oarrm20n1_t arr,  oarrm20n1_t out = None): 
    """
    ...
    if out is not None:
      ...
      oarrm20n1_invert_to( &arr.arr,&out.arr)

    else:

      res = oarrm20n1_invert( &arr.arr)
  ...
  #***************************************************************************************************
  @staticmethod
  def transpose( oarrm20n1_t arr,  oarrm20n1_t out = None ): 
    """
    ...
    if out is not None:
      ...
      oarrm20n1_transpose_to( &arr.arr, &out.arr)

    else:

      res = oarrm20n1_transpose( &arr.arr)
  ...
  #***************************************************************************************************
  @staticmethod
  def add( oarrm20n1_t lhs, oarrm20n1_t rhs, oarrm20n1_t out = None): 
    """
    ...
    if out is not None:
      ...
      oarrm20n1_sum_OO_to( &lhs.arr, &rhs.arr ,&out.arr)
