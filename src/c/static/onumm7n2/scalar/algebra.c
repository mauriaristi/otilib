...
onumm7n2_t onumm7n2_div_ro(coeff_t num, onumm7n2_t* den){
    ...
    onumm7n2_t inv = onumm7n2_pow(den,-1);
    onumm7n2_t res = onumm7n2_mul_ro(num,&inv);
...
onumm7n2_t onumm7n2_div_oo(onumm7n2_t* num, onumm7n2_t* den){
    ...
    onumm7n2_t res = onumm7n2_mul_oo(num,&inv);
...
onumm7n2_t onumm7n2_div_or(onumm7n2_t* num, coeff_t val){
    ...
    return onumm7n2_mul_ro(1.0/val,num);
...
onumm7n2_t onumm7n2_feval(coeff_t* feval_re, onumm7n2_t* x){
  ...
  onumm7n2_t deltax = (*x), deltax_power = (*x);
  deltax.r = 0.0;
  deltax_power.r = 0.0;
  onumm7n2_set_r(0.0, &res);
  //  Real
  res.r = feval_re[0];
  // Order 1
  factor *=1;
  coef    = feval_re[1]/ factor;;
  onumm7n2_gem_ro_to( coef, &deltax_power, &res, &res);
  deltax_power = onumm7n2_mul_oo(&deltax_power,&deltax);
  // Order 2
  factor *=2;
