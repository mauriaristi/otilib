...
ord_t feonumm1n8_get_order( feonumm1n8_t* num ){
    ...
    for( i = 0; i<num->nip; i++ ){
        ...
        order = MAX(order, onumm1n8_get_order(&num->p_data[i]) );
...
void feonumm1n8_get_order_im_to( ord_t order, feonumm1n8_t* num, feonumm1n8_t* res){
    ...
    feonumm1n8_dimCheck(num,res);

    for (k = 0; k<num->nip; k++ ){
        
        onumm1n8_get_order_im_to( order, &num->p_data[k], &res->p_data[k]);
...
feonumm1n8_t feonumm1n8_get_order_im( ord_t order, feonumm1n8_t* num){
    ...
    res = feonumm1n8_zeros( num->nip);

    feonumm1n8_get_order_im_to( order, num, &res);
...
void feonumm1n8_extract_im_to( imdir_t idx, ord_t order, feonumm1n8_t* num, feonumm1n8_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm1n8_extract_im_to( idx, order, &num->p_data[k], &res->p_data[k]);
...
feonumm1n8_t feonumm1n8_extract_im( imdir_t idx, ord_t order, feonumm1n8_t* num){
    ...
    feonumm1n8_extract_im_to( idx, order, num, &res);
...
void feonumm1n8_extract_deriv_to( imdir_t idx, ord_t order, feonumm1n8_t* num, feonumm1n8_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm1n8_extract_deriv_to( idx, order, &num->p_data[k], &res->p_data[k]);
...
feonumm1n8_t feonumm1n8_extract_deriv( imdir_t idx, ord_t order, feonumm1n8_t* num){
    ...
    feonumm1n8_extract_deriv_to( idx, order, num, &res);
...
void feonumm1n8_get_deriv_to( imdir_t idx, ord_t order, feonumm1n8_t* num, feonumm1n8_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm1n8_get_deriv_to( idx, order, &num->p_data[k], &res->p_data[k]);
...
feonumm1n8_t feonumm1n8_get_deriv( imdir_t idx, ord_t order, feonumm1n8_t* num){
    ...
    feonumm1n8_get_deriv_to( idx, order, num, &res);
...
void feonumm1n8_get_im_to( imdir_t idx, ord_t order, feonumm1n8_t* num, feonumm1n8_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm1n8_get_im_to_o( idx, order, &num->p_data[k], &res->p_data[k]);
...
feonumm1n8_t feonumm1n8_get_im( imdir_t idx, ord_t order, feonumm1n8_t* num){
    ...
    feonumm1n8_get_im_to( idx, order, num, &res);
...
void feonumm1n8_truncate_im_to( imdir_t idx, ord_t order, feonumm1n8_t* num,  feonumm1n8_t* res){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm1n8_truncate_im_to( idx, order, &num->p_data[k], &res->p_data[k]);
...
feonumm1n8_t feonumm1n8_truncate_im( imdir_t idx, ord_t order, feonumm1n8_t* num){
    ...
    feonumm1n8_truncate_im_to( idx, order, num, &res);
...
void feonumm1n8_set_im_r( coeff_t val, imdir_t idx, ord_t order, feonumm1n8_t* num){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm1n8_set_im_r( val, idx, order, &num->p_data[k]);
...
void feonumm1n8_set_im_o( onumm1n8_t* val, imdir_t idx, ord_t order, feonumm1n8_t* num){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm1n8_set_im_o( val, idx, order, &num->p_data[k]);
...
void feonumm1n8_set_im_f( feonumm1n8_t* val, imdir_t idx, ord_t order, feonumm1n8_t* num){
    ...
    feonumm1n8_dimCheck(val,num);

    for (k = 0; k<num->nip; k++ ){
        
        onumm1n8_set_im_o( &val->p_data[k], idx, order, &num->p_data[k]);
...
void feonumm1n8_set_deriv_r( coeff_t val, imdir_t idx, ord_t order, feonumm1n8_t* num){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm1n8_set_deriv_r( val, idx, order, &num->p_data[k]);
...
void feonumm1n8_set_deriv_o( onumm1n8_t* val, imdir_t idx, ord_t order, feonumm1n8_t* num){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm1n8_set_deriv_o( val, idx, order, &num->p_data[k]);
...
void feonumm1n8_set_deriv_f( feonumm1n8_t* val, imdir_t idx, ord_t order, feonumm1n8_t* num){
    ...
    for (k = 0; k<num->nip; k++ ){
        ...
        onumm1n8_set_deriv_o( &val->p_data[k], idx, order, &num->p_data[k]);
...
// ****************************************************************************************************
void feonumm1n8_set_to( feonumm1n8_t* src, feonumm1n8_t* dst){
    
    uint64_t i;

    feonumm1n8_dimCheck(src,dst);

    for (i = 0; i<src->nip; i++ ){
        
        onumm1n8_copy_to( &src->p_data[i], &dst->p_data[i]);
...
feonumm1n8_t feonumm1n8_copy( feonumm1n8_t* src){
    ...
    res = feonumm1n8_createEmpty(src->nip);

    feonumm1n8_copy_to( src, &res);
...
void feonumm1n8_set_o( onumm1n8_t* num, feonumm1n8_t* res){
    ...
    for (i = 0; i<res->nip; i++ ){
        ...
        onumm1n8_set_o( num, &res->p_data[i]);
...
void feonumm1n8_set_r( coeff_t num, feonumm1n8_t* res){
    ...
    for (i = 0; i<res->nip; i++ ){
        ...
        onumm1n8_set_r( num, &res->p_data[i]);
...
void feonumm1n8_set_item_k_o( onumm1n8_t* num, uint64_t k, feonumm1n8_t* res){
    ...
    if (k < res->nip){
        ...
        onumm1n8_set_o(num, &res->p_data[k]); 

    } else {

        printf("ERROR: Index out of bounds in feonumm1n8_get_item_k.\n");
...
void feonumm1n8_set_item_k_r(   coeff_t  num, uint64_t k, feonumm1n8_t* res){
    ...
    if (k < res->nip){
        ...
        onumm1n8_set_r(num, &res->p_data[k]); 
...
void feonumm1n8_get_item_k_to(feonumm1n8_t* num, uint64_t k, onumm1n8_t* res){
    ...
    if (k < num->nip){
        ...
        onumm1n8_copy_to( &num->p_data[k], res);
...
// ****************************************************************************************************
feonumm1n8_t feonumm1n8_zeros(uint64_t nip){

    feonumm1n8_t  res  = feonumm1n8_createEmpty(nip);
    
    feonumm1n8_set_r( 0.0, &res);
...
// ****************************************************************************************************
inline feonumm1n8_t feonumm1n8_createEmpty(uint64_t nip){

    feonumm1n8_t  res ;  
    void * memory = NULL;

    // Allocate memory and check if correctly allocated.
    memory = malloc( nip * sizeof( onumm1n8_t ) );

    if ( memory == NULL ){
        printf("ERROR: Not enough memory to handle array of feonumm1n8.\n Exiting...\n");
        exit(OTI_OutOfMemory); // TODO: Raise error instead of quitting the program.
    }
    
    res.p_data = ( onumm1n8_t* ) memory;
    res.nip = nip;
...
// ****************************************************************************************************
inline feonumm1n8_t feonumm1n8_init(void){
...
// ****************************************************************************************************
inline feonumm1n8_t feonumm1n8_empty_like(feonumm1n8_t* arr){

    feonumm1n8_t res = feonumm1n8_createEmpty(arr->nip);
