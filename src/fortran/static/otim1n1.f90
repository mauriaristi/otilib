MODULE otim1n1
   ...
   INTERFACE OPERATOR(**)
      MODULE PROCEDURE ONUMM1N1_POW_OR,ONUMM1N1_POW_RO,ONUMM1N1_POW_I8O,ONUMM1N1_POW_I4O,&
                       ONUMM1N1_POW_OI8,ONUMM1N1_POW_OI4,ONUMM1N1_POW_OO
   END INTERFACE
   ...
   INTERFACE MAX
      MODULE PROCEDURE ONUMM1N1_MAX
   END INTERFACE

   INTERFACE MIN
      MODULE PROCEDURE ONUMM1N1_MIN
   END INTERFACE

   INTERFACE MAXLOC
      MODULE PROCEDURE ONUMM1N1_MAXLOC_R1,ONUMM1N1_MAXLOC_R2,ONUMM1N1_MAXLOC_R3,ONUMM1N1_MAXLOC_R4
   END INTERFACE

   INTERFACE MAXVAL
      MODULE PROCEDURE ONUMM1N1_MAXVAL_R1,ONUMM1N1_MAXVAL_R2,ONUMM1N1_MAXVAL_R3,ONUMM1N1_MAXVAL_R4
   END INTERFACE

   INTERFACE MINLOC
      MODULE PROCEDURE ONUMM1N1_MINLOC_R1,ONUMM1N1_MINLOC_R2,ONUMM1N1_MINLOC_R3,ONUMM1N1_MINLOC_R4
   END INTERFACE

   INTERFACE MINVAL
      MODULE PROCEDURE ONUMM1N1_MINVAL_R1,ONUMM1N1_MINVAL_R2,ONUMM1N1_MINVAL_R3,ONUMM1N1_MINVAL_R4
   END INTERFACE
...
FUNCTION ONUMM1N1_GETIM_M(VAL,IDX) RESULT(RES)
  ...
  FUNCTION ONUMM1N1_MAX(X1,X2) RESULT(RES)
      IMPLICIT NONE
      TYPE(ONUMM1N1), INTENT(IN) :: X1, X2
                                                
      TYPE(ONUMM1N1) :: RES
      RES = X1
      IF (X2>RES) RES = X2  

  END FUNCTION ONUMM1N1_MAX

  FUNCTION ONUMM1N1_MIN(X1,X2) RESULT(RES)
      IMPLICIT NONE
      TYPE(ONUMM1N1), INTENT(IN) :: X1, X2
  ...
  END FUNCTION ONUMM1N1_MIN

  FUNCTION ONUMM1N1_MAXLOC_R1(ARRAY, MASK, BACK) RESULT(RES)
      IMPLICIT NONE
      TYPE(ONUMM1N1), INTENT(IN) :: ARRAY(:)
  ...
  END FUNCTION ONUMM1N1_MAXLOC_R1

  FUNCTION ONUMM1N1_MAXLOC_R2(ARRAY, MASK, BACK) RESULT(RES)
      IMPLICIT NONE
      TYPE(ONUMM1N1), INTENT(IN) :: ARRAY(:,:)
  ...
  END FUNCTION ONUMM1N1_MAXLOC_R2
  
  FUNCTION ONUMM1N1_MAXLOC_R3(ARRAY, MASK, BACK) RESULT(RES)
      IMPLICIT NONE
      TYPE(ONUMM1N1), INTENT(IN) :: ARRAY(:,:,:)
  ...
  END FUNCTION ONUMM1N1_MAXLOC_R3

  FUNCTION ONUMM1N1_MAXLOC_R4(ARRAY, MASK, BACK) RESULT(RES)
      IMPLICIT NONE
      TYPE(ONUMM1N1), INTENT(IN) :: ARRAY(:,:,:,:)
  ...
  END FUNCTION ONUMM1N1_MAXLOC_R4

  
  FUNCTION ONUMM1N1_MAXVAL_R1(ARRAY) RESULT(RES)
      IMPLICIT NONE
      TYPE(ONUMM1N1), INTENT(IN) :: ARRAY(:)
  ...
  END FUNCTION ONUMM1N1_MAXVAL_R1

  FUNCTION ONUMM1N1_MAXVAL_R2(ARRAY) RESULT(RES)
      IMPLICIT NONE
      TYPE(ONUMM1N1), INTENT(IN) :: ARRAY(:,:)
      INTEGER :: IDX( RANK( ARRAY ) )
      TYPE(ONUMM1N1) :: RES
  ...
  END FUNCTION ONUMM1N1_MAXVAL_R2

  FUNCTION ONUMM1N1_MAXVAL_R3(ARRAY) RESULT(RES)
      IMPLICIT NONE
      TYPE(ONUMM1N1), INTENT(IN) :: ARRAY(:,:,:)
      INTEGER :: IDX( RANK( ARRAY ) )
      TYPE(ONUMM1N1) :: RES
  ...
  END FUNCTION ONUMM1N1_MAXVAL_R3

  FUNCTION ONUMM1N1_MAXVAL_R4(ARRAY) RESULT(RES)
      IMPLICIT NONE
      TYPE(ONUMM1N1), INTENT(IN) :: ARRAY(:,:,:,:)
      INTEGER :: IDX( RANK( ARRAY ) )
      TYPE(ONUMM1N1) :: RES
  ...
  END FUNCTION ONUMM1N1_MAXVAL_R4


    FUNCTION ONUMM1N1_MINLOC_R1(ARRAY, MASK, BACK) RESULT(RES)
      IMPLICIT NONE
      TYPE(ONUMM1N1), INTENT(IN) :: ARRAY(:)
      LOGICAL, INTENT(IN), OPTIONAL :: MASK(SIZE(ARRAY,1))
      LOGICAL, INTENT(IN), OPTIONAL :: BACK  ! Search from the back
  ...
  END FUNCTION ONUMM1N1_MINLOC_R1

  FUNCTION ONUMM1N1_MINLOC_R2(ARRAY, MASK, BACK) RESULT(RES)
      IMPLICIT NONE
      TYPE(ONUMM1N1), INTENT(IN) :: ARRAY(:,:)
      LOGICAL, INTENT(IN), OPTIONAL :: MASK(SIZE(ARRAY,1),SIZE(ARRAY,2))
      LOGICAL, INTENT(IN), OPTIONAL :: BACK  ! Search from the back
  ...
  END FUNCTION ONUMM1N1_MINLOC_R2
  
  FUNCTION ONUMM1N1_MINLOC_R3(ARRAY, MASK, BACK) RESULT(RES)
      IMPLICIT NONE
      TYPE(ONUMM1N1), INTENT(IN) :: ARRAY(:,:,:)
      LOGICAL, INTENT(IN), OPTIONAL :: MASK(SIZE(ARRAY,1),SIZE(ARRAY,2),SIZE(ARRAY,3))
      LOGICAL, INTENT(IN), OPTIONAL :: BACK  ! Search from the back
  ...
  END FUNCTION ONUMM1N1_MINLOC_R3

  FUNCTION ONUMM1N1_MINLOC_R4(ARRAY, MASK, BACK) RESULT(RES)
      IMPLICIT NONE
      TYPE(ONUMM1N1), INTENT(IN) :: ARRAY(:,:,:,:)
      LOGICAL, INTENT(IN), OPTIONAL :: MASK(SIZE(ARRAY,1),SIZE(ARRAY,2),SIZE(ARRAY,3),SIZE(ARRAY,4))
      LOGICAL, INTENT(IN), OPTIONAL :: BACK  ! Search from the back
  ...
  END FUNCTION ONUMM1N1_MINLOC_R4



  FUNCTION ONUMM1N1_MINVAL_R1(ARRAY) RESULT(RES)
      IMPLICIT NONE
      TYPE(ONUMM1N1), INTENT(IN) :: ARRAY(:)
      INTEGER :: IDX( RANK( ARRAY ) )
      TYPE(ONUMM1N1) :: RES
  ...
  END FUNCTION ONUMM1N1_MINVAL_R1

  FUNCTION ONUMM1N1_MINVAL_R2(ARRAY) RESULT(RES)
      IMPLICIT NONE
      TYPE(ONUMM1N1), INTENT(IN) :: ARRAY(:,:)
      INTEGER :: IDX( RANK( ARRAY ) )
      TYPE(ONUMM1N1) :: RES
  ...
  END FUNCTION ONUMM1N1_MINVAL_R2

  FUNCTION ONUMM1N1_MINVAL_R3(ARRAY) RESULT(RES)
      IMPLICIT NONE
      TYPE(ONUMM1N1), INTENT(IN) :: ARRAY(:,:,:)
      INTEGER :: IDX( RANK( ARRAY ) )
      TYPE(ONUMM1N1) :: RES
  ...
  END FUNCTION ONUMM1N1_MINVAL_R3

  FUNCTION ONUMM1N1_MINVAL_R4(ARRAY) RESULT(RES)
      IMPLICIT NONE
      TYPE(ONUMM1N1), INTENT(IN) :: ARRAY(:,:,:,:)
      INTEGER :: IDX( RANK( ARRAY ) )
      TYPE(ONUMM1N1) :: RES
  ...
  END FUNCTION ONUMM1N1_MINVAL_R4

  ! FUNCTION ONUMM1N1_MAXLOC_DIM_R1(ARRAY, DIM, MASK, KIND, BACK) RESULT(RES)
  !     IMPLICIT NONE
  !     TYPE(ONUMM1N1), INTENT(IN) :: ARRAY(:)
  ...
  ! END FUNCTION ONUMM1N1_MAXLOC_DIM_R1

  ! FUNCTION ONUMM1N1_MAXLOC_DIM_R2(ARRAY, DIM, MASK, KIND, BACK) RESULT(RES)
  !     IMPLICIT NONE
  !     TYPE(ONUMM1N1), INTENT(IN) :: ARRAY(:,:)
  !     INTEGER, INTENT(IN) :: DIM  
  !     LOGICAL, INTENT(IN), OPTIONAL :: MASK(SIZE(ARRAY,1),SIZE(ARRAY,2))
  ...
  ! END FUNCTION ONUMM1N1_MAXLOC_DIM_R2
  
  ! FUNCTION ONUMM1N1_MAXLOC_DIM_R3(ARRAY, DIM, MASK, KIND, BACK) RESULT(RES)
  !     IMPLICIT NONE
  !     TYPE(ONUMM1N1), INTENT(IN) :: ARRAY(:,:,:)
  !     INTEGER, INTENT(IN) :: DIM  
  !     LOGICAL, INTENT(IN), OPTIONAL :: MASK(SIZE(ARRAY,1),SIZE(ARRAY,2),SIZE(ARRAY,3))
  ...
  ! END FUNCTION ONUMM1N1_MAXLOC_DIM_R3

  ! FUNCTION ONUMM1N1_MAXLOC_DIM_R4(ARRAY, DIM, MASK, KIND, BACK) RESULT(RES)
  !     IMPLICIT NONE
  !     TYPE(ONUMM1N1), INTENT(IN) :: ARRAY(:,:,:,:)
  !     INTEGER, INTENT(IN) :: DIM  
  !     LOGICAL, INTENT(IN), OPTIONAL :: MASK(SIZE(ARRAY,1),SIZE(ARRAY,2),SIZE(ARRAY,3),SIZE(ARRAY,4))
  ...
  ! END FUNCTION ONUMM1N1_MAXLOC_DIM_R4
   ...
   ELEMENTAL FUNCTION ONUMM1N1_POW_I8O(E,X) RESULT(RES)

      TYPE(ONUMM1N1), INTENT(IN) :: X
      INTEGER(8), INTENT(IN) :: E
      TYPE(ONUMM1N1) :: RES
      
      RES = ONUMM1N1_POW_RO(REAL(E,8),X)
      
   END FUNCTION 

   ELEMENTAL FUNCTION ONUMM1N1_POW_I4O(E,X) RESULT(RES)
   ...
   ELEMENTAL FUNCTION ONUMM1N1_POW_OI8(X,E) RESULT(RES)

      TYPE(ONUMM1N1), INTENT(IN) :: X
      INTEGER(8), INTENT(IN) :: E
      TYPE(ONUMM1N1) :: RES
      
      RES = ONUMM1N1_POW_OR(X,REAL(E,8))
      
   END FUNCTION 

   ELEMENTAL FUNCTION ONUMM1N1_POW_OI4(X,E) RESULT(RES)
